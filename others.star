...
v8_builder(
    ...
    bucket = "ci",
    triggered_by = ["v8-trigger"],
    console_info = {"category": "V8", "console_view": "experiments", "short_name": None},
...
v8_builder(
    ...
    bucket = "ci",
    triggered_by = ["v8-trigger"],
    console_info = {"category": "Layout", "console_view": "integration", "short_name": None},
...
v8_builder(
    ...
    bucket = "ci",
    triggered_by = ["v8-trigger"],
    console_info = {"category": "Nonlayout", "console_view": "integration", "short_name": None},
...
v8_builder(
    ...
    bucket = "ci",
    triggered_by = ["v8-trigger"],
    console_info = {"category": "GPU", "console_view": "integration", "short_name": None},
    executable = {"name": "chromium_integration"},
    dimensions = {"os": "Windows-10", "cpu": "x86-64"},
    execution_timeout = 10800,
    properties = {"$build/goma": {"server_host": "goma.chromium.org", "enable_ats": True, "rpc_extra_params": "?prod"}, "mastername": "client.v8.fyi"},
...
v8_builder(
    ...
    bucket = "ci",
    triggered_by = ["v8-trigger"],
    console_info = {"category": "Node.js", "console_view": "integration", "short_name": None},
...
v8_builder(
    ...
    console_info = {"category": "Windows", "console_view": "clusterfuzz", "short_name": None},
    dimensions = {"os": "Windows-10", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Mac", "console_view": "clusterfuzz", "short_name": None},
    dimensions = {"os": "Mac-10.13", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Linux", "console_view": "clusterfuzz", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    name = "V8 NumFuzz",
    bucket = "ci",
    console_info = {"category": "Fuzzers", "console_view": "clusterfuzz", "short_name": None},
    dimensions = {"host_class": "multibot"},
    execution_timeout = 19800,
...
v8_builder(
    ...
    console_info = {"category": "Future", "console_view": "chromium", "short_name": None},
    executable = {"name": "chromium"},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Linux", "console_view": "official", "short_name": None},
...
v8_builder(
    ...
    console_info = {"category": "Windows", "console_view": "official", "short_name": None},
    executable = {"name": "v8/archive"},
    dimensions = {"os": "Windows-10", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Mac", "console_view": "official", "short_name": None},
    executable = {"name": "v8/archive"},
    dimensions = {"os": "Mac-10.13", "cpu": "x86-64"},
    properties = {"build_config": "Release", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "mastername": "client.v8.official", "target_bits": 64},
    caches = [
...
v8_builder(
    ...
    console_info = {"category": "Arm", "console_view": "perf", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Arm64", "console_view": "perf", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Linux", "console_view": "perf", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Linux64", "console_view": "perf", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"triggers_proxy": True, "build_config": "Release", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "mastername": "client.v8.perf"},
)
...
v8_builder(
    ...
    console_info = {"category": None, "console_view": "tryserver", "short_name": None},
...
v8_builder(
    ...
    console_info = {"category": "Linux64", "console_view": "br.beta", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    bucket = "ci.br.beta",
    triggered_by = ["v8-trigger-br-beta"],
    console_info = {"category": "Fuchsia", "console_view": "br.beta", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
...
v8_builder(
    ...
    console_info = {"category": "Linux64", "console_view": "br.stable", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"triggers": ["V8 Linux64"], "mastername": "client.v8", "track_build_dependencies": True, "build_config": "Release", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "binary_size_tracking": {"category": "linux64", "binary": "d8"}},
)
v8_builder(
...
v8_builder(
    ...
    bucket = "ci.br.stable",
    triggered_by = ["v8-trigger-br-stable"],
    console_info = {"category": "Fuchsia", "console_view": "br.stable", "short_name": None},
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"build_config": "Release", "target_platform": "fuchsia", "mastername": "client.v8", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}},
)
