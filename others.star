...
v8_builder(
    ...
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "v8_tot": True, "mastername": "client.v8.fyi", "triggers": ["v8_node_linux64_perf"]},
)
v8_builder(
...
v8_builder(
    ...
    bucket = "ci.br.beta",
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"triggers": ["BETA V8 Linux64"], "mastername": "client.v8", "track_build_dependencies": True, "build_config": "Release", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "binary_size_tracking": {"category": "linux64", "binary": "d8"}},
)
v8_builder(
    name = "V8 Linux64 - debug builder",
    bucket = "ci.br.beta",
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"build_config": "Debug", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "mastername": "client.v8", "set_gclient_var": "download_jsfunfuzz", "triggers": ["BETA V8 Fuzzer", "BETA V8 Linux64 - debug"]},
)
v8_builder(
    name = "V8 Fuchsia - builder",
    bucket = "ci.br.beta",
...
v8_builder(
    ...
    bucket = "ci.br.stable",
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"triggers": ["STABLE V8 Linux64"], "mastername": "client.v8", "track_build_dependencies": True, "build_config": "Release", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "binary_size_tracking": {"category": "linux64", "binary": "d8"}},
)
v8_builder(
    name = "V8 Linux64 - debug builder",
    bucket = "ci.br.stable",
    dimensions = {"os": "Ubuntu-16.04", "cpu": "x86-64"},
    properties = {"build_config": "Debug", "$build/goma": {"server_host": "goma.chromium.org", "rpc_extra_params": "?prod"}, "mastername": "client.v8", "set_gclient_var": "download_jsfunfuzz", "triggers": ["STABLE V8 Fuzzer", "STABLE V8 Linux64 - debug"]},
)
v8_builder(
    name = "V8 Fuchsia - builder",
    bucket = "ci.br.stable",
