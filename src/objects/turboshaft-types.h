...
class TurboshaftTypeKind {
 public:
  DEFINE_TORQUE_GENERATED_TURBOSHAFT_TYPE_KIND()
};
...
class TurboshaftFloat32Type
    : public TorqueGeneratedTurboshaftFloat32Type<TurboshaftFloat32Type,
                                                  TurboshaftType> {
 public:
  class BodyDescriptor;

  TQ_OBJECT_CONSTRUCTORS(TurboshaftFloat32Type)
};
