...
class JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor
    : public BodyDescriptorBase {
 public:
  template <typename ObjectVisitor>
  static inline void IterateJSObjectWithEmbedderSlotsHeader(
    ...
    // Visit JSObjectWithEmbedderSlots or JSSpecialObject header.
  ...
  static inline void IterateJSObjectWithEmbedderSlotsTail(
      Tagged<Map> map, Tagged<HeapObject> obj, int object_size,
      ObjectVisitor* v) {
  ...
  static_assert(Internals::kJSObjectWithEmbedderSlotsHeaderSize ==
                JSSpecialObject::kHeaderSize);
};

class JSObjectWithEmbedderSlots::BodyDescriptor
    : public JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor {
 public:
  template <typename ObjectVisitor>
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
                                 int object_size, ObjectVisitor* v) {
    IterateJSObjectWithEmbedderSlotsHeader(map, obj, object_size, v);
    IterateJSObjectWithEmbedderSlotsTail<
        JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor>(
...
class JSArrayBuffer::BodyDescriptor final
 ...
 public:
  ...
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
    ...
    IterateJSObjectWithEmbedderSlotsTail<JSArrayBuffer>(map, obj, object_size,
                                                        v);
  }
...
class JSTypedArray::BodyDescriptor : public JSArrayBufferView::BodyDescriptor {
 public:
  ...
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
    ...
    // JSObject tail: embedder fields + in-object properties.
    IterateJSObjectWithEmbedderSlotsTail<JSTypedArray>(map, obj, object_size,
                                                       v);
  }
...
class JSDataViewOrRabGsabDataView::BodyDescriptor final
 ...
 public:
  ...
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
    ...
    // JSObject tail: embedder fields + in-object properties.
    IterateJSObjectWithEmbedderSlotsTail<JSDataViewOrRabGsabDataView>(
        map, obj, object_size, v);
  }
...
#undef CASE
    ...
    case JS_SPECIAL_API_OBJECT_TYPE:
      return Op::template apply<JSObjectWithEmbedderSlots::BodyDescriptor,
