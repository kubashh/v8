...
class JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor
 ...
 public:
  ...
  static_assert(Internals::kJSObjectWithEmbedderSlotsHeaderSize == kHeaderSize);
};
...
class JSObjectWithEmbedderSlots::BodyDescriptor : public BodyDescriptorBase {
 public:
  ...
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
                                 int object_size, int tail_start_index,
                                 ObjectVisitor* v) {
    JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor::IterateBody(
        map, obj, object_size, tail_start_index, v);
  }
 ...
 public:
  ...
  static inline void IterateBody(Tagged<Map> map, Tagged<HeapObject> obj,
    ...
    IteratePointers(obj, kStartOfStrongFieldsOffset, kEndOfStrongFieldsOffset,
                    v);
    // JSObjectWithEmbedderSlots (including JSObject).
    Base::IterateBody(map, obj, object_size, tail_start_index, v);
  }
};
...
#undef CASE
    ...
    case JS_SPECIAL_API_OBJECT_TYPE:
      return Op::template apply<
          JSObjectWithEmbedderSlotsOrJSSpecialObjectBodyDescriptor, false>(
          std::forward<Args>(args)...);
