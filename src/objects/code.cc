...
int AbstractCode::SourcePosition(int offset) {
  ...
  if (IsBytecodeArray()) {
    ...
    DCHECK(BytecodeArray::cast(*this)->HasSourcePositionTable());
  }
...
void Code::Disassemble(const char* name, std::ostream& os, Address current_pc) {
  ...
  {
    SourcePositionTableIterator it(SourcePositionTableOrEmpty(),
...
void BytecodeArray::Disassemble(std::ostream& os) {
  ...
  SourcePositionTableIterator source_positions(SourcePositionTableOrEmpty());
