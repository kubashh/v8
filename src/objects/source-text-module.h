...
class SourceTextModule
 ...
 private:
  ...
  // child. The integer is a per-module graph ordinal for when this module first
  // started async evaluation and is used for sorting async parent modules when
  // determining which parent module can start executing after an async
