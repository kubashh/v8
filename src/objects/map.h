...
class Map : public HeapObject {
 public:
  ...
  class HasNoInterestingSymbols : public BitField<bool, 28, 1> {};
  ...
  // Tells whether the instance with this map definitely doesn't have any
  // properties for interesting symbols on it.
  // An "interesting symbol" is one for which Name::IsInterestingSymbol()
  // returns true, i.e. a well-known symbol like @@toStringTag.
  inline void set_has_no_interesting_symbols(bool value);
  inline bool has_no_interesting_symbols() const;
