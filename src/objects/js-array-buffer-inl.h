...
DEF_GETTER(JSArrayBuffer, backing_store, void*) {
  ...
  Address value =
      ReadCagedPointerFieldAllowNullptr(kBackingStoreOffset, cage_base);
#else
...
#ifdef V8_HEAP_SANDBOX
  WriteCagedPointerFieldAllowNullptr(kBackingStoreOffset, isolate, addr);
#else
...
#ifdef V8_HEAP_SANDBOX
  return ReadCagedPointerFieldAllowNullptr(kExternalPointerOffset, cage_base);
#else
...
#ifdef V8_HEAP_SANDBOX
  WriteCagedPointerFieldAllowNullptr(kExternalPointerOffset, isolate, value);
#else
...
#ifdef V8_HEAP_SANDBOX
  Address value =
      ReadCagedPointerFieldAllowNullptr(kDataPointerOffset, cage_base);
#else
...
#ifdef V8_HEAP_SANDBOX
  WriteCagedPointerFieldAllowNullptr(kDataPointerOffset, isolate, value);
#else
