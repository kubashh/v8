...
class JSTypedArray : public JSArrayBufferView {
 public:
  ...
  // During serialization the backing reference is stored in the typed array
  // object and upon deserialization the backing store reference is converted
  // back to an actual external (off-heap) pointer value.
  // The the backing reference is stored in the external_pointer field.
