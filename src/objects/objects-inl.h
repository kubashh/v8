...
Address Object::ReadCagedPointerFieldAllowNullptr(
    size_t offset, PtrComprCageBase cage_base) const {
  return i::ReadCagedPointerFieldAllowNullptr(field_address(offset), cage_base);
}
...
void Object::WriteCagedPointerFieldAllowNullptr(size_t offset,
                                                PtrComprCageBase cage_base,
                                                Address value) {
  i::WriteCagedPointerFieldAllowNullptr(field_address(offset), cage_base,
                                        value);
}

void Object::WriteCagedPointerFieldAllowNullptr(size_t offset, Isolate* isolate,
                                                Address value) {
  i::WriteCagedPointerFieldAllowNullptr(field_address(offset),
