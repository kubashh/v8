...
class V8_NODISCARD StrDecimalLiteral {
 ...
 private:
  bool negative_;
  double exp_value_;
  int integer_start_pos_;
  int integer_end_pos_;
  int fraction_start_pos_;
  int fraction_end_pos_;
  Handle<String> str_;
...
int StrDecimalLiteral::Digit(int index) const {
  ...
  if (index < integer_end_pos_ - integer_start_pos_ + fraction_end_pos_ -
                  fraction_start_pos_) {
