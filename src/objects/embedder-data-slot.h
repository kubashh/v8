...
class EmbedderDataSlot
 ...
 public:
  ...
  V8_INLINE bool GetAndClearExternalPointerForSerialization(
      ExternalPointer_t* out_ptr, const DisallowGarbageCollection& no_gc);
  V8_INLINE void RestoreExternalPointerAfterSerialization(
      ExternalPointer_t value, const DisallowGarbageCollection& no_gc);
