...
class OrderedHashSet : public OrderedHashTable<OrderedHashSet, 1> {
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(OrderedHashSet, OrderedHashTable, OrderedHashSet, 1)
};
...
class OrderedHashMap : public OrderedHashTable<OrderedHashMap, 2> {
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(OrderedHashMap, OrderedHashTable, OrderedHashMap, 2)
};
...
class OrderedNameDictionary
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(OrderedNameDictionary, OrderedHashTable,
                         OrderedNameDictionary, 3)
};
