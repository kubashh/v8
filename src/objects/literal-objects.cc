...
const int kNoEnumerationIndex = 0;
const int kInitialDynamicEnumerationIndex = ComputeEnumerationIndex(0);
STATIC_ASSERT(kNoEnumerationIndex < PropertyDetails::kInitialIndex);
STATIC_ASSERT(PropertyDetails::kInitialIndex < kInitialDynamicEnumerationIndex);
