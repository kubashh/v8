...
// static
ContextSlotReprCell::Representation ContextSlotReprCell::RepresentationOf(
    Tagged<Object> object) {
  if (IsUndefined(object)) return ContextSlotReprCell::kUndefined;
  if (Is<Smi>(object)) return ContextSlotReprCell::kSmi;
  if (Is<HeapNumber>(object)) return ContextSlotReprCell::kMutableHeapNumber;
  return ContextSlotReprCell::kOther;
}

ContextSlotReprCell::Representation ContextSlotReprCell::repr() const {
  return static_cast<ContextSlotReprCell::Representation>(raw_repr().value());
}
void ContextSlotReprCell::set_repr(ContextSlotReprCell::Representation repr) {
