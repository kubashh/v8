...
// static
MaybeHandle<Object> JSAtomicsMutex::RunOrQueueCallable(
    Handle<JSAtomicsMutex> mutex, Isolate* isolate, Handle<JSObject> callback,
    Handle<JSPromise> promise) {
  AsyncLockGuard lock_guard(isolate, mutex, callback, promise);
