 ...
 public:
  ...
  void HandleNotify() {
    ...
    if (mutex_lock->AsyncLock() ||
        JSAtomicsMutex::AsyncLockSlowPath(mutex_lock)) {
...
// static
void JSAtomicsMutex::RunOrQueueCallableSlowPath(Handle<JSAtomicsMutex> mutex,
                                                Isolate* isolate,
                                                Handle<JSObject> run_under_lock,
                                                Handle<JSObject> promise) {
  if (AsyncLockSlowPath(mutex)) {
...
// static
void AsyncWaiterQueueNode::EnqueueAsync(Isolate* isolate,
