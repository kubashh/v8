...
class JSAtomicsMutex
 ...
 public:
  ...
  // static inline detail::AsyncWaiterQueueNode* AsyncLock(Isolate* requester,
  ...
  static MaybeHandle<Object> RunCallable(Handle<JSAtomicsMutex> mutex,
                                         Isolate* isolate,
                                         Handle<JSObject> run_under_lock,
                                         Handle<JSPromise> promise);
  inline static void RunOrQueueCallable(Handle<JSAtomicsMutex> mutex,
                                        Isolate* isolate,
                                        Handle<JSObject> run_under_lock,
                                        Handle<JSPromise> promise);
 ...
 private:
  ...
  V8_EXPORT_PRIVATE void UnlockSlowPath(Isolate* requester,
                                        std::atomic<StateT>* state);
  // V8_EXPORT_PRIVATE static detail::AsyncWaiterQueueNode*
  // AsyncLockSlowPath(Isolate* requester,
  //                                            Handle<JSAtomicsMutex> mutex,
  //                                            std::atomic<StateT>* state);
