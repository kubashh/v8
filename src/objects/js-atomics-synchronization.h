...
// to terminate the worker where this was called, so we need to make sure to
// release the lock on isolate deinitialization. In order to implement this we
// repurpose the LockAsyncWaiterQueueNodes after the lock is taken and:
