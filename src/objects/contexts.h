...
#define NATIVE_CONTEXT_FIELDS(V)                                               \
  ...
  V(INITIAL_ASYNC_CONTEXT_VARIABLE_MAP_INDEX, Map,                             \
    initial_async_context_variable_map)                                        \
  V(INITIAL_ASYNC_CONTEXT_SNAPSHOT_MAP_INDEX, Map,                             \
    initial_async_context_snapshot_map)                                        \
