...
class DebugInfo : public TorqueGeneratedDebugInfo<DebugInfo, Struct> {
 public:
  ...
  using TorqueGeneratedDebugInfo::debug_bytecode_array;
  using TorqueGeneratedDebugInfo::original_bytecode_array;
  using TorqueGeneratedDebugInfo::set_debug_bytecode_array;
  using TorqueGeneratedDebugInfo::set_original_bytecode_array;
