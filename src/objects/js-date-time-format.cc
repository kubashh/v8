...
MaybeHandle<JSDateTimeFormat> JSDateTimeFormat::Initialize(
  ...
  std::set<std::string> relevant_extension_keys{"hc"};
  ...
  if (has_hour_option) {
    ...
    HourCycle hc_default = HourCycle::UNDEFINED;
    if (pattern.find("K") != std::string::npos) {
      hc_default = HourCycle::H11;
    } else if (pattern.find("h") != std::string::npos) {
      hc_default = HourCycle::H12;
    } else if (pattern.find("H") != std::string::npos) {
      hc_default = HourCycle::H23;
    } else if (pattern.find("k") != std::string::npos) {
      hc_default = HourCycle::H24;
    }
