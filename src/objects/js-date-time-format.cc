...
class PatternMap {
 public:
  PatternMap(const std::string pattern, const std::string value)
...
class PatternItem {
 public:
  PatternItem(const std::string property, std::vector<const PatternMap> pairs,
...
static const std::vector<const PatternItem>& GetPatternItems() {
  ...
  static std::vector<const PatternItem> kPatternItems = {
      PatternItem("weekday",
...
void SetPropertyFromPattern(Isolate* isolate, const std::string& pattern,
  ...
  const std::vector<const PatternItem>& items = GetPatternItems();
