...
icu::DateIntervalFormat* LazyCreateDateIntervalFormat(
    Isolate* isolate, Handle<JSDateTimeFormat> date_time_format) {
  ManagedIcuDateIntervalFormat managed_format =
  ...
  Handle<ManagedIcuDateIntervalFormat> managed_interval_format =
      ManagedIcuDateIntervalFormat::FromUniquePtr(
...
MaybeHandle<JSDateTimeFormat> JSDateTimeFormat::New(
  ...
  Handle<ManagedIcuLocale> managed_locale =
      ManagedIcuLocale::FromRawPtr(isolate, 0, icu_locale.clone());

  Handle<ManagedIcuSimpleDateFormat> managed_format =
      ManagedIcuSimpleDateFormat::FromUniquePtr(isolate, 0,
                                                std::move(icu_date_format));

  Handle<ManagedIcuDateIntervalFormat> managed_interval_format =
      ManagedIcuDateIntervalFormat::FromRawPtr(isolate, 0, nullptr);
