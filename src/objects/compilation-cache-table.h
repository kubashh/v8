...
class CompilationCacheTable
 ...
 public:
  ...
  // entry is still present and can be used to get the Script. Thus, the return
  // type here may be either SharedFunctionInfo or Script.
  static MaybeHandle<HeapObject> LookupScript(
