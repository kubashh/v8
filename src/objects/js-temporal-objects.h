...
class JSTemporalCalendar
 ...
 public:
  ...
  V8_WARN_UNUSED_RESULT static MaybeHandle<JSReceiver> From(
  ...
  DECL_ACCESSORS(internal, Managed<TemporalCalendarInternal>)
...
class JSTemporalTimeZone
 ...
 public:
  ...
  V8_WARN_UNUSED_RESULT static MaybeHandle<JSTemporalPlainDateTime>
  GetPlainDateTimeFor(Isolate* isolate, Handle<JSReceiver> time_zone,
...
V8_WARN_UNUSED_RESULT MaybeHandle<Oddball> IsValidTemporalCalendarField(
