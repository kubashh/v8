...
class MapWord {
 public:
  ...
  inline Address ptr() const { return value_; }
  ...
  constexpr bool operator==(const MapWord& other) const {
    return static_cast<Tagged_t>(value_) == static_cast<Tagged_t>(other.ptr());
  }
  constexpr bool operator!=(const MapWord& other) const {
    return static_cast<Tagged_t>(value_) != static_cast<Tagged_t>(other.ptr());
  }
