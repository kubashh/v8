...
class Object : public TaggedImpl<HeapObjectReferenceType::STRONG, Address> {
 public:
  ...
  V8_EXPORT_PRIVATE static void ShortPrint(Tagged<Object> obj,
                                           FILE* out = stdout);
  ...
  V8_EXPORT_PRIVATE static void Print(Tagged<Object> obj);

  // Prints this object with details.
  V8_EXPORT_PRIVATE static void Print(Tagged<Object> obj, std::ostream& os);
#else
  template <typename T>
  ...
  template <typename T>
  static void Print(T obj, std::ostream& os) {
    ShortPrint(obj, os);
  }
#endif
