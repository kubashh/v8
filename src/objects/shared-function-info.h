...
class SharedFunctionInfo
 ...
 public:
  ...
  inline Tagged<Code> InterpreterTrampoline(const Isolate* isolate) const;
  inline bool HasInterpreterData(const Isolate* isolate) const;
  inline Tagged<InterpreterData> interpreter_data(const Isolate* isolate) const;
