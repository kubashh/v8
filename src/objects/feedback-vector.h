...
class FeedbackVector
 ...
 public:
  ...
  static void Init(Isolate* isolate, FeedbackVector vector,
                   DisallowGarbageCollection&, int length,
                   Handle<SharedFunctionInfo> shared,
                   Handle<ClosureFeedbackCellArray> closure_feedback_cell_array,
                   IsCompiledScope* is_compiled_scope);
  static void PostInit(Isolate* isolate, Handle<FeedbackVector> vector);
