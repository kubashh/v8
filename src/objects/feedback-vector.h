...
class V8_EXPORT_PRIVATE FeedbackVectorSpec {
 public:
  ...
  int AddFeedbackCellForCreateClosure() { return create_closure_slot_count_++; }
...
class FeedbackMetadata : public HeapObject {
 public:
  ...
  static const int kCreateClosureSlotCountOffset =
      kSlotCountOffset + kInt32Size;
  static const int kHeaderSize = kCreateClosureSlotCountOffset + kInt32Size;
