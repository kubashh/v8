...
class V8_NODISCARD WaiterQueueNode {
 public:
  ...
  static void RemoveFromUnlockedWaiterList(WaiterQueueNode* node);
  static void RemoveFromLockedWaiterList(WaiterQueueNode* node);
  static void MoveToLockedWaiterList(WaiterQueueNode* node);
