...
class ObjectHashTableBase : public HashTable<Derived, Shape> {
 ...
 protected:
  ...
  OBJECT_CONSTRUCTORS_T2(ObjectHashTableBase, HashTable, Derived, Shape)
};
...
class ObjectHashTable
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(ObjectHashTable, ObjectHashTableBase, ObjectHashTable,
...
class EphemeronHashTable
 ...
 protected:
  ...
  OBJECT_CONSTRUCTORS_T2(EphemeronHashTable, ObjectHashTableBase,
                         EphemeronHashTable, EphemeronHashTableShape)
};
...
class ObjectHashSet : public HashTable<ObjectHashSet, ObjectHashSetShape> {
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(ObjectHashSet, HashTable, ObjectHashSet,
                         ObjectHashSetShape)
};
