...
// external pointer table. This class uses lazily-initialized external pointer
// slots. As such, its content can simply be zero-initialized, and the external
// pointer table entries are only allocated when an index is written to the
// first time.
