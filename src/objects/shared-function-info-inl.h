...
const wasm::NativeModule* SharedFunctionInfo::native_module() const {
  ...
  return wasm_module_object.native_module();
}

inline int SharedFunctionInfo::wasm_function_index() const {
