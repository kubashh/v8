...
Object CompilationCacheTable::FirstValueAt(InternalIndex entry) {
  return get(EntryToIndex(entry) + 1);
}

void CompilationCacheTable::SetKeyAt(InternalIndex entry, Object value,
                                     WriteBarrierMode mode) {
  set(EntryToIndex(entry), value, mode);
}

void CompilationCacheTable::SetFirstValueAt(InternalIndex entry, Object value,
                                            WriteBarrierMode mode) {
