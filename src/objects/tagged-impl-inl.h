...
bool TaggedImpl<kRefType, StorageType>::GetHeapObjectIfStrong(
  ...
  // Implementation for compressed pointers.
  if (IsStrong()) {
    *result = HeapObject::cast(Object(DecompressTaggedPointer(isolate, ptr_)));
    return true;
  }
  return false;
}
...
HeapObject TaggedImpl<kRefType, StorageType>::GetHeapObjectAssumeStrong(
  ...
  // Implementation for compressed pointers.
  DCHECK(IsStrong());
  return HeapObject::cast(Object(DecompressTaggedPointer(isolate, ptr_)));
}
...
HeapObject TaggedImpl<kRefType, StorageType>::GetHeapObject(
  ...
  if (kCanBeWeak) {
    ...
    return HeapObject::cast(
        Object(DecompressTaggedPointer(isolate, ptr_ & ~kWeakHeapObjectMask)));
  } else {
    DCHECK(!HAS_WEAK_HEAP_OBJECT_TAG(ptr_));
    return HeapObject::cast(Object(DecompressTaggedPointer(isolate, ptr_)));
  }
