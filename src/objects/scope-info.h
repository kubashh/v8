...
#undef DECL_INDEX
 ...
 private:
  ...
  class VariableModeField : public BitField<VariableMode, 0, 4> {};
  class InitFlagField
      : public BitField<InitializationFlag, VariableModeField::kNext, 1> {};
  class MaybeAssignedFlagField
      : public BitField<MaybeAssignedFlag, InitFlagField::kNext, 1> {};
