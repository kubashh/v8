...
void WeakArrayListWithEmptySlots::MarkSlotEmpty(Handle<WeakArrayList> array,
                                                int index) {
  DCHECK_GT(index, 0);
...
Smi* WeakArrayListWithEmptySlots::empty_slot_index(
    Handle<WeakArrayList> array) {
  return array->Get(kEmptySlotIndex)->ToSmi();
}

void WeakArrayListWithEmptySlots::set_empty_slot_index(
    Handle<WeakArrayList> array, int index) {
