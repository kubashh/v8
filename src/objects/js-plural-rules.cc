...
void CreateDataPropertyForOptions(Isolate* isolate, Handle<JSObject> obj,
  ...
  CHECK(JSReceiver::CreateDataProperty(isolate, obj, key_str, value, kDontThrow)
            .FromJust());
}
...
void CreateDataPropertyForOptions(Isolate* isolate, Handle<JSObject> obj,
  ...
  CreateDataPropertyForOptions(isolate, obj, value_smi, key);
}
