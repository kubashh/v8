...
inline int64_t R(double d) { return static_cast<int64_t>(d); }
...
MaybeHandle<JSTemporalTimeZone> CreateTemporalTimeZone(
  ...
  Maybe<int64_t> maybe_offset_nanoseconds =
      TemporalParser::ParseTimeZoneOffsetString(isolate, identifier_str, false);
...
MaybeHandle<JSTemporalPlainDate> ToTemporalDate(Isolate* isolate,
  ...
  Maybe<DateRecord> maybe_result =
      TemporalParser::ParseTemporalDateString(isolate, string);
...
MaybeHandle<JSTemporalPlainDateTime> ToTemporalDateTime(
  ...
  if (item_obj->IsJSReceiver()) {
    ...
    Maybe<DateTimeRecord> maybe_result =
        TemporalParser::ParseTemporalDateTimeString(isolate, string);
...
MaybeHandle<JSTemporalPlainTime> ToTemporalTime(Isolate* isolate,
  ...
  if (item_obj->IsJSReceiver()) {
    ...
    Maybe<TimeRecord> maybe_result =
        TemporalParser::ParseTemporalTimeString(isolate, string);
...
#undef EXTRACT_CALENDAR
  ...
  Maybe<DateRecord> maybe_result =
      TemporalParser::ParseTemporalMonthDayString(isolate, string);
...
MaybeHandle<JSTemporalPlainYearMonth> ToTemporalYearMonth(
  ...
  Maybe<DateRecord> maybe_result =
      TemporalParser::ParseTemporalYearMonthString(isolate, string);
...
MaybeHandle<JSTemporalZonedDateTime> ToTemporalZonedDateTime(
  ...
  if (item_obj->IsJSReceiver()) {
    ...
    Maybe<ZonedDateTimeRecord> maybe_result =
        TemporalParser::ParseTemporalZonedDateTimeString(isolate, string);
    MAYBE_RETURN(maybe_result, Handle<JSTemporalZonedDateTime>());
    from_result2 = true;
  ...
  if (offset_behaviour == OffsetBehaviour::kOption) {
    ...
    Maybe<int64_t> maybe_offset_nanoseconds =
        TemporalParser::ParseTimeZoneOffsetString(isolate, offset_string);
...
#undef EXTRACT_CALENDAR
  ...
  if (!IsBuiltinCalendar(isolate, identifier)) {
    ...
    Maybe<std::string> maybe_identifier =
        TemporalParser::ParseTemporalCalendarString(isolate, identifier);
...
MaybeHandle<JSTemporalDuration> ToTemporalDuration(Isolate* isolate,
  ...
  if (item->IsJSReceiver()) {
    ...
    Maybe<DurationRecord> maybe_result =
        TemporalParser::ParseTemporalDurationString(isolate, string);
    MAYBE_RETURN(maybe_result, Handle<JSTemporalDuration>());
    result = maybe_result.FromJust();
  }
...
MaybeHandle<JSReceiver> ToTemporalTimeZone(
  ...
  Maybe<std::string> maybe_result =
      TemporalParser::ParseTemporalTimeZone(isolate, identifier);
...
MaybeHandle<Object> ToRelativeTemporalObject(Isolate* isolate,
  ...
  if (value_obj->IsJSReceiver()) {
    ...
    Maybe<ZonedDateTimeRecord> maybe_relative_result =
        TemporalParser::ParseTemporalRelativeToString(isolate, string);
...
const std::string FormatSecondsStringPart(int32_t second, int32_t millisecond,
  ...
  if (precision == Precision::kAuto) {
    ...
    if (precision == Precision::k0) return seconds_string.str();
...
MaybeHandle<String> BuiltinTimeZoneGetOffsetStringFor(
    ...
    Handle<JSTemporalInstant> instant, const char* method) {
  Maybe<std::string> maybe_result =
      BuiltinTimeZoneGetOffsetStdStringFor(isolate, time_zone, instant, method);
...
Maybe<DateTimeRecord> TemporalParser::ParseISODateTime(
    Isolate* isolate, const ParsedResult& parsed) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<DateTimeRecord> TemporalParser::ParseTemporalDateTimeString(
    Isolate* isolate, Handle<String> iso_string) {
  ...
  // 4. Return result.
  return TemporalParser::ParseISODateTime(isolate, parsed);
}

// #sec-temporal-parsetemporaldatestring
Maybe<DateRecord> TemporalParser::ParseTemporalDateString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
  ...
  // 3. Let result be ? ParseISODateTime(isoString).
  Maybe<DateTimeRecord> maybe_result =
      TemporalParser::ParseISODateTime(isolate, parsed);
...
Maybe<TimeRecord> TemporalParser::ParseTemporalTimeString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<DateRecord> TemporalParser::ParseTemporalYearMonthString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<DateRecord> TemporalParser::ParseTemporalMonthDayString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<ZonedDateTimeRecord> TemporalParser::ParseTemporalZonedDateTimeString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<DurationRecord> TemporalParser::ParseTemporalDurationString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<TimeZoneRecord> TemporalParser::ParseTemporalTimeZoneString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<std::string> TemporalParser::ParseTemporalTimeZone(
    Isolate* isolate, Handle<String> string) {
  TEMPORAL_ENTER_FUNC();

  // 2. Let result be ? ParseTemporalTimeZoneString(string).
  Maybe<TimeZoneRecord> maybe_result =
      TemporalParser::ParseTemporalTimeZoneString(isolate, string);
...
Maybe<int64_t> TemporalParser::ParseTimeZoneOffsetString(
    Isolate* isolate, Handle<String> iso_string, bool throwIfNotSatisfy) {
  TEMPORAL_ENTER_FUNC();
...
bool TemporalParser::IsValidTimeZoneNumericUTCOffsetString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<std::string> TemporalParser::ParseTemporalCalendarString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
  ...
  if (!IsBuiltinCalendar(isolate, parsed.calendar_name)) {
    // a. Throw a RangeError exception.
    THROW_NEW_ERROR_RETURN_VALUE(
        isolate,
...
Maybe<ZonedDateTimeRecord> TemporalParser::ParseTemporalRelativeToString(
    Isolate* isolate, Handle<String> iso_string) {
  TEMPORAL_ENTER_FUNC();
...
MaybeHandle<BigInt> ParseTemporalInstant(Isolate* isolate,
  ...
  Maybe<int64_t> maybe_offset_nanoseconds =
      TemporalParser::ParseTimeZoneOffsetString(
...
Maybe<int64_t> GetOffsetNanosecondsFor(Isolate* isolate,
  ...
  // 2. If getOffsetNanosecondsFor is undefined, set getOffsetNanosecondsFor to
  // %Temporal.TimeZone.prototype.getOffsetNanosecondsFor%.
  if (get_offset_nanoseconds_for->IsUndefined()) {
    if (!time_zone_obj->IsJSTemporalTimeZone()) {
      THROW_NEW_ERROR_RETURN_VALUE(
          isolate,
    ...
    ASSIGN_RETURN_ON_EXCEPTION_VALUE(
        ...
        JSTemporalTimeZone::GetOffsetNanosecondsFor(isolate, time_zone,
                                                    instant),
        Nothing<int64_t>());
  } else {
...
Maybe<DurationRecord> ToLimitedTemporalDuration(
  ...
  if (!temporal_duration_like->IsJSReceiver()) {
    ...
    Maybe<DurationRecord> maybe_duration =
        TemporalParser::ParseTemporalDurationString(isolate, str);
...
MaybeHandle<JSTemporalPlainDateTime> MoveRelativeDate(
  ...
  Maybe<int64_t> maybe_days = DaysUntil(isolate, relative_to, later, method);
...
Maybe<bool> DifferenceIntlDate(Isolate* isolate,
                               ...
                               int64_t* out_years, int64_t* out_months,
                               int64_t* out_weeks, int64_t* out_days,
                               const char* method) {
  TEMPORAL_ENTER_FUNC();
...
Maybe<bool> AddIntlDate(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                        ...
                        ShowOverflow overflow, int32_t* out_year,
...
#ifdef V8_INTL_SUPPORT
// Step of 5a of #sup-temporal.calendar.prototype.dayofweek
// Return  the result of implementation-defined processing of temporalDate and
// calendar.[[Identifier]].
int32_t ToIntlDayOfWeek(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
...
// Step 5a of #sup-temporal.calendar.prototype.dayofyear
// a. Return the result of implementation-defined processing of temporalDate and
// calendar.[[Identifier]].
int32_t ToIntlDayOfYear(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                        int32_t year, int32_t month, int32_t day) {
  TEMPORAL_ENTER_FUNC();
...
// Step 6b of #sup-temporal.calendar.prototype.weekofyear
// Return the result of implementation-defined processing of temporalDate and
// calendar.[[Identifier]].
int32_t ToIntlWeekOfYear(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                         int32_t year, int32_t month, int32_t day) {
  TEMPORAL_ENTER_FUNC();
...
int32_t IntlDaysInMonth(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                        int32_t year, int32_t month) {
  TEMPORAL_ENTER_FUNC();
...
int32_t IntlDaysInYear(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                       int32_t year) {
  TEMPORAL_ENTER_FUNC();
...
int32_t IntlMonthsInYear(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                         int32_t year) {
  TEMPORAL_ENTER_FUNC();
  return 12;
}

bool IsIntlLeapYear(Isolate* isolate, Handle<JSTemporalCalendar> calendar,
                    int32_t year) {
  TEMPORAL_ENTER_FUNC();
  return isolate->date_cache()->IsLeap(year);
}
...
MaybeHandle<String> FormatDateTime(Isolate* isolate, Handle<JSReceiver> x,
...
MaybeHandle<JSTemporalDuration> JSTemporalDuration::Round(
  ...
  Maybe<Unit> maybe_smallest_unit = ToSmallestTemporalUnit(
      isolate, options, std::set<Unit>({}), Unit::kNotPresent, method);
  ...
  Maybe<Unit> maybe_largest_unit =
      ToLargestTemporalUnit(isolate, options, std::set<Unit>({}),
  ...
  Maybe<RoundingMode> maybe_rounding_mode = ToTemporalRoundingMode(
      isolate, options, RoundingMode::kHalfExpand, method);
  ...
  Handle<Object> relative_to_obj;
  ASSIGN_RETURN_ON_EXCEPTION(isolate, relative_to_obj,
                             ToRelativeTemporalObject(isolate, options, method),
                             JSTemporalDuration);
...
MaybeHandle<Object> JSTemporalDuration::Total(
  ...
  Maybe<Unit> maybe_unit =
      ToTemporalDurationTotalUnit(isolate, options, method);
...
Maybe<bool> ISODateFromFields(Isolate* isolate, Handle<JSReceiver> fields,
  ...
  ASSIGN_RETURN_ON_EXCEPTION_VALUE(
      isolate, fields,
      PrepareTemporalFields(isolate, fields, field_names, false, false),
      Nothing<bool>());
...
Maybe<bool> IntlDateFromFields(Isolate* isolate,
  ...
  ASSIGN_RETURN_ON_EXCEPTION_VALUE(
      isolate, fields,
      PrepareTemporalFields(isolate, fields, field_names, true, false),
      Nothing<bool>());
...
MaybeHandle<JSTemporalDuration> JSTemporalCalendar::DateUntil(
  ...
  return CreateTemporalDuration(isolate, years, months, weeks, days, 0, 0, 0, 0,
                                0, 0);
}

#define GET_FROM_DATE_AND_YEAR_MONTH(name, field, RT)                          \
  if (temporal_date_like->IsJSTemporalPlainDate()) {                           \
    name = Handle<JSTemporalPlainDate>::cast(temporal_date_like)->field();     \
  } else if (temporal_date_like->IsJSTemporalPlainDateTime()) {                \
    name = Handle<JSTemporalPlainDateTime>::cast(temporal_date_like)->field(); \
  } else if (temporal_date_like->IsJSTemporalPlainYearMonth()) {               \
    name =                                                                     \
        Handle<JSTemporalPlainYearMonth>::cast(temporal_date_like)->field();   \
  } else {                                                                     \
...
#define GET_FROM_DATE_AND_MONTH_DAY(name, field, RT)                           \
  if (temporal_date_like->IsJSTemporalPlainDate()) {                           \
    name = Handle<JSTemporalPlainDate>::cast(temporal_date_like)->field();     \
  } else if (temporal_date_like->IsJSTemporalPlainDateTime()) {                \
    name = Handle<JSTemporalPlainDateTime>::cast(temporal_date_like)->field(); \
  } else if (temporal_date_like->IsJSTemporalPlainMonthDay()) {                \
    name = Handle<JSTemporalPlainMonthDay>::cast(temporal_date_like)->field(); \
  } else {                                                                     \
    /* a. Set temporalDateLike to ? ToTemporalDate(temporalDateLike). */       \
    Handle<JSTemporalPlainDate> date;                                          \
    ASSIGN_RETURN_ON_EXCEPTION(                                                \
...
#define GET_FROM_DATE_AND_YEAR_MONTH_AND_MONTH_DAY(name, field, RT)            \
  if (temporal_date_like->IsJSTemporalPlainMonthDay()) {                       \
    name = Handle<JSTemporalPlainMonthDay>::cast(temporal_date_like)->field(); \
  } else {                                                                     \
    GET_FROM_DATE_AND_YEAR_MONTH(name, field, RT)                              \
  }
...
MaybeHandle<Smi> JSTemporalCalendar::Year(Isolate* isolate,
  ...
  GET_FROM_DATE_AND_YEAR_MONTH(year, iso_year, Smi)
#ifdef V8_INTL_SUPPORT
  if (calendar->calendar_index() != 0) {
...
MaybeHandle<Smi> JSTemporalCalendar::Month(Isolate* isolate,
  ...
  GET_FROM_DATE_AND_YEAR_MONTH(month, iso_month, Smi)
#ifdef V8_INTL_SUPPORT
  if (calendar->calendar_index() != 0) {
...
MaybeHandle<Smi> JSTemporalCalendar::Day(Isolate* isolate,
  ...
  GET_FROM_DATE_AND_MONTH_DAY(day, iso_day, Smi)
#ifdef V8_INTL_SUPPORT
  if (calendar->calendar_index() == 0) {
...
#define TO_ISO_OR_INTL(name, Name)                                          \
  MaybeHandle<Smi> JSTemporalCalendar::Name(                                \
    ...
    if (calendar->calendar_index() == 0) {                                  \
      ...
      name = ToIntl##Name(isolate, calendar, date->iso_year(),              \
...
#ifdef V8_INTL_SUPPORT
    days_in_month = IntlDaysInMonth(isolate, calendar, year, month);
#else   // V8_INTL_SUPPORT
    UNREACHABLE();
#endif  // V8_INTL_SUPPORT
  }
...
#ifdef V8_INTL_SUPPORT
    days_in_year = IntlDaysInYear(isolate, calendar, year);
#else   // V8_INTL_SUPPORT
    UNREACHABLE();
#endif  // V8_INTL_SUPPORT
  }
...
#ifdef V8_INTL_SUPPORT
    months_in_year = IntlMonthsInYear(isolate, calendar, year);
#else   // V8_INTL_SUPPORT
    UNREACHABLE();
#endif  // V8_INTL_SUPPORT
  }
...
MaybeHandle<Oddball> JSTemporalCalendar::InLeapYear(
  ...
  // have an [[InitializedTemporalDate]], [[InitializedTemporalDateTime]], or
  // [[InitializedTemporalYearMonth]] internal slot, then
  GET_FROM_DATE_AND_YEAR_MONTH(year, iso_year, Oddball)
  bool in_leap_year;
  // 4. If calendar.[[Identifier]] is "iso8601", then
  if (calendar->calendar_index() == 0) {
...
#ifdef V8_INTL_SUPPORT
    in_leap_year = IsIntlLeapYear(isolate, calendar, year);
#else   // V8_INTL_SUPPORT
    UNREACHABLE();
#endif  // V8_INTL_SUPPORT
  }
...
std::string JSTemporalTimeZone::id() const {
  if (is_offset()) {
    return FormatTimeZoneOffsetString(offset_nanoseconds());
  }
#ifdef V8_INTL_SUPPORT
...
MaybeHandle<JSTemporalDuration> UntilOrSince(
  ...
  Maybe<Unit> maybe_largest_unit = ToLargestTemporalUnit(
      isolate, options, disallowed_units, Unit::kAuto, smallest_unit, method);
  MAYBE_RETURN(maybe_largest_unit, Handle<JSTemporalDuration>());
  Unit largest_unit = maybe_largest_unit.FromJust();
...
MaybeHandle<String> JSTemporalPlainDate::ToLocaleString(
  ...
  return FormatDateTime(isolate, temporal_date, locales, options, method);
#else   // V8_INTL_SUPPORT
...
MaybeHandle<String> JSTemporalPlainDateTime::ToLocaleString(
  ...
  return FormatDateTime(isolate, date_time, locales, options, method);
#else   // V8_INTL_SUPPORT
...
MaybeHandle<JSTemporalPlainDateTime> JSTemporalPlainDateTime::Round(
  ...
  Maybe<int> maybe_rounding_increment = ToTemporalDateTimeRoundingIncrement(
      isolate, options, smallest_unit, method);
...
MaybeHandle<String> JSTemporalPlainMonthDay::ToLocaleString(
  ...
  return FormatDateTime(isolate, month_day, locales, options, method);
#else   // V8_INTL_SUPPORT
...
MaybeHandle<JSTemporalDuration> UntilOrSince(
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      ...
      PrepareTemporalFields(isolate, other, field_names, false, false),
      JSTemporalDuration);
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      isolate, relative_to,
      CreateTemporalDateTime(isolate, this_date->iso_year(),
                             this_date->iso_month(), this_date->iso_day(), 0, 0,
                             0, 0, 0, 0, calendar),
      JSTemporalDuration);
...
MaybeHandle<String> JSTemporalPlainYearMonth::ToLocaleString(
  ...
  return FormatDateTime(isolate, year_month, locales, options, method);
#else   // V8_INTL_SUPPORT
  // #sec-temporal.plainyearmonth.prototype.tolocalestring
  return TemporalYearMonthToString(
      isolate, year_month->iso_year(), year_month->iso_month(),
      year_month->iso_day(),
      Handle<JSReceiver>(year_month->calendar(), isolate), ShowCalendar::kAuto);
#endif  // V8_INTL_SUPPORT
}
...
MaybeHandle<JSReceiver> JSTemporalPlainTime::GetISOFields(
  ...
  ASSIGN_RETURN_ON_EXCEPTION(isolate, iso8601_calendar,
                             GetISO8601Calendar(isolate), JSTemporalPlainTime);
...
MaybeHandle<String> JSTemporalPlainTime::ToLocaleString(
  ...
  return FormatDateTime(isolate, temporal_time, locales, options, method);
#else   // V8_INTL_SUPPORT
...
MaybeHandle<Smi> JSTemporalZonedDateTime::HoursInDay(
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      isolate, today,
      CreateTemporalDateTime(isolate, temporal_date_time->iso_year(),
                             temporal_date_time->iso_month(),
                             temporal_date_time->iso_day(), 0, 0, 0, 0, 0, 0,
                             iso_calendar),
      Smi);
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      isolate, tomorrow,
      CreateTemporalDateTime(isolate, tomorrow_year, tomorrow_month,
...
MaybeHandle<JSTemporalZonedDateTime> JSTemporalZonedDateTime::With(
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      isolate, fields,
      PrepareTemporalFields(isolate, fields, field_names, false, true),
      JSTemporalZonedDateTime);
...
MaybeHandle<JSTemporalZonedDateTime> JSTemporalZonedDateTime::Round(
  ...
  ASSIGN_RETURN_ON_EXCEPTION(
      ...
      InterpretISODateTimeOffset(
          ...
          time_zone, Disambiguation::kCompatible, Offset::kPrefer, method),
      JSTemporalZonedDateTime);
...
MaybeHandle<JSTemporalPlainYearMonth> JSTemporalZonedDateTime::ToPlainYearMonth(
  ...
  Handle<JSReceiver> fields;
  ASSIGN_RETURN_ON_EXCEPTION(isolate, fields,
                             PrepareTemporalFields(isolate, temporal_date_time,
                                                   field_names, false, false),
                             JSTemporalPlainYearMonth);
...
MaybeHandle<String> JSTemporalZonedDateTime::ToLocaleString(
  ...
  return FormatDateTime(isolate, zoned_date_time, locales, options, method);
#else   // V8_INTL_SUPPORT
...
MaybeHandle<String> JSTemporalInstant::ToLocaleString(
  ...
  return FormatDateTime(isolate, handle, locales, options, method);
#else   // V8_INTL_SUPPORT
  // 1. Let instant be the this value.
  // 2. Perform ? RequireInternalSlot(instant, [[InitializedTemporalInstant]]).
