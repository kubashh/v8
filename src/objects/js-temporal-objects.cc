...
Maybe<DateTimeRecord> ParseTemporalDateTimeString(Isolate* isolate,
  ...
  // 4. Return result.
  return ParseISODateTime(isolate, iso_string, maybe_parsed.FromJust());
}
...
#define IF_TYPE_GET_YEAR_MONTH_DAY(t, T, y, m, d)                       \
  if ((t)->IsJSTemporalPlain##T()) {                                    \
...
#define ELSE_IF_TYPE_GET_YEAR_MONTH_DAY(t, T, y, m, d) \
  else IF_TYPE_GET_YEAR_MONTH_DAY(t, T, y, m, d)

#define ELSE_CALL_TO_DATE_GET_YEAR_MONTH_DAY(t, y, m, d, RT)                   \
  else {                                                                       \
...
#define GET_YEAR_MONTH_DAY_FROM_DATE_AND_YEAR_MONTH(t, y, m, d, RT) \
  IF_TYPE_GET_YEAR_MONTH_DAY((t), Date, (y), (m), (d))              \
  ELSE_IF_TYPE_GET_YEAR_MONTH_DAY((t), DateTime, (y), (m), (d))     \
  ELSE_IF_TYPE_GET_YEAR_MONTH_DAY((t), YearMonth, (y), (m), (d))    \
  ELSE_CALL_TO_DATE_GET_YEAR_MONTH_DAY((t), (y), (m), (d), RT)

#define GET_YEAR_MONTH_DAY_FROM_DATE_AND_YEAR_MONTH_AND_MONTH_DAY(t, y, m, d, \
                                                                  RT)         \
  IF_TYPE_GET_YEAR_MONTH_DAY((t), MonthDay, (y), (m), (d))                    \
  else GET_YEAR_MONTH_DAY_FROM_DATE_AND_YEAR_MONTH((t), (y), (m), (d), RT)

#define GET_YEAR_MONTH_DAY_FROM_DATE_AND_MONTH_DAY(t, y, m, d, RT) \
  IF_TYPE_GET_YEAR_MONTH_DAY((t), Date, (y), (m), (d))             \
  ELSE_IF_TYPE_GET_YEAR_MONTH_DAY((t), DateTime, (y), (m), (d))    \
  ELSE_IF_TYPE_GET_YEAR_MONTH_DAY((t), MonthDay, (y), (m), (d))    \
  ELSE_CALL_TO_DATE_GET_YEAR_MONTH_DAY((t), (y), (m), (d), RT)
...
MaybeHandle<String> JSTemporalCalendar::MonthCode(
  ...
  int32_t month;
  int32_t day;
  GET_YEAR_MONTH_DAY_FROM_DATE_AND_YEAR_MONTH_AND_MONTH_DAY(
      temporal_date_like, year, month, day, String)
