...
DateTimeRecord BalanceTimeFast(const UnbalancedTimeRecord& input) {
  TEMPORAL_ENTER_FUNC();
  CHECK_LT(input.hour, kFastBalanceTimeLimit);
  CHECK_LT(input.minute, kFastBalanceTimeLimit);
  CHECK_LT(input.second, kFastBalanceTimeLimit);
  CHECK_LT(input.millisecond, kFastBalanceTimeLimit);
  CHECK_LT(input.microsecond, kFastBalanceTimeLimit);
  CHECK_LT(input.nanosecond, kFastBalanceTimeLimit);
