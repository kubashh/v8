...
bool JSFunction::IsInOptimizationQueue() {
  ...
  OptimizationMarker marker = feedback_vector().optimization_marker();
  return marker == OptimizationMarker::kInOptimizationQueueNoCachedCode ||
         marker == OptimizationMarker::kInOptimizationQueueMayHaveCachedCode;
}
