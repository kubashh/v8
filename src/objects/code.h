...
#undef DEFINE_CODE_KIND_ENUM
  ...
  inline int inlined_bytecode_size() const;
  inline void set_inlined_bytecode_size(int size);
...
#undef CODE_FIELDS
  ...
  static constexpr int kHeaderPaddingSize = COMPRESS_POINTERS_BOOL ? 16 : 0;
