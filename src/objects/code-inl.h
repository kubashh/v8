...
bool Code::IsStrongObjectInOptimizedCode(HeapObject object) {
  ...
  return InstanceTypeChecker::IsFeedbackVector(instance_type) ||
         ...
         InstanceTypeChecker::IsAllocationSite(instance_type) ||
         InstanceTypeChecker::IsTemplateObjectDescription(instance_type) ||
         InstanceTypeChecker::IsBigIntBase(instance_type) ||
         InstanceTypeChecker::IsSymbol(instance_type);
}
