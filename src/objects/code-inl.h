...
inline bool Code::is_baseline_trampoline_builtin() const {
  return builtin() != Builtin::kNoBuiltinId &&
         (builtin() == Builtin::kBaselineOutOfLinePrologue ||
...
inline bool Code::is_baseline_leave_frame_builtin() const {
  return builtin() == Builtin::kBaselineLeaveFrame;
}

inline bool Code::checks_optimization_marker() const {
  bool checks_marker = (builtin() == Builtin::kCompileLazy ||
                        builtin() == Builtin::kInterpreterEntryTrampoline ||
...
void Code::set_builtin(Builtin builtin) {
...
bool Code::is_builtin() const { return builtin() != Builtin::kNoBuiltinId; }
...
bool Code::IsExecutable() {
  return !Builtins::IsBuiltinId(builtin()) || !is_off_heap_trampoline() ||
         Builtins::CodeObjectIsExecutable(builtin());
}
