...
class Dictionary : public HashTable<Derived, Shape> {
 ...
 protected:
  ...
  OBJECT_CONSTRUCTORS_T2(Dictionary, HashTable, Derived, Shape)
};
...
class BaseNameDictionary : public Dictionary<Derived, Shape> {
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(BaseNameDictionary, Dictionary, Derived, Shape)
};
...
class NameDictionary
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(NameDictionary, BaseNameDictionary, NameDictionary,
                         NameDictionaryShape)
};
...
class GlobalDictionary
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(GlobalDictionary, BaseNameDictionary, GlobalDictionary,
...
class SimpleNumberDictionary
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(SimpleNumberDictionary, Dictionary,
                         SimpleNumberDictionary, SimpleNumberDictionaryShape)
};
...
class NumberDictionary
 ...
 public:
  ...
  OBJECT_CONSTRUCTORS_T2(NumberDictionary, Dictionary, NumberDictionary,
