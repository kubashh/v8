...
void ShortPrint(Object obj, FILE* out) {
  return ShortPrint(Tagged<Object>(obj), out);
}
void ShortPrint(Object obj, StringStream* accumulator) {
  return ShortPrint(Tagged<Object>(obj), accumulator);
}
void ShortPrint(Object obj, std::ostream& os) {
  return ShortPrint(Tagged<Object>(obj), os);
}
