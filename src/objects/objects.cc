...
// static
void Object::ShortPrint(Tagged<Object> obj, FILE* out) {
  OFStream os(out);
  os << Brief(obj);
}

// static
void Object::ShortPrint(Tagged<Object> obj, StringStream* accumulator) {
...
// static
void Object::ShortPrint(Tagged<Object> obj, std::ostream& os) {
  os << Brief(obj);
}

std::ostream& operator<<(std::ostream& os, const Object& obj) {
  Object::ShortPrint(obj, os);
  return os;
}
...
void HeapObject::HeapObjectShortPrint(std::ostream& os) {
  ...
  switch (map(cage_base)->instance_type()) {
    ...
    case AWAIT_CONTEXT_TYPE: {
      ...
      HeapStringAllocator allocator;
      StringStream accumulator(&allocator);
      Object::ShortPrint(Context::cast(*this)->extension(), &accumulator);
      os << accumulator.ToCString().get();
      os << '>';
      break;
    }
...
#undef PRINT_HOLE
    ...
    case CELL_TYPE: {
      ...
      HeapStringAllocator allocator;
      StringStream accumulator(&allocator);
      Object::ShortPrint(Cell::cast(*this)->value(), &accumulator);
      os << accumulator.ToCString().get();
      os << '>';
      break;
    }
    case PROPERTY_CELL_TYPE: {
      ...
      Object::ShortPrint(cell->name(), os);
      os << " value=";
      HeapStringAllocator allocator;
      StringStream accumulator(&allocator);
      Object::ShortPrint(cell->value(kAcquireLoad), &accumulator);
      os << accumulator.ToCString().get();
      os << '>';
      break;
    }
