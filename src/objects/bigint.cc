...
Handle<BigInt> MutableBigInt::MakeImmutable(Handle<MutableBigInt> result) {
  ...
  if (to_trim != 0) {
    MutableBigInt_MakeImmutable(result->ptr(), new_length, to_trim);
...
void MutableBigInt_MakeImmutable(Address addr, intptr_t new_length,
                                 intptr_t to_trim) {
...
void MutableBigInt_AbsoluteAdd(Address result_addr, Address x_addr,
                               Address y_addr) {
...
void MutableBigInt_AbsoluteSub(Address result_addr, Address x_addr,
                               Address y_addr) {
  BigInt x = BigInt::unchecked_cast(Object(x_addr));
  BigInt y = BigInt::unchecked_cast(Object(y_addr));
  MutableBigInt result = MutableBigInt::unchecked_cast(Object(result_addr));
