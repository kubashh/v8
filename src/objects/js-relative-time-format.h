...
class JSRelativeTimeFormat : public JSObject {
 public:
  ...
  enum Style {
    STYLE_LONG,   // Everything spelled out.
    STYLE_SHORT,  // Abbreviations used when possible.
    STYLE_NARROW  // Use the shortest possible form.
  };
  ...
  // "yesterday").
  enum Numeric {
    NUMERIC_ALWAYS,  // numerical descriptions are always used ("1 day ago")
    NUMERIC_AUTO  // numerical descriptions are used only when no more specific
