...
class JSRelativeTimeFormat : public JSObject {
 public:
  ...
  static icu::RelativeDateTimeFormatter* UnpackFormatter(Isolate* isolate,
                                                         Handle<JSObject> obj);
  Handle<String> style_str(Isolate* isolate) const;
  Handle<String> numeric_str(Isolate* isolate) const;
