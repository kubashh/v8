...
SMI_ACCESSORS(JSRelativeTimeFormat, style, kStyleOffset);
SMI_ACCESSORS(JSRelativeTimeFormat, numeric, kNumericOffset);
ACCESSORS(JSRelativeTimeFormat, formatter, Object, kFormatterOffset);
