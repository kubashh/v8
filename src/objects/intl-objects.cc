...
namespace {
Handle<Object> GetNumberingSystem(Isolate* isolate,
  ...
  Handle<Object> value = factory->undefined_value();
  if (U_SUCCESS(status)) {
    value = factory->NewStringFromAsciiChecked(numbering_system->getName());
  }
...
void SetResolvedDateSettings(Isolate* isolate, const icu::Locale& icu_locale,
  ...
  JSObject::SetProperty(
      ...
      GetNumberingSystem(isolate, icu_locale), LanguageMode::kSloppy)
      .Assert();
...
void Intl::DefineWEProperty(Isolate* isolate, Handle<JSReceiver> target,
  ...
  Intl::DefineWEProperty(isolate, target,
