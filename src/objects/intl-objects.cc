...
Maybe<Intl::ResolvedLocale*> Intl::ResolveLocale(
  ...
  // means this shouldn't fail.
  r->locale_with_unicode_extensions = r->locale + r->unicode_extensions;
  uloc_forLanguageTag(r->locale_with_unicode_extensions.c_str(), icu_result,
  ...
  if (extensions.size()) {
    r->locale_with_relevant_extensions = r->locale + "-u";
    for (auto extension : extensions) {
      r->locale_with_relevant_extensions +=
          "-" + extension.first + "-" + extension.second;
    }
    r->locale_with_unicode_extensions = r->locale_with_relevant_extensions;
  } else {
    r->locale_with_relevant_extensions = r->locale;
  }
