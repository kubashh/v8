...
icu::RegexMatcher* GetLanguageSingletonRegexMatcher(Isolate* isolate) {
  ...
  CHECK(language_singleton_regexp_matcher);
...
icu::RegexMatcher* GetLanguageTagRegexMatcher(Isolate* isolate) {
  ...
  CHECK(language_tag_regexp_matcher);
...
icu::RegexMatcher* GetLanguageVariantRegexMatcher(Isolate* isolate) {
  ...
  CHECK(language_variant_regexp_matcher);
...
// IsStructuallyValidLanguageTag called.
// namespace {
/**
 ...
 */
bool IsStructuallyValidLanguageTag(Isolate* isolate,
