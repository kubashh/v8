...
#ifndef V8_OBJECTS_JS_MODULE_H_
#define V8_OBJECTS_JS_MODULE_H_
...
class JSModule : public Module {
 ...
 public:
  ...
  DECL_CAST(JSModule)
  DECL_VERIFIER(JSModule)
  DECL_PRINTER(JSModule)
  ...
  static Handle<Object> LoadVariable(Isolate* isolate, Handle<JSModule> module,
                                     int cell_index);
  static void StoreVariable(Handle<JSModule> module, int cell_index,
                            Handle<Object> value);
...
#define JS_MODULE_FIELDS(V)               \
  ...
  DEFINE_FIELD_OFFSET_CONSTANTS(Module::kSize, JS_MODULE_FIELDS)
#undef SCRIPT_MODULE_FIELDS
 ...
 private:
  ...
  static void CreateExport(Isolate* isolate, Handle<JSModule> module,
                           int cell_index, Handle<FixedArray> names);
  static void CreateIndirectExport(Isolate* isolate, Handle<JSModule> module,
                                   Handle<String> name,
  ...
  static V8_WARN_UNUSED_RESULT bool PrepareInstantiate(
      Isolate* isolate, Handle<JSModule> module, v8::Local<v8::Context> context,
  ...
  static void FetchStarExports(Isolate* isolate, Handle<JSModule> module,
  ...
  static void Reset(Isolate* isolate, Handle<JSModule> module);

  OBJECT_CONSTRUCTORS(JSModule, Module);
};
