...
namespace {
bool IsUnmodifiedApiObjectThreadSafeImpl(FullObjectSlot o,
                                         Tagged<JSObject>* js_object_out) {
...
bool JSObject::IsUnmodifiedApiObject(FullObjectSlot o) {
  ...
  if (!IsUnmodifiedApiObjectThreadSafeImpl(o, &js_object)) return false;
...
bool JSObject::IsUnmodifiedApiObjectThreadSafe(FullObjectSlot o) {
  return IsUnmodifiedApiObjectThreadSafeImpl(o, nullptr);
}
