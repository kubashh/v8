...
MaybeHandle<JSV8BreakIterator> JSV8BreakIterator::New(
  ...
  Handle<ManagedIcuBreakIterator> managed_break_iterator =
      ManagedIcuBreakIterator::FromUniquePtr(isolate, 0,
                                             std::move(break_iterator));
  Handle<ManagedIcuUnicodeString> managed_unicode_string =
      ManagedIcuUnicodeString::FromRawPtr(isolate, 0, nullptr);
...
void JSV8BreakIterator::AdoptText(
  ...
  Handle<ManagedIcuUnicodeString> unicode_string =
