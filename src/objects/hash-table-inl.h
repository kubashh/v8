...
NameToIndexDictionary::NameToIndexDictionary(Address ptr)
    : HashTable<NameToIndexDictionary, NameToIndexShape>(ptr) {
  SLOW_DCHECK(IsNameToIndexDictionary());
}

CAST_ACCESSOR(ObjectHashTable)
CAST_ACCESSOR(EphemeronHashTable)
CAST_ACCESSOR(ObjectHashSet)
CAST_ACCESSOR(NameToIndexDictionary)
...
// static
Handle<Map> NameToIndexDictionary::GetMap(ReadOnlyRoots roots) {
  return roots.name_to_index_dictionary_map_handle();
}
