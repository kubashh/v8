...
void AccessorAssembler::GenerateCloneObjectIC_Slow() {
  ...
  GotoIf(TaggedIsSmi(source), &try_fast_case);
  {
    ...
    // handle the source object. We optimistically go ahead and assume that for
    // dictionary mode objects, or non simple properties the number of in
    // object properties will be set to 0 (or a reasonable value).
