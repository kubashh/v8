...
void AccessorAssembler::GenerateLoadIC() {
  ...
  TNode<Object> name = Parameter(Descriptor::kName);
...
void AccessorAssembler::GenerateLoadSuperIC() {
  ...
  TNode<Object> receiver = Parameter(Descriptor::kReceiver);
  TNode<Object> lookup_start_object = Parameter(Descriptor::kLookupStartObject);
  TNode<Object> name = Parameter(Descriptor::kName);
  auto slot = Parameter<TaggedIndex>(Descriptor::kSlot);
  auto vector = Parameter<HeapObject>(Descriptor::kVector);
  auto context = Parameter<Context>(Descriptor::kContext);
...
void AccessorAssembler::GenerateStoreInArrayLiteralIC() {
  ...
  TNode<Object> array = Parameter(Descriptor::kReceiver);
  TNode<Object> index = Parameter(Descriptor::kName);
  TNode<Object> value = Parameter(Descriptor::kValue);
  auto slot = Parameter<TaggedIndex>(Descriptor::kSlot);
  auto vector = Parameter<HeapObject>(Descriptor::kVector);
  auto context = Parameter<Context>(Descriptor::kContext);
