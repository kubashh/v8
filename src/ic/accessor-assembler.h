...
class AccessorAssembler : public CodeStubAssembler {
 ...
 protected:
  ...
  void HandleStoreICTransitionToFastMap(const StoreICParameters* p,
                                        Node* transition_map, Node* bitfield3,
                                        Label* miss,
 ...
 private:
  ...
  void CheckTransitionMapHandlerValidityCell(Node* transition_map, Label* miss,
                                             bool expect_no_validity_cell);
