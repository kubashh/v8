...
class V8_EXPORT_PRIVATE AccessorAssembler : public CodeStubAssembler {
 public:
  ...
  struct LoadICParameters {
    LoadICParameters(
        TNode<Context> context, base::Optional<TNode<Object>> receiver,
        TNode<Object> name, TNode<TaggedIndex> slot, TNode<HeapObject> vector,
 ...
 protected:
  struct StoreICParameters : public LoadICParameters {
    StoreICParameters(
        ...
        base::Optional<TNode<Object>> receiver_and_lookup_start_object,
        TNode<Object> name, TNode<Object> value, TNode<TaggedIndex> slot,
        TNode<HeapObject> vector)
        : LoadICParameters(context, receiver_and_lookup_start_object, name,
                           slot, vector),
          value_(value) {}
 ...
 private:
  ...
  void GenericElementLoad(TNode<HeapObject> receiver, TNode<Map> holder_map,
                          TNode<Int32T> instance_type, TNode<IntPtrT> index,
                          Label* slow);

  enum UseStubCache { kUseStubCache, kDontUseStubCache };
  void GenericPropertyLoad(TNode<HeapObject> receiver, TNode<Map> holder_map,
