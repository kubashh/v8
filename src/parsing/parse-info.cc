...
UnoptimizedCompilePerThreadState::UnoptimizedCompilePerThreadState(
    Isolate* isolate)
    : UnoptimizedCompilePerThreadState(
          isolate->stack_guard()->real_climit(),
          isolate->counters()->runtime_call_stats()) {}

UnoptimizedCompilePerThreadState::UnoptimizedCompilePerThreadState(
    uintptr_t stack_limit, RuntimeCallStats* runtime_call_stats)
    : stack_limit_(stack_limit), runtime_call_stats_(runtime_call_stats) {}
...
std::unique_ptr<ParseInfo> ParseInfo::ForToplevelFunction(
  ...
  std::unique_ptr<ParseInfo> result(
      new ParseInfo(flags, compile_state, UnoptimizedCompilePerThreadState()));
