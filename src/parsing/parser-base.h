...
#undef ALLOW_ACCESSORS
 ...
 protected:
   ...
   public:
    explicit ClassInfo(ParserBase* parser)
        : variable(nullptr),
          ...
          has_instance_class_elements(false),
          is_anonymous(false),
    ...
    bool has_instance_class_elements;
    bool is_anonymous;
  ...
  ClassLiteralPropertyT ParseClassPropertyDefinition(
      ...
      bool* is_private);
  ExpressionT ParseClassElementInitializer(ClassInfo* class_info, int beg_pos,
                                           bool is_static);
...
template <typename Impl>
typename ParserBase<Impl>::ExpressionT
ParserBase<Impl>::ParseClassElementInitializer(ClassInfo* class_info,
  ...
  if (is_static) {
    ...
    class_info->has_instance_class_elements = true;
  }
