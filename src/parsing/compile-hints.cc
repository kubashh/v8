...
v8::ScriptCompiler::CachedData* CompileHints::Serialize(std::vector<int>& compile_hints) {
  ...
  ScriptCompiler::CachedData* result =
      new ScriptCompiler::CachedData(reinterpret_cast<uint8_t*>(data), static_cast<int>(hints_count) * sizeof(int),
