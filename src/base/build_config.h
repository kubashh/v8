...
// executable pages.
// In particular,
// 1) when memory region is reserved for allocating executable pages, the whole
//    region is committed with RWX permissions and then decommitted,
...
// otherwise allocation of the pointer compression cage would make the whole
// region RXW and subsequent attempts to set permissions of data pages to RW
// would fail.
//
