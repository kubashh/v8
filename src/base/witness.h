 ...
 * to construct witness objects. Objects constructed in this way are "primary".
 * Witness objects can be copied and moved freely but the copies are not
 * primary. When a "primary" witness object is destroyed, all copies are
...
#ifndef DEBUG
static_assert(std::is_empty_v<Witness<int>>);
#endif
