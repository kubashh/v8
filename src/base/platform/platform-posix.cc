...
PKU& PKU::getInstance() {
  ...
  if (!instance.is_initialized_) {
    ...
    instance.is_support_pku_ =
        instance.pku_key_ != base::OS::kNoMemoryProtectionKey;
...
bool PKU::HasMemoryProtectionKeySupport() {
  PKU& instance = PKU::getInstance();
  return instance.is_support_pku_;
}
...
void OS::SetWriteableForMemoryProtectionKey(bool writeable) {
  return PKU::SetWriteableForMemoryProtectionKey(writeable);
}
...
bool OS::HasMemoryProtectionKeySupport() {
  return PKU::HasMemoryProtectionKeySupport();
}
