...
// Defines the page initialization behavior of a BoundedPageAllocator.
...
class V8_BASE_EXPORT BoundedPageAllocator : public v8::PageAllocator {
 public:
  ...
  BoundedPageAllocator(v8::PageAllocator* page_allocator, Address start,
                       ...
                       InitializationBehavior initialization_behavior);
 ...
 private:
  ...
  const InitializationBehavior initialization_behavior_;
};
