...
class KeyAccumulator final {
 public:
  ...
  Maybe<bool> CollectOwnPropertyNames(Handle<JSReceiver> receiver,
                                      Handle<JSObject> object);
  V8_WARN_UNUSED_RESULT bool CollectPrivateNames(Handle<JSReceiver> receiver,
                                                 Handle<JSObject> object);
  ...
  V8_WARN_UNUSED_RESULT bool AddKey(Object key,
                                    AddKeyConversion convert = DO_NOT_CONVERT);
  V8_WARN_UNUSED_RESULT bool AddKey(Handle<Object> key,
                                    AddKeyConversion convert = DO_NOT_CONVERT);
  V8_WARN_UNUSED_RESULT bool AddKeys(Handle<FixedArray> array,
                                     AddKeyConversion convert);
  V8_WARN_UNUSED_RESULT bool AddKeys(Handle<JSObject> array_like,
                                     AddKeyConversion convert);
