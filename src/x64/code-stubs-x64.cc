...
static void CheckInputType(MacroAssembler* masm, AsmRegister input,
...
static void BranchIfNotInternalizedString(MacroAssembler* masm, Label* label,
                                          AsmRegister object,
                                          AsmRegister scratch) {
...
void CompareICStub::GenerateGeneric(MacroAssembler* masm) {
  ...
  if (cc == equal) {
    ...
    // internalized strings they aren't equal. AsmRegister rax (not rax) already
...
void CompareICStub::GenerateInternalizedStrings(MacroAssembler* masm) {
  ...
  AsmRegister left = rdx;
  AsmRegister right = rax;
  AsmRegister tmp1 = rcx;
  AsmRegister tmp2 = rbx;
