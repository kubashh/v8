...
antlrcpp::Any AstGenerator::visitGenericType(
    TorqueParser::GenericTypeContext* context) {
  GenericTypeDeclaration* result = RegisterNode(new GenericTypeDeclaration{
      Pos(context), context->IDENTIFIER()->getSymbol()->getText()});
  return base::implicit_cast<Declaration*>(result);
}
