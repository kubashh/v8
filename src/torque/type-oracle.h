...
class TypeOracle {
 public:
  ...
  Type GetTaggedType() { return GetBuiltinType(TAGGED_TYPE_STRING); }

  Type GetExceptionType() { return GetBuiltinType(EXCEPTION_TYPE_STRING); }

  Type GetBranchType() { return GetBuiltinType(BRANCH_TYPE_STRING); }
