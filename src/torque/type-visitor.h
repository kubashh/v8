...
class TypeVisitor {
 public:
  ...
  static void FinalizeClassFieldsAndMethods(
 ...
 private:
  static void DeclareMethods(AggregateType* container,
                             const std::vector<Declaration*>& methods);
  static void AddStructFieldsAndMethods(StructType* struct_type,
