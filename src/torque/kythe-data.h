...
class KytheConsumer {
 public:
  ...
  virtual void AddCall(Kind kind, kythe_entity_t caller_entity, KythePosition call_pos,
...
class KytheData : public ContextualClass<KytheData> {
 ...
 private:
  static kythe_entity_t AddBindingDefinitionImpl(uint64_t binding_index,
