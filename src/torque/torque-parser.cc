...
base::Optional<ParseResult> YieldIntegerLiteral(
  ...
  if (std::distance(pos, end) >= 2 && *pos == '0' && *(pos + 1) == 'x') {
          ...
          *index,
          MakeCall(
              ...
              {MakeNode<BasicTypeExpression>(std::vector<std::string>{},
                                             ...
                                             std::vector<TypeExpression*>{})},
              {MakeNode<IntegerLiteralExpression>(IntegerLiteral::FromInt(1))},
              {}),
          MakeCall(
              MakeNode<Identifier>("FromConstexpr"),
              {MakeNode<BasicTypeExpression>(std::vector<std::string>{},
                                             MakeNode<Identifier>("intptr"),
                                             std::vector<TypeExpression*>{})},
              {MakeNode<IntegerLiteralExpression>(IntegerLiteral::FromInt(0))},
              {}));
    }
