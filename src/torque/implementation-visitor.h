...
class ImplementationVisitor : public FileVisitor {
 public:
  ...
  size_t InitializeAggregateHelper(const AggregateType* aggregate_type,
                                   VisitResult allocate_result,
                                   InitializerResults* initializer_results,
                                   std::vector<std::string>* constexpr_values);

  VisitResult InitializeAggregate(const AggregateType* aggregate_type,
                                  VisitResult allocate_result,
                                  InitializerResults* initializer_results);
  ...
  DECLARE_CONTEXTUAL_VARIABLE(CurrentReturnCount, size_t);
 ...
 private:
  ...
  VisitResult AddVariableObjectSize(VisitResult object_size,
  ...
  std::pair<base::Optional<StackRange>, std::vector<std::string>>
