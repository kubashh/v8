...
class ResidueClass {
 public:
  ...
  // value.
  base::Optional<size_t> KnownValue() const {
  ...
  // which is a subset of {ab + k2^c | k \in Z}
  // if 2^c is a common divisor of x2^b, y2^a (and hence also of 2^(a+b))
