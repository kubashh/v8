...
#define NATIVE_CONTEXT_FIELDS(V)                                               \
  ...
  V(INITIAL_STRING_ITERATOR_PROTOTYPE_MAP_INDEX, Map,                          \
    initial_string_iterator_prototype_map)                                     \
  V(INITIAL_STRING_SYMBOL_ITERATOR_FUN_INDEX, JSFunction,                      \
    initial_string_symbol_iterator_fun)                                        \
