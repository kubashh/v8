...
#define NATIVE_CONTEXT_FIELDS(V)                                               \
  ...
  V(SLOPPY_FUNCTION_WITH_NAME_AND_WITHOUT_PROTOTYPE_MAP_INDEX, Map,            \
    sloppy_function_with_name_and_without_prototype_map)                       \
  V(SLOPPY_FUNCTION_WITH_READONLY_PROTOTYPE_MAP_INDEX, Map,                    \
    sloppy_function_with_readonly_prototype_map)                               \
  V(SLOPPY_FUNCTION_WITH_NAME_AND_READONLY_PROTOTYPE_MAP_INDEX, Map,           \
    sloppy_function_with_name_and_readonly_prototype_map)                      \
