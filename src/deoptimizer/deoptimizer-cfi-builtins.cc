...
void Builtins_DeoptimizeStartAtBytecode();
void Builtins_DeoptimizeStartAtNextBytecode();
...
constexpr function_ptr builtins[] = {
    ...
    &Builtins_DeoptimizeStartAtBytecode,
    &Builtins_DeoptimizeStartAtNextBytecode,
};
