...
void Builtins_DeoptimizeEnterAtBytecode();
void Builtins_DeoptimizeEnterAtNextBytecode();
...
constexpr function_ptr builtins[] = {
    ...
    &Builtins_DeoptimizeEnterAtBytecode,
    &Builtins_DeoptimizeEnterAtNextBytecode,
};
