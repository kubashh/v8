...
class ActiveSparkplugFunction : public ThreadVisitor {
 public:
  explicit ActiveSparkplugFunction(SharedFunctionInfo shared)
      : shared_(shared) {}
  explicit ActiveSparkplugFunction() : shared_(SharedFunctionInfo()) {}
...
void Deoptimizer::DeoptimizeSparkplug(JSFunction function) {
  DeoptimizeSparkplug(function.shared());
}
