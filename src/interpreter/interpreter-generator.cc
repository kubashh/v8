...
class NegateAssemblerImpl : public UnaryNumericOpAssembler {
 public:
  ...
  virtual ~NegateAssemblerImpl() {}

  Node* SmiOp(Node* operand, Variable* var_feedback, Label* do_float_op,
...
class IncDecAssembler : public UnaryNumericOpAssembler {
 public:
  ...
  virtual ~IncDecAssembler() {}

  Token::Value op() { return op_; }
  void set_op(Token::Value op) {
  ...
  Node* SmiOp(Node* smi_value, Variable* var_feedback, Label* do_float_op,
              Variable* var_float) override {
    DCHECK(op() != Token::ILLEGAL);  // Must call set_op() first.
...
IGNITION_HANDLER(Inc, IncDecAssembler) {
  set_op(Token::INC);
  UnaryOpWithFeedback();
}
...
IGNITION_HANDLER(Dec, IncDecAssembler) {
  set_op(Token::DEC);
  UnaryOpWithFeedback();
}
