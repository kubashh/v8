...
class V8_EXPORT_PRIVATE InterpreterAssembler : public CodeStubAssembler {
 public:
  ...
  void IncrementCallCount(compiler::TNode<FeedbackVector> feedback_vector,
                          compiler::TNode<IntPtrT> slot_id);
  ...
  void CollectCallFeedback(compiler::TNode<Object> target,
                           compiler::TNode<Context> context,
                           compiler::TNode<Object> maybe_feedback_vector,
                           compiler::TNode<IntPtrT> slot_id);
  ...
  compiler::TNode<Object> ConstructWithSpread(
      ...
      compiler::TNode<IntPtrT> slot_id, TNode<Object> maybe_feedback_vector);

  // Call runtime function with |args| arguments which will return |return_size|
  // number of values.
  compiler::TNode<Object> CallRuntimeN(compiler::TNode<Word32T> function_id,
                                       compiler::TNode<Context> context,
                                       const RegListNodePair& args,
                                       int return_size = 1);
  ...
  compiler::TNode<Object> JumpBackward(compiler::TNode<IntPtrT> jump_offset);
