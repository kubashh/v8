...
class V8_EXPORT_PRIVATE InterpreterAssembler : public CodeStubAssembler {
 public:
  ...
  // |operand_index| in the current bytecode.
  compiler::TNode<IntPtrT> BytecodeOperandIdx(int operand_index);
  ...
  // |operand_index| in the current bytecode.
  compiler::TNode<IntPtrT> BytecodeOperandUImmWord(int operand_index);
  ...
  compiler::TNode<IntPtrT> BytecodeOperandNativeContextIndex(int operand_index);
  ...
  compiler::TNode<Object> LoadConstantPoolEntry(compiler::TNode<IntPtrT> index);
  // Load and untag constant at |index| in the constant pool.
  TNode<IntPtrT> LoadAndUntagConstantPoolEntry(compiler::TNode<IntPtrT> index);
  ...
  compiler::TNode<Object> Jump(compiler::TNode<IntPtrT> jump_offset);

  // Jump backward relative to the current bytecode by the |jump_offset|.
  compiler::Node* JumpBackward(compiler::TNode<IntPtrT> jump_offset);
  ...
  compiler::TNode<Object> Dispatch();
  ...
  compiler::TNode<Object> DispatchToBytecode(
 ...
 private:
  ...
  compiler::TNode<IntPtrT> BytecodeOperandConstantPoolIdx(
      int operand_index,
      LoadSensitivity needs_poisoning = LoadSensitivity::kCritical);
  ...
  compiler::TNode<Object> DispatchToBytecodeHandlerEntry(
      compiler::TNode<WordT> handler_entry,
