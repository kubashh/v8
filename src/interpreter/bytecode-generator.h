...
#undef DECLARE_VISIT
 ...
 private:
  ...
  // Checks if the visited expression is one shot i.e executed only once.
  // Any expression  either in a top level code  or an IIFE
  // that is not surrounded by loops is eligible for one shot otimizations.
