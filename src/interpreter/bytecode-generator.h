...
#define DECLARE_VISIT(type) NO_INLINE(void Visit##type(type* node));
...
#undef DECLARE_VISIT
 ...
 private:
  ...
  NO_INLINE(void VisitArithmeticExpression(BinaryOperation* binop));
  NO_INLINE(void VisitCommaExpression(BinaryOperation* binop));
  NO_INLINE(void VisitLogicalOrExpression(BinaryOperation* binop));
  NO_INLINE(void VisitLogicalAndExpression(BinaryOperation* binop));
  ...
  INLINE(void BuildLogicalTest(Token::Value token, Expression* left,
                               Expression* right));
  ...
  void VisitInSameExecutionScope(Expression* expr);
