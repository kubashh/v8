...
#undef DECLARE_VISIT
 ...
 private:
  ...
  enum class PrepareLhsMode { kNoKeyToName, kEarlyKeyToName };
  ...
  class AssignmentLhsData {
   public:
    ...
    static AssignmentLhsData NamedSuperProperty(
      ...
      return AssignmentLhsData(NAMED_SUPER_PROPERTY, nullptr,
                               super_property_args, Register(), Register(),
                               nullptr, nullptr);
    }
    static AssignmentLhsData KeyedSuperProperty(
        RegisterList super_property_args) {
      return AssignmentLhsData(KEYED_SUPER_PROPERTY, nullptr,
                               super_property_args, Register(), Register(),
                               nullptr, nullptr);
    }

    LhsKind assign_type() const { return assign_type_; }
   ...
   private:
    AssignmentLhsData(LhsKind assign_type, Expression* expr,
