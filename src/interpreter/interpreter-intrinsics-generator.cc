...
class IntrinsicsGenerator {
 public:
  ...
  Node* InvokeIntrinsic(Node* function_id, TNode<Context> context,
...
Node* GenerateInvokeIntrinsic(
    InterpreterAssembler* assembler, Node* function_id, TNode<Context> context,
    const InterpreterAssembler::RegListNodePair& args) {
...
Node* IntrinsicsGenerator::InvokeIntrinsic(
    Node* function_id, TNode<Context> context,
    const InterpreterAssembler::RegListNodePair& args) {
...
Node* IntrinsicsGenerator::GeneratorGetResumeMode(
    const InterpreterAssembler::RegListNodePair& args, TNode<Context> context) {
  TNode<Object> generator = __ LoadRegisterFromRegisterList(args, 0);
  TNode<Object> const value = __ LoadObjectField(
      __ CAST(generator), JSGeneratorObject::kResumeModeOffset);
