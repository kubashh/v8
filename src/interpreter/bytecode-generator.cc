...
void BytecodeGenerator::VisitDoWhileStatement(DoWhileStatement* stmt) {
  BoundBlockCoverageBuilder coverage_builder(stmt, block_coverage_builder_);
  LoopBuilder loop_builder(builder(), &coverage_builder);
...
void BytecodeGenerator::VisitYieldStar(YieldStar* expr) {
...

  {
    ...
    {
      BoundBlockCoverageBuilder coverage_builder(expr, block_coverage_builder_);
      LoopBuilder loop(builder(), &coverage_builder);
