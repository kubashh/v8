...
BytecodeGenerator::AssignmentLhsData BytecodeGenerator::PrepareAssignmentLhs(
  ...
  switch (assign_type) {
    ...
    case NAMED_SUPER_PROPERTY: {
      ...
      VisitForRegisterValue(super_property->this_expression(),
...
void BytecodeGenerator::VisitNamedSuperPropertyLoad(Property* property,
  ...
  SuperPropertyReference* super_property =
      property->obj()->AsSuperPropertyReference();
  RegisterList args = register_allocator()->NewRegisterList(3);
  VisitForRegisterValue(super_property->this_expression(), args[0]);
...
void BytecodeGenerator::VisitThisExpression(ThisExpression* expr) {
  ...
  HoleCheckMode hole_check_mode =
      IsDerivedConstructor(closure_scope()->function_kind())
