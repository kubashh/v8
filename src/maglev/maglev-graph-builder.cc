...
class FunctionContextSpecialization final {
 public:
...
bool MaglevGraphBuilder::TrySpecializeLoadContextSlotToFunctionContext(
  ...
  // Converting the context node to a Constant currently generates slower code
  // than keeping it as-is.
  // TODO(v8:7700): Improve codegen for constants and reconsider enabling this.
  static constexpr bool kFoldContextConstant = false;
