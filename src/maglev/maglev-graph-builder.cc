...
ValueNode* MaglevGraphBuilder::GetTaggedValue(
  ...
  switch (representation) {
    case ValueRepresentation::kInt32: {
      if (NodeTypeIsSmi(known_node_aspects().NodeTypeFor(value))) {
        return known_node_aspects().SetTaggedAlternative(
            value, AddNewNode<UnsafeSmiTag>({value}));
      }
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<Int32ToNumber>({value}));
    }
    case ValueRepresentation::kUint32: {
      ...
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<Uint32ToNumber>({value}));
    }
    case ValueRepresentation::kFloat64: {
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<Float64ToTagged>({value}));
    }
    case ValueRepresentation::kHoleyFloat64: {
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<HoleyFloat64ToTagged>({value}));
    }
...
ValueNode* MaglevGraphBuilder::GetSmiValue(
  ...
  switch (representation) {
    case ValueRepresentation::kInt32: {
      ...
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<CheckedSmiTagInt32>({value}));
    }
    case ValueRepresentation::kUint32: {
      if (NodeTypeIsSmi(known_node_aspects().NodeTypeFor(value))) {
        return known_node_aspects().SetTaggedAlternative(
      ...
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<CheckedSmiTagUint32>({value}));
    }
    case ValueRepresentation::kFloat64: {
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<CheckedSmiTagFloat64>({value}));
    }
    case ValueRepresentation::kHoleyFloat64: {
      return known_node_aspects().SetTaggedAlternative(
          value, AddNewNode<CheckedSmiTagFloat64>({value}));
...
ValueNode* MaglevGraphBuilder::GetTruncatedInt32ForToNumber(ValueNode* value,
  ...
  // too.
  if (ValueNode* alt = known_node_aspects().Int32Alternative(value)) {
    return alt;
  }
  if (ValueNode* alt =
          known_node_aspects().TruncatedInt32ToNumberAlternative(value)) {
    return alt;
  }
  ...
  switch (representation) {
    case ValueRepresentation::kTagged: {
      ...
      if (NodeTypeIsSmi(old_type)) {
        ...
        return known_node_aspects().SetInt32Alternative(
            value, AddNewNode<UnsafeSmiUntag>({value}));
      }
      if (desired_type == NodeType::kSmi) {
        return known_node_aspects().SetInt32Alternative(
            value, AddNewNode<CheckedSmiUntag>({value}));
      }
      TaggedToFloat64ConversionType conversion_type =
          ToNumberHintToConversionType(hint);
      if (NodeTypeIs(old_type, desired_type)) {
        return known_node_aspects().SetTruncatedInt32ToNumberAlternative(
            value, AddNewNode<TruncateNumberOrOddballToInt32>({value},
                                                              conversion_type));
      }
      return known_node_aspects().SetTruncatedInt32ToNumberAlternative(
          value, AddNewNode<CheckedTruncateNumberOrOddballToInt32>(
    ...
    case ValueRepresentation::kHoleyFloat64: {
      return known_node_aspects().SetTruncatedInt32ToNumberAlternative(
          value, AddNewNode<TruncateFloat64ToInt32>({value}));
    }
...
ValueNode* MaglevGraphBuilder::GetInt32(ValueNode* value) {
  ...
  switch (representation) {
    case ValueRepresentation::kTagged: {
      ...
      return known_node_aspects().SetInt32Alternative(value,
                                                      BuildSmiUntag(value));
    }
    case ValueRepresentation::kUint32: {
      if (NodeTypeIsSmi(known_node_aspects().NodeTypeFor(value))) {
      ...
      return known_node_aspects().SetInt32Alternative(
          value, AddNewNode<CheckedUint32ToInt32>({value}));
    }
    case ValueRepresentation::kFloat64:
    ...
    case ValueRepresentation::kHoleyFloat64: {
      return known_node_aspects().SetInt32Alternative(
          value, AddNewNode<CheckedTruncateFloat64ToInt32>({value}));
    }
...
ValueNode* MaglevGraphBuilder::GetFloat64ForToNumber(ValueNode* value,
  ...
  if (ValueNode* alt = known_node_aspects().Float64Alternative(value)) {
    return alt;
  }
  ...
  switch (representation) {
    case ValueRepresentation::kTagged: {
      switch (hint) {
        ...
        case ToNumberHint::kAssumeNumber:
          ...
          return known_node_aspects().SetFloat64Alternative(
              value, BuildNumberOrOddballToFloat64(
        ...
        case ToNumberHint::kAssumeNumberOrOddball: {
          ...
          if (NodeTypeIsNumber(known_node_aspects().NodeTypeFor(value))) {
            known_node_aspects().SetFloat64Alternative(value, float64_node);
          }
          return float64_node;
        }
      }
    ...
    case ValueRepresentation::kInt32:
      return known_node_aspects().SetFloat64Alternative(
          value, AddNewNode<ChangeInt32ToFloat64>({value}));
    case ValueRepresentation::kUint32:
      return known_node_aspects().SetFloat64Alternative(
          value, AddNewNode<ChangeUint32ToFloat64>({value}));
    case ValueRepresentation::kHoleyFloat64: {
      switch (hint) {
        case ToNumberHint::kAssumeSmi:
        case ToNumberHint::kDisallowToNumber:
        case ToNumberHint::kAssumeNumber:
          ...
          // also become the canonical float64_alternative.
          return known_node_aspects().SetFloat64Alternative(
              value, AddNewNode<CheckedHoleyFloat64ToFloat64>({value}));
        case ToNumberHint::kAssumeNumberOrOddball:
          // NumberOrOddball->Float64 conversions are not exact alternatives,
          // since they lose the information that this is an oddball, so they
...
compiler::OptionalHeapObjectRef MaglevGraphBuilder::TryGetConstant(
  ...
  if (auto c = known_node_aspects().ConstantAlternative(node)) {
...
void MaglevGraphBuilder::SetKnownValue(ValueNode* node,
  ...
  known_node_aspects().SetConstantAlternative(node, GetConstant(ref));
}
  ...
  switch (object->properties().value_representation()) {
    ...
    case ValueRepresentation::kTagged:
      ...
      if (SmiConstant* constant = object->TryCast<SmiConstant>()) {
        ...
        return known_node_aspects().GetOrSetInt32Alternative(
            object, [&]() { return AddNewNode<UnsafeSmiUntag>({object}); });
      } else {
...
ReduceResult MaglevGraphBuilder::TryReduceArrayForEach(
  ...
  NodeInfo* node_info = known_node_aspects().TryGetInfoFor(receiver);
...
BasicBlock* MaglevGraphBuilder::BuildSpecializedBranchIfCompareNode(
  ...
  if (node->value_representation() == ValueRepresentation::kInt32) {
    ...
    if (auto as_int32 = known_node_aspects().Int32Alternative(node)) {
      return make_specialized_branch_if_compare(ValueRepresentation::kInt32,
                                                as_int32);
    } else if (auto as_float64 =
                   known_node_aspects().Float64Alternative(node)) {
      return make_specialized_branch_if_compare(ValueRepresentation::kFloat64,
                                                as_float64);
    } else {
...
void MaglevGraphBuilder::VisitThrowReferenceErrorIfHole() {
  ...
  // allow the hole.
  if (known_node_aspects().Int32Alternative(value) ||
      known_node_aspects().TruncatedInt32ToNumberAlternative(value) ||
      known_node_aspects().Float64Alternative(value)) {
    return;
  }
