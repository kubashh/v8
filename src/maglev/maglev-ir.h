...
// Nodes that can deopt are in the end slower that nodes that can't, because the
// register allocator / code generator have to set up the deopt. Thus, to have
// better performance, we split the LoadxxxTypedArrayElement nodes in two: those
// who can deopt and those who can't. Deoptimization in a
