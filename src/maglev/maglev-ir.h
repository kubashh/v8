...
class LazyDeoptInfo : public DeoptInfo {
 public:
  LazyDeoptInfo(Zone* zone, DeoptFrame&& top_frame,
      ...
      : DeoptInfo(zone, std::move(top_frame), feedback_to_update),
        ...
        bitfield_(DeoptingCallReturnPcField::encode(-1) |
 ...
 private:
  using DeoptingCallReturnPcField = base::BitField<int, 0, 30>;
  ...
  // to know is correct.
  static const int kMaxCodeSize = 512 * MB;
  static_assert(DeoptingCallReturnPcField::kMax >= kMaxCodeSize);
