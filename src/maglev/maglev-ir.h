 ...
 private:
  ...
  union {
    struct {
      ...
      // been bound. However, once the backedge is bound, we might be able to
      // refine it. {post_loop_type_} is used to keep track of the loop Phi
      // type.
      NodeType post_loop_type_ = NodeType::kUnknown;
    };
