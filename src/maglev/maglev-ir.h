...
class VirtualObject : public FixedInputValueNodeT<0, VirtualObject> {
 ...
 public:
  ...
  explicit VirtualObject(uint64_t bitfield, compiler::MapRef map,
      ...
      : Base(bitfield),
        ...
        double_elements_length_(length),
  ...
  size_t size() const {
    switch (type_) {
      ...
      case kFixedDoubleArray:
        return FixedDoubleArray::SizeFor(double_elements_length_);
    }
  }
  ...
  uint32_t double_elements_length() const {
    ...
    return double_elements_length_;
  }
 ...
 private:
  ...
  union {
    Float64 number_;
    struct {
      uint32_t double_elements_length_;
      compiler::FixedDoubleArrayRef double_elements_;
    };
    struct {
