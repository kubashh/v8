...
inline void MaglevAssembler::CheckJSAnyIsStringAndBranch(
    ...
    bool fallthrough_when_false) {
  CheckObjectTypeInRangeAndBranch(
      heap_object, FIRST_STRING_TYPE, LAST_STRING_TYPE, if_true, true_distance,
      fallthrough_when_true, if_false, false_distance, fallthrough_when_false);
}
