...
void EmitPolymorphicAccesses(MaglevAssembler* masm, NodeT* node,
  ...
  bool any_access_info_has_heap_number_map_simple =
      AnyMapIsHeapNumberSimple(node->access_infos());

  CHECK_EQ(any_access_info_has_heap_number_map, any_access_info_has_heap_number_map_simple);
