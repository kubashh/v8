...
class PropertyCallbackArguments
 ...
 private:
   ...
   */
  Handle<JSObject> CallPropertyEnumerator(Handle<InterceptorInfo> interceptor);

  Handle<Object> CallIndexedGetterCallback(IndexedPropertyGetterCallback f,
                                           uint32_t index);
  Handle<Object> CallNamedGetterCallback(GenericNamedPropertyGetterCallback f,
                                         Handle<Name> name);
