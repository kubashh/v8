...
DEFINE_BOOL(efficiency_mode_for_background_isolate, false,
...
DEFINE_FLOAT(efficiency_mode_delay_turbofan, 1.0,
             "Defer turbofan factor in efficiency mode.")
