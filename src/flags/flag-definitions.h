...
DEFINE_UINT(max_opt, 999,
            ...
            "> 4 == any, 0 == ignition/interpreter, 1 == sparkplug/baseline, "
            "2 == maglev, 3 == turboshaft, 4 == turbofan")

DEFINE_WEAK_VALUE_IMPLICATION(max_opt < 4, turbofan, false)
DEFINE_WEAK_VALUE_IMPLICATION(max_opt < 3, turboshaft, false)
#ifdef V8_ENABLE_MAGLEV
