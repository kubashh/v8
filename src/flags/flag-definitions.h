...
DEFINE_BOOL(code_space_dual_mapping, false, "")
DEFINE_NEG_IMPLICATION(code_space_dual_mapping, write_protect_code_memory)
DEFINE_NEG_IMPLICATION(jitless, code_space_dual_mapping)
