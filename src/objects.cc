...
void BytecodeArray::increment_bytecode_age() {
  ...
  uintptr_t age_byte_shift = (age_byte_address & word_alignment_mask) * 8u;
  uintptr_t age_byte_mask = 0xFFu << age_byte_shift;
