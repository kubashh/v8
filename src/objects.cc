...
void SharedFunctionInfo::InitFromFunctionLiteral(
  ...
  DCHECK_IMPLIES(lit->requires_instance_elements_initializer(),
                 IsClassConstructor(lit->kind()));
  shared_info->set_requires_instance_elements_initializer(
      lit->requires_instance_elements_initializer());
