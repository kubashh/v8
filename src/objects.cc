...
Handle<SmallOrderedHashSet> SmallOrderedHashSet::Add(
  ...
  table->SetDataEntry(new_entry, SmallOrderedHashSet::kKeyOffset, *key);
...
Handle<SmallOrderedHashMap> SmallOrderedHashMap::Add(
  ...
  table->SetDataEntry(new_entry, SmallOrderedHashMap::kValueOffset, *value);
  table->SetDataEntry(new_entry, SmallOrderedHashMap::kKeyOffset, *key);
  table->SetFirstEntry(bucket, new_entry);
  table->SetNextEntry(new_entry, previous_entry);
