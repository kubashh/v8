...
class EmbeddedFileWriter {
 ...
 private:
  ...
  static void WriteFilePrelude(PlatformDependentEmbeddedFileWriter* w) {
  ...
  void WriteFilePrologue(PlatformDependentEmbeddedFileWriter* w,
                         const i::EmbeddedData* blob) const {
    {
      char embedded_blob_data_symbol[kTemporaryStringLength];
      i::SNPrintF(i::Vector<char>(embedded_blob_data_symbol),
