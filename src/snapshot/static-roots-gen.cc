...
#undef ELEMENT
    ...
    obj_ranges.push_back(
        {"FreeSpaceOrFillerMap",
         {RootIndex::kFreeSpaceMap, RootIndex::kOnePointerFillerMap,
          RootIndex::kTwoPointerFillerMap}});
    obj_ranges.push_back({"StringMap", string_types});
    obj_ranges.push_back({"InternalizedStringMap", internalized_string_types});
  }
  ...
  // Output symbol for every root. Ordered by ptr to make it easier to see the
