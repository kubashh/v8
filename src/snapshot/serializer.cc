...
void Serializer::ObjectSerializer::Serialize() {
  ...
  DCHECK_IMPLIES(serializer_->MustBeDeferred(*object_), serializer_->MayDeferObjects());
  if (serializer_->MayDeferObjects() && ((recursion.ExceedsMaximum() && CanBeDeferred(*object_)) ||
