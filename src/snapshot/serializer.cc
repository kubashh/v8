...
void Serializer::ObjectSerializer::VisitExternalPointer(HeapObject host,
  ...
  // TODO(12700) handle other external references here as well. This should
  ...
  if (host.IsJSExternalObject()) {
    ...
    Address value = ptr;
#endif
    // TODO(12700) should we specify here whether we expect the references to be
    // internal or external (or either)?
