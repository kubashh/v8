...
void PlatformDependentEmbeddedFileWriter::End() {}
...
void PlatformDependentEmbeddedFileWriter::AnnotateSymbolAsFunction(
    const char* name) {
  // TODO(mvstanton): Investigate how to do this on windows.
}
...
void PlatformDependentEmbeddedFileWriter::End() { fprintf(fp_, "END\n"); }
