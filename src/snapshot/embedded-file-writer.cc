...
// static
int EmbeddedFileWriter::WriteDirectiveOrSeparator(
    PlatformEmbeddedFileWriterBase* w, int current_line_length,
...
// static
int EmbeddedFileWriter::WriteByteChunk(PlatformEmbeddedFileWriterBase* w,
...
// static
int EmbeddedFileWriter::WriteLineEndIfNeeded(PlatformEmbeddedFileWriterBase* w,
                                             int current_line_length,
                                             int write_size) {
