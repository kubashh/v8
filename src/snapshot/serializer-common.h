...
class SerializerDeserializer : public RootVisitor {
 ...
 protected:
  ...
  enum Where {
    ...
    kBuiltin = 0x0e,
    // 0x17       Root array item.
    kRootArray = 0x17,
    // 0x18        Object provided in the attached list.
    kAttachedReference = 0x18,

    // 0x0f        Misc, see below (incl. 0x2f, 0x4f, 0x6f).
    // 0x19..0x1f  Misc, see below (incl. 0x39..0x3f, 0x59..0x5f, 0x79..0x7f).
  };
  ...
  // 0x16, 0x3d..0x3f, 0x59..0x5f, 0x76, 0x77, 0x79..0x7f unused.
