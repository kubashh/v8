...
// The startup and shareable object caches are terminated by undefined. We
// visit these caches...
...
void SerializerDeserializer::IterateShareableObjectCache(Isolate* isolate,
                                                         RootVisitor* visitor) {
  IterateObjectCache(isolate, isolate->shareable_object_cache(),
                     Root::kShareableObjectCache, visitor);
}
