...
class V8_EXPORT_PRIVATE SharedHeapSerializer : public RootsSerializer {
 public:
  ...
  // Terminate the shared space object cache with an undefined value and
  ...
  // shared space object cache if not already present and emit a
  ...
  static bool ShouldBeInSharedHeap(Isolate* isolate, HeapObject obj);
