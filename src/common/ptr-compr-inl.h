...
template <>
V8_EXPORT_PRIVATE uintptr_t V8HeapCompressionSchemeImpl<MainCage>::base_;
template <>
V8_EXPORT_PRIVATE uintptr_t V8HeapCompressionSchemeImpl<TrustedCage>::base_;
#else
template <>
V8_EXPORT_PRIVATE Address
V8HeapCompressionSchemeImpl<MainCage>::base_non_inlined();
template <>
V8_EXPORT_PRIVATE void
V8HeapCompressionSchemeImpl<MainCage>::set_base_non_inlined(Address base);
template <>
thread_local uintptr_t V8HeapCompressionSchemeImpl<MainCage>::base_;
template <>
thread_local uintptr_t V8HeapCompressionSchemeImpl<TrustedCage>::base_;
