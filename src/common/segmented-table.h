 ...
 *
 * The table provides thread-safe allocation and free of segments and an inline
 * freelist implementation. Allocation and Freeing of entries is implemented in
 * subclasses since it depends on if the table is manually managed or GCed.
 *
...
class V8_EXPORT_PRIVATE SegmentedTable {
 ...
 protected:
  ...
  //
  // An segmented table uses simple, singly-linked lists to manage free entries.
