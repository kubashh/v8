...
class ResetPKUPermissionsForThreadSpawning;
}
...
class V8_NODISCARD RwxMemoryWriteScope {
 ...
 private:
  ...
  friend class wasm::ResetPKUPermissionsForThreadSpawning;
...
class V8_NODISCARD RwxMemoryWriteScopeForTesting final
 ...
 public:
#if V8_HAS_PTHREAD_JIT_WRITE_PROTECT || V8_HAS_PKU_JIT_WRITE_PROTECT
  V8_EXPORT_PRIVATE RwxMemoryWriteScopeForTesting() = default;
  V8_EXPORT_PRIVATE ~RwxMemoryWriteScopeForTesting() = default;
#else
