...
enum class AllocationType : uint8_t {
  ...
  kTrusted,    // Like kOld, but when the sandbox is enabled, use the
               // TRUSTED_SPACE or TRUSTED_LO_SPACE located outside of the
               // sandbox, where objects cannot directly be corrupted by an
               // attacker.
};
