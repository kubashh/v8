...
// enabled pointer compression with shared cage and disabled external code
// space because if the code range will be deleted while the cage is still
// alive then attempt to configure permissions of pages that were previously
// set to RWX will fail.
//
