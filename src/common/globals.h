...
constexpr bool kArgcIncludesReceiver = true;
constexpr int kArgcReceiverSlots = 1;
constexpr uint16_t kDontAdaptArgumentsSentinel = 0;
#else
constexpr bool kArgcIncludesReceiver = false;
constexpr int kArgcReceiverSlots = 0;
