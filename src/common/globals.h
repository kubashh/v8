...
constexpr uint64_t kTracedHandleEarlyResetZapValue =
    uint64_t{0x1beffed00baffedf};
constexpr uint64_t kTracedHandleGCResetZapValue = uint64_t{0x1beffed0ebaffedf};
...
constexpr uint32_t kTracedHandleEarlyResetZapValue = 0xbeffedf;
constexpr uint32_t kTracedHandleGCResetZapValue = 0xbeffadf;
