...
// The base can be any OS page-aligned value such that [base, base + 4GB)
// contains the whole code range (the alignment is required for avoiding
// corruption of tagged value's tags).
