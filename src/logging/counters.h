...
#define FOR_EACH_THREAD_SPECIFIC_COUNTER(V)                             \
  ...
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, FastPopulateReferenceMaps)   \
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, FastRegisterAllocator)       \
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, FastSpillSlotAllocator)      \
