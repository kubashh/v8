...
#define FOR_EACH_THREAD_SPECIFIC_COUNTER(V)                                  \
  ...
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, SimplifiedLoweringPropagatePhase) \
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, SimplifiedLoweringRetypePhase)    \
  ADD_THREAD_SPECIFIC_COUNTER(V, Optimize, SimplifiedLoweringLoweringPhase)  \
