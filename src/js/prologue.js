...
function PostNatives(utils) {
  ...
  %InstallToContext([
    "array_entries_iterator", GlobalArray.prototype.entries,
    "array_for_each_iterator", GlobalArray.prototype.forEach,
    "array_keys_iterator", GlobalArray.prototype.keys,
    "array_values_iterator", GlobalArray.prototype[iteratorSymbol],
  ]);
