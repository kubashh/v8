...
inline constexpr bool IsSubtype(MachineRepresentation rep1,
                                MachineRepresentation rep2) {
  return rep1 == rep2 || ((rep1 == MachineRepresentation::kTaggedSigned ||
                           rep1 == MachineRepresentation ::kTaggedPointer) &&
