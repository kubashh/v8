...
/*
Address GetEvacuationEntryHandleLocation() {
  Address payload_ = payload_.load(std::memory_order_relaxed);
  DCHECK(ContainsEvacuationEntry(payload);
  return Untag(payload, kExternalPointerEvacuationEntryTag);
}
*/
