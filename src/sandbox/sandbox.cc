...
void Sandbox::InitializeConstants() {
  ...
  // "objects" there that are guaranteed to cause a fault on any accidental
  // access (e.g. the empty backing store buffer).
  ...
  CHECK(address_space_->AllocateGuardRegion(end_ - allocation_granularity,
