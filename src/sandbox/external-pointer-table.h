...
struct ExternalPointerTableEntry {
  ...
  // Move the content of this entry into the provided entry. This invalidates
  // the entry.
...
class V8_EXPORT_PRIVATE ExternalPointerTable
 ...
 private:
  ...
  // below the start of the evacuation area, which is now a huge value.
