...
void MacroAssembler::MoveFused(const Register& scratch1,
  ...
  uint64_t fused1 = (static_cast<uint64_t>(values[3]) << 32) + values[2];
  uint64_t fused2 = (static_cast<uint64_t>(values[1]) << 32) + values[0];
  Mov(scratch1, fused1);
  Mov(scratch2, fused2);
}
...
void MacroAssembler::MoveFused(const Register& scratch,
  ...
  uint64_t fused = (static_cast<uint64_t>(values[1]) << 32) + values[0];
  Mov(scratch, fused);
}
#endif
