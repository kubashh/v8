...
class V8_EXPORT_PRIVATE Assembler : public AssemblerBase {
 public:
  ...
  void EmitConstPoolWithJumpIfNeeded() {
    constpool_.Check(Emission::kIfNeeded, Jump::kRequired);
  }
 ...
 public:
  ...
  void SetNextConstPoolCheckForTesting(int instructions) {
    constpool_.SetNextCheckIn(instructions);
  }
#endif
