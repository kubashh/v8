...
void BaselinePrologueDescriptor::InitializePlatformSpecific(
    CallInterfaceDescriptorData* data) {
  // TODO(leszeks): Clean-up into helper methods.
...
void CallTrampolineBaselineDescriptor::InitializePlatformSpecific(
    CallInterfaceDescriptorData* data) {
  DefaultInitializePlatformSpecific(data, kParameterCount);
}
...
void CallWithSpreadBaselineDescriptor::InitializePlatformSpecific(
    CallInterfaceDescriptorData* data) {
  DefaultInitializePlatformSpecific(data, kParameterCount);
}
...
void ConstructWithSpreadBaselineDescriptor::InitializePlatformSpecific(
    CallInterfaceDescriptorData* data) {
  DefaultInitializePlatformSpecific(data,
                                    kParameterCount - kStackArgumentsCount);
}
...
void UnaryOpBaselineDescriptor::InitializePlatformSpecific(
    CallInterfaceDescriptorData* data) {
