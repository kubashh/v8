...
FUNCTION_REFERENCE(mutable_big_int_trim_function, MutableBigInt_Trim)

FUNCTION_REFERENCE(mutable_big_int_absolute_add_and_make_immutable_function,
                   MutableBigInt_AbsoluteAddAndMakeImmutable)

FUNCTION_REFERENCE(mutable_big_int_absolute_compare_function,
                   MutableBigInt_AbsoluteCompare)

FUNCTION_REFERENCE(mutable_big_int_absolute_sub_and_make_immutable_function,
                   MutableBigInt_AbsoluteSubAndMakeImmutable)
