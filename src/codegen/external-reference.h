...
#define EXTERNAL_REFERENCE_LIST(V)                                            \
  ...
  V(mutable_big_int_absolute_add_function, "MutableBigInt_AbsoluteAdd")       \
  V(mutable_big_int_absolute_compare_function,                                \
    "MutableBigInt_AbsoluteCompare")                                          \
  V(mutable_big_int_absolute_sub_function, "MutableBigInt_AbsoluteSub")       \
  V(mutable_big_int_make_immutable_function, "MutableBigInt_MakeImmutable")   \
