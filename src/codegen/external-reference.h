...
#define EXTERNAL_REFERENCE_STACK_ACCESS_LIST(V)                          \
  V(address_of_load_from_stack_count, Vector<const char>, function_name, \
    "load_from_stack_count")                                             \
  V(address_of_store_to_stack_count, Vector<const char>, function_name,  \
...
#define DECL_EXTERNAL_REFERENCE(name, type, arg, desc) \
  V8_EXPORT_PRIVATE static ExternalReference name(type arg);
