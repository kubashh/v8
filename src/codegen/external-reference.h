...
#define EXTERNAL_REFERENCE_LIST(V)                                            \
  ...
  V(mutable_big_int_absolute_add_and_make_immutable_function,                 \
    "MutableBigInt_AbsoluteAddAndMakeImmutable")                              \
  V(mutable_big_int_absolute_compare_function,                                \
    "MutableBigInt_AbsoluteCompare")                                          \
  V(mutable_big_int_absolute_sub_and_make_immutable_function,                 \
    "MutableBigInt_AbsoluteSubAndMakeImmutable")                              \
  V(mutable_big_int_trim_function, "MutableBigInt_Trim")                      \
