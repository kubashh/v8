...
#undef SC
 ...
 private:
  static void Add(Address* table, Address address, int* index);

  static void AddReferencesIsolateIndependent(int* index);
  static void AddBuiltins(int* index);
  static void AddRuntimeFunctions(int* index);
  static void AddAccessors(int* index);

  void AddAllIsolateIndependentReferences(int* index);
  void AddReferencesIsolateDependent(Isolate* isolate, int* index);
  ...
  static Address ref_addr_isolate_independent_[kSizeIsolateIndependent];
