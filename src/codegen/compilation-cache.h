...
class CompilationCacheScript : public CompilationSubCache {
 public:
  ...
  MaybeHandle<HeapObject> Lookup(Handle<String> source,
...
class V8_EXPORT_PRIVATE CompilationCache {
 public:
  ...
  // Finds the SharedFunctionInfo or Script for a script source string. Returns
  // an empty handle if the cache doesn't contain a script for the given source
  // string with the right origin.
  MaybeHandle<HeapObject> LookupScript(Handle<String> source,
                                       const ScriptDetails& script_details,
                                       LanguageMode language_mode);
