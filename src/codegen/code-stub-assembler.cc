...
void CodeStubAssembler::StoreCagedPointerToObject(TNode<HeapObject> object,
  ...
  CSA_DCHECK(this, WordNotEqual(address, IntPtrConstant(0)));
  ...
  CSA_CHECK(this, IntPtrGreaterThanOrEqual(address, cage_base));
  CSA_CHECK(this, IntPtrLessThan(address, cage_end));
#endif
