  ...
  BIND(&loop);
  {
    ...
    BIND(&if_left_not_smi);
    {
      ...
      BIND(&if_left_string);
      {
        ...
        StringEqual(CAST(left), CAST(right), &combine_feedback,
        ...
        BIND(&if_rhsisnotsmi);
        {
          ...
          BIND(&if_lhsisstring);
          {
            ...
            BIND(&if_rhsisstring);
            {
              ...
              StringEqual(CAST(lhs), CAST(rhs), &end, &end, &result);
            }
...
void CodeStubAssembler::StringEqual(TNode<String> lhs,
                                    TNode<IntPtrT> lhs_length,
                                    TNode<String> rhs,
                                    TNode<IntPtrT> rhs_length, Label* if_true,
                                    Label* if_false,
                                    TVariable<Oddball>* result) {
        ...
        [&] {
          ...
          if (mode != SameValueMode::kNumbersOnly) {
            BIND(&if_lhsisstring);
            {
              ...
              StringEqual(CAST(lhs), CAST(rhs), if_true, if_false);
            }
