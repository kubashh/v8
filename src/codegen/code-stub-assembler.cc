...
TNode<BoolT> CodeStubAssembler::IsSideEffectFreeDebuggingActive() {
  ...
  int32_t mask = static_cast<int32_t>(ExecutionModeFlag::kCheckSideEffects);
  TNode<Int32T> is_active = Word32And(execution_mode, Int32Constant(mask));
  return Word32NotEqual(is_active, Int32Constant(0));
}
