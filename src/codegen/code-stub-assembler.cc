...
TNode<Float32T> CodeStubAssembler::ChangeFloat16ToFloat32(
  ...
  TNode<Uint32T> w = ReinterpretCast<Uint32T>(
      Word32Shl(BitcastFloat16ToInt32(value), Uint32Constant(16)));
  /*
...
TNode<Float16T> CodeStubAssembler::TruncateFloat32ToFloat16(
  ...
  // base = Float32Abs(Float32Mul(Float32Mul(value, scale_to_inf),
scale_to_zero));
...
TNode<Number> CodeStubAssembler::ChangeFloat16ToTagged(TNode<Float16T> value) {
  // TODO(irezvov): Handle Smi
  return AllocateHeapNumberWithValue(
      ChangeFloat32ToFloat64(ChangeFloat16ToFloat32(value)));
}
