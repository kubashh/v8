...
TNode<Int64T> CodeStubAssembler::Word64PopulationCount(
    TNode<Word64T> value_word) {
  if (IsWord64PopcntSupported()) {
    return Word64Popcnt(value_word);
  }
  ...
  TNode<Uint64T> value = Unsigned(value_word);
  TNode<Uint64T> lhs, rhs;
  ...
  return Signed(Word64And(value, Uint64Constant(0xff)));
}
...
TNode<Int32T> CodeStubAssembler::Word32PopulationCount(TNode<Word32T> value) {
  ...
  TNode<Int64T> res64 = Word64Popcnt(ChangeUint32ToUint64(value));
...
TNode<Int32T> CodeStubAssembler::Word32CountTrailingZeros(
  ...
  TNode<Int64T> res64 = Word64Ctz(ChangeUint32ToUint64(value));
  return TruncateInt64ToInt32(Signed(res64));
}
