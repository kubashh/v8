...
void CodeStubAssembler::CollectCallableFeedback(Node* target, Node* context,
...
void CodeStubAssembler::CollectCallFeedback(Node* target, Node* context,
...
void CodeStubAssembler::IncrementCallCount(Node* feedback_vector,
                                           Node* slot_id) {
