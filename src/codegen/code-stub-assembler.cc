...
TNode<IntPtrT> CodeStubAssembler::LoadAndUntagSmi(SloppyTNode<HeapObject> base,
                                                  int index) {
  if (SmiValuesAre32Bits()) {
#if V8_TARGET_LITTLE_ENDIAN
    index += 4;
...
void CodeStubAssembler::StoreAndTagSmi(SloppyTNode<HeapObject> base, int offset,
                                       Node* value) {
  if (SmiValuesAre32Bits()) {
...
TNode<Oddball> CodeStubAssembler::HasProperty(SloppyTNode<Context> context,
  ...
  CodeStubAssembler::LookupInHolder lookup_property_in_holder =
      [this, &return_true](Node* receiver, Node* holder, Node* holder_map,
                           TNode<Int32T> holder_instance_type,
                           Node* unique_name, Label* next_holder,
                           Label* if_bailout) {
  ...
  CodeStubAssembler::LookupInHolder lookup_element_in_holder =
      [this, &return_true, &return_false](
          ...
          TNode<Int32T> holder_instance_type, Node* index, Label* next_holder,
          Label* if_bailout) {
