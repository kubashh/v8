...
class V8_EXPORT_PRIVATE OptimizedCompilationInfo final {
 public:
  ...
  int inlined_bytecode_size() const { return inlined_bytecode_size_; }

  void set_inlined_bytecode_size(int size) { inlined_bytecode_size_ = size; }
