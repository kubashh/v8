...
void SafepointTableBuilder::RemoveDuplicates() {
  ...
  const EntryBuilder& first_info = entries_.front();
  auto is_identical_except_for_pc = [](const EntryBuilder& info1,
                                       const EntryBuilder& info2) {
