...
void Assembler::sse_instr(XMMRegister dst, XMMRegister src, byte prefix,
                          byte escape, byte opcode) {
  sse2_instr(dst, src, prefix, escape, opcode);
}

void Assembler::sse_instr(XMMRegister dst, Operand src, byte prefix,
                          byte escape, byte opcode) {
  sse2_instr(dst, src, prefix, escape, opcode);
}
