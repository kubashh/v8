...
#undef BINT_COMPARISON_OP
  ...
  TNode<BoolT> IsCodeDataContainer(TNode<HeapObject> object) {
  ...
  TNode<Code> FromCodeTNonBuiltin(TNode<CodeDataContainer> code) {
  ...
  TNode<CodeDataContainer> ToCodeDataContainer(
      TNode<Code> code, TNode<CodeDataContainer> code_data_container) {
