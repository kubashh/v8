...
#undef BINT_COMPARISON_OP
  ...
  // Specialized operation to be used when deleting entries:
  // Decreases the number of present entries and increases the number of deleted
  // ones. Returns new (= incremented) number of present entries.
