...
#undef BINT_COMPARISON_OP
  ...
  void GotoIfNotNumber(SloppyTNode<Object> value, Label* is_not_number);
  void GotoIfNumber(SloppyTNode<Object> value, Label* is_number);
  ...
  TNode<Struct> AllocateStruct(TNode<Map> map, AllocationFlags flags = kNone);
