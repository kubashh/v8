...
#undef BINT_COMPARISON_OP
  ...
  void StringEqual(TNode<String> lhs, TNode<String> rhs, Label* if_true,
                   Label* if_false, TVariable<Oddball>* result = nullptr) {
    return StringEqual(lhs, LoadStringLengthAsWord(lhs), rhs,
                       LoadStringLengthAsWord(rhs), if_true, if_false, result);
  }

  void StringEqual(TNode<String> lhs, TNode<IntPtrT> lhs_length,
                   TNode<String> rhs, TNode<IntPtrT> rhs_length, Label* if_true,
                   Label* if_false, TVariable<Oddball>* result = nullptr);
