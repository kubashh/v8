...
#undef BINT_COMPARISON_OP
  ...
  void InitializeJSObjectWithEmbedderSlotsCppHeapWrapperPtr(
      TNode<JSObjectWithEmbedderSlots> holder) {
    StoreObjectField(holder, JSObjectWithEmbedderSlots::kCppHeapWrappableOffset,
