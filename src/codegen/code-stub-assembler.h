...
#undef BINT_COMPARISON_OP
  ...
  TNode<JSArray> ExtractFastJSArray(
      TNode<Context> context, TNode<JSArray> array, TNode<BInt> begin,
      TNode<BInt> count, base::Optional<TNode<BInt>> capacity = base::nullopt,
      base::Optional<TNode<AllocationSite>> allocation_site = base::nullopt);
  ...
  using FastArrayForEachBody =
      std::function<void(TNode<HeapObject> fixed_array, TNode<IntPtrT> offset)>;
  ...
  void BuildFastArrayForEach(
    ...
    BuildFastArrayForEach(list, fixed_array, kind, first_element_inclusive,
