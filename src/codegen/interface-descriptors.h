...
class V8_EXPORT_PRIVATE CallInterfaceDescriptor {
 ...
 protected:
  ...
  static void InitializePlatformUnimplemented(
      CallInterfaceDescriptorData* data, int register_parameter_count) {
    DefaultInitializePlatformSpecific(
        data, std::min(register_parameter_count, 4));
  }
...
class CallWithSpreadBaselineDescriptor : public CallInterfaceDescriptor {
 public:
  ...
  DECLARE_DESCRIPTOR(CallWithSpreadBaselineDescriptor, CallInterfaceDescriptor)
};
...
// TODO(jgruber): Pass the slot as UintPtr.
class ConstructWithSpreadBaselineDescriptor : public CallInterfaceDescriptor {
 public:
  ...
  DEFINE_JS_PARAMETER_TYPES(MachineType::Int32(),      // kSlot
                            MachineType::AnyTagged())  // kSpread
  DECLARE_DESCRIPTOR(ConstructWithSpreadBaselineDescriptor,
                     CallInterfaceDescriptor)
...
// TODO(jgruber): Pass the slot as UintPtr.
class CallTrampolineBaselineDescriptor : public CallInterfaceDescriptor {
 public:
  DEFINE_PARAMETERS_VARARGS(kFunction, kActualArgumentsCount, kSlot)
  DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(),  // kFunction
                         MachineType::Int32(),      // kActualArgumentsCount
                         MachineType::Int32())      // kSlot
  DECLARE_DESCRIPTOR(CallTrampolineBaselineDescriptor, CallInterfaceDescriptor)
};
...
// TODO(jgruber): Pass the slot as UintPtr.
class ConstructBaselineDescriptor : public CallInterfaceDescriptor {
 public:
  DEFINE_JS_PARAMETERS_NO_CONTEXT(kSlot)
  DEFINE_JS_PARAMETER_TYPES(MachineType::Int32())  // kSlot
  DECLARE_JS_COMPATIBLE_DESCRIPTOR(ConstructBaselineDescriptor,
                                   CallInterfaceDescriptor, 1)
};
...
class UnaryOpBaselineDescriptor : public CallInterfaceDescriptor {
 public:
  DEFINE_PARAMETERS(kValue, kSlot)
  DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(),  // kValue
                         MachineType::UintPtr())    // kSlot
  DECLARE_DESCRIPTOR(UnaryOpBaselineDescriptor, CallInterfaceDescriptor)
};
