...
class TSANSeqCstStoreDescriptor final
    : public StaticCallInterfaceDescriptor<TSANSeqCstStoreDescriptor> {
 public:
  DEFINE_PARAMETERS_NO_CONTEXT(kAddress, kValue)
  DEFINE_PARAMETER_TYPES(MachineType::Pointer(),    // kAddress
                         MachineType::AnyTagged())  // kValue

  DECLARE_DESCRIPTOR(TSANSeqCstStoreDescriptor)
