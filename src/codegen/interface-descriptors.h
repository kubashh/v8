...
class BaselineOnStackReplacementDescriptor
 ...
 public:
  DEFINE_PARAMETERS_NO_CONTEXT(kCurrentLoopDepth, kCurrentBytecodeOffset,
                               kOsrUrgencyAndInstallTarget)
  DEFINE_PARAMETER_TYPES(MachineType::Int32(),  // kCurrentLoopDepth
                         MachineType::Int32(),  // kCurrentBytecodeOffset
  ...
  static constexpr inline Register CurrentBytecodeOffsetRegister();
