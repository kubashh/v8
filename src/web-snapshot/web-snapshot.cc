...
void WebSnapshotSerializerDeserializer::IterateBuiltinObjects(
  ...
  auto generator_function =
      JSFunction::cast(isolate_->context()
  ...
  func(*factory()->NewStringFromAsciiChecked("GeneratorFunction.prototype"),
       generator_function.instance_prototype());
  ...
  func(
      *factory()->NewStringFromAsciiChecked("AsyncGeneratorFunction.prototype"),
      async_generator_function.instance_prototype());
