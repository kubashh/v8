...
// Sets given page allocator as the platform page allocator, returns the current
// one. This function *must* be used only for testing purposes.
// It is not thread-safe, the testing infrastructure should ensure that
