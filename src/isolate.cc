...
extern const uint8_t* v8_Default_embedded_blob_;
extern const uint32_t v8_Default_embedded_blob_size_;
...
extern const uint8_t* v8_Trusted_embedded_blob_;
extern const uint32_t v8_Trusted_embedded_blob_size_;
