...
#undef SMI_COMPARISON_OP
  ...
  void JumpIfNotInNewSpace(Node* object, Label* not_in_new_space);

  void MoveElements(TNode<FixedArrayBase> elements, ElementsKind kind,
                    TNode<Smi> dst_index, TNode<Smi> src_index,
                    TNode<Smi> length);

  void MemCopy(TNode<FixedDoubleArray> src_elements, TNode<Smi> src_index,
               TNode<FixedDoubleArray> dst_Elements, TNode<Smi> dst_index,
               TNode<Smi> length);
