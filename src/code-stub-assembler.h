...
#undef HEAP_CONSTANT_TEST
  ...
  // Select the maximum of the two provided Float64 values.
  Node* Float64Max(Node* left, Node* right);
  // Select the minimum of the two provided Float64 values.
  Node* Float64Min(Node* left, Node* right);
