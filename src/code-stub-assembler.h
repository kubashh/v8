...
#undef SMI_COMPARISON_OP
  ...
  Node* IsConfigurable(Node* map);
  Node* IsWritable(Node* map);

 protected:
  Node* HasDescriptorLhsOrRhs(Node* desc, Label* if_bailout, const char* lhs,
                              const char* rhs);

 public:
  Node* IsAccessorDescriptor(Node* desc, Label* if_bailout);
  Node* IsDataDescriptor(Node* desc, Label* if_bailout);
