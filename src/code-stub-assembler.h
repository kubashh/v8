...
#undef SMI_COMPARISON_OP
  ...
  enum class CopyFixedArrayFlag {
    kCopyFixedArrays = 1,
    kCopyFixedDoubleArrays = 2,
    kCopyAllFixedArrays = kCopyFixedArrays | kCopyFixedDoubleArrays
  };

  typedef base::Flags<CopyFixedArrayFlag> CopyFixedArrayFlags;

  Node* CopyFixedArray(
      Node* source, Node* first = nullptr, Node* count = nullptr,
      Node* capacity = nullptr,
      CopyFixedArrayFlags copy_flags = CopyFixedArrayFlag::kCopyAllFixedArrays,
      ParameterMode parameter_mode = INTPTR_PARAMETERS);

  Node* CopyFixedArray(Node* source, CopyFixedArrayFlags copy_flags) {
    return CopyFixedArray(source, nullptr, nullptr, nullptr, copy_flags);
  }
  ...
  Node* IsPrototypeOriginalArrayConstructor(Node* context, Node* map);
