...
// This is a helper class for creating/accessing the ClosureFeedbackCellArray.
// ClosureFeedbackCellArray is a FixedArray that contains feedback cells used
// when creating closures from a particular JSFunction. Along with the feedback
// cells, the first slot (slot 0) is used to hold a budget to measure the
// hotness of the function.
// This FixedArray is created once the function is compiled and is
...
class ClosureFeedbackCellArray {
 public:
  ...
  static inline FeedbackCell GetClosureFeedbackCell(
