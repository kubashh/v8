...
void Deoptimizer::GenerateDeoptimizationEntries(MacroAssembler* masm,
  ...
  // Get the bailout id passed as s6 by the caller
  __ mov(a2, s6);
  ...
  // register t0.
  __ mov(a3, ra);
  __ Addu(t0, sp, Operand(kSavedRegistersAreaSize + kPointerSize));
  ...
  __ Addu(sp, sp, Operand(kSavedRegistersAreaSize + kPointerSize));
