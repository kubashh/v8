...
#if V8_OS_ANDROID
  // On Android, enable Atomics. Enable SharedArrayBuffer with site isolation.
  bool shared_array_buffer =
      FLAG_cross_site_isolated || FLAG_harmony_sharedarraybuffer;
  bool atomics = true;
#else
  // On desktop, SABs and Atomics require the feature flag or COOP+COEP.
  // TODO(bbudge) Switch to Android behavior when desktop migration is complete.
  bool shared_array_buffer =
      FLAG_cross_site_isolated || FLAG_harmony_sharedarraybuffer;
