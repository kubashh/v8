...
V8_NOINLINE Handle<JSFunction> SimpleCreateFunction(Isolate* isolate,
  ...
  if (adapt) {
    fun->shared().set_internal_formal_parameter_count(len + kArgcReceiverSlots);
  } else {
...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // -- P r o m i s e
    ...
    shared->set_internal_formal_parameter_count(kArgcReceiverSlots + 1);
    shared->set_length(1);
  ...
  {  // -- R e g E x p
    ...
    shared->set_internal_formal_parameter_count(kArgcReceiverSlots + 2);
    shared->set_length(2);
