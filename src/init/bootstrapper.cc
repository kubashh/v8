...
void Genesis::InitializeGlobal_harmony_async_context() {
  ...
  native_context()->set_initial_async_local_map(async_local_fun->initial_map());
  ...
  native_context()->set_initial_async_snapshot_map(
      async_snapshot_fun->initial_map());
  ...
  SimpleInstallFunction(isolate_, async_snapshot_prototype, "restore",
