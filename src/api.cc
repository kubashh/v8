...
void debug::SetBreakOnFunctionCall(Isolate* isolate) {
  reinterpret_cast<i::Isolate*>(isolate)->debug()->SetBreakOnFunctionCall();
}

void debug::ClearBreakOnFunctionCall(Isolate* isolate) {
  reinterpret_cast<i::Isolate*>(isolate)->debug()->ClearBreakOnFunctionCall();
}
