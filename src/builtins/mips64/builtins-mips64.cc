...
void Generate_BaselineOrInterpreterEntry(MacroAssembler* masm,
  ...
  if (!is_osr) {
    ...
    __ Branch(&start_with_baseline, ne, t2, Operand(BASELINE_DATA_TYPE));
...
void Builtins::Generate_DeoptimizeEnterAtBytecode(MacroAssembler* masm) {
  Generate_BaselineOrInterpreterEntry(masm, false);
}

void Builtins::Generate_DeoptimizeEnterAtNextBytecode(MacroAssembler* masm) {
