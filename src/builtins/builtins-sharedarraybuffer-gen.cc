...
TF_BUILTIN(AtomicsLoad, SharedArrayBufferBuiltinsAssembler) {
  TNode<Object> maybe_array = Parameter(Descriptor::kArray);
  TNode<Object> index = Parameter(Descriptor::kIndex);
...
TF_BUILTIN(AtomicsCompareExchange, SharedArrayBufferBuiltinsAssembler) {
  TNode<Object> maybe_array = Parameter(Descriptor::kArray);
  TNode<Object> index = Parameter(Descriptor::kIndex);
  TNode<Object> old_value = Parameter(Descriptor::kOldValue);
  TNode<Object> new_value = Parameter(Descriptor::kNewValue);
  auto context = Parameter<Context>(Descriptor::kContext);
...
#define BINOP_BUILTIN(op, method_name)                            \
  TF_BUILTIN(Atomics##op, SharedArrayBufferBuiltinsAssembler) {   \
    TNode<Object> array = Parameter(Descriptor::kArray);          \
    TNode<Object> index = Parameter(Descriptor::kIndex);          \
    TNode<Object> value = Parameter(Descriptor::kValue);          \
    auto context = Parameter<Context>(Descriptor::kContext);      \
