...
void Builtins::Generate_ResumeGeneratorTrampoline(MacroAssembler* masm) {
  ...
  if (v8_flags.debug_code) {
    ...
    GetSharedFunctionInfoBytecodeOrBaseline(masm, sfi, bytecode, x0,
                                            &is_baseline);
    __ IsObjectType(bytecode, x3, x3, BYTECODE_ARRAY_TYPE);
...
void Builtins::Generate_InterpreterEntryTrampoline(
  ...
  GetSharedFunctionInfoBytecodeOrBaseline(
      masm, sfi, kInterpreterBytecodeArrayRegister, x11, &is_baseline);
...
void Builtins::Generate_CallApiCallbackImpl(MacroAssembler* masm,
  ...
  //   sp[2 * kSystemPointerSize]: kIncumbentContext
  ...
  __ Ldr(scratch, incumbent_context_mem_op);
  __ Str(scratch,
         MemOperand(sp, FCA::kIncumbentContextIndex * kSystemPointerSize));
  __ Str(caller_context, incumbent_context_mem_op);
