...
TF_BUILTIN(IterableToList, IteratorBuiltinsAssembler) {
  ...
  TNode<Object> iterable = Parameter(Descriptor::kIterable);
  TNode<Object> iterator_fn = Parameter(Descriptor::kIteratorFn);
...
TF_BUILTIN(GetIteratorWithFeedbackLazyDeoptContinuation,
  ...
  TNode<Object> iterator_method = Parameter(Descriptor::kResult);
