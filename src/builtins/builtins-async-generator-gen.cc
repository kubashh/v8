...
void AsyncGeneratorBuiltinsAssembler::AsyncGeneratorEnqueue(
  ...
  Bind(&enqueue);
  {
    ...
    CallStub(CodeFactory::AsyncGeneratorResumeNext(isolate()), context,
             generator);
...
TF_BUILTIN(AsyncGeneratorYield, AsyncGeneratorBuiltinsAssembler) {
  ...
  CallStub(CodeFactory::AsyncGeneratorResolve(isolate()), context, generator,
           value, FalseConstant());
...
TF_BUILTIN(AsyncGeneratorRawYield, AsyncGeneratorBuiltinsAssembler) {
  ...
  Bind(&if_slow);
  {
    ...
    var_done.Bind(Select(IsBoolean(done), [=]() { return done; },
                         [=]() {
                           return CallStub(CodeFactory::ToBoolean(isolate()),
                                           context, done);
                         },
...
TF_BUILTIN(AsyncGeneratorResumeNext, AsyncGeneratorBuiltinsAssembler) {
  ...
  Bind(&if_abrupt);
  {
    ...
    Bind(&reject_promise);
    CallStub(CodeFactory::AsyncGeneratorReject(isolate()), context, generator,
