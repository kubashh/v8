...
class AsyncGeneratorBuiltinsAssembler : public AsyncBuiltinsAssembler {
 public:
  ...
  Node* HasCatchHandlerForPC(Node* context, Node* generator);
...
Node* AsyncGeneratorBuiltinsAssembler::HasCatchHandlerForPC(Node* context,
                                                            Node* generator) {
  return CallRuntime(Runtime::kAsyncGeneratorHasCatchHandlerForPC, context,
                     generator);
}
}  // namespace
...
TF_BUILTIN(AsyncGeneratorResumeNext, AsyncGeneratorBuiltinsAssembler) {
  ...
  BIND(&if_abrupt);
  {
    ...
    TailCallBuiltin(Builtins::kAsyncGeneratorReturn, context, generator,
                    next_value, HasCatchHandlerForPC(context, generator));
