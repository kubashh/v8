...
static void MaybeTailCallOptimizedCodeSlot(MacroAssembler* masm,
  ...
  // -----------------------------------
  DCHECK(!AreAliased(feedback_vector, a0, a1, a3, t0, t1, t2, t3));
...

  {
    ...
    __ lw(t1, FieldMemOperand(optimized_code_entry,
                              Code::kKindSpecificFlags1Offset));
    __ And(t1, t1, Operand(1 << Code::kMarkedForDeoptimizationBit));
    __ Branch(&found_deoptimized_code, ne, t1, Operand(zero_reg));
