...
void Generate_DeoptimizationEntry(MacroAssembler* masm,
  ...
  // Get the bailout id from the isolate data.
  masm->IndirectLoadExternalReference(
      a2, ExternalReference::Create(IsolateAddressId::kDeoptimizationIdAddress,
                                    isolate));
  __ lw(a2, MemOperand(a2));
  ...
  masm->IndirectLoadExternalReference(
      t1, ExternalReference::isolate_address(isolate));
