...
class ArrayIncludesIndexofAssembler : public CodeStubAssembler {
 public:
  ...
  enum class SimpleElementKind { kSmi, kObject, kUnknown };
...
void ArrayIncludesIndexofAssembler::GenerateSmiOrObject(
  ...
  if (kCanVectorize && array_kind == SimpleElementKind::kObject) {
  ...
  BIND(&heap_num_loop);
  {
    ...
    if (kCanVectorize && array_kind == SimpleElementKind::kSmi) {
...
TF_BUILTIN(ArrayIncludesObject, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIncludes, context, elements, search_element,
                      array_length, from_index, SimpleElementKind::kObject);
}
...
TF_BUILTIN(ArrayIncludesSmi, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIncludes, context, elements, search_element,
                      array_length, from_index, SimpleElementKind::kSmi);
}
...
TF_BUILTIN(ArrayIncludesSmiOrObject, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIncludes, context, elements, search_element,
                      array_length, from_index, SimpleElementKind::kUnknown);
}
...
TF_BUILTIN(ArrayIndexOfObject, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIndexOf, context, elements, search_element, array_length,
                      from_index, SimpleElementKind::kObject);
}
...
TF_BUILTIN(ArrayIndexOfSmi, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIndexOf, context, elements, search_element, array_length,
                      from_index, SimpleElementKind::kSmi);
}
...
TF_BUILTIN(ArrayIndexOfSmiOrObject, ArrayIncludesIndexofAssembler) {
  ...
  GenerateSmiOrObject(kIndexOf, context, elements, search_element, array_length,
                      from_index, SimpleElementKind::kUnknown);
}
