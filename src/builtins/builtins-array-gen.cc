...
#if defined(__SSE3__) || (defined(__ARM_NEON) && (INTPTR_MAX == INT64_MAX))
...
void ArrayIncludesIndexofAssembler::GenerateSmiOrObject(
  ...
  if (kCanVectorize && array_kind == PACKED_ELEMENTS) {
    ...
    TNode<Object> result = CAST(CallCFunction(
        ...
        std::make_pair(MachineType::Pointer(), elements),
        std::make_pair(MachineType::UintPtr(), array_length),
        std::make_pair(MachineType::UintPtr(), from_index),
