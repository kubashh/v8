...
TF_BUILTIN(ArrayIncludesSmiOrObject, ArrayIncludesIndexofAssembler) {
  ...
  TNode<Object> search_element = Parameter(Descriptor::kSearchElement);
...
TF_BUILTIN(ArrayIteratorPrototypeNext, CodeStubAssembler) {
  ...
  auto context = Parameter<Context>(Descriptor::kContext);
  TNode<Object> maybe_iterator = Parameter(Descriptor::kReceiver);
...
TF_BUILTIN(FlatMapIntoArray, ArrayFlattenAssembler) {
  ...
  TNode<Object> this_arg = Parameter(Descriptor::kThisArg);
...
void ArrayBuiltinsAssembler::GenerateArraySingleArgumentConstructor(
  ...
  TNode<Object> array_size = Parameter(Descriptor::kArraySizeSmiParameter);
