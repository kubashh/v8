...
TF_BUILTIN(TypedArrayFrom, TypedArrayBuiltinsAssembler) {
...

  {
    ...
    // normal JS array (boxing the values if they won't fit in an SMI).
    //
    ...
    // overridden, then we know the behaviour of the iterator: returning the
    ...
    //
    // Drop through to the default check_iterator behaviour if any of these
    // checks fail.
    ...
    // Source is a TypedArray with unmodified iterator behaviour. Use the
