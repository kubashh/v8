...
TNode<FixedTypedArrayBase> TypedArrayBuiltinsAssembler::AllocateElements(
    TNode<Map> map, TNode<UintPtrT> total_size_uint, TNode<Number> length) {
  static const intptr_t fta_base_data_offset =
      ExternalReference::fixed_typed_array_base_data_offset().address();

  TNode<IntPtrT> total_size = Signed(total_size_uint);
