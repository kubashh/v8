...
TF_BUILTIN(StringPrototypeReplace, StringBuiltinsAssembler) {
  ...
  const TNode<Object> search = Parameter(Descriptor::kSearch);
  const TNode<Object> replace = Parameter(Descriptor::kReplace);
  auto context = Parameter<Context>(Descriptor::kContext);
...
TF_BUILTIN(StringPrototypeMatch, StringMatchSearchAssembler) {
  TNode<Object> receiver = Parameter(Descriptor::kReceiver);
  TNode<Object> maybe_regexp = Parameter(Descriptor::kRegexp);
  auto context = Parameter<Context>(Descriptor::kContext);
