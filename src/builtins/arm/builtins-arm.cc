...
static void FastPathCheckForOptimizedCodeSlot(
  ...
  // -----------------------------------
  DCHECK(!AreAliased(feedback_vector, r1, r3, scratch1));
...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm) {
  ...
  FastPathCheckForOptimizedCodeSlot(masm, feedback_vector, r4, &maybe_optimized,
  ...
  GenerateMaybeTailCallOptimizedCodeSlot(masm, feedback_vector, r4, r6,
                                         &optimized_code_slot_is_weak_ref,
                                         &fast_path);
