...
void Builtins::Generate_CallApiCallbackImpl(MacroAssembler* masm,
  ...
  //   sp[3 * kSystemPointerSize]: kPrevIncumbentContext
  ...
  __ str(scratch,
         MemOperand(sp, FCA::kPrevIncumbentContextIndex * kSystemPointerSize));
