...
void Builtins::Generate_CallOrConstructForwardVarargs(MacroAssembler* masm,
  ...
  __ b(le, &stack_done);
  {
    ...
    __ add(
        r4, r4,
        Operand(CommonFrameConstants::kFixedFrameSizeAboveFp + kPointerSize));
    __ lsl(r2, r2, Operand(kSystemPointerSizeLog2));
    __ add(r4, r4, r2);
...
#ifdef V8_REVERSE_JSARGS
        __ str(scratch, MemOperand(r2, r5, LSL, kPointerSizeLog2));
#else
        __ push(scratch);
#endif
        __ b(ne, &loop);
