...
void Generate_PushArguments(MacroAssembler* masm, Register array, Register argc,
  ...
  if (kArgcIncludesReceiver) {
    __ sub(counter, argc, Operand(kArgcReceiverSlots));
  } else {
    __ mov(counter, argc);
  }
  __ b(&entry);
...
void Builtins::Generate_ResumeGeneratorTrampoline(MacroAssembler* masm) {
  ...
  if (kArgcIncludesReceiver) {
    __ sub(r3, r3, Operand(kArgcReceiverSlots));
  }
  __ ldr(r2,
...
void Builtins::Generate_InterpreterPushArgsThenCallImpl(
  ...
  if (kArgcIncludesReceiver && skip_receiver) {
    __ sub(r3, r0, Operand(kArgcReceiverSlots));
...
void Builtins::Generate_InterpreterPushArgsThenConstructImpl(
  ...
  if (kArgcIncludesReceiver) {
    ...
    __ sub(argc_without_receiver, r0, Operand(kArgcReceiverSlots));
  }
...
void Generate_ContinueToBuiltinHelper(MacroAssembler* masm,
  ...
  if (java_script_builtin && with_result) {
    ...
    constexpr int return_value_offset =
        BuiltinContinuationFrameConstants::kFixedSlotCount - kArgcReceiverSlots;
...
void Builtins::Generate_FunctionPrototypeApply(MacroAssembler* masm) {
  ...
  // present) instead.
  {
    ...
    __ cmp(r0, Operand(kArgcReceiverSlots + 1));
    __ ldr(r5, MemOperand(sp, kSystemPointerSize), ge);  // thisArg
    __ cmp(r0, Operand(kArgcReceiverSlots + 2), ge);
  ...
  {
    __ mov(r0, Operand(kArgcReceiverSlots));
...
void Builtins::Generate_FunctionPrototypeCall(MacroAssembler* masm) {
  ...
  {
    Label done;
    __ cmp(r0, Operand(kArgcReceiverSlots));
    __ b(ne, &done);
    __ PushRoot(RootIndex::kUndefinedValue);
...
void Builtins::Generate_ReflectApply(MacroAssembler* masm) {
  ...
  // thisArgument (if present) instead.
  {
    ...
    __ cmp(r0, Operand(kArgcReceiverSlots + 3), ge);
...
void Builtins::Generate_CallOrConstructForwardVarargs(MacroAssembler* masm,
  ...
  if (kArgcIncludesReceiver) {
    __ sub(r5, r5, Operand(kArgcReceiverSlots));
  }
