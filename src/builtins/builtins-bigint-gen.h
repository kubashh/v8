...
class BigIntBuiltinsAssembler : public CodeStubAssembler {
 public:
  ...
  void CppTrimMutableBigInt(TNode<BigInt> result, TNode<IntPtrT> new_length,
                            TNode<IntPtrT> to_trim) {
    TNode<ExternalReference> mutable_big_int_trim =
        ExternalConstant(ExternalReference::mutable_big_int_trim_function());
    CallCFunction(mutable_big_int_trim, MachineType::AnyTagged(),
  ...
  void CppAbsoluteAddAndMakeImmutable(TNode<BigInt> result, TNode<BigInt> x,
                                      TNode<BigInt> y) {
    TNode<ExternalReference> mutable_big_int_absolute_add_and_make_immutable =
        ExternalConstant(
            ExternalReference::
                mutable_big_int_absolute_add_and_make_immutable_function());
    CallCFunction(mutable_big_int_absolute_add_and_make_immutable,
  ...
  void CppAbsoluteSubAndMakeImmutable(TNode<BigInt> result, TNode<BigInt> x,
                                      TNode<BigInt> y) {
    TNode<ExternalReference> mutable_big_int_absolute_sub_and_make_immutable =
        ExternalConstant(
            ExternalReference::
                mutable_big_int_absolute_sub_and_make_immutable_function());
    CallCFunction(mutable_big_int_absolute_sub_and_make_immutable,
                  MachineType::AnyTagged(),
                  std::make_pair(MachineType::AnyTagged(), result),
                  std::make_pair(MachineType::AnyTagged(), x),
                  std::make_pair(MachineType::AnyTagged(), y));
