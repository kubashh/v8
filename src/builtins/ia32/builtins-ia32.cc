...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm) {
  ...
  // Modify the bytecode offset in the stack to be kFunctionEntryOffset
  ...
  // After the call, restore the bytecode array, bytcode offset and accumulator
  // registers again. Also, restore the stack to its previous value.
  __ mov(kInterpreterBytecodeArrayRegister,
         Operand(ebp, InterpreterFrameConstants::kBytecodeArrayFromFp));
  __ mov(kInterpreterBytecodeOffsetRegister,
         Immediate(BytecodeArray::kFirstBytecodeOffset));
...
void Builtins::Generate_InterpreterEnterBytecodeAdvance(MacroAssembler* masm) {
  ...
  __ cmp(kInterpreterBytecodeOffsetRegister,
         Immediate(BytecodeArray::kFunctionEntryOffset));
  ...
  // check, it will have a bailout ID of kFunctionEntryOffset, which is
