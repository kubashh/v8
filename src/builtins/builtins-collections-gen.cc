...
void CollectionsBuiltinsAssembler::AddToOrderedHashTable(
  ...
  BIND(&entry_found);
  {
    ...
    store_existing_entry(table, entry_start_position_or_hash.value());
    Goto(&done);
  }
  ...
  BIND(&store_new_entry);
  {
    StoreOrderedHashTableNewEntry(
        ...
        number_of_buckets.value(), occupancy.value(), store_new_entry);
    Goto(&done);
  }
...
TF_BUILTIN(MapPrototypeSet, CollectionsBuiltinsAssembler) {
  ...
  StoreAtEntry<OrderedHashMap> store_new_entry =
  ...
  StoreAtEntry<OrderedHashMap> store_existing_entry =
...
void CollectionsBuiltinsAssembler::StoreOrderedHashTableNewEntry(
  ...
  const TNode<IntPtrT> entry_start = IntPtrAdd(
      ...
      number_of_buckets);
  store_new_entry(table, entry_start);
