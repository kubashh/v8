...
//   // JS_MAP_VALUE_ITERATOR_TYPE object that is not partially consumed and
//   still
//   // has original iteration behavior.
//   void BranchIfIterableWithOriginalKeyOrValueMapIterator(TNode<Object>
//   iterable,
//                                                          TNode<Context>
//                                                          context, Label*
//                                                          if_true, Label*
...
//   // object that still has original iteration behavior. In case of the
//   iterator,
...
//   // Create a JSArray with PACKED_ELEMENTS kind from a Map.prototype.keys()
//   or
...
//   // iterator and iterate directly on the underlying hash table. In the end
//   it
...
//   // Create a JSArray with PACKED_ELEMENTS kind from a Set.prototype.keys()
//   or
//   // Set.prototype.values() iterator, or a Set. The |iterable| is assumed to
//   // satisfy IterableWithOriginalValueSetIterator. This function will skip
//   the
//   // iterator and iterate directly on the underlying hash table. In the end,
//   if
...
//   // {hash} with using the comparison code generated by {key_compare}. The
//   code
//   // jumps to {entry_found} if the key is found, or to {not_found} if the key
//   // was not found. In the {entry_found} branch, the variable
//   // entry_start_position will be bound to the index of the entry (relative
//   to
//   // OrderedHashTable::kHashTableStartIndex).
//   //
//   // The {CollectionType} template parameter stands for the particular
//   instance
