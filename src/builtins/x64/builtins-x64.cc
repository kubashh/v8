...
static void GenerateMaybeTailCallOptimizedCodeSlot(
    ...
    Register optimized_code_entry, Register scratch1, Register scratch2,
  ...
  DCHECK(!AreAliased(feedback_vector, rdx, rdi, optimized_code_entry, scratch1,
                     scratch2));
...

  {
    ...
    ReplaceClosureCodeWithOptimizedCode(masm, optimized_code_entry, closure,
                                        scratch1, scratch2, feedback_vector);
    static_assert(kJavaScriptCallCodeStartRegister == rcx, "ABI mismatch");
...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm) {
  ...
  GenerateMaybeTailCallOptimizedCodeSlot(
      masm, feedback_vector, optimized_code_entry, r11, r15,
