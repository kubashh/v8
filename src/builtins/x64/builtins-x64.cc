...
void Builtins::Generate_BaselineLeaveFrame(MacroAssembler* masm) {
  Register params_size =
      Builtins::CallInterfaceDescriptorFor(Builtins::kBaselineLeaveFrame)
          .GetRegisterParameter(BaselineLeaveFrameDescriptor::kParamsSize);
...
void Builtins::Generate_BaselinePrologue(MacroAssembler* masm) {
  ...
  // Load the feedback vector from the closure.
  Register feedback_vector = rbx;
  __ LoadTaggedPointerField(feedback_vector, FieldOperand(closure,
                            JSFunction::kFeedbackCellOffset));
  __ LoadTaggedPointerField(feedback_vector, FieldOperand(feedback_vector,
                            Cell::kValueOffset));
