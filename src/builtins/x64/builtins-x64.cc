...
void Generate_PushArguments(MacroAssembler* masm, Register array, Register argc,
  ...
  if (kArgcIncludesReceiver) {
    __ leaq(counter, Operand(argc, -kArgcReceiverSlots));
  } else {
...
void Builtins::Generate_InterpreterPushArgsThenConstructImpl(
  ...
  if (kArgcIncludesReceiver) {
    ...
    __ leaq(argc_without_receiver, Operand(rax, -kArgcReceiverSlots));
  }
...
void Builtins::Generate_FunctionPrototypeApply(MacroAssembler* masm) {
  ...
  // present) instead.
  {
    ...
    __ movq(rbx, rdx);
    __ movq(rdi, args[0]);
    __ cmpq(rax, Immediate(kArgcReceiverSlots));
    __ j(equal, &no_this_arg, Label::kNear);
    {
      __ movq(rdx, args[1]);
      __ cmpq(rax, Immediate(kArgcReceiverSlots + 1));
  ...
  {
    __ Move(rax, kArgcReceiverSlots);
...
void Builtins::Generate_ReflectApply(MacroAssembler* masm) {
  ...
  // thisArgument (if present) instead.
  {
    ...
    __ cmpq(rax, Immediate(kArgcReceiverSlots + 3));
    __ j(below, &done, Label::kNear);
