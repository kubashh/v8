...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm) {
  ...
  Label maybe_load_debug_bytecode_array, bytecode_array_loaded, first_execution,
      continue_first_execution;
  __ movp(rax, FieldOperand(closure, JSFunction::kSharedFunctionInfoOffset));
  __ testl(FieldOperand(rax, SharedFunctionInfo::kCompilerHintsOffset),
