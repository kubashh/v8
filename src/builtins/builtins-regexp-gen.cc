...
TNode<String> RegExpBuiltinsAssembler::LoadRegExpResultFirstMatch(
  ...
  BIND(&if_fast);
  {
    ...
    // It is assumed the first match is guaranteed to be a string for fast
    // RegExp results. See ConstructNewResultFromMatchInfo().
