...
TNode<JSRegExpResult> RegExpBuiltinsAssembler::ConstructNewResultFromMatchInfo(
  ...
  VariableList vars({&var_from_cursor, &var_to_cursor}, zone());
  Label loop(this, vars);
...
TNode<JSArray> RegExpBuiltinsAssembler::RegExpPrototypeSplitBody(
  ...
  VariableList vars(
      ...
      zone());
  Label loop(this, vars), push_suffix_and_out(this), out(this);
  Goto(&loop);
