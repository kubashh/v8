...
TNode<JSRegExpResult> RegExpBuiltinsAssembler::ConstructNewResultFromMatchInfo(
  ...
  TNode<IntPtrT> num_indices = PositiveSmiUntag(CAST(LoadObjectField(
      match_info, RegExpMatchInfoShape::kNumberOfCaptureRegistersOffset)));
...
TNode<HeapObject> RegExpBuiltinsAssembler::RegExpExecInternal(
  ...
  BIND(&if_success);
  {
    ...
    StoreObjectField(match_info,
                     RegExpMatchInfo::Shape::kNumberOfCaptureRegistersOffset,
                     register_count);
    StoreObjectField(match_info, RegExpMatchInfo::Shape::kLastSubjectOffset,
                     string);
    StoreObjectField(match_info, RegExpMatchInfo::Shape::kLastInputOffset,
                     string);
