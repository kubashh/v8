...
TF_BUILTIN(RegExpConstructor, RegExpBuiltinsAssembler) {
  TNode<Object> pattern = Parameter(Descriptor::kPattern);
  TNode<Object> flags = Parameter(Descriptor::kFlags);
...
TF_BUILTIN(RegExpPrototypeCompile, RegExpBuiltinsAssembler) {
  TNode<Object> maybe_receiver = Parameter(Descriptor::kReceiver);
  TNode<Object> maybe_pattern = Parameter(Descriptor::kPattern);
  TNode<Object> maybe_flags = Parameter(Descriptor::kFlags);
  auto context = Parameter<Context>(Descriptor::kContext);
