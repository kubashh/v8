...
#define BUILTIN_LIST_BASE(CPP, API, TFJ, TFC, TFS, TFH, ASM)                   \
  ...
  TFC(ToBigInt64, WasmBigIntToI64, 1)                                          \
  TFC(NewBigInt, WasmI64ToBigInt, 1)                                           \
  TFC(NewBigInt32, WasmI64ToBigInt32, 1)                                       \
                                                                               \
  ...
  TFC(WasmNewBigInt, WasmI64ToBigInt, 1)                                       \
  TFC(WasmNewBigInt32, WasmI64ToBigInt32, 1)                                   \
                                                                               \
  /* WeakMap */                                                                \
