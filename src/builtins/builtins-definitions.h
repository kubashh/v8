...
#define BUILTIN_LIST_BASE_TIER1(CPP, TFJ, TFC, TFS, TFH, ASM)                  \
  ...
  TFS(ArrayIncludesPackedSmi, kElements, kSearchElement, kLength, kFromIndex)  \
  TFS(ArrayIncludesPackedObject, kElements, kSearchElement, kLength,           \
      kFromIndex)                                                              \
  ...
  TFS(ArrayIndexOfPackedSmi, kElements, kSearchElement, kLength, kFromIndex)   \
  TFS(ArrayIndexOfPackedObject, kElements, kSearchElement, kLength,            \
      kFromIndex)                                                              \
