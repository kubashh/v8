...
BUILTIN(AtomicsMutexAsyncUnlockResolveHandler) {
  ...
  Handle<Object> mutex = Handle<Object>(
      context->get(JSAtomicsMutex::AsyncContextSlot::kMutex), isolate);
  Handle<Object> unlock_promise = Handle<Object>(
      context->get(JSAtomicsMutex::AsyncContextSlot::kUnlockPromise), isolate);
...
BUILTIN(AtomicsConditionGetLock) {
  ...
  Handle<Object> js_mutex_obj = Handle<Object>(
      context->get(JSAtomicsCondition::AsyncContextSlot::kMutex), isolate);
  Handle<JSAtomicsMutex> js_mutex = Handle<JSAtomicsMutex>::cast(js_mutex_obj);
  Handle<JSPromise> lock_promise = isolate->factory()->NewJSPromise();
  JSAtomicsMutex::LockAsync(isolate, js_mutex, lock_promise,
