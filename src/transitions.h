...
// prototype transitions and multiple property transitions. The details related
...
class TransitionsAccessor {
 public:
  explicit TransitionsAccessor(Map* map) : map_(map) { Initialize(); }
...
// should be using TransitionsAccessors.
