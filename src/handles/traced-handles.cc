...
bool ComputeWeaknessForYoungObject(EmbedderRootsHandler* handler,
                                   TracedNode* node,
                                   JSObject::MarkingMode marking_mode) {
  bool is_unmodified_api_object =
      JSObject::IsUnmodifiedApiObjectForMarking(node->location(), marking_mode);
...
bool TracedHandles::IsWeak(Address* location,
                           ...
                           const JSObject::MarkingMode marking_mode) {
