...
#ifdef V8_ENABLE_DIRECT_HANDLE
  V8_INLINE ValueHelper::RepresentationType repr() const {
    return location_ ? *location_ : ValueHelper::kEmpty;
  }
#else
  V8_INLINE ValueHelper::RepresentationType repr() const { return location_; }
...
#endif
{
 public:
  ...
  V8_INLINE ValueHelper::RepresentationType repr() const { return obj_; }
