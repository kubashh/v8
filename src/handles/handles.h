...
#ifdef V8_ENABLE_DIRECT_HANDLE
  V8_INLINE ValueHelper::InternalType internal() const {
    return location_ ? *location_ : ValueHelper::EmptyInternal;
  }
#else
  V8_INLINE ValueHelper::InternalType internal() const { return location_; }
...
#endif
{
 public:
  ...
  V8_INLINE ValueHelper::InternalType internal() const { return obj_; }
