...
#undef DEFINE_CODE_KIND_ENUM
  ...
  // [deopted_once]: For kind OPTIMIZED_FUNCTION tells whether
  // the code was already deoptimized.
  inline bool deopted_once();
  inline void set_deopted_once(bool flag);
...
#undef DECLARE_CODE_AGE_ENUM
  ...
  static const int kDeoptedOnceBit = kMarkedForDeoptimizationBit + 1;
  static const int kIsTurbofannedBit = kDeoptedOnceBit + 1;
  ...
  class DeoptedOnceField : public BitField<bool, kDeoptedOnceBit, 1> {
  };  // NOLINT
