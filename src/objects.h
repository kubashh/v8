...
class Object : public ObjectImpl<HeapObjectReferenceType::STRONG> {
 public:
  constexpr Object() : ObjectImpl(kNullAddress) {}
  explicit constexpr Object(Address ptr) : ObjectImpl(ptr) {}

  // These operator->() overloads are required for handlified code.
  constexpr Object* operator->() { return this; }
  constexpr const Object* operator->() const { return this; }
