...
#undef DEFINE_CODE_KIND_ENUM
  ...
  // [has_tagged_stack]: For compiled code or builtins: Tells whether the stack
  // of the frame holds tagged pointers. True for other kinds.
  inline bool has_tagged_stack();
  inline void set_has_tagged_stack(bool value);
