...
#undef DEFINE_CODE_KIND_ENUM
  ...
  // [checks_optimization_marker]: Tells whether the code checks the
  // optimization marker in the function's feedback vector.
...
class JSFunction: public JSObject {
 public:
  ...
  void MarkForOptimization(bool concurrent);
