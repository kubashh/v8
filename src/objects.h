...
#undef DECLARE_FRAME_ARRAY_ACCESSORS
  ...
  // Flags.
  static constexpr int kIsWasmFrame = 1 << 0;
  static constexpr int kIsWasmInterpretedFrame = 1 << 1;
  static constexpr int kIsAsmJsWasmFrame = 1 << 2;
  static constexpr int kIsStrict = 1 << 3;
  static constexpr int kForceConstructor = 1 << 4;
  static constexpr int kAsmJsAtNumberConversion = 1 << 5;
