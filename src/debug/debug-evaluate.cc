...
// static
DebugEvaluate::SideEffectState DebugEvaluate::FunctionHasNoSideEffect(
  ...
  if (info->HasBytecodeArray()) {
    ...
    return requires_runtime_checks ? kRequiresRuntimeChecks : kSideEffectFree;
  } else {
