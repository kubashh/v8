...
class Debug {
 public:
  ...
  void SetBreakOnFunctionCall();
  void ClearBreakOnFunctionCall();
  ...
  bool break_on_function_call() const {
    return thread_local_.break_on_function_call_;
  }
