...
typedef std::function<bool(i::IsStaticFlag)> FlagFilter;
typedef std::function<bool(i::VariableMode)> VariableModeFilter;
typedef std::function<void(i::VariableMode, i::Handle<i::String>,
                           i::Handle<i::Object>)>
