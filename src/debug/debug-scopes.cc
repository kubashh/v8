...
void ScopeIterator::DebugPrint() {
  ...
  switch (Type()) {
    ...
    case ScopeIterator::ScopeTypeWith:
      os << "With:\n";
      Object::Print(context_->extension(), os);
      break;

    case ScopeIterator::ScopeTypeCatch:
      os << "Catch:\n";
      Object::Print(context_->extension(), os);
      Object::Print(context_->get(Context::THROWN_OBJECT_INDEX), os);
      break;
    ...
    case ScopeIterator::ScopeTypeScript:
      os << "Script:\n";
      Object::Print(context_->native_context()->script_context_table(), os);
      break;
