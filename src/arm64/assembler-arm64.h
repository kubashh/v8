...
class V8_EXPORT_PRIVATE Assembler : public AssemblerBase {
 public:
  ...
  static constexpr int kMaxDistToIntPool = 1 * MB;
  static constexpr int kMaxDistToFPPool = 1 * MB;
  ...
  static constexpr int kCheckConstPoolInterval = 128 * kInstrSize;
  ...
  // is an approximation.
  static constexpr int kApproxDistToIntPool = 64 * KB;
  static constexpr int kApproxDistToFPPool = kApproxDistToIntPool;

  static constexpr int kOpportunityDistToIntPool = 64 * KB;
  static constexpr int kOpportunityDistToFPPool = 64 * KB;
