...
class V8_EXPORT_PRIVATE Assembler : public AssemblerBase {
 public:
  ...
  static constexpr int kMaxDistToIntPool = 64 * KB;
  static constexpr int kMaxDistToFPPool = 64 * KB;
  static constexpr int kOpportunityDistToIntPool = 4 * KB;
  static constexpr int kOpportunityDistToFPPool = 4 * KB;
