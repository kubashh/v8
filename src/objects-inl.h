...
void HeapObject::set_map(Map* value) {
  if (value != nullptr) {
#ifdef VERIFY_HEAP
    Heap::FromHeapObject(this)->VerifyObjectLayoutChange(this, value);
#endif
  }
  ...
  if (value != nullptr) {
    ...
    Heap::FromHeapObject(this)->incremental_marking()->RecordWrite(
        this, nullptr, value);
  }
}
...
void WeakCell::clear() {
  ...
  DCHECK(Heap::FromHeapObject(this)->gc_state() == Heap::MARK_COMPACT ||
         this == Heap::FromHeapObject(this)->empty_weak_cell());
...
void WeakCell::initialize(HeapObject* val) {
  ...
  // all weak cells.
  Heap* heap = Heap::FromHeapObject(this);
...
void PropertyArray::set(int index, Object* value) {
  ...
  WRITE_BARRIER(Heap::FromHeapObject(this), this, offset, value);
}
...
void PropertyArray::set(int index, Object* value, WriteBarrierMode mode) {
  ...
  int offset = kHeaderSize + index * kPointerSize;
  RELAXED_WRITE_FIELD(this, offset, value);
  CONDITIONAL_WRITE_BARRIER(Heap::FromHeapObject(this), this, offset, value,
                            mode);
}
...
FreeSpace* FreeSpace::next() {
  DCHECK(map() ==
             Heap::FromHeapObject(this)->root(Heap::kFreeSpaceMapRootIndex) ||
         (!Heap::FromHeapObject(this)->deserialization_complete() &&
          map() == nullptr));
...
FreeSpace* FreeSpace::cast(HeapObject* o) {
  SLOW_DCHECK(!Heap::FromHeapObject(o)->deserialization_complete() ||
              o->IsFreeSpace());
...
void SmallOrderedHashTable<Derived>::SetDataEntry(int entry, int relative_index,
  ...
  WRITE_BARRIER(Heap::FromHeapObject(this), this,
...
void Dictionary<Derived, Shape>::ClearEntry(int entry) {
  Object* the_hole = Heap::FromHeapObject(this)->the_hole_value();
