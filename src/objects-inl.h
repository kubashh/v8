...
ACCESSORS(Microtask, context, Context, kContextOffset)
...
ACCESSORS(PromiseCapability, resolve, HeapObject, kResolveOffset)
ACCESSORS(PromiseCapability, reject, HeapObject, kRejectOffset)
