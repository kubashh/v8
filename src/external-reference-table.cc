...
void ExternalReferenceTable::AddReferences(Isolate* isolate) {
  ...
  Add(ExternalReference::wasm_float64_pow(isolate).address(),
      "wasm::float64_pow");
  Add(ExternalReference::wasm_context_mem_size_address().address(),
      "wasm::context_mem_size_address");
  Add(ExternalReference::wasm_context_mem_start_address().address(),
      "wasm::context_mem_start_address");
