...
void Genesis::InitializeGlobal_harmony_locale() {
  ...
  SimpleInstallGetter(prototype, factory()->InternalizeUtf8String("currency"),
                      Builtins::kLocalePrototypeCurrency, true);
  ...
  SimpleInstallGetter(prototype, factory()->InternalizeUtf8String("timeZone"),
                      Builtins::kLocalePrototypeTimeZone, true);
}
