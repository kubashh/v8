...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // --- A s y n c G e n e r a t o r ---
    ...
    // AsyncGeneratorYield
    code = builtins->AsyncGeneratorYieldResolveClosure();
    info = factory->NewSharedFunctionInfo(factory->empty_string(), code, false);
    info->set_internal_formal_parameter_count(1);
    info->set_length(1);
    ...
    info = factory->NewSharedFunctionInfo(
        factory->empty_string(),
        isolate->builtins()->AsyncGeneratorReturnClosedResolveClosure(), false);
    info->set_internal_formal_parameter_count(1);
    info->set_length(1);
    ...
    info = factory->NewSharedFunctionInfo(
        factory->empty_string(),
        isolate->builtins()->AsyncGeneratorReturnClosedRejectClosure(), false);
    info->set_internal_formal_parameter_count(1);
    info->set_length(1);
