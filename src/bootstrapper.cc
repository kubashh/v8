...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // --- S t r i n g ---
    ...
    Handle<JSFunction> string_symbol_iterator_function = SimpleInstallFunction(
    ...
    native_context()->set_initial_string_symbol_iterator_fun(
        *string_symbol_iterator_function);
  }
