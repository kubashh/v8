...
#undef DECLARE_FEATURE_INITIALIZATION
  ...
  Handle<Map> sloppy_function_map_name_and_writable_prototype_;
...
Handle<JSFunction> Genesis::CreateEmptyFunction(Isolate* isolate) {
  ...
  sloppy_function_map_name_and_writable_prototype_ =
  ...
  Map::SetPrototype(sloppy_function_map_name_and_writable_prototype_,
                    empty_function);
...
void Genesis::CreateIteratorMaps(Handle<JSFunction> empty) {
  ...
  map = CreateNonConstructorMap(
      isolate(), strict_function_map_writable_prototype_,
...
void Genesis::InitializeGlobal(Handle<JSGlobalObject> global_object,
  ...
  {  // --- F u n c t i o n ---
    ...
    sloppy_function_map_name_and_writable_prototype_->SetConstructor(
        *function_fun);
...
void Genesis::MakeFunctionInstancePrototypeWritable() {
  ...
  DCHECK(!sloppy_function_map_name_and_writable_prototype_.is_null());
