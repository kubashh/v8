...
inline v8::Local<v8::Function> AsyncWrap::init_function() const {
  return init_function_.Get(isolate_);
}
inline void AsyncWrap::set_init_function(v8::Local<v8::Function> value) {
  init_function_.Reset(isolate_, value);
}
inline v8::Local<v8::Function> AsyncWrap::before_function() const {
  return before_function_.Get(isolate_);
}
inline void AsyncWrap::set_before_function(v8::Local<v8::Function> value) {
  before_function_.Reset(isolate_, value);
}
inline v8::Local<v8::Function> AsyncWrap::after_function() const {
  return after_function_.Get(isolate_);
}
inline void AsyncWrap::set_after_function(v8::Local<v8::Function> value) {
  after_function_.Reset(isolate_, value);
}
inline v8::Local<v8::Function> AsyncWrap::promiseResolve_function() const {
  return promiseResolve_function_.Get(isolate_);
}
inline void AsyncWrap::set_promiseResolve_function(
