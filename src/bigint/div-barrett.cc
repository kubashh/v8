...
// Many thanks to Karl Wiberg, kwiberg@chromium.org, for both writing up an
...
// Computes the inverse of V, via naive division. Result in Z.
...
void ProcessorImpl::DivideBarrett(RWDigits Q, RWDigits R, Digits A, Digits B,
  ...
  // R may be wider than B, zero out any extra digits if so.
