...
class JsonMap : public ZoneObject {
 ...
 private:
  Handle<Map> DoInternalize(Isolate* isolate, AllocationType allocation,
                            bool slow_elements);

  Handle<Map> object_;
  Handle<Map> slow_elements_object_;
  JsonMap* parent_;
  union {
...
class JsonObject : public JsonValue {
 public:
  explicit JsonObject(Zone* zone, JsonMap* map,
    ...
    slow_elements_ = size_threshold <= (max_index + 1);
