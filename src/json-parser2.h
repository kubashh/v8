...
class JsonMap : public ZoneObject {
 public:
  ...
  JsonMap() : parent_(nullptr), property_(nullptr), hash_(0) {}
...
class JsonObject : public JsonValue {
 public:
  explicit JsonObject(JsonMap* map)
      : JsonValue(JsonValue::Kind::OBJECT), map_(map) {}
...
class JsonLiteral : public JsonValue {
 public:
  explicit JsonLiteral(const char* name)
