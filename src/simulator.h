...
#if V8_OS_AIX
    // `volatile` is required for function_desc to be initialized correctly
    // As function_desc[0] is used implictly when fn() is called, GCC doesn't
    // initialized it because it can't see the implict use.
