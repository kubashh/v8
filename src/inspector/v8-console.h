...
class V8Console : public v8::debug::ConsoleDelegate {
 ...
 private:
  ...
  static void ScheduleAsyncTask(const v8::FunctionCallbackInfo<v8::Value>&);
  static void StartAsyncTask(const v8::FunctionCallbackInfo<v8::Value>&);
  static void FinishAsyncTask(const v8::FunctionCallbackInfo<v8::Value>&);
  static void CancelAsyncTask(const v8::FunctionCallbackInfo<v8::Value>&);
