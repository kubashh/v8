...
class V8Console : public v8::debug::ConsoleDelegate {
 ...
 private:
  ...
  void scheduleAsyncTaskGetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);
  void scheduleAsyncTaskSetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);

  void startAsyncTaskGetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);
  void startAsyncTaskSetterCallback(const v8::FunctionCallbackInfo<v8::Value>&);

  void finishAsyncTaskGetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);
  void finishAsyncTaskSetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);

  void cancelAsyncTaskGetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);
  void cancelAsyncTaskSetterCallback(
      const v8::FunctionCallbackInfo<v8::Value>&);
