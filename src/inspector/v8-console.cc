...
void V8Console::scheduleAsyncTaskGetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  if (info.Length() != 2) {
...
void V8Console::scheduleAsyncTaskSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  // We can't make the attribute readonly as it breaks existing code that relies
  // on being able to assign to console.scheduleAsyncTask in strict mode.
}

void V8Console::startAsyncTaskGetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  if (info.Length() != 1) {
    info.GetIsolate()->ThrowError("Unexpected arguments");
    return;
...
void V8Console::startAsyncTaskSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  // We can't make the attribute readonly as it breaks existing code that relies
  // on being able to assign to console.startAsyncTask in strict mode.
}

void V8Console::finishAsyncTaskGetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  if (info.Length() != 1) {
    info.GetIsolate()->ThrowError("Unexpected arguments");
    return;
...
void V8Console::finishAsyncTaskSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  // We can't make the attribute readonly as it breaks existing code that relies
  // on being able to assign to console.finishAsyncTask in strict mode.
}

void V8Console::cancelAsyncTaskGetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  if (info.Length() != 1) {
    info.GetIsolate()->ThrowError("Unexpected arguments");
    return;
...
void V8Console::cancelAsyncTaskSetterCallback(
    const v8::FunctionCallbackInfo<v8::Value>& info) {
  // We can't make the attribute readonly as it breaks existing code that relies
  // on being able to assign to console.cancelAsyncTask in strict mode.
}
...
void V8Console::installAsyncStackTaggingAPI(v8::Local<v8::Context> context,
  ...
  v8::Local<v8::External> data = v8::External::New(isolate, this);
  console->SetAccessorProperty(
      toV8StringInternalized(isolate, "scheduleAsyncTask"),
      v8::Function::New(
          context,
          &V8Console::call<&V8Console::scheduleAsyncTaskGetterCallback>, data,
          0, v8::ConstructorBehavior::kThrow,
          v8::SideEffectType::kHasNoSideEffect)
          .ToLocalChecked(),
      v8::Function::New(
          context,
          &V8Console::call<&V8Console::scheduleAsyncTaskSetterCallback>, data,
          0, v8::ConstructorBehavior::kThrow)
          .ToLocalChecked(),
      static_cast<v8::PropertyAttribute>(v8::None), v8::DEFAULT);
  console->SetAccessorProperty(
      toV8StringInternalized(isolate, "startAsyncTask"),
      v8::Function::New(
          context, &V8Console::call<&V8Console::startAsyncTaskGetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow,
          v8::SideEffectType::kHasNoSideEffect)
          .ToLocalChecked(),
      v8::Function::New(
          context, &V8Console::call<&V8Console::startAsyncTaskSetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow)
          .ToLocalChecked(),
      static_cast<v8::PropertyAttribute>(v8::None), v8::DEFAULT);
  console->SetAccessorProperty(
      toV8StringInternalized(isolate, "finishAsyncTask"),
      v8::Function::New(
          context, &V8Console::call<&V8Console::finishAsyncTaskGetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow,
          v8::SideEffectType::kHasNoSideEffect)
          .ToLocalChecked(),
      v8::Function::New(
          context, &V8Console::call<&V8Console::finishAsyncTaskSetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow)
          .ToLocalChecked(),
      static_cast<v8::PropertyAttribute>(v8::None), v8::DEFAULT);
  console->SetAccessorProperty(
      toV8StringInternalized(isolate, "cancelAsyncTask"),
      v8::Function::New(
          context, &V8Console::call<&V8Console::cancelAsyncTaskGetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow,
          v8::SideEffectType::kHasNoSideEffect)
          .ToLocalChecked(),
      v8::Function::New(
          context, &V8Console::call<&V8Console::cancelAsyncTaskSetterCallback>,
          data, 0, v8::ConstructorBehavior::kThrow)
          .ToLocalChecked(),
      static_cast<v8::PropertyAttribute>(v8::None), v8::DEFAULT);
}
