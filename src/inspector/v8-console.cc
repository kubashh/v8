...
void V8Console::installAsyncStackTaggingAPI(v8::Local<v8::Context> context,
  ...
  v8::Local<v8::External> data = v8::External::New(isolate, this);
  console
      ->Set(v8::String::NewFromUtf8(isolate, "info",
                                    v8::NewStringType::kInternalized)
                .ToLocalChecked(),
            v8::FunctionTemplate::New(isolate, &ScheduleAsyncTask), data)
      .Check();
  console
      ->Set(v8::String::NewFromUtf8(isolate, "startAsyncTask",
                                    v8::NewStringType::kInternalized)
                .ToLocalChecked(),
            v8::FunctionTemplate::New(isolate, &StartAsyncTask), data)
      .Check();
  console
      ->Set(v8::String::NewFromUtf8(isolate, "finishAsyncTask",
                                    v8::NewStringType::kInternalized)
                .ToLocalChecked(),
            v8::FunctionTemplate::New(isolate, &FinishAsyncTask), data)
      .Check();
  console
      ->Set(v8::String::NewFromUtf8(isolate, "cancelAsyncTask",
                                    v8::NewStringType::kInternalized)
                .ToLocalChecked(),
