...
class V8_EXPORT_PRIVATE PagedSpace : NON_EXPORTED_BASE(public Space) {
 public:
  ...
  // concurrent sweeping are counted as being allocated!
 ...
 protected:
  ...
  V8_WARN_UNUSED_RESULT bool RefillLabFromFreeList(size_t min_size,
                                                   size_t max_size,
                                                   AllocationOrigin origin,
                                                   Address* top,
                                                   Address* limit);

  V8_WARN_UNUSED_RESULT bool ContributeToSweeping(size_t required_freed_bytes,
                                                  int max_pages);
  ...
  void StartBlackAllocation(Address top, Address limit) override;
  void StopBlackAllocation(Address top, Address limit) override;

  bool TryExpand(ThreadKind);
