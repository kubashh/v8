...
// -----------------------------------------------------------------------------
// Trusted space.
// Only available when the sandbox is enabled. It is essentially an old space
// located outside of the sandbox. As such, an attacker cannot directly corrupt
// objects located in this space, which can therefore be considered trusted.
