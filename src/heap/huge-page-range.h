...
/*
Each heap has an instance of HugePageRangeManager, the HugePageRangeManager
manages all HugePageRanges in this heap.
*/
class HugePageRangeManager {
 public:
  ...
  Page* TryAllocatePageInHugePageRange(Space* owner);
