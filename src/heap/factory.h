...
class V8_EXPORT_PRIVATE Factory : public FactoryBase<Factory> {
 public:
  ...
  //
  // Old-generation flat strings can be internalized by mutating their mapreturn
  // kInPlace, along with the matching internalized string map for string is
  // stored in internalized_map.
  //
