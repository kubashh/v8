...
class DefaultJobThread : public std::thread {
 public:
  template <typename Function>
  explicit DefaultJobThread(Function function) : std::thread(function) {}
...
class DefaultJob final : public DefaultJobImpl<DefaultJobThread> {
 public:
  explicit DefaultJob(Key key, std::unique_ptr<cppgc::JobTask> job_task)
