...
void Heap::CollectGarbageForTesting(
    cppgc::internal::GarbageCollector::Config::StackState stack_state) {
  CollectGarbage({internal::GarbageCollector::Config::CollectionType::kMajor,
                  stack_state, MarkingType::kAtomic, SweepingType::kAtomic,
                  internal::GarbageCollector::Config::IsForcedGC::kForced});
}
