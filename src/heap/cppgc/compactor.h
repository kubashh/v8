...
class V8_EXPORT_PRIVATE Compactor final {
 ...
 public:
  ...
  void InitializeIfShouldCompact(GCConfig::MarkingType, GCConfig::StackState);
  void CancelIfShouldNotCompact(GCConfig::MarkingType, GCConfig::StackState);
 ...
 private:
  bool ShouldCompact(GCConfig::MarkingType, GCConfig::StackState) const;
