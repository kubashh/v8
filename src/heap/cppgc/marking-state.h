...
class MarkingStateBase {
 public:
  ...
  MarkingWorklists::WeakContainersWorklists& weak_containers_worklist() {
 ...
 protected:
  ...
  MarkingWorklists::WeakContainersWorklists& weak_containers_worklist_;
...
void MarkingStateBase::ProcessWeakContainer(const void* object,
  ...
  // the TraceDescriptor will be nullptr.
...
class MutatorMarkingState : public MarkingStateBase {
 public:
  ...
  inline void RePushWeakContainer(HeapObjectHeader&);
...
void MutatorMarkingState::RePushWeakContainer(HeapObjectHeader& header) {
...
bool MutatorMarkingState::IsMarkedWeakContainer(HeapObjectHeader& header) {
  return weak_containers_worklist_.Contains(&header);
}
