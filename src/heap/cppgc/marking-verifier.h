...
class V8_EXPORT_PRIVATE MarkingVerifierBase
 ...
 public:
  ...
  void Run(GCConfig::StackState, uintptr_t, v8::base::Optional<size_t>);

 protected:
  MarkingVerifierBase(HeapBase&, GCConfig::CollectionType, VerificationState&,
 ...
 private:
  ...
  GCConfig::CollectionType collection_type_;
};

class V8_EXPORT_PRIVATE MarkingVerifier final : public MarkingVerifierBase {
 public:
  MarkingVerifier(HeapBase&, GCConfig::CollectionType);
