...
using HeapRegistryStorage = std::vector<HeapBase*>;

HeapRegistryStorage& GetHeapRegistryStorage() {
  static v8::base::LazyInstance<std::vector<HeapBase*>>::type heap_registry =
