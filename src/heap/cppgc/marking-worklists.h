...
class MarkingWorklists {
 ...
 public:
  ...
  using WeakContainersWorklists = ExternalMarkingWorklist;
  ...
  WeakContainersWorklists* weak_containers_worklist() {
 ...
 private:
  ...
  WeakContainersWorklists weak_containers_worklist_;
};
