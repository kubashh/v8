...
class V8_EXPORT_PRIVATE BaseSpace {
 public:
  ...
  bool needs_asan_contiguous_container_annotations() const {
    return needs_asan_contiguous_container_annotations_;
  }
 ...
 private:
  ...
  const bool needs_asan_contiguous_container_annotations_ = false;
};
