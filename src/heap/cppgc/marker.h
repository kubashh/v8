...
class V8_EXPORT_PRIVATE Marker {
 ...
 public:
  ...
  // Signals entering the atomic pause. The method
  ...
  // Finishing marking. This method expects no more objects to be marked and
  // merely updates marking states if needed.
  void FinishMarking();
