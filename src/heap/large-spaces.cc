...
void LargeObjectSpace::RemovePageWithoutObjectsCount(LargePage* page) {
  size_ -= static_cast<int>(page->size());
...
void LargeObjectSpace::RemovePage(LargePage* page, size_t object_size) {
  objects_size_ -= object_size;
  RemovePageWithoutObjectsCount(page);
}
...
void CodeLargeObjectSpace::RemovePageWithoutObjectsCount(LargePage* page) {
  RemoveChunkMapEntries(page);
  heap()->isolate()->RemoveCodeMemoryChunk(page);
  OldLargeObjectSpace::RemovePageWithoutObjectsCount(page);
}
