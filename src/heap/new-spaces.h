...
class SemiSpace : public Space {
 public:
  ...
  bool RefillLab(int min_size, int max_size, AllocationAlignment alignment,
                 AllocationOrigin origin, Address* top, Address* limit);

  bool RefillLabFromCurrentPage(int min_size, int max_size,
                                AllocationAlignment alignment,
                                AllocationOrigin origin, Address* top,
                                Address* limit);

  void Free(Address* top, Address* limit);
 ...
 public:
  ...
  size_t Size() final {
    return to_space_.pages_used() *
           ...
           to_space_.page_high() - to_space_.current_top();
  }
  ...
  size_t AllocatedSinceLastGC() {
    ...
    if (current_page != last_page) {
      ...
      return last_page->area_end() - age_mark;
    }
    do {
