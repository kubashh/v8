 ...
 public:
  ...
  class LocalSweeper final {
   public:
    ...
    bool ParallelSweepSpace(AllocationSpace identity,
                            SweepingMode sweeping_mode,
                            uint max_pages = std::numeric_limits<uint>::max());
  ...
  // Returns true if any swept pages can be allocated on.
  bool ParallelSweepSpace(AllocationSpace identity, SweepingMode sweeping_mode,
                          uint max_pages = std::numeric_limits<uint>::max());
