...
class Scavenger {
    ...
    class Local {
     public:
      explicit Local(PromotionList* promotion_list)
          : regular_object_promotion_list_(
     ...
     private:
      RegularObjectPromotionList::Local regular_object_promotion_list_;
      LargeObjectPromotionList::Local large_object_promotion_list_;
    };
 ...
 private:
  ...
  Heap* const heap_;
  EmptyChunksList::Local empty_chunks_;
  PromotionList::Local promotion_list_;
  CopiedList::Local copied_list_;
  EphemeronTableList::Local ephemeron_table_list_;
