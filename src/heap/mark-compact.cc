 ...
 private:
  ...
  inline bool EvacuateWithoutCopying(HeapObject* object) {
    ...
    if (object->IsThinString()) {
      ...
      this->TransferColorIfNeeded(object, actual);
...
static inline SlotCallbackResult UpdateSlot(Object** slot) {
  ...
  if (obj->IsHeapObject()) {
    ...
    if (map_word.IsForwardingAddress()) {
      ...
      // While we should never allocate on evacuation candidates, a previously
      // allocated ThinString could reside on an evacuation candidate.
