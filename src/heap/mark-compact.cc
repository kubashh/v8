...
class YoungGenerationMarker {
 public:
  YoungGenerationMarker(Heap* heap, MinorMarkCompactCollector* collector,
                        MarkingDeque* marking_deque)
      : collector_(collector),
        marking_deque_(marking_deque),
        visitor_(heap, marking_deque) {}

  MarkingDeque* marking_deque() { return marking_deque_; }
  YoungGenerationMarkingVisitor* visitor() { return &visitor_; }
  MinorMarkCompactCollector* collector() { return collector_; }
