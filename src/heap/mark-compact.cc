...
void MarkCompactCollector::EvacuatePagesInParallel() {
  ...
  // added to one of the compaction space. Merge remembered sets for
  // those pages such that slots are either recorded in the sweeping
  // or the old-to-new remembered set after mark-compact.
