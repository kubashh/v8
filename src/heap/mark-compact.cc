...
class MarkYoungGenerationJobTraits {
 public:
  ...
  static bool ProcessPageInParallel(Heap* heap, PerTaskData data,
    ...
    MarkUntypedPointers(heap, chunk, data);
    MarkTypedPointers(heap, chunk, data);
 ...
 private:
  static void MarkUntypedPointers(Heap* heap, MemoryChunk* chunk,
  ...
  static void MarkTypedPointers(Heap* heap, MemoryChunk* chunk,
                                const PerTaskData data) {
