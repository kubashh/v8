 ...
 public:
  ...
  void Run(JobDelegate* delegate) override {
    ...
    if (delegate->IsJoiningThread()) {
      ...
      TRACE_GC_WITH_KIND(tracer_, evacuator->GetBackgroundTracingScope(),
 ...
 public:
  ...
  void Run(JobDelegate* delegate) override {
    if (delegate->IsJoiningThread()) {
      ...
      TRACE_GC_WITH_KIND(tracer_, background_scope_, ThreadKind::kBackground);
      UpdatePointers(delegate);
    }
  }
 ...
 public:
  ...
  void Run(JobDelegate* delegate) override {
    if (delegate->IsJoiningThread()) {
      ...
      TRACE_GC_WITH_KIND(collector_->heap()->tracer(),
