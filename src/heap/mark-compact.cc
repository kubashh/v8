...
// are retained. For MarkingMode::YOUNG_GENERATION we will only consider
// clearing objects in the young generation and preserve all others.
template <MarkingMode mode>
...
void MarkCompactCollector::ClearNonLiveReferencesInYoungGeneration() {
...

  {
    ...
    heap()->ProcessYoungWeakReferences(&mark_compact_object_retainer);
  }
}
