 ...
 public:
  ...
  explicit EvacuationAllocator(Heap* heap, LocalSpaceKind local_space_kind)
      : heap_(heap),
        ...
        new_space_small_allocator_(nullptr, ThreadKind::kBackground, new_space_,
                                   kTaggedSize, kLabSize, kLabSize,
                                   ReadOnlyRoots(heap)),
        new_space_medium_allocator_(nullptr, ThreadKind::kBackground,
                                    new_space_, kTaggedSize, 0, 0,
                                    ReadOnlyRoots(heap)),
        old_space_allocator_(nullptr, ThreadKind::kBackground,
                             compaction_spaces_.Get(OLD_SPACE), kTaggedSize, 0,
                             0, ReadOnlyRoots(heap)),
        code_space_allocator_(nullptr, ThreadKind::kBackground,
