...
Handle<JSObject> Factory::NewFastOrSlowJSObjectFromMap(
  ...
  if (new_js_object_type == NewJSObjectType::kPossibleAPIWrapper &&
      (IsJSApiObject(*js_object) || IsJSGlobalObject(*js_object) ||
       IsJSGlobalProxy(*js_object) || IsJSSpecialApiObject(*js_object) ||
       IsJSTypedArray(*js_object) || IsJSPromise(*js_object) ||
       IsJSArrayBuffer(*js_object) || IsJSDataView(*js_object) ||
       IsJSRabGsabDataView(*js_object))) {
