...
class MemoryChunk : public BasicMemoryChunk {
 ...
 protected:
  ...
  // The mark_compact_epoch_ is maintained on sweepable old generation pages
  // and on new space pages. It is kept in sync with the Mark-Compact epoch
  // counter. A MemoryChunk is swept and iterable if its mark_compact_epoch_
  // matches the epoch in Mark-Compact.
