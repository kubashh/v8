...
class Page : public MemoryChunk {
 public:
  ...
  // [page_addr + area_start_ .. page_addr + kPageSize + kSystemPointerSize].
  static Page* FromAllocationAreaAddress(Address address) {
    return Page::FromAddress(address - kSystemPointerSize);
  }
 ...
 public:
  ...
  virtual int RoundSizeDownToObjectAlignment(int size) {
    if (id_ == CODE_SPACE) {
      ...
      return RoundDown(size, kSystemPointerSize);
    }
  }
...
class SkipList {
 public:
  ...
  void AddObject(Address addr, int size) {
    ...
    int end_region = RegionNumber(addr + size - kSystemPointerSize);
...
class V8_EXPORT_PRIVATE FreeList {
 ...
 private:
  ...
  static const size_t kMinBlockSize = 3 * kSystemPointerSize;
  ...
  static const size_t kTiniestListMax = 0xa * kSystemPointerSize;
  static const size_t kTinyListMax = 0x1f * kSystemPointerSize;
  static const size_t kSmallListMax = 0xff * kSystemPointerSize;
  static const size_t kMediumListMax = 0x7ff * kSystemPointerSize;
  static const size_t kLargeListMax = 0x3fff * kSystemPointerSize;
