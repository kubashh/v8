...
bool SemiSpace::RefillLab(ThreadKind, int min_size, int max_size,
...
bool SemiSpace::RefillLabImpl(int min_size, int max_size,
                              AllocationAlignment alignment,
                              AllocationOrigin origin, Address* top,
                              Address* limit) {
  if (*top != kNullAddress) {
...
bool NewSpace::RefillLab(ThreadKind, int min_size, int max_size,
                         AllocationAlignment alignment, AllocationOrigin origin,
                         Address* top, Address* limit) {
  base::MutexGuard guard(&mutex_);
  return to_space_.RefillLabImpl(min_size, max_size, alignment, origin, top,
                                 limit);
}
