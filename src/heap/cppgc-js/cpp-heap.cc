...
void CppHeap::FinishMarkingAndStartSweeping() {
...

  {
    ...
    const cppgc::internal::Sweeper::SweepingStrategy sweeping_strategy =
        v8_flags.cppheap_optimize_sweep_for_mutator
            ? cppgc::internal::Sweeper::SweepingStrategy::
                  kMinimizeMutatorInterference
            : cppgc::internal::Sweeper::SweepingStrategy::kMinimizeMemory;
    ...
    sweeper().Start(sweeping_config, sweeping_strategy,
