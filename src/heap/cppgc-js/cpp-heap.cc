...
class V8_EXPORT_PRIVATE UnifiedHeapConcurrentMarker
...
class UnifiedHeapMarker final : public cppgc::internal::MarkerBase {
 ...
 protected:
  ...
  std::unique_ptr<cppgc::internal::ConcurrentMarkerBase>
  CreateConcurrentMarker() final;
...
std::unique_ptr<cppgc::internal::ConcurrentMarkerBase>
UnifiedHeapMarker::CreateConcurrentMarker() {
  return std::make_unique<UnifiedHeapConcurrentMarker>(
