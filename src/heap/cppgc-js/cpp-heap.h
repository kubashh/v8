...
class V8_EXPORT_PRIVATE CppHeap final
 ...
 public:
  ...
  using StackState = cppgc::internal::GCConfig::StackState;
  using CollectionType = cppgc::internal::GCConfig::CollectionType;
  ...
  void InitializeTracing(cppgc::internal::GCConfig::CollectionType,
 ...
 private:
  ...
  base::Optional<cppgc::internal::GCConfig::CollectionType> collection_type_;
