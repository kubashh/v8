...
GCType Heap::GetGCTypeFromGarbageCollector(GarbageCollector collector) {
  switch (collector) {
...
bool Heap::CollectGarbage(AllocationSpace space,
  ...
  // CollectGarbage consists of three phases:
  // 1. A prologue phase which may execute callbacks. These callbacks may
  // allocate and trigger another garbage collection.
  // 2. The main garbage collection phase.
  // 3. An epilogue phase which may execute callbacks. These callbacks may
  // allocate and trigger another garbage collection

  /////////////////////////////////////////////////////////////////////////////
  // 1. Invoke all callbacks which should happen before the actual garbage
