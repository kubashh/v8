...
enum class HeapLimitHandling { kRespect, kIgnoreSoftLimit, kIgnore };
...
class Allocator {
 public:
  ...
  bool IsLabEmpty() const { return lab_.original_limit == lab_.top; }

  size_t LabSize() const { return lab_.original_limit - lab_.top; }
