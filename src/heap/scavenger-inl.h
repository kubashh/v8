...
int ScavengeVisitor::VisitJSApiObject(Tagged<Map> map,
  ...
  int size =
      JSObjectWithEmbedderSlotsOrJSCustomElementsObjectBodyDescriptor::SizeOf(
          map, object);
  JSObjectWithEmbedderSlotsOrJSCustomElementsObjectBodyDescriptor::IterateBody(
      map, object, size, this);
  return size;
}
