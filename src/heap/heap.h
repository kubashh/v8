...
class Heap {
 public:
  ...
  // given alignment.
  V8_EXPORT_PRIVATE static size_t GetMaximumFillToAlign(
      AllocationAlignment alignment);
  // Calculates the actual amount of filler required for a given address at the
  // given alignment.
  V8_EXPORT_PRIVATE static size_t GetFillToAlign(Address address,
                                                 AllocationAlignment alignment);
...
#undef ROOT_ACCESSOR
  ...
  bool ShouldExpandOldGenerationOnSlowAllocation(
      ThreadKind, LocalHeap* local_heap = nullptr);
