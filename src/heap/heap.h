...
#undef ROOT_ACCESSOR
  ...
  bool allocation_limit_configured() const {
    return allocation_limit_configured_.load(std::memory_order_relaxed);
  }

  void set_allocation_limit_configured(bool value) {
    allocation_limit_configured_.store(value, std::memory_order_relaxed);
  }
  ...
  std::atomic<bool> allocation_limit_configured_ = false;
