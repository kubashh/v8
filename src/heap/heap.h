...
#undef ROOT_ACCESSOR
  ...
  // otherwise it falls back to a slower path indicated by the flag.
  enum AllocateRawSlowPathFlag { kLightRetry, kRetryOrFail };
  template <AllocateRawSlowPathFlag slowPathFlag>
  V8_WARN_UNUSED_RESULT inline HeapObject AllocateRawFastPath(
  ...
  // returned.
  V8_WARN_UNUSED_RESULT inline HeapObject AllocateRawWithLightRetry(
      int size, AllocationType allocation, AllocationOrigin origin,
      AllocationAlignment alignment = kWordAligned);
  V8_WARN_UNUSED_RESULT inline HeapObject AllocateRawWithLightRetry(
  ...
  V8_WARN_UNUSED_RESULT inline HeapObject AllocateRawWithRetryOrFail(
      int size, AllocationType allocation, AllocationOrigin origin,
      AllocationAlignment alignment = kWordAligned);
  V8_WARN_UNUSED_RESULT inline HeapObject AllocateRawWithRetryOrFail(
      int size, AllocationType allocation,
