...
#undef ROOT_ACCESSOR
  ...
  enum class ScanStackMode { kNone, kFromMarker, kComplete, kUninitialized };
  ...
  void IterateStackConservatively(RootVisitor* v, ScanStackMode mode);
...
#undef ROOT_ACCESSOR
  ...
  ScanStackMode scan_stack_mode_ = ScanStackMode::kUninitialized;
...
class V8_NODISCARD ScanStackModeScopeForTesting : public ScanStackModeScope {
 public:
