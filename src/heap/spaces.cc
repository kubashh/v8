...
bool Space::AddAllocationObserver(AllocationObserver* observer) {
  return allocation_counter_.AddAllocationObserver(observer);
}

bool Space::RemoveAllocationObserver(AllocationObserver* observer) {
  return allocation_counter_.RemoveAllocationObserver(observer);
}
...
bool SpaceWithLinearArea::AddAllocationObserver(AllocationObserver* observer) {
  if (Space::AddAllocationObserver(observer)) {
    UpdateInlineAllocationLimit(0);
    return true;
  }
  return false;
...
bool SpaceWithLinearArea::RemoveAllocationObserver(
    AllocationObserver* observer) {
  if (Space::RemoveAllocationObserver(observer)) {
    UpdateInlineAllocationLimit(0);
    return true;
  }
  return false;
