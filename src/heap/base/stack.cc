...
void Stack::SaveContext(bool check_invariant) {
  // TODO(v8:13257): Remove the method's parameter and the implication as soon
  ...
  // TODO(v8:13257): Remove the implication as soon as IsValidMarker is
  // compatible with stack switching.
  DCHECK_IMPLIES(check_invariant, IsValidMarker(stack_start_, stack_top));
