...
void ArrayBufferSweeper::PrepareYoung() {
...
void ArrayBufferSweeper::PrepareFull() {
  DCHECK(sweeping_young_.IsEmpty());
  DCHECK(sweeping_old_.IsEmpty());
