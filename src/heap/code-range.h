...
class CodeRange final : public VirtualMemoryCage {
 public:
  ...
  // Returns the a code range without the reserved writable region, which is
  // supposed to contain unwind information.
  base::AddressRegion GetNonABICompliantRegion();
