...
class InitializeClassElementsStatement final : public Statement {
 public:
  ...
  ZonePtrList<Property>* elements() const { return elements_; }

 private:
  friend class AstNodeFactory;

  InitializeClassElementsStatement(ZonePtrList<Property>* elements, int pos)
      : Statement(pos, kInitializeClassElementsStatement),
        elements_(elements) {}

  ZonePtrList<Property>* elements_;
};
...
#undef STATEMENT_WITH_LABELS
  ...
  InitializeClassElementsStatement* NewInitializeClassElementsStatement(
    ...
    return new (zone_) InitializeClassElementsStatement(args, pos);
  }
