...
class NaryOperation final : public Expression {
 public:
  ...
  // Reserve a certain amount of space in the subsequent entry list, for memory
  // efficiency.
  void ReserveSubsequent(size_t size) { subsequent_.reserve(size); }
...
#undef STATEMENT_WITH_LABELS
  ...
  NaryOperation* NewNaryOperation(Token::Value op, Expression* first) {
    return new (zone_) NaryOperation(zone_, op, first);
  }
