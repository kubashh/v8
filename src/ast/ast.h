...
class SuperPropertyReference final : public Expression {
 public:
  ThisExpression* this_expression() const { return this_expression_; }
  Expression* home_object() const { return home_object_; }

 private:
  friend class AstNodeFactory;

  SuperPropertyReference(ThisExpression* this_expression,
                         Expression* home_object, int pos)
      : Expression(pos, kSuperPropertyReference),
        this_expression_(this_expression),
        home_object_(home_object) {
    DCHECK(home_object->IsProperty());
  }

  ThisExpression* this_expression_;
...
class SuperCallReference final : public Expression {
 ...
 private:
  ...
  SuperCallReference(ThisExpression* this_expression,
...
#undef STATEMENT_WITH_LABELS
  ...
  SuperPropertyReference* NewSuperPropertyReference(
      class ThisExpression* this_expression, Expression* home_object, int pos) {
    return new (zone_)
        SuperPropertyReference(this_expression, home_object, pos);
  }

  SuperCallReference* NewSuperCallReference(
      class ThisExpression* this_expression, VariableProxy* new_target_var,
      VariableProxy* this_function_var, int pos) {
    return new (zone_) SuperCallReference(this_expression, new_target_var,
