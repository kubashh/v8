...
{
  outer_scope_and_calls_eval_.SetPointer(scope);
  outer_scope_and_calls_eval_.SetStorage(scope->scope_calls_eval_);
...
Scope::Snapshot::~Snapshot() {
  ...
  if (outer_scope_and_calls_eval_.GetStorage()) {
    outer_scope_and_calls_eval_.GetPointer()->scope_calls_eval_ = true;
  }
}
