...
class V8_EXPORT_PRIVATE ClassScope : public Scope {
 public:
  ...
  bool should_save_class_variable_index() const {
    return has_reparsed_anonymous_class_variable_ ||
  ...
  void set_has_reparsed_anonymous_class_variable() {
    has_reparsed_anonymous_class_variable_ = true;
  }
 ...
 private:
  ...
  // preparsed data.
  bool has_reparsed_anonymous_class_variable_ = false;
};
