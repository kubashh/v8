...
#define INTERFACE_DESCRIPTOR_LIST(V)   \
  ...
  V(WasmToJavaScriptTypeConversion_32) \
...
class WasmToJavaScriptTypeConversion_32Descriptor final
    : public CallInterfaceDescriptor {
 public:
  DEFINE_PARAMETERS_NO_CONTEXT(kLow, kHigh)
  DEFINE_PARAMETER_TYPES(MachineType::Int32(),  // kLow
                         MachineType::Int32())  // kHigh
  DECLARE_DESCRIPTOR(WasmToJavaScriptTypeConversion_32Descriptor,
                     CallInterfaceDescriptor)
};
