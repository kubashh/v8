...
void JSObjectWithEmbedderSlotsPrintHeader(std::ostream& os,
                                          Tagged<JSObject> obj,
...
void JSPromise::JSPromisePrint(std::ostream& os) {
  JSObjectWithEmbedderSlotsPrintHeader(os, *this, "JSPromise");
...
void JSArrayBuffer::JSArrayBufferPrint(std::ostream& os) {
  JSObjectWithEmbedderSlotsPrintHeader(os, *this, "JSArrayBuffer");
...
void JSTypedArray::JSTypedArrayPrint(std::ostream& os) {
  JSObjectWithEmbedderSlotsPrintHeader(os, *this, "JSTypedArray");
  os << "\n - buffer: " << Brief(buffer());
...
void JSGlobalProxy::JSGlobalProxyPrint(std::ostream& os) {
  JSObjectWithEmbedderSlotsPrintHeader(os, *this, "JSGlobalProxy");
  JSObjectPrintBody(os, *this);
}

void JSGlobalObject::JSGlobalObjectPrint(std::ostream& os) {
  JSObjectWithEmbedderSlotsPrintHeader(os, *this, "JSGlobalObject");
