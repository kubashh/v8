...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kAsyncContextVariable_string = 0x4241;
  static constexpr Tagged_t kAsyncContextSnapshot_string = 0x4265;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4289;
  static constexpr Tagged_t kAtomicsMutex_string = 0x42a9;
  static constexpr Tagged_t kauto_string = 0x42c5;
  static constexpr Tagged_t kawait_string = 0x42d5;
  static constexpr Tagged_t kBigInt_string = 0x42e9;
  static constexpr Tagged_t kbigint_string = 0x42fd;
  static constexpr Tagged_t kBigInt64Array_string = 0x4311;
  static constexpr Tagged_t kBigUint64Array_string = 0x432d;
  static constexpr Tagged_t kbind_string = 0x4349;
  static constexpr Tagged_t kblank_string = 0x4359;
  static constexpr Tagged_t kBoolean_string = 0x436d;
  static constexpr Tagged_t kboolean_string = 0x4381;
  static constexpr Tagged_t kboolean_to_string = 0x4395;
  static constexpr Tagged_t kbound__string = 0x43b1;
  static constexpr Tagged_t kbuffer_string = 0x43c5;
  static constexpr Tagged_t kbyte_length_string = 0x43d9;
  static constexpr Tagged_t kbyte_offset_string = 0x43f1;
  static constexpr Tagged_t kCompileError_string = 0x4409;
  static constexpr Tagged_t kcalendar_string = 0x4421;
  static constexpr Tagged_t kcallee_string = 0x4435;
  static constexpr Tagged_t kcaller_string = 0x4449;
  static constexpr Tagged_t kcause_string = 0x445d;
  static constexpr Tagged_t kcharacter_string = 0x4471;
  ...
  static constexpr Tagged_t kconjunction_string = 0x44c5;
  static constexpr Tagged_t kconsole_string = 0x44dd;
  static constexpr Tagged_t kconstrain_string = 0x44f1;
  static constexpr Tagged_t kconstruct_string = 0x4509;
  static constexpr Tagged_t kcurrent_string = 0x4521;
  static constexpr Tagged_t kDate_string = 0x4535;
  static constexpr Tagged_t kdate_to_string = 0x4545;
  static constexpr Tagged_t kdateAdd_string = 0x4561;
  static constexpr Tagged_t kdateFromFields_string = 0x4575;
  static constexpr Tagged_t kdateUntil_string = 0x4591;
  static constexpr Tagged_t kday_string = 0x45a9;
  static constexpr Tagged_t kdayOfWeek_string = 0x45b9;
  static constexpr Tagged_t kdayOfYear_string = 0x45d1;
  static constexpr Tagged_t kdays_string = 0x45e9;
  static constexpr Tagged_t kdaysInMonth_string = 0x45f9;
  static constexpr Tagged_t kdaysInWeek_string = 0x4611;
  static constexpr Tagged_t kdaysInYear_string = 0x4629;
  static constexpr Tagged_t kdefault_string = 0x4641;
  static constexpr Tagged_t kdefineProperty_string = 0x4655;
  static constexpr Tagged_t kdeleteProperty_string = 0x4671;
  static constexpr Tagged_t kdetached_string = 0x468d;
  static constexpr Tagged_t kdisjunction_string = 0x46a1;
  static constexpr Tagged_t kdone_string = 0x46b9;
  static constexpr Tagged_t kdot_brand_string = 0x46c9;
  static constexpr Tagged_t kdot_catch_string = 0x46dd;
  static constexpr Tagged_t kdot_default_string = 0x46f1;
  static constexpr Tagged_t kdot_for_string = 0x4705;
  static constexpr Tagged_t kdot_generator_object_string = 0x4715;
  static constexpr Tagged_t kdot_home_object_string = 0x4735;
  static constexpr Tagged_t kdot_new_target_string = 0x474d;
  static constexpr Tagged_t knew_target_string = 0x474d;
  static constexpr Tagged_t kdot_result_string = 0x4765;
  static constexpr Tagged_t kdot_repl_result_string = 0x4779;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4791;
  static constexpr Tagged_t kdot_switch_tag_string = 0x47b1;
  static constexpr Tagged_t kdotAll_string = 0x47c9;
  static constexpr Tagged_t kError_string = 0x47dd;
  static constexpr Tagged_t kEvalError_string = 0x47f1;
  static constexpr Tagged_t kelement_string = 0x4809;
  static constexpr Tagged_t kepochMicroseconds_string = 0x481d;
  static constexpr Tagged_t kepochMilliseconds_string = 0x483d;
  static constexpr Tagged_t kepochNanoseconds_string = 0x485d;
  static constexpr Tagged_t kepochSeconds_string = 0x4879;
  static constexpr Tagged_t kera_string = 0x4891;
  static constexpr Tagged_t keraYear_string = 0x48a1;
  static constexpr Tagged_t kerror_string = 0x48b5;
  static constexpr Tagged_t kerrors_string = 0x48c9;
  static constexpr Tagged_t kerror_to_string = 0x48dd;
  static constexpr Tagged_t keval_string = 0x48f9;
  static constexpr Tagged_t kexception_string = 0x4909;
  static constexpr Tagged_t kexec_string = 0x4921;
  static constexpr Tagged_t kfalse_string = 0x4931;
  static constexpr Tagged_t kfields_string = 0x4945;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4959;
  static constexpr Tagged_t kflags_string = 0x4979;
  static constexpr Tagged_t kFloat32Array_string = 0x498d;
  static constexpr Tagged_t kFloat64Array_string = 0x49a5;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x49bd;
  static constexpr Tagged_t kfrom_string = 0x49e1;
  static constexpr Tagged_t kFunction_string = 0x49f1;
  static constexpr Tagged_t kfunction_native_code_string = 0x4a05;
  static constexpr Tagged_t kfunction_string = 0x4a31;
  static constexpr Tagged_t kfunction_to_string = 0x4a45;
  static constexpr Tagged_t kGenerator_string = 0x4a65;
  static constexpr Tagged_t kget_space_string = 0x4a7d;
  static constexpr Tagged_t kget_string = 0x4a8d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4a9d;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4ac1;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4ae5;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4b09;
  static constexpr Tagged_t kglobal_string = 0x4b25;
  static constexpr Tagged_t kglobalThis_string = 0x4b39;
  static constexpr Tagged_t kgroups_string = 0x4b51;
  static constexpr Tagged_t kgrowable_string = 0x4b65;
  static constexpr Tagged_t khas_string = 0x4b79;
  static constexpr Tagged_t khasIndices_string = 0x4b89;
  static constexpr Tagged_t khour_string = 0x4ba1;
  static constexpr Tagged_t khours_string = 0x4bb1;
  static constexpr Tagged_t khoursInDay_string = 0x4bc5;
  static constexpr Tagged_t kignoreCase_string = 0x4bdd;
  static constexpr Tagged_t kid_string = 0x4bf5;
  static constexpr Tagged_t killegal_access_string = 0x4c05;
  static constexpr Tagged_t killegal_argument_string = 0x4c21;
  static constexpr Tagged_t kinLeapYear_string = 0x4c3d;
  static constexpr Tagged_t kindex_string = 0x4c55;
  static constexpr Tagged_t kindices_string = 0x4c69;
  static constexpr Tagged_t kInfinity_string = 0x4c7d;
  static constexpr Tagged_t kinfinity_string = 0x4c91;
  static constexpr Tagged_t kinput_string = 0x4ca5;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4cb9;
  static constexpr Tagged_t kInt16Array_string = 0x4ce5;
  static constexpr Tagged_t kInt32Array_string = 0x4cfd;
  static constexpr Tagged_t kInt8Array_string = 0x4d15;
  static constexpr Tagged_t kisExtensible_string = 0x4d2d;
  static constexpr Tagged_t kiso8601_string = 0x4d45;
  static constexpr Tagged_t kisoDay_string = 0x4d59;
  static constexpr Tagged_t kisoHour_string = 0x4d6d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4d81;
  static constexpr Tagged_t kisoMillisecond_string = 0x4d9d;
  static constexpr Tagged_t kisoMinute_string = 0x4db9;
  static constexpr Tagged_t kisoMonth_string = 0x4dd1;
  static constexpr Tagged_t kisoNanosecond_string = 0x4de5;
  static constexpr Tagged_t kisoSecond_string = 0x4e01;
  static constexpr Tagged_t kisoYear_string = 0x4e19;
  static constexpr Tagged_t kIterator_string = 0x4e2d;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4e41;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4e5d;
  static constexpr Tagged_t kkeys_string = 0x4e79;
  static constexpr Tagged_t klargestUnit_string = 0x4e89;
  static constexpr Tagged_t klastIndex_string = 0x4ea1;
  static constexpr Tagged_t klet_string = 0x4eb9;
  static constexpr Tagged_t kline_string = 0x4ec9;
  static constexpr Tagged_t klinear_string = 0x4ed9;
  static constexpr Tagged_t kLinkError_string = 0x4eed;
  static constexpr Tagged_t klong_string = 0x4f05;
  static constexpr Tagged_t kMap_string = 0x4f15;
  static constexpr Tagged_t kMapIterator_string = 0x4f25;
  static constexpr Tagged_t kmax_byte_length_string = 0x4f3d;
  static constexpr Tagged_t kmedium_string = 0x4f59;
  static constexpr Tagged_t kmergeFields_string = 0x4f6d;
  static constexpr Tagged_t kmessage_string = 0x4f85;
  static constexpr Tagged_t kmeta_string = 0x4f99;
  static constexpr Tagged_t kminus_Infinity_string = 0x4fa9;
  static constexpr Tagged_t kmicrosecond_string = 0x4fc1;
  static constexpr Tagged_t kmicroseconds_string = 0x4fd9;
  static constexpr Tagged_t kmillisecond_string = 0x4ff1;
  static constexpr Tagged_t kmilliseconds_string = 0x5009;
  static constexpr Tagged_t kminute_string = 0x5021;
  static constexpr Tagged_t kminutes_string = 0x5035;
  static constexpr Tagged_t kModule_string = 0x5049;
  static constexpr Tagged_t kmonth_string = 0x505d;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5071;
  static constexpr Tagged_t kmonths_string = 0x5091;
  static constexpr Tagged_t kmonthsInYear_string = 0x50a5;
  static constexpr Tagged_t kmonthCode_string = 0x50bd;
  static constexpr Tagged_t kmultiline_string = 0x50d5;
  ...
  static constexpr Tagged_t kObject_prototype_string = 0x5261;
  static constexpr Tagged_t kof_string = 0x527d;
  static constexpr Tagged_t koffset_string = 0x528d;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x52a1;
  static constexpr Tagged_t kok_string = 0x52c1;
  static constexpr Tagged_t kother_string = 0x52d1;
  static constexpr Tagged_t koverflow_string = 0x52e5;
  static constexpr Tagged_t kownKeys_string = 0x52f9;
  static constexpr Tagged_t kpercent_string = 0x530d;
  static constexpr Tagged_t kplainDate_string = 0x5321;
  static constexpr Tagged_t kplainTime_string = 0x5339;
  static constexpr Tagged_t kposition_string = 0x5351;
  static constexpr Tagged_t kpreventExtensions_string = 0x5365;
  static constexpr Tagged_t kprivate_constructor_string = 0x5385;
  static constexpr Tagged_t kPromise_string = 0x539d;
  static constexpr Tagged_t kpromise_string = 0x53b1;
  static constexpr Tagged_t kproto_string = 0x53c5;
  static constexpr Tagged_t kproxy_string = 0x53dd;
  static constexpr Tagged_t kProxy_string = 0x53f1;
  static constexpr Tagged_t kquery_colon_string = 0x5405;
  static constexpr Tagged_t kRangeError_string = 0x5415;
  static constexpr Tagged_t kraw_json_string = 0x542d;
  static constexpr Tagged_t kraw_string = 0x5441;
  static constexpr Tagged_t kReferenceError_string = 0x5451;
  static constexpr Tagged_t kReflectGet_string = 0x546d;
  static constexpr Tagged_t kReflectHas_string = 0x5485;
  static constexpr Tagged_t kRegExp_string = 0x549d;
  static constexpr Tagged_t kregexp_to_string = 0x54b1;
  static constexpr Tagged_t kreject_string = 0x54cd;
  static constexpr Tagged_t krelativeTo_string = 0x54e1;
  static constexpr Tagged_t kresizable_string = 0x54f9;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5511;
  static constexpr Tagged_t kreturn_string = 0x5531;
  static constexpr Tagged_t krevoke_string = 0x5545;
  static constexpr Tagged_t kroundingIncrement_string = 0x5559;
  static constexpr Tagged_t kRuntimeError_string = 0x5579;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5591;
  static constexpr Tagged_t kScript_string = 0x55b5;
  static constexpr Tagged_t kscript_string = 0x55c9;
  static constexpr Tagged_t ksecond_string = 0x55dd;
  static constexpr Tagged_t kseconds_string = 0x55f1;
  static constexpr Tagged_t kshort_string = 0x5605;
  static constexpr Tagged_t kSet_string = 0x5619;
  static constexpr Tagged_t ksentence_string = 0x5629;
  static constexpr Tagged_t kset_space_string = 0x563d;
  static constexpr Tagged_t kset_string = 0x564d;
  static constexpr Tagged_t kSetIterator_string = 0x565d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5675;
  static constexpr Tagged_t kShadowRealm_string = 0x5691;
  static constexpr Tagged_t kSharedArray_string = 0x56a9;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x56c1;
  static constexpr Tagged_t kSharedStruct_string = 0x56e1;
  static constexpr Tagged_t ksign_string = 0x56f9;
  static constexpr Tagged_t ksize_string = 0x5709;
  static constexpr Tagged_t ksmallestUnit_string = 0x5719;
  static constexpr Tagged_t ksource_string = 0x5731;
  static constexpr Tagged_t ksourceText_string = 0x5745;
  static constexpr Tagged_t kstack_string = 0x575d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5771;
  static constexpr Tagged_t kstatic_initializer_string = 0x578d;
  static constexpr Tagged_t ksticky_string = 0x57ad;
  static constexpr Tagged_t kString_string = 0x57c1;
  static constexpr Tagged_t kstring_string = 0x57d5;
  static constexpr Tagged_t kstring_to_string = 0x57e9;
  static constexpr Tagged_t ksuppressed_string = 0x5805;
  static constexpr Tagged_t kSuppressedError_string = 0x581d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5839;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5855;
  static constexpr Tagged_t kSymbol_replace_string = 0x5871;
  static constexpr Tagged_t ksymbol_species_string = 0x588d;
  static constexpr Tagged_t kSymbol_species_string = 0x58a9;
  static constexpr Tagged_t kSymbol_split_string = 0x58c5;
  static constexpr Tagged_t kSymbol_string = 0x58dd;
  static constexpr Tagged_t ksymbol_string = 0x58f1;
  static constexpr Tagged_t kSyntaxError_string = 0x5905;
  static constexpr Tagged_t ktarget_string = 0x591d;
  static constexpr Tagged_t kthis_function_string = 0x5931;
  static constexpr Tagged_t kthis_string = 0x594d;
  static constexpr Tagged_t kthrow_string = 0x595d;
  static constexpr Tagged_t ktimed_out_string = 0x5971;
  static constexpr Tagged_t ktimeZone_string = 0x5989;
  static constexpr Tagged_t ktoJSON_string = 0x599d;
  static constexpr Tagged_t ktoString_string = 0x59b1;
  static constexpr Tagged_t ktrue_string = 0x59c5;
  static constexpr Tagged_t ktotal_string = 0x59d5;
  static constexpr Tagged_t kTypeError_string = 0x59e9;
  static constexpr Tagged_t kUint16Array_string = 0x5a01;
  static constexpr Tagged_t kUint32Array_string = 0x5a19;
  static constexpr Tagged_t kUint8Array_string = 0x5a31;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5a49;
  static constexpr Tagged_t kundefined_string = 0x5a69;
  static constexpr Tagged_t kundefined_to_string = 0x5a81;
  static constexpr Tagged_t kunicode_string = 0x5aa1;
  static constexpr Tagged_t kunicodeSets_string = 0x5ab5;
  static constexpr Tagged_t kunit_string = 0x5acd;
  static constexpr Tagged_t kURIError_string = 0x5add;
  static constexpr Tagged_t kUTC_string = 0x5af1;
  static constexpr Tagged_t kvalueOf_string = 0x5b01;
  static constexpr Tagged_t kWeakMap_string = 0x5b15;
  static constexpr Tagged_t kWeakRef_string = 0x5b29;
  static constexpr Tagged_t kWeakSet_string = 0x5b3d;
  static constexpr Tagged_t kweek_string = 0x5b51;
  static constexpr Tagged_t kweeks_string = 0x5b61;
  static constexpr Tagged_t kweekOfYear_string = 0x5b75;
  static constexpr Tagged_t kwith_string = 0x5b8d;
  static constexpr Tagged_t kword_string = 0x5b9d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5bad;
  static constexpr Tagged_t kyear_string = 0x5bcd;
  static constexpr Tagged_t kyears_string = 0x5bdd;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5bf1;
  static constexpr Tagged_t kHashTableHoleValue = 0x5bfd;
  static constexpr Tagged_t kPromiseHoleValue = 0x5c09;
  static constexpr Tagged_t kUninitializedValue = 0x5c15;
  static constexpr Tagged_t kArgumentsMarker = 0x5c21;
  static constexpr Tagged_t kTerminationException = 0x5c2d;
  static constexpr Tagged_t kException = 0x5c39;
  static constexpr Tagged_t kOptimizedOut = 0x5c45;
  static constexpr Tagged_t kStaleRegister = 0x5c51;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5c5d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5c69;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5c75;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5c85;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5c95;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5ca5;
  static constexpr Tagged_t kclass_fields_symbol = 0x5cb5;
  static constexpr Tagged_t kclass_positions_symbol = 0x5cc5;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5cd5;
  static constexpr Tagged_t kerror_script_symbol = 0x5ce5;
  static constexpr Tagged_t kerror_stack_symbol = 0x5cf5;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5d05;
  static constexpr Tagged_t kfrozen_symbol = 0x5d15;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d25;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d35;
  static constexpr Tagged_t knonextensible_symbol = 0x5d45;
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5d55;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5d65;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5d75;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5d85;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5d95;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5da5;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5db5;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5dc5;
  static constexpr Tagged_t ksealed_symbol = 0x5dd5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5de5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5df5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5e05;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e15;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e25;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e35;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e45;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5e55;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5e65;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5e75;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5e85;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5e95;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5ec5;
  static constexpr Tagged_t kmatch_symbol = 0x5efd;
  static constexpr Tagged_t ksearch_symbol = 0x5f25;
  static constexpr Tagged_t kto_primitive_symbol = 0x5f51;
  static constexpr Tagged_t kunscopables_symbol = 0x5f81;
  static constexpr Tagged_t khas_instance_symbol = 0x5fb1;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5fe1;
  static constexpr Tagged_t kconstructor_string = 0x6039;
  static constexpr Tagged_t knext_string = 0x6051;
  static constexpr Tagged_t kresolve_string = 0x6061;
  static constexpr Tagged_t kthen_string = 0x6075;
  ...
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x60d5;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x60e5;
  static constexpr Tagged_t kEmptySymbolTable = 0x6109;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6125;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6139;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x614d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x6159;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x6179;
  static constexpr Tagged_t kNativeScopeInfo = 0x619d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x61b5;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x61cd;
  static constexpr Tagged_t kWasmNullPadding = 0x61d5;
