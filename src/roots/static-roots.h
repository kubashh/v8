...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kmega_transition_symbol = 0xe25;
  static constexpr Tagged_t kEmptyPropertyDictionary = 0xe35;
  static constexpr Tagged_t kEmptyOrderedPropertyDictionary = 0xe61;
  static constexpr Tagged_t kEmptyByteArray = 0xe79;
  static constexpr Tagged_t kEmptyScopeInfo = 0xe81;
  static constexpr Tagged_t kEmptyPropertyArray = 0xe91;
  static constexpr Tagged_t kMinusZeroValue = 0xe99;
  static constexpr Tagged_t kNanValue = 0xea5;
  static constexpr Tagged_t kHoleNanValue = 0xeb1;
  static constexpr Tagged_t kInfinityValue = 0xebd;
  static constexpr Tagged_t kMinusInfinityValue = 0xec9;
  static constexpr Tagged_t kMaxSafeInteger = 0xed5;
  static constexpr Tagged_t kMaxUInt32 = 0xee1;
  static constexpr Tagged_t kSmiMinValue = 0xeed;
  static constexpr Tagged_t kSmiMaxValuePlusOne = 0xef9;
  static constexpr Tagged_t kPromiseFulfillReactionJobTaskMap = 0xf05;
  static constexpr Tagged_t kPromiseRejectReactionJobTaskMap = 0xf2d;
  static constexpr Tagged_t kCallableTaskMap = 0xf55;
  static constexpr Tagged_t kCallbackTaskMap = 0xf7d;
  static constexpr Tagged_t kPromiseResolveThenableJobTaskMap = 0xfa5;
  static constexpr Tagged_t kFunctionTemplateInfoMap = 0xfcd;
  static constexpr Tagged_t kObjectTemplateInfoMap = 0xff5;
  static constexpr Tagged_t kAccessCheckInfoMap = 0x101d;
  static constexpr Tagged_t kAccessorPairMap = 0x1045;
  static constexpr Tagged_t kAliasedArgumentsEntryMap = 0x106d;
  static constexpr Tagged_t kAllocationMementoMap = 0x1095;
  static constexpr Tagged_t kArrayBoilerplateDescriptionMap = 0x10bd;
  static constexpr Tagged_t kAsmWasmDataMap = 0x10e5;
  static constexpr Tagged_t kAsyncGeneratorRequestMap = 0x110d;
  static constexpr Tagged_t kBreakPointMap = 0x1135;
  static constexpr Tagged_t kBreakPointInfoMap = 0x115d;
  static constexpr Tagged_t kBytecodeWrapperMap = 0x1185;
  static constexpr Tagged_t kClassBoilerplateMap = 0x11ad;
  static constexpr Tagged_t kClassPositionsMap = 0x11d5;
  static constexpr Tagged_t kCodeWrapperMap = 0x11fd;
  static constexpr Tagged_t kDebugInfoMap = 0x1225;
  static constexpr Tagged_t kErrorStackDataMap = 0x124d;
  static constexpr Tagged_t kFunctionTemplateRareDataMap = 0x1275;
  static constexpr Tagged_t kInterceptorInfoMap = 0x129d;
  static constexpr Tagged_t kModuleRequestMap = 0x12c5;
  static constexpr Tagged_t kPromiseCapabilityMap = 0x12ed;
  static constexpr Tagged_t kPromiseOnStackMap = 0x1315;
  ...
  static constexpr Tagged_t kScriptMap = 0x13dd;
  static constexpr Tagged_t kScriptOrModuleMap = 0x1405;
  static constexpr Tagged_t kSourceTextModuleInfoEntryMap = 0x142d;
  static constexpr Tagged_t kStackFrameInfoMap = 0x1455;
  static constexpr Tagged_t kTemplateObjectDescriptionMap = 0x147d;
  static constexpr Tagged_t kTuple2Map = 0x14a5;
  static constexpr Tagged_t kWasmExceptionTagMap = 0x14cd;
  static constexpr Tagged_t kWasmIndirectFunctionTableMap = 0x14f5;
  ...
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataMap = 0x1685;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataMap = 0x16ad;
  static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap =
      0x16d5;
  static constexpr Tagged_t kUncompiledDataWithPreparseDataAndJobMap = 0x16fd;
  static constexpr Tagged_t kOnHeapBasicBlockProfilerDataMap = 0x1725;
  static constexpr Tagged_t kTurbofanBitsetTypeMap = 0x174d;
  static constexpr Tagged_t kTurbofanUnionTypeMap = 0x1775;
  static constexpr Tagged_t kTurbofanRangeTypeMap = 0x179d;
  static constexpr Tagged_t kTurbofanHeapConstantTypeMap = 0x17c5;
  static constexpr Tagged_t kTurbofanOtherNumberConstantTypeMap = 0x17ed;
  static constexpr Tagged_t kTurboshaftWord32TypeMap = 0x1815;
  static constexpr Tagged_t kTurboshaftWord32RangeTypeMap = 0x183d;
  static constexpr Tagged_t kTurboshaftWord64TypeMap = 0x1865;
  static constexpr Tagged_t kTurboshaftWord64RangeTypeMap = 0x188d;
  static constexpr Tagged_t kTurboshaftFloat64TypeMap = 0x18b5;
  static constexpr Tagged_t kTurboshaftFloat64RangeTypeMap = 0x18dd;
  static constexpr Tagged_t kInternalClassMap = 0x1905;
  static constexpr Tagged_t kSmiPairMap = 0x192d;
  static constexpr Tagged_t kSmiBoxMap = 0x1955;
  static constexpr Tagged_t kExportedSubClassBaseMap = 0x197d;
  static constexpr Tagged_t kExportedSubClassMap = 0x19a5;
  static constexpr Tagged_t kAbstractInternalClassSubclass1Map = 0x19cd;
  static constexpr Tagged_t kAbstractInternalClassSubclass2Map = 0x19f5;
  static constexpr Tagged_t kExportedSubClass2Map = 0x1a1d;
  static constexpr Tagged_t kSortStateMap = 0x1a45;
  static constexpr Tagged_t kWasmStringViewIterMap = 0x1a6d;
  static constexpr Tagged_t kSloppyArgumentsElementsMap = 0x1a95;
  static constexpr Tagged_t kStrongDescriptorArrayMap = 0x1abd;
  static constexpr Tagged_t kTurboshaftWord32SetTypeMap = 0x1ae5;
  static constexpr Tagged_t kTurboshaftWord64SetTypeMap = 0x1b0d;
  static constexpr Tagged_t kTurboshaftFloat64SetTypeMap = 0x1b35;
  static constexpr Tagged_t kInternalClassWithStructElementsMap = 0x1b5d;
  static constexpr Tagged_t kOrderedHashMapMap = 0x1b85;
  static constexpr Tagged_t kOrderedHashSetMap = 0x1bad;
  static constexpr Tagged_t kSimpleNumberDictionaryMap = 0x1bd5;
  static constexpr Tagged_t kNameToIndexHashTableMap = 0x1bfd;
  static constexpr Tagged_t kEmbedderDataArrayMap = 0x1c25;
  static constexpr Tagged_t kEphemeronHashTableMap = 0x1c4d;
  static constexpr Tagged_t kScriptContextTableMap = 0x1c75;
  static constexpr Tagged_t kObjectBoilerplateDescriptionMap = 0x1c9d;
  static constexpr Tagged_t kCoverageInfoMap = 0x1cc5;
  static constexpr Tagged_t kRegExpMatchInfoMap = 0x1ced;
  static constexpr Tagged_t kSideEffectCallHandlerInfoMap = 0x1d15;
  static constexpr Tagged_t kSideEffectFreeCallHandlerInfoMap = 0x1d3d;
  static constexpr Tagged_t kSourceTextModuleMap = 0x1d65;
  static constexpr Tagged_t kSyntheticModuleMap = 0x1d8d;
  static constexpr Tagged_t kWasmApiFunctionRefMap = 0x1db5;
  static constexpr Tagged_t kWasmCapiFunctionDataMap = 0x1ddd;
  static constexpr Tagged_t kWasmExportedFunctionDataMap = 0x1e05;
  static constexpr Tagged_t kWasmInternalFunctionMap = 0x1e2d;
  static constexpr Tagged_t kWasmJSFunctionDataMap = 0x1e55;
  static constexpr Tagged_t kWasmResumeDataMap = 0x1e7d;
  static constexpr Tagged_t kWasmTypeInfoMap = 0x1ea5;
  static constexpr Tagged_t kWasmContinuationObjectMap = 0x1ecd;
  static constexpr Tagged_t kWasmNullMap = 0x1ef5;
  static constexpr Tagged_t kWasmTrustedInstanceDataMap = 0x1f1d;
  static constexpr Tagged_t kWeakCellMap = 0x1f45;
  static constexpr Tagged_t kExternalPointerArrayMap = 0x1f6d;
  static constexpr Tagged_t kInterpreterDataMap = 0x1f95;
  static constexpr Tagged_t kDictionaryTemplateInfoMap = 0x1fbd;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x1fe5;
  static constexpr Tagged_t kEmptyArrayList = 0x200d;
  static constexpr Tagged_t kEmptyObjectBoilerplateDescription = 0x2019;
  ...
  static constexpr Tagged_t kEmptySwissPropertyDictionary = 0x2049;
  static constexpr Tagged_t kSingleCharacterStringTable = 0x2069;
  static constexpr Tagged_t kdot_string = 0x2751;
  static constexpr Tagged_t kzero_string = 0x2771;
  static constexpr Tagged_t kone_string = 0x2781;
  static constexpr Tagged_t kadoptText_string = 0x3471;
  static constexpr Tagged_t kapproximatelySign_string = 0x3489;
  static constexpr Tagged_t kbaseName_string = 0x34a9;
  static constexpr Tagged_t kaccounting_string = 0x34bd;
  static constexpr Tagged_t kbreakType_string = 0x34d5;
  static constexpr Tagged_t kcalendars_string = 0x34ed;
  static constexpr Tagged_t kcardinal_string = 0x3505;
  static constexpr Tagged_t kcaseFirst_string = 0x3519;
  static constexpr Tagged_t kceil_string = 0x3531;
  static constexpr Tagged_t kcompare_string = 0x3541;
  static constexpr Tagged_t kcollation_string = 0x3555;
  static constexpr Tagged_t kcollations_string = 0x356d;
  static constexpr Tagged_t kcompact_string = 0x3585;
  static constexpr Tagged_t kcompactDisplay_string = 0x3599;
  static constexpr Tagged_t kcurrency_string = 0x35b5;
  static constexpr Tagged_t kcurrencyDisplay_string = 0x35c9;
  static constexpr Tagged_t kcurrencySign_string = 0x35e5;
  static constexpr Tagged_t kdateStyle_string = 0x35fd;
  static constexpr Tagged_t kdateTimeField_string = 0x3615;
  static constexpr Tagged_t kdayPeriod_string = 0x3631;
  static constexpr Tagged_t kdaysDisplay_string = 0x3649;
  static constexpr Tagged_t kdecimal_string = 0x3661;
  static constexpr Tagged_t kdialect_string = 0x3675;
  static constexpr Tagged_t kdigital_string = 0x3689;
  static constexpr Tagged_t kdirection_string = 0x369d;
  static constexpr Tagged_t kendRange_string = 0x36b5;
  static constexpr Tagged_t kengineering_string = 0x36c9;
  static constexpr Tagged_t kexceptZero_string = 0x36e1;
  static constexpr Tagged_t kexpand_string = 0x36f9;
  static constexpr Tagged_t kexponentInteger_string = 0x370d;
  static constexpr Tagged_t kexponentMinusSign_string = 0x3729;
  static constexpr Tagged_t kexponentSeparator_string = 0x3749;
  static constexpr Tagged_t kfallback_string = 0x3769;
  static constexpr Tagged_t kfirst_string = 0x377d;
  static constexpr Tagged_t kfirstDay_string = 0x3791;
  static constexpr Tagged_t kfloor_string = 0x37a5;
  static constexpr Tagged_t kformat_string = 0x37b9;
  static constexpr Tagged_t kfraction_string = 0x37cd;
  static constexpr Tagged_t kfractionalDigits_string = 0x37e1;
  static constexpr Tagged_t kfractionalSecond_string = 0x37fd;
  static constexpr Tagged_t kfull_string = 0x3819;
  static constexpr Tagged_t kgranularity_string = 0x3829;
  static constexpr Tagged_t kgrapheme_string = 0x3841;
  static constexpr Tagged_t kgroup_string = 0x3855;
  static constexpr Tagged_t kh11_string = 0x3869;
  static constexpr Tagged_t kh12_string = 0x3879;
  static constexpr Tagged_t kh23_string = 0x3889;
  static constexpr Tagged_t kh24_string = 0x3899;
  static constexpr Tagged_t khalfCeil_string = 0x38a9;
  static constexpr Tagged_t khalfEven_string = 0x38bd;
  static constexpr Tagged_t khalfExpand_string = 0x38d1;
  static constexpr Tagged_t khalfFloor_string = 0x38e9;
  static constexpr Tagged_t khalfTrunc_string = 0x3901;
  static constexpr Tagged_t khour12_string = 0x3919;
  static constexpr Tagged_t khourCycle_string = 0x392d;
  static constexpr Tagged_t khourCycles_string = 0x3945;
  static constexpr Tagged_t khoursDisplay_string = 0x395d;
  static constexpr Tagged_t kideo_string = 0x3975;
  static constexpr Tagged_t kignorePunctuation_string = 0x3985;
  static constexpr Tagged_t kInvalid_Date_string = 0x39a5;
  static constexpr Tagged_t kinteger_string = 0x39bd;
  static constexpr Tagged_t kisWordLike_string = 0x39d1;
  static constexpr Tagged_t kkana_string = 0x39e9;
  static constexpr Tagged_t klanguage_string = 0x39f9;
  static constexpr Tagged_t klanguageDisplay_string = 0x3a0d;
  static constexpr Tagged_t klessPrecision_string = 0x3a29;
  static constexpr Tagged_t kletter_string = 0x3a45;
  static constexpr Tagged_t klist_string = 0x3a59;
  static constexpr Tagged_t kliteral_string = 0x3a69;
  static constexpr Tagged_t klocale_string = 0x3a7d;
  static constexpr Tagged_t kloose_string = 0x3a91;
  static constexpr Tagged_t klower_string = 0x3aa5;
  static constexpr Tagged_t kltr_string = 0x3ab9;
  static constexpr Tagged_t kmaximumFractionDigits_string = 0x3ac9;
  static constexpr Tagged_t kmaximumSignificantDigits_string = 0x3aed;
  static constexpr Tagged_t kmicrosecondsDisplay_string = 0x3b11;
  static constexpr Tagged_t kmillisecondsDisplay_string = 0x3b31;
  static constexpr Tagged_t kmin2_string = 0x3b51;
  static constexpr Tagged_t kminimalDays_string = 0x3b61;
  static constexpr Tagged_t kminimumFractionDigits_string = 0x3b79;
  static constexpr Tagged_t kminimumIntegerDigits_string = 0x3b9d;
  static constexpr Tagged_t kminimumSignificantDigits_string = 0x3bbd;
  static constexpr Tagged_t kminus_0 = 0x3be1;
  static constexpr Tagged_t kminusSign_string = 0x3bf1;
  static constexpr Tagged_t kminutesDisplay_string = 0x3c09;
  static constexpr Tagged_t kmonthsDisplay_string = 0x3c25;
  static constexpr Tagged_t kmorePrecision_string = 0x3c41;
  static constexpr Tagged_t knan_string = 0x3c5d;
  static constexpr Tagged_t knanosecondsDisplay_string = 0x3c6d;
  static constexpr Tagged_t knarrowSymbol_string = 0x3c8d;
  static constexpr Tagged_t knegative_string = 0x3ca5;
  static constexpr Tagged_t knever_string = 0x3cb9;
  static constexpr Tagged_t knone_string = 0x3ccd;
  static constexpr Tagged_t knotation_string = 0x3cdd;
  static constexpr Tagged_t knormal_string = 0x3cf1;
  static constexpr Tagged_t knumberingSystem_string = 0x3d05;
  static constexpr Tagged_t knumberingSystems_string = 0x3d21;
  static constexpr Tagged_t knumeric_string = 0x3d3d;
  static constexpr Tagged_t kordinal_string = 0x3d51;
  static constexpr Tagged_t kpercentSign_string = 0x3d65;
  static constexpr Tagged_t kplusSign_string = 0x3d7d;
  static constexpr Tagged_t kquarter_string = 0x3d91;
  static constexpr Tagged_t kregion_string = 0x3da5;
  static constexpr Tagged_t krelatedYear_string = 0x3db9;
  static constexpr Tagged_t kroundingMode_string = 0x3dd1;
  static constexpr Tagged_t kroundingPriority_string = 0x3de9;
  static constexpr Tagged_t krtl_string = 0x3e05;
  static constexpr Tagged_t kscientific_string = 0x3e15;
  static constexpr Tagged_t ksecondsDisplay_string = 0x3e2d;
  static constexpr Tagged_t ksegment_string = 0x3e49;
  static constexpr Tagged_t kSegmentIterator_string = 0x3e5d;
  static constexpr Tagged_t kSegments_string = 0x3e79;
  static constexpr Tagged_t ksensitivity_string = 0x3e8d;
  static constexpr Tagged_t ksep_string = 0x3ea5;
  static constexpr Tagged_t kshared_string = 0x3eb5;
  static constexpr Tagged_t ksignDisplay_string = 0x3ec9;
  static constexpr Tagged_t kstandard_string = 0x3ee1;
  static constexpr Tagged_t kstartRange_string = 0x3ef5;
  static constexpr Tagged_t kstrict_string = 0x3f0d;
  static constexpr Tagged_t kstripIfInteger_string = 0x3f21;
  static constexpr Tagged_t kstyle_string = 0x3f3d;
  static constexpr Tagged_t kterm_string = 0x3f51;
  static constexpr Tagged_t ktextInfo_string = 0x3f61;
  static constexpr Tagged_t ktimeStyle_string = 0x3f75;
  static constexpr Tagged_t ktimeZones_string = 0x3f8d;
  static constexpr Tagged_t ktimeZoneName_string = 0x3fa5;
  static constexpr Tagged_t ktrailingZeroDisplay_string = 0x3fbd;
  static constexpr Tagged_t ktrunc_string = 0x3fdd;
  static constexpr Tagged_t ktwo_digit_string = 0x3ff1;
  static constexpr Tagged_t ktype_string = 0x4005;
  static constexpr Tagged_t kunknown_string = 0x4015;
  static constexpr Tagged_t kupper_string = 0x4029;
  static constexpr Tagged_t kusage_string = 0x403d;
  static constexpr Tagged_t kuseGrouping_string = 0x4051;
  static constexpr Tagged_t kunitDisplay_string = 0x4069;
  static constexpr Tagged_t kweekday_string = 0x4081;
  static constexpr Tagged_t kweekend_string = 0x4095;
  static constexpr Tagged_t kweeksDisplay_string = 0x40a9;
  static constexpr Tagged_t kweekInfo_string = 0x40c1;
  static constexpr Tagged_t kyearName_string = 0x40d5;
  static constexpr Tagged_t kyearsDisplay_string = 0x40e9;
  static constexpr Tagged_t kadd_string = 0x4101;
  static constexpr Tagged_t kAggregateError_string = 0x4111;
  static constexpr Tagged_t kalways_string = 0x412d;
  static constexpr Tagged_t kanonymous_function_string = 0x4141;
  static constexpr Tagged_t kanonymous_string = 0x4161;
  static constexpr Tagged_t kapply_string = 0x4179;
  static constexpr Tagged_t kArguments_string = 0x418d;
  static constexpr Tagged_t karguments_string = 0x41a5;
  static constexpr Tagged_t karguments_to_string = 0x41bd;
  static constexpr Tagged_t kArray_string = 0x41dd;
  static constexpr Tagged_t karray_to_string = 0x41f1;
  static constexpr Tagged_t kArrayBuffer_string = 0x420d;
  static constexpr Tagged_t kArrayIterator_string = 0x4225;
  static constexpr Tagged_t kas_string = 0x4241;
  static constexpr Tagged_t kassert_string = 0x4251;
  static constexpr Tagged_t kasync_string = 0x4265;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4279;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4299;
  static constexpr Tagged_t kauto_string = 0x42b5;
  static constexpr Tagged_t kawait_string = 0x42c5;
  static constexpr Tagged_t kBigInt_string = 0x42d9;
  static constexpr Tagged_t kbigint_string = 0x42ed;
  static constexpr Tagged_t kBigInt64Array_string = 0x4301;
  static constexpr Tagged_t kBigUint64Array_string = 0x431d;
  static constexpr Tagged_t kbind_string = 0x4339;
  static constexpr Tagged_t kblank_string = 0x4349;
  static constexpr Tagged_t kBoolean_string = 0x435d;
  static constexpr Tagged_t kboolean_string = 0x4371;
  static constexpr Tagged_t kboolean_to_string = 0x4385;
  static constexpr Tagged_t kbound__string = 0x43a1;
  static constexpr Tagged_t kbuffer_string = 0x43b5;
  static constexpr Tagged_t kbyte_length_string = 0x43c9;
  static constexpr Tagged_t kbyte_offset_string = 0x43e1;
  static constexpr Tagged_t kCompileError_string = 0x43f9;
  static constexpr Tagged_t kcalendar_string = 0x4411;
  static constexpr Tagged_t kcallee_string = 0x4425;
  static constexpr Tagged_t kcaller_string = 0x4439;
  static constexpr Tagged_t kcause_string = 0x444d;
  static constexpr Tagged_t kcharacter_string = 0x4461;
  static constexpr Tagged_t kcode_string = 0x4479;
  static constexpr Tagged_t kcolumn_string = 0x4489;
  static constexpr Tagged_t kcomputed_string = 0x449d;
  static constexpr Tagged_t kconjunction_string = 0x44b5;
  static constexpr Tagged_t kconsole_string = 0x44cd;
  static constexpr Tagged_t kconstrain_string = 0x44e1;
  static constexpr Tagged_t kconstruct_string = 0x44f9;
  static constexpr Tagged_t kcurrent_string = 0x4511;
  static constexpr Tagged_t kDate_string = 0x4525;
  static constexpr Tagged_t kdate_to_string = 0x4535;
  static constexpr Tagged_t kdateAdd_string = 0x4551;
  static constexpr Tagged_t kdateFromFields_string = 0x4565;
  static constexpr Tagged_t kdateUntil_string = 0x4581;
  static constexpr Tagged_t kday_string = 0x4599;
  static constexpr Tagged_t kdayOfWeek_string = 0x45a9;
  static constexpr Tagged_t kdayOfYear_string = 0x45c1;
  static constexpr Tagged_t kdays_string = 0x45d9;
  static constexpr Tagged_t kdaysInMonth_string = 0x45e9;
  static constexpr Tagged_t kdaysInWeek_string = 0x4601;
  static constexpr Tagged_t kdaysInYear_string = 0x4619;
  static constexpr Tagged_t kdefault_string = 0x4631;
  static constexpr Tagged_t kdefineProperty_string = 0x4645;
  static constexpr Tagged_t kdeleteProperty_string = 0x4661;
  static constexpr Tagged_t kdetached_string = 0x467d;
  static constexpr Tagged_t kdisjunction_string = 0x4691;
  static constexpr Tagged_t kdone_string = 0x46a9;
  static constexpr Tagged_t kdot_brand_string = 0x46b9;
  static constexpr Tagged_t kdot_catch_string = 0x46cd;
  static constexpr Tagged_t kdot_default_string = 0x46e1;
  static constexpr Tagged_t kdot_for_string = 0x46f5;
  static constexpr Tagged_t kdot_generator_object_string = 0x4705;
  static constexpr Tagged_t kdot_home_object_string = 0x4725;
  static constexpr Tagged_t kdot_new_target_string = 0x473d;
  static constexpr Tagged_t knew_target_string = 0x473d;
  static constexpr Tagged_t kdot_result_string = 0x4755;
  static constexpr Tagged_t kdot_repl_result_string = 0x4769;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4781;
  static constexpr Tagged_t kdot_switch_tag_string = 0x47a1;
  static constexpr Tagged_t kdotAll_string = 0x47b9;
  static constexpr Tagged_t kError_string = 0x47cd;
  static constexpr Tagged_t kEvalError_string = 0x47e1;
  static constexpr Tagged_t kelement_string = 0x47f9;
  static constexpr Tagged_t kepochMicroseconds_string = 0x480d;
  static constexpr Tagged_t kepochMilliseconds_string = 0x482d;
  static constexpr Tagged_t kepochNanoseconds_string = 0x484d;
  static constexpr Tagged_t kepochSeconds_string = 0x4869;
  static constexpr Tagged_t kera_string = 0x4881;
  static constexpr Tagged_t keraYear_string = 0x4891;
  static constexpr Tagged_t kerror_string = 0x48a5;
  ...
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4ca9;
  ...
  static constexpr Tagged_t kIterator_string = 0x4e1d;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4e31;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4e4d;
  static constexpr Tagged_t kkeys_string = 0x4e69;
  static constexpr Tagged_t klargestUnit_string = 0x4e79;
  static constexpr Tagged_t klastIndex_string = 0x4e91;
  ...
  static constexpr Tagged_t kNaN_string = 0x50dd;
  static constexpr Tagged_t knanosecond_string = 0x50ed;
  static constexpr Tagged_t knanoseconds_string = 0x5105;
  static constexpr Tagged_t knarrow_string = 0x511d;
  static constexpr Tagged_t knative_string = 0x5131;
  static constexpr Tagged_t kNFC_string = 0x5145;
  static constexpr Tagged_t kNFD_string = 0x5155;
  static constexpr Tagged_t kNFKC_string = 0x5165;
  static constexpr Tagged_t kNFKD_string = 0x5175;
  static constexpr Tagged_t knot_equal_string = 0x5185;
  static constexpr Tagged_t knull_string = 0x519d;
  static constexpr Tagged_t knull_to_string = 0x51ad;
  static constexpr Tagged_t kNumber_string = 0x51c9;
  static constexpr Tagged_t knumber_string = 0x51dd;
  static constexpr Tagged_t knumber_to_string = 0x51f1;
  static constexpr Tagged_t kObject_string = 0x520d;
  static constexpr Tagged_t kobject_string = 0x5221;
  static constexpr Tagged_t kobject_to_string = 0x5235;
  static constexpr Tagged_t kObject_prototype_string = 0x5251;
  static constexpr Tagged_t kof_string = 0x526d;
  static constexpr Tagged_t koffset_string = 0x527d;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5291;
  static constexpr Tagged_t kok_string = 0x52b1;
  static constexpr Tagged_t kother_string = 0x52c1;
  static constexpr Tagged_t koverflow_string = 0x52d5;
  static constexpr Tagged_t kownKeys_string = 0x52e9;
  static constexpr Tagged_t kpercent_string = 0x52fd;
  static constexpr Tagged_t kplainDate_string = 0x5311;
  static constexpr Tagged_t kplainTime_string = 0x5329;
  static constexpr Tagged_t kposition_string = 0x5341;
  static constexpr Tagged_t kpreventExtensions_string = 0x5355;
  static constexpr Tagged_t kprivate_constructor_string = 0x5375;
  static constexpr Tagged_t kPromise_string = 0x538d;
  static constexpr Tagged_t kpromise_string = 0x53a1;
  static constexpr Tagged_t kproto_string = 0x53b5;
  static constexpr Tagged_t kproxy_string = 0x53cd;
  static constexpr Tagged_t kProxy_string = 0x53e1;
  static constexpr Tagged_t kquery_colon_string = 0x53f5;
  static constexpr Tagged_t kRangeError_string = 0x5405;
  static constexpr Tagged_t kraw_json_string = 0x541d;
  static constexpr Tagged_t kraw_string = 0x5431;
  static constexpr Tagged_t kReferenceError_string = 0x5441;
  static constexpr Tagged_t kReflectGet_string = 0x545d;
  static constexpr Tagged_t kReflectHas_string = 0x5475;
  static constexpr Tagged_t kRegExp_string = 0x548d;
  static constexpr Tagged_t kregexp_to_string = 0x54a1;
  static constexpr Tagged_t kreject_string = 0x54bd;
  static constexpr Tagged_t krelativeTo_string = 0x54d1;
  static constexpr Tagged_t kresizable_string = 0x54e9;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5501;
  static constexpr Tagged_t kreturn_string = 0x5521;
  static constexpr Tagged_t krevoke_string = 0x5535;
  static constexpr Tagged_t kroundingIncrement_string = 0x5549;
  static constexpr Tagged_t kRuntimeError_string = 0x5569;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5581;
  static constexpr Tagged_t kScript_string = 0x55a5;
  static constexpr Tagged_t kscript_string = 0x55b9;
  static constexpr Tagged_t ksecond_string = 0x55cd;
  static constexpr Tagged_t kseconds_string = 0x55e1;
  static constexpr Tagged_t kshort_string = 0x55f5;
  static constexpr Tagged_t kSet_string = 0x5609;
  static constexpr Tagged_t ksentence_string = 0x5619;
  static constexpr Tagged_t kset_space_string = 0x562d;
  static constexpr Tagged_t kset_string = 0x563d;
  static constexpr Tagged_t kSetIterator_string = 0x564d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5665;
  static constexpr Tagged_t kShadowRealm_string = 0x5681;
  static constexpr Tagged_t kSharedArray_string = 0x5699;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x56b1;
  static constexpr Tagged_t kSharedStruct_string = 0x56d1;
  static constexpr Tagged_t ksign_string = 0x56e9;
  static constexpr Tagged_t ksize_string = 0x56f9;
  static constexpr Tagged_t ksmallestUnit_string = 0x5709;
  static constexpr Tagged_t ksource_string = 0x5721;
  static constexpr Tagged_t ksourceText_string = 0x5735;
  static constexpr Tagged_t kstack_string = 0x574d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5761;
  static constexpr Tagged_t kstatic_initializer_string = 0x577d;
  static constexpr Tagged_t ksticky_string = 0x579d;
  static constexpr Tagged_t kString_string = 0x57b1;
  static constexpr Tagged_t kstring_string = 0x57c5;
  static constexpr Tagged_t kstring_to_string = 0x57d9;
  static constexpr Tagged_t ksuppressed_string = 0x57f5;
  static constexpr Tagged_t kSuppressedError_string = 0x580d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5829;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5845;
  static constexpr Tagged_t kSymbol_replace_string = 0x5861;
  static constexpr Tagged_t ksymbol_species_string = 0x587d;
  static constexpr Tagged_t kSymbol_species_string = 0x5899;
  static constexpr Tagged_t kSymbol_split_string = 0x58b5;
  static constexpr Tagged_t kSymbol_string = 0x58cd;
  static constexpr Tagged_t ksymbol_string = 0x58e1;
  static constexpr Tagged_t kSyntaxError_string = 0x58f5;
  static constexpr Tagged_t ktarget_string = 0x590d;
  static constexpr Tagged_t kthis_function_string = 0x5921;
  static constexpr Tagged_t kthis_string = 0x593d;
  static constexpr Tagged_t kthrow_string = 0x594d;
  static constexpr Tagged_t ktimed_out_string = 0x5961;
  static constexpr Tagged_t ktimeZone_string = 0x5979;
  static constexpr Tagged_t ktoJSON_string = 0x598d;
  static constexpr Tagged_t ktoString_string = 0x59a1;
  static constexpr Tagged_t ktrue_string = 0x59b5;
  static constexpr Tagged_t ktotal_string = 0x59c5;
  static constexpr Tagged_t kTypeError_string = 0x59d9;
  static constexpr Tagged_t kUint16Array_string = 0x59f1;
  static constexpr Tagged_t kUint32Array_string = 0x5a09;
  static constexpr Tagged_t kUint8Array_string = 0x5a21;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5a39;
  static constexpr Tagged_t kundefined_string = 0x5a59;
  static constexpr Tagged_t kundefined_to_string = 0x5a71;
  static constexpr Tagged_t kunicode_string = 0x5a91;
  static constexpr Tagged_t kunicodeSets_string = 0x5aa5;
  static constexpr Tagged_t kunit_string = 0x5abd;
  static constexpr Tagged_t kURIError_string = 0x5acd;
  static constexpr Tagged_t kUTC_string = 0x5ae1;
  static constexpr Tagged_t kvalueOf_string = 0x5af1;
  static constexpr Tagged_t kWeakMap_string = 0x5b05;
  static constexpr Tagged_t kWeakRef_string = 0x5b19;
  static constexpr Tagged_t kWeakSet_string = 0x5b2d;
  static constexpr Tagged_t kweek_string = 0x5b41;
  static constexpr Tagged_t kweeks_string = 0x5b51;
  static constexpr Tagged_t kweekOfYear_string = 0x5b65;
  static constexpr Tagged_t kwith_string = 0x5b7d;
  static constexpr Tagged_t kword_string = 0x5b8d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5b9d;
  static constexpr Tagged_t kyear_string = 0x5bbd;
  static constexpr Tagged_t kyears_string = 0x5bcd;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5be1;
  static constexpr Tagged_t kHashTableHoleValue = 0x5bed;
  static constexpr Tagged_t kPromiseHoleValue = 0x5bf9;
  static constexpr Tagged_t kUninitializedValue = 0x5c05;
  static constexpr Tagged_t kArgumentsMarker = 0x5c11;
  static constexpr Tagged_t kTerminationException = 0x5c1d;
  static constexpr Tagged_t kException = 0x5c29;
  static constexpr Tagged_t kOptimizedOut = 0x5c35;
  static constexpr Tagged_t kStaleRegister = 0x5c41;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5c4d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5c59;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5c65;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5c75;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5c85;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5c95;
  static constexpr Tagged_t kclass_fields_symbol = 0x5ca5;
  static constexpr Tagged_t kclass_positions_symbol = 0x5cb5;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5cc5;
  static constexpr Tagged_t kerror_script_symbol = 0x5cd5;
  static constexpr Tagged_t kerror_stack_symbol = 0x5ce5;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5cf5;
  static constexpr Tagged_t kfrozen_symbol = 0x5d05;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d15;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d25;
  static constexpr Tagged_t knonextensible_symbol = 0x5d35;
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5d45;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5d55;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5d65;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5d75;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5d85;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5d95;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5da5;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5db5;
  static constexpr Tagged_t ksealed_symbol = 0x5dc5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5dd5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5de5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5df5;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e05;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e15;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e25;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e35;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5e45;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5e55;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5e65;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5e75;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5e85;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5eb5;
  static constexpr Tagged_t kmatch_symbol = 0x5eed;
  static constexpr Tagged_t ksearch_symbol = 0x5f15;
  static constexpr Tagged_t kto_primitive_symbol = 0x5f41;
  static constexpr Tagged_t kunscopables_symbol = 0x5f71;
  static constexpr Tagged_t khas_instance_symbol = 0x5fa1;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5fd1;
  static constexpr Tagged_t kconstructor_string = 0x6029;
  static constexpr Tagged_t knext_string = 0x6041;
  static constexpr Tagged_t kresolve_string = 0x6051;
  static constexpr Tagged_t kthen_string = 0x6065;
  static constexpr Tagged_t kiterator_symbol = 0x6075;
  static constexpr Tagged_t kmatch_all_symbol = 0x6085;
  static constexpr Tagged_t kreplace_symbol = 0x6095;
  static constexpr Tagged_t kspecies_symbol = 0x60a5;
  static constexpr Tagged_t ksplit_symbol = 0x60b5;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x60c5;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x60d5;
  static constexpr Tagged_t kEmptySymbolTable = 0x60f9;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6115;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6129;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x613d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x6149;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x6169;
  static constexpr Tagged_t kNativeScopeInfo = 0x618d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x61a5;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x61bd;
  static constexpr Tagged_t kWasmNullPadding = 0x61c5;
...
static constexpr std::array<Tagged_t, 759> StaticReadOnlyRootsPointerTable = {
    ...
    StaticReadOnlyRoot::kmega_transition_symbol,
