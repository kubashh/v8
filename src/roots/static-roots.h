...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kAsyncLockedWaiterWrapperMap = 0x112d;
  ...
  static constexpr Tagged_t kFunctionTemplateInfoMap = 0x1745;
  ...
  static constexpr Tagged_t kanonymous_function_string = 0x4201;
  static constexpr Tagged_t kanonymous_string = 0x4221;
  static constexpr Tagged_t kapply_string = 0x4239;
  static constexpr Tagged_t kArguments_string = 0x424d;
  static constexpr Tagged_t karguments_string = 0x4265;
  static constexpr Tagged_t karguments_to_string = 0x427d;
  static constexpr Tagged_t kArray_string = 0x429d;
  static constexpr Tagged_t karray_to_string = 0x42b1;
  static constexpr Tagged_t kArrayBuffer_string = 0x42cd;
  static constexpr Tagged_t kArrayIterator_string = 0x42e5;
  static constexpr Tagged_t kas_string = 0x4301;
  static constexpr Tagged_t kassert_string = 0x4311;
  static constexpr Tagged_t kasync_string = 0x4325;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4339;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4359;
  static constexpr Tagged_t kauto_string = 0x4375;
  static constexpr Tagged_t kawait_string = 0x4385;
  static constexpr Tagged_t kBigInt_string = 0x4399;
  static constexpr Tagged_t kbigint_string = 0x43ad;
  static constexpr Tagged_t kBigInt64Array_string = 0x43c1;
  static constexpr Tagged_t kBigUint64Array_string = 0x43dd;
  static constexpr Tagged_t kbind_string = 0x43f9;
  static constexpr Tagged_t kblank_string = 0x4409;
  static constexpr Tagged_t kBoolean_string = 0x441d;
  static constexpr Tagged_t kboolean_string = 0x4431;
  static constexpr Tagged_t kboolean_to_string = 0x4445;
  static constexpr Tagged_t kbound__string = 0x4461;
  static constexpr Tagged_t kbuffer_string = 0x4475;
  static constexpr Tagged_t kbyte_length_string = 0x4489;
  static constexpr Tagged_t kbyte_offset_string = 0x44a1;
  static constexpr Tagged_t kCompileError_string = 0x44b9;
  static constexpr Tagged_t kcalendar_string = 0x44d1;
  static constexpr Tagged_t kcallee_string = 0x44e5;
  static constexpr Tagged_t kcaller_string = 0x44f9;
  static constexpr Tagged_t kcause_string = 0x450d;
  static constexpr Tagged_t kcharacter_string = 0x4521;
  static constexpr Tagged_t kcode_string = 0x4539;
  static constexpr Tagged_t kcolumn_string = 0x4549;
  static constexpr Tagged_t kcomputed_string = 0x455d;
  static constexpr Tagged_t kconjunction_string = 0x4575;
  static constexpr Tagged_t kconsole_string = 0x458d;
  static constexpr Tagged_t kconstrain_string = 0x45a1;
  static constexpr Tagged_t kconstruct_string = 0x45b9;
  static constexpr Tagged_t kcurrent_string = 0x45d1;
  static constexpr Tagged_t kDate_string = 0x45e5;
  static constexpr Tagged_t kdate_to_string = 0x45f5;
  static constexpr Tagged_t kdateAdd_string = 0x4611;
  static constexpr Tagged_t kdateFromFields_string = 0x4625;
  static constexpr Tagged_t kdateUntil_string = 0x4641;
  static constexpr Tagged_t kday_string = 0x4659;
  static constexpr Tagged_t kdayOfWeek_string = 0x4669;
  static constexpr Tagged_t kdayOfYear_string = 0x4681;
  static constexpr Tagged_t kdays_string = 0x4699;
  static constexpr Tagged_t kdaysInMonth_string = 0x46a9;
  static constexpr Tagged_t kdaysInWeek_string = 0x46c1;
  static constexpr Tagged_t kdaysInYear_string = 0x46d9;
  static constexpr Tagged_t kdefault_string = 0x46f1;
  static constexpr Tagged_t kdefineProperty_string = 0x4705;
  static constexpr Tagged_t kdeleteProperty_string = 0x4721;
  static constexpr Tagged_t kdetached_string = 0x473d;
  static constexpr Tagged_t kdisjunction_string = 0x4751;
  static constexpr Tagged_t kdone_string = 0x4769;
  static constexpr Tagged_t kdot_brand_string = 0x4779;
  static constexpr Tagged_t kdot_catch_string = 0x478d;
  static constexpr Tagged_t kdot_default_string = 0x47a1;
  static constexpr Tagged_t kdot_for_string = 0x47b5;
  static constexpr Tagged_t kdot_generator_object_string = 0x47c5;
  static constexpr Tagged_t kdot_home_object_string = 0x47e5;
  static constexpr Tagged_t kdot_new_target_string = 0x47fd;
  static constexpr Tagged_t knew_target_string = 0x47fd;
  static constexpr Tagged_t kdot_result_string = 0x4815;
  static constexpr Tagged_t kdot_repl_result_string = 0x4829;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4841;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4861;
  static constexpr Tagged_t kdotAll_string = 0x4879;
  static constexpr Tagged_t kError_string = 0x488d;
  static constexpr Tagged_t kEvalError_string = 0x48a1;
  static constexpr Tagged_t kelement_string = 0x48b9;
  static constexpr Tagged_t kepochMicroseconds_string = 0x48cd;
  static constexpr Tagged_t kepochMilliseconds_string = 0x48ed;
  static constexpr Tagged_t kepochNanoseconds_string = 0x490d;
  static constexpr Tagged_t kepochSeconds_string = 0x4929;
  static constexpr Tagged_t kera_string = 0x4941;
  static constexpr Tagged_t keraYear_string = 0x4951;
  static constexpr Tagged_t kerror_string = 0x4965;
  static constexpr Tagged_t kerrors_string = 0x4979;
  static constexpr Tagged_t kerror_to_string = 0x498d;
  static constexpr Tagged_t keval_string = 0x49a9;
  static constexpr Tagged_t kexception_string = 0x49b9;
  static constexpr Tagged_t kexec_string = 0x49d1;
  static constexpr Tagged_t kfalse_string = 0x49e1;
  static constexpr Tagged_t kfields_string = 0x49f5;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4a09;
  static constexpr Tagged_t kflags_string = 0x4a29;
  static constexpr Tagged_t kFloat16Array_string = 0x4a3d;
  static constexpr Tagged_t kFloat32Array_string = 0x4a55;
  static constexpr Tagged_t kFloat64Array_string = 0x4a6d;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4a85;
  static constexpr Tagged_t kfrom_string = 0x4aa9;
  static constexpr Tagged_t kFunction_string = 0x4ab9;
  static constexpr Tagged_t kfunction_native_code_string = 0x4acd;
  static constexpr Tagged_t kfunction_string = 0x4af9;
  static constexpr Tagged_t kfunction_to_string = 0x4b0d;
  static constexpr Tagged_t kGenerator_string = 0x4b2d;
  static constexpr Tagged_t kget_space_string = 0x4b45;
  static constexpr Tagged_t kget_string = 0x4b55;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4b65;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4b89;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4bad;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4bd1;
  static constexpr Tagged_t kglobal_string = 0x4bed;
  static constexpr Tagged_t kglobalThis_string = 0x4c01;
  static constexpr Tagged_t kgroups_string = 0x4c19;
  static constexpr Tagged_t kgrowable_string = 0x4c2d;
  static constexpr Tagged_t khas_string = 0x4c41;
  static constexpr Tagged_t khasIndices_string = 0x4c51;
  static constexpr Tagged_t khour_string = 0x4c69;
  static constexpr Tagged_t khours_string = 0x4c79;
  static constexpr Tagged_t khoursInDay_string = 0x4c8d;
  static constexpr Tagged_t kignoreCase_string = 0x4ca5;
  static constexpr Tagged_t kid_string = 0x4cbd;
  static constexpr Tagged_t killegal_access_string = 0x4ccd;
  static constexpr Tagged_t killegal_argument_string = 0x4ce9;
  static constexpr Tagged_t kinLeapYear_string = 0x4d05;
  static constexpr Tagged_t kindex_string = 0x4d1d;
  static constexpr Tagged_t kindices_string = 0x4d31;
  static constexpr Tagged_t kInfinity_string = 0x4d45;
  static constexpr Tagged_t kinfinity_string = 0x4d59;
  static constexpr Tagged_t kinput_string = 0x4d6d;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4d81;
  static constexpr Tagged_t kInt16Array_string = 0x4dad;
  static constexpr Tagged_t kInt32Array_string = 0x4dc5;
  static constexpr Tagged_t kInt8Array_string = 0x4ddd;
  static constexpr Tagged_t kisExtensible_string = 0x4df5;
  static constexpr Tagged_t kiso8601_string = 0x4e0d;
  static constexpr Tagged_t kisoDay_string = 0x4e21;
  static constexpr Tagged_t kisoHour_string = 0x4e35;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4e49;
  static constexpr Tagged_t kisoMillisecond_string = 0x4e65;
  static constexpr Tagged_t kisoMinute_string = 0x4e81;
  static constexpr Tagged_t kisoMonth_string = 0x4e99;
  static constexpr Tagged_t kisoNanosecond_string = 0x4ead;
  static constexpr Tagged_t kisoSecond_string = 0x4ec9;
  static constexpr Tagged_t kisoYear_string = 0x4ee1;
  static constexpr Tagged_t kIterator_string = 0x4ef5;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4f09;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4f25;
  static constexpr Tagged_t kkeys_string = 0x4f41;
  static constexpr Tagged_t klargestUnit_string = 0x4f51;
  static constexpr Tagged_t klastIndex_string = 0x4f69;
  static constexpr Tagged_t klet_string = 0x4f81;
  static constexpr Tagged_t kline_string = 0x4f91;
  static constexpr Tagged_t klinear_string = 0x4fa1;
  static constexpr Tagged_t kLinkError_string = 0x4fb5;
  static constexpr Tagged_t klong_string = 0x4fcd;
  static constexpr Tagged_t kMap_string = 0x4fdd;
  static constexpr Tagged_t kMapIterator_string = 0x4fed;
  static constexpr Tagged_t kmax_byte_length_string = 0x5005;
  static constexpr Tagged_t kmedium_string = 0x5021;
  static constexpr Tagged_t kmergeFields_string = 0x5035;
  static constexpr Tagged_t kmessage_string = 0x504d;
  static constexpr Tagged_t kmeta_string = 0x5061;
  static constexpr Tagged_t kminus_Infinity_string = 0x5071;
  static constexpr Tagged_t kmicrosecond_string = 0x5089;
  static constexpr Tagged_t kmicroseconds_string = 0x50a1;
  static constexpr Tagged_t kmillisecond_string = 0x50b9;
  static constexpr Tagged_t kmilliseconds_string = 0x50d1;
  static constexpr Tagged_t kminute_string = 0x50e9;
  static constexpr Tagged_t kminutes_string = 0x50fd;
  static constexpr Tagged_t kModule_string = 0x5111;
  static constexpr Tagged_t kmonth_string = 0x5125;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5139;
  static constexpr Tagged_t kmonths_string = 0x5159;
  static constexpr Tagged_t kmonthsInYear_string = 0x516d;
  static constexpr Tagged_t kmonthCode_string = 0x5185;
  static constexpr Tagged_t kmultiline_string = 0x519d;
  static constexpr Tagged_t kNaN_string = 0x51b5;
  static constexpr Tagged_t knanosecond_string = 0x51c5;
  static constexpr Tagged_t knanoseconds_string = 0x51dd;
  static constexpr Tagged_t knarrow_string = 0x51f5;
  static constexpr Tagged_t knative_string = 0x5209;
  static constexpr Tagged_t kNFC_string = 0x521d;
  static constexpr Tagged_t kNFD_string = 0x522d;
  static constexpr Tagged_t kNFKC_string = 0x523d;
  static constexpr Tagged_t kNFKD_string = 0x524d;
  static constexpr Tagged_t knot_equal_string = 0x525d;
  static constexpr Tagged_t knull_string = 0x5275;
  static constexpr Tagged_t knull_to_string = 0x5285;
  static constexpr Tagged_t kNumber_string = 0x52a1;
  static constexpr Tagged_t knumber_string = 0x52b5;
  static constexpr Tagged_t knumber_to_string = 0x52c9;
  static constexpr Tagged_t kObject_string = 0x52e5;
  static constexpr Tagged_t kobject_string = 0x52f9;
  static constexpr Tagged_t kobject_to_string = 0x530d;
  static constexpr Tagged_t kObject_prototype_string = 0x5329;
  static constexpr Tagged_t kof_string = 0x5345;
  static constexpr Tagged_t koffset_string = 0x5355;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5369;
  static constexpr Tagged_t kok_string = 0x5389;
  static constexpr Tagged_t kother_string = 0x5399;
  static constexpr Tagged_t koverflow_string = 0x53ad;
  static constexpr Tagged_t kownKeys_string = 0x53c1;
  static constexpr Tagged_t kpercent_string = 0x53d5;
  static constexpr Tagged_t kplainDate_string = 0x53e9;
  static constexpr Tagged_t kplainTime_string = 0x5401;
  static constexpr Tagged_t kposition_string = 0x5419;
  static constexpr Tagged_t kpreventExtensions_string = 0x542d;
  static constexpr Tagged_t kprivate_constructor_string = 0x544d;
  static constexpr Tagged_t kPromise_string = 0x5465;
  static constexpr Tagged_t kpromise_string = 0x5479;
  static constexpr Tagged_t kproto_string = 0x548d;
  static constexpr Tagged_t kproxy_string = 0x54a5;
  static constexpr Tagged_t kProxy_string = 0x54b9;
  static constexpr Tagged_t kquery_colon_string = 0x54cd;
  static constexpr Tagged_t kRangeError_string = 0x54dd;
  static constexpr Tagged_t kraw_json_string = 0x54f5;
  static constexpr Tagged_t kraw_string = 0x5509;
  static constexpr Tagged_t kReferenceError_string = 0x5519;
  static constexpr Tagged_t kReflectGet_string = 0x5535;
  static constexpr Tagged_t kReflectHas_string = 0x554d;
  static constexpr Tagged_t kRegExp_string = 0x5565;
  static constexpr Tagged_t kregexp_to_string = 0x5579;
  static constexpr Tagged_t kreject_string = 0x5595;
  static constexpr Tagged_t krelativeTo_string = 0x55a9;
  static constexpr Tagged_t kresizable_string = 0x55c1;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x55d9;
  static constexpr Tagged_t kreturn_string = 0x55f9;
  static constexpr Tagged_t krevoke_string = 0x560d;
  static constexpr Tagged_t kroundingIncrement_string = 0x5621;
  static constexpr Tagged_t kRuntimeError_string = 0x5641;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5659;
  static constexpr Tagged_t kScript_string = 0x567d;
  static constexpr Tagged_t kscript_string = 0x5691;
  static constexpr Tagged_t ksecond_string = 0x56a5;
  static constexpr Tagged_t kseconds_string = 0x56b9;
  static constexpr Tagged_t kshort_string = 0x56cd;
  static constexpr Tagged_t kSet_string = 0x56e1;
  static constexpr Tagged_t ksentence_string = 0x56f1;
  static constexpr Tagged_t kset_space_string = 0x5705;
  static constexpr Tagged_t kset_string = 0x5715;
  static constexpr Tagged_t kSetIterator_string = 0x5725;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x573d;
  static constexpr Tagged_t kShadowRealm_string = 0x5759;
  static constexpr Tagged_t kSharedArray_string = 0x5771;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5789;
  static constexpr Tagged_t kSharedStruct_string = 0x57a9;
  static constexpr Tagged_t ksign_string = 0x57c1;
  static constexpr Tagged_t ksize_string = 0x57d1;
  static constexpr Tagged_t ksmallestUnit_string = 0x57e1;
  static constexpr Tagged_t ksource_string = 0x57f9;
  static constexpr Tagged_t ksourceText_string = 0x580d;
  static constexpr Tagged_t kstack_string = 0x5825;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5839;
  static constexpr Tagged_t kstatic_initializer_string = 0x5855;
  static constexpr Tagged_t ksticky_string = 0x5875;
  static constexpr Tagged_t kString_string = 0x5889;
  static constexpr Tagged_t kstring_string = 0x589d;
  static constexpr Tagged_t kstring_to_string = 0x58b1;
  static constexpr Tagged_t ksuppressed_string = 0x58cd;
  static constexpr Tagged_t kSuppressedError_string = 0x58e5;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5901;
  static constexpr Tagged_t kSymbol_match_all_string = 0x591d;
  static constexpr Tagged_t kSymbol_replace_string = 0x5939;
  static constexpr Tagged_t ksymbol_species_string = 0x5955;
  static constexpr Tagged_t kSymbol_species_string = 0x5971;
  static constexpr Tagged_t kSymbol_split_string = 0x598d;
  static constexpr Tagged_t kSymbol_string = 0x59a5;
  static constexpr Tagged_t ksymbol_string = 0x59b9;
  static constexpr Tagged_t kSyntaxError_string = 0x59cd;
  static constexpr Tagged_t ktarget_string = 0x59e5;
  static constexpr Tagged_t kthis_function_string = 0x59f9;
  static constexpr Tagged_t kthis_string = 0x5a15;
  static constexpr Tagged_t kthrow_string = 0x5a25;
  static constexpr Tagged_t ktimed_out_string = 0x5a39;
  static constexpr Tagged_t ktimeZone_string = 0x5a51;
  static constexpr Tagged_t ktoJSON_string = 0x5a65;
  static constexpr Tagged_t ktoString_string = 0x5a79;
  static constexpr Tagged_t ktrue_string = 0x5a8d;
  static constexpr Tagged_t ktotal_string = 0x5a9d;
  static constexpr Tagged_t kTypeError_string = 0x5ab1;
  static constexpr Tagged_t kUint16Array_string = 0x5ac9;
  static constexpr Tagged_t kUint32Array_string = 0x5ae1;
  static constexpr Tagged_t kUint8Array_string = 0x5af9;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5b11;
  static constexpr Tagged_t kundefined_string = 0x5b31;
  static constexpr Tagged_t kundefined_to_string = 0x5b49;
  static constexpr Tagged_t kunicode_string = 0x5b69;
  static constexpr Tagged_t kunicodeSets_string = 0x5b7d;
  static constexpr Tagged_t kunit_string = 0x5b95;
  static constexpr Tagged_t kURIError_string = 0x5ba5;
  static constexpr Tagged_t kUTC_string = 0x5bb9;
  static constexpr Tagged_t kWeakMap_string = 0x5bc9;
  static constexpr Tagged_t kWeakRef_string = 0x5bdd;
  static constexpr Tagged_t kWeakSet_string = 0x5bf1;
  static constexpr Tagged_t kweek_string = 0x5c05;
  static constexpr Tagged_t kweeks_string = 0x5c15;
  static constexpr Tagged_t kweekOfYear_string = 0x5c29;
  static constexpr Tagged_t kwith_string = 0x5c41;
  static constexpr Tagged_t kword_string = 0x5c51;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5c61;
  static constexpr Tagged_t kyear_string = 0x5c81;
  static constexpr Tagged_t kyears_string = 0x5c91;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5ca5;
  static constexpr Tagged_t kHashTableHoleValue = 0x5cb1;
  static constexpr Tagged_t kPromiseHoleValue = 0x5cbd;
  static constexpr Tagged_t kUninitializedValue = 0x5cc9;
  static constexpr Tagged_t kArgumentsMarker = 0x5cd5;
  static constexpr Tagged_t kTerminationException = 0x5ce1;
  static constexpr Tagged_t kException = 0x5ced;
  static constexpr Tagged_t kOptimizedOut = 0x5cf9;
  static constexpr Tagged_t kStaleRegister = 0x5d05;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5d11;
  ...
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5d89;
  static constexpr Tagged_t kerror_message_symbol = 0x5d99;
  ...
  static constexpr Tagged_t knative_context_index_symbol = 0x5df9;
  static constexpr Tagged_t knonextensible_symbol = 0x5e09;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5e19;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5e29;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5e39;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5e49;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5e59;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5e69;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5e79;
  static constexpr Tagged_t ksealed_symbol = 0x5e89;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5e99;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5ea9;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5eb9;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5ec9;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5ed9;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5ee9;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5ef9;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5f09;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5f19;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5f29;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5f39;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5f49;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5f79;
  static constexpr Tagged_t kmatch_symbol = 0x5fb1;
  static constexpr Tagged_t ksearch_symbol = 0x5fd9;
  static constexpr Tagged_t kunscopables_symbol = 0x6005;
  static constexpr Tagged_t kdispose_symbol = 0x6035;
...
static constexpr std::array<Tagged_t, 765> StaticReadOnlyRootsPointerTable = {
    ...
    StaticReadOnlyRoot::kAsyncLockedWaiterWrapperMap,
