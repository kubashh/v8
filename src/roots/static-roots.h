...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kaccess_string = 0x4285;
  static constexpr Tagged_t kaccessor_string = 0x4299;
  static constexpr Tagged_t kadd_string = 0x42ad;
  static constexpr Tagged_t kaddInitializer_string = 0x42bd;
  static constexpr Tagged_t kAggregateError_string = 0x42d9;
  static constexpr Tagged_t kalways_string = 0x42f5;
  static constexpr Tagged_t kanonymous_string = 0x4309;
  static constexpr Tagged_t kapply_string = 0x4321;
  static constexpr Tagged_t kArguments_string = 0x4335;
  static constexpr Tagged_t karguments_string = 0x434d;
  static constexpr Tagged_t karguments_to_string = 0x4365;
  static constexpr Tagged_t kArray_string = 0x4385;
  static constexpr Tagged_t karray_to_string = 0x4399;
  static constexpr Tagged_t kArrayBuffer_string = 0x43b5;
  static constexpr Tagged_t kArrayIterator_string = 0x43cd;
  static constexpr Tagged_t kas_string = 0x43e9;
  static constexpr Tagged_t kassert_string = 0x43f9;
  static constexpr Tagged_t kasync_string = 0x440d;
  static constexpr Tagged_t kAtomicsCondition_string = 0x4421;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4441;
  static constexpr Tagged_t kauto_string = 0x445d;
  static constexpr Tagged_t kBigInt_string = 0x446d;
  static constexpr Tagged_t kbigint_string = 0x4481;
  static constexpr Tagged_t kBigInt64Array_string = 0x4495;
  static constexpr Tagged_t kBigUint64Array_string = 0x44b1;
  static constexpr Tagged_t kbind_string = 0x44cd;
  static constexpr Tagged_t kblank_string = 0x44dd;
  static constexpr Tagged_t kBoolean_string = 0x44f1;
  static constexpr Tagged_t kboolean_string = 0x4505;
  static constexpr Tagged_t kboolean_to_string = 0x4519;
  static constexpr Tagged_t kbound__string = 0x4535;
  static constexpr Tagged_t kbuffer_string = 0x4549;
  static constexpr Tagged_t kbyte_length_string = 0x455d;
  static constexpr Tagged_t kbyte_offset_string = 0x4575;
  static constexpr Tagged_t kCompileError_string = 0x458d;
  static constexpr Tagged_t kcalendar_string = 0x45a5;
  static constexpr Tagged_t kcallee_string = 0x45b9;
  static constexpr Tagged_t kcaller_string = 0x45cd;
  static constexpr Tagged_t kcause_string = 0x45e1;
  static constexpr Tagged_t kcharacter_string = 0x45f5;
  static constexpr Tagged_t kclass_string = 0x460d;
  static constexpr Tagged_t kcode_string = 0x4621;
  static constexpr Tagged_t kcolumn_string = 0x4631;
  static constexpr Tagged_t kcomputed_string = 0x4645;
  static constexpr Tagged_t kconjunction_string = 0x465d;
  static constexpr Tagged_t kconsole_string = 0x4675;
  static constexpr Tagged_t kconstrain_string = 0x4689;
  static constexpr Tagged_t kconstruct_string = 0x46a1;
  static constexpr Tagged_t kcurrent_string = 0x46b9;
  static constexpr Tagged_t kDate_string = 0x46cd;
  static constexpr Tagged_t kdate_to_string = 0x46dd;
  static constexpr Tagged_t kdateAdd_string = 0x46f9;
  static constexpr Tagged_t kdateFromFields_string = 0x470d;
  static constexpr Tagged_t kdateUntil_string = 0x4729;
  static constexpr Tagged_t kday_string = 0x4741;
  static constexpr Tagged_t kdayOfWeek_string = 0x4751;
  static constexpr Tagged_t kdayOfYear_string = 0x4769;
  static constexpr Tagged_t kdays_string = 0x4781;
  static constexpr Tagged_t kdaysInMonth_string = 0x4791;
  static constexpr Tagged_t kdaysInWeek_string = 0x47a9;
  static constexpr Tagged_t kdaysInYear_string = 0x47c1;
  static constexpr Tagged_t kdefault_string = 0x47d9;
  static constexpr Tagged_t kdefineProperty_string = 0x47ed;
  static constexpr Tagged_t kdeleteProperty_string = 0x4809;
  static constexpr Tagged_t kdetached_string = 0x4825;
  static constexpr Tagged_t kdisjunction_string = 0x4839;
  static constexpr Tagged_t kdisposed_string = 0x4851;
  static constexpr Tagged_t kdone_string = 0x4865;
  static constexpr Tagged_t kdot_brand_string = 0x4875;
  static constexpr Tagged_t kdot_catch_string = 0x4889;
  static constexpr Tagged_t kdot_default_string = 0x489d;
  static constexpr Tagged_t kdot_for_string = 0x48b1;
  static constexpr Tagged_t kdot_generator_object_string = 0x48c1;
  static constexpr Tagged_t kdot_home_object_string = 0x48e1;
  static constexpr Tagged_t kdot_new_target_string = 0x48f9;
  static constexpr Tagged_t knew_target_string = 0x48f9;
  static constexpr Tagged_t kdot_result_string = 0x4911;
  static constexpr Tagged_t kdot_repl_result_string = 0x4925;
  static constexpr Tagged_t kdot_static_home_object_string = 0x493d;
  static constexpr Tagged_t kdot_switch_tag_string = 0x495d;
  static constexpr Tagged_t kdotAll_string = 0x4975;
  static constexpr Tagged_t kError_string = 0x4989;
  static constexpr Tagged_t kEvalError_string = 0x499d;
  static constexpr Tagged_t kelement_string = 0x49b5;
  static constexpr Tagged_t kepochMicroseconds_string = 0x49c9;
  static constexpr Tagged_t kepochMilliseconds_string = 0x49e9;
  static constexpr Tagged_t kepochNanoseconds_string = 0x4a09;
  static constexpr Tagged_t kepochSeconds_string = 0x4a25;
  static constexpr Tagged_t kera_string = 0x4a3d;
  static constexpr Tagged_t keraYear_string = 0x4a4d;
  static constexpr Tagged_t kerror_string = 0x4a61;
  static constexpr Tagged_t kerrors_string = 0x4a75;
  static constexpr Tagged_t kerror_to_string = 0x4a89;
  static constexpr Tagged_t keval_string = 0x4aa5;
  static constexpr Tagged_t kexception_string = 0x4ab5;
  static constexpr Tagged_t kexec_string = 0x4acd;
  static constexpr Tagged_t kfalse_string = 0x4add;
  static constexpr Tagged_t kfield_string = 0x4af1;
  static constexpr Tagged_t kfields_string = 0x4b05;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4b19;
  static constexpr Tagged_t kflags_string = 0x4b39;
  static constexpr Tagged_t kFloat16Array_string = 0x4b4d;
  static constexpr Tagged_t kFloat32Array_string = 0x4b65;
  static constexpr Tagged_t kFloat64Array_string = 0x4b7d;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4b95;
  static constexpr Tagged_t kfrom_string = 0x4bb9;
  static constexpr Tagged_t kFunction_string = 0x4bc9;
  static constexpr Tagged_t kfunction_native_code_string = 0x4bdd;
  static constexpr Tagged_t kfunction_string = 0x4c09;
  static constexpr Tagged_t kfunction_to_string = 0x4c1d;
  static constexpr Tagged_t kGenerator_string = 0x4c3d;
  static constexpr Tagged_t kget_space_string = 0x4c55;
  static constexpr Tagged_t kget_string = 0x4c65;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4c75;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4c99;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4cbd;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4ce1;
  static constexpr Tagged_t kgetter_string = 0x4cfd;
  static constexpr Tagged_t kglobal_string = 0x4d11;
  static constexpr Tagged_t kglobalThis_string = 0x4d25;
  static constexpr Tagged_t kgroups_string = 0x4d3d;
  static constexpr Tagged_t kgrowable_string = 0x4d51;
  static constexpr Tagged_t khas_string = 0x4d65;
  static constexpr Tagged_t khasIndices_string = 0x4d75;
  static constexpr Tagged_t khour_string = 0x4d8d;
  static constexpr Tagged_t khours_string = 0x4d9d;
  static constexpr Tagged_t khoursInDay_string = 0x4db1;
  static constexpr Tagged_t kignoreCase_string = 0x4dc9;
  static constexpr Tagged_t kid_string = 0x4de1;
  static constexpr Tagged_t killegal_access_string = 0x4df1;
  static constexpr Tagged_t killegal_argument_string = 0x4e0d;
  static constexpr Tagged_t kinLeapYear_string = 0x4e29;
  static constexpr Tagged_t kindex_string = 0x4e41;
  static constexpr Tagged_t kindices_string = 0x4e55;
  static constexpr Tagged_t kInfinity_string = 0x4e69;
  static constexpr Tagged_t kinfinity_string = 0x4e7d;
  static constexpr Tagged_t kinput_string = 0x4e91;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4ea5;
  static constexpr Tagged_t kInt16Array_string = 0x4ed1;
  static constexpr Tagged_t kInt32Array_string = 0x4ee9;
  static constexpr Tagged_t kInt8Array_string = 0x4f01;
  static constexpr Tagged_t kisExtensible_string = 0x4f19;
  static constexpr Tagged_t kiso8601_string = 0x4f31;
  static constexpr Tagged_t kisoDay_string = 0x4f45;
  static constexpr Tagged_t kisoHour_string = 0x4f59;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4f6d;
  static constexpr Tagged_t kisoMillisecond_string = 0x4f89;
  static constexpr Tagged_t kisoMinute_string = 0x4fa5;
  static constexpr Tagged_t kisoMonth_string = 0x4fbd;
  static constexpr Tagged_t kisoNanosecond_string = 0x4fd1;
  static constexpr Tagged_t kisoSecond_string = 0x4fed;
  static constexpr Tagged_t kisoYear_string = 0x5005;
  static constexpr Tagged_t kIterator_string = 0x5019;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x502d;
  static constexpr Tagged_t kjsMemoryRange_string = 0x5049;
  static constexpr Tagged_t kkeys_string = 0x5065;
  static constexpr Tagged_t kkind_string = 0x5075;
  static constexpr Tagged_t klargestUnit_string = 0x5085;
  static constexpr Tagged_t klastIndex_string = 0x509d;
  static constexpr Tagged_t klet_string = 0x50b5;
  static constexpr Tagged_t kline_string = 0x50c5;
  static constexpr Tagged_t klinear_string = 0x50d5;
  static constexpr Tagged_t kLinkError_string = 0x50e9;
  static constexpr Tagged_t klong_string = 0x5101;
  static constexpr Tagged_t kMap_string = 0x5111;
  static constexpr Tagged_t kMapIterator_string = 0x5121;
  static constexpr Tagged_t kmax_byte_length_string = 0x5139;
  static constexpr Tagged_t kmedium_string = 0x5155;
  static constexpr Tagged_t kmergeFields_string = 0x5169;
  static constexpr Tagged_t kmessage_string = 0x5181;
  static constexpr Tagged_t kmeta_string = 0x5195;
  static constexpr Tagged_t kmethod_string = 0x51a5;
  static constexpr Tagged_t kminus_Infinity_string = 0x51b9;
  static constexpr Tagged_t kmicrosecond_string = 0x51d1;
  static constexpr Tagged_t kmicroseconds_string = 0x51e9;
  static constexpr Tagged_t kmillisecond_string = 0x5201;
  static constexpr Tagged_t kmilliseconds_string = 0x5219;
  static constexpr Tagged_t kminute_string = 0x5231;
  static constexpr Tagged_t kminutes_string = 0x5245;
  static constexpr Tagged_t kModule_string = 0x5259;
  static constexpr Tagged_t kmonth_string = 0x526d;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5281;
  static constexpr Tagged_t kmonths_string = 0x52a1;
  static constexpr Tagged_t kmonthsInYear_string = 0x52b5;
  static constexpr Tagged_t kmonthCode_string = 0x52cd;
  static constexpr Tagged_t kmultiline_string = 0x52e5;
  static constexpr Tagged_t kNaN_string = 0x52fd;
  static constexpr Tagged_t knanosecond_string = 0x530d;
  static constexpr Tagged_t knanoseconds_string = 0x5325;
  static constexpr Tagged_t knarrow_string = 0x533d;
  static constexpr Tagged_t knative_string = 0x5351;
  static constexpr Tagged_t kNFC_string = 0x5365;
  static constexpr Tagged_t kNFD_string = 0x5375;
  static constexpr Tagged_t kNFKC_string = 0x5385;
  static constexpr Tagged_t kNFKD_string = 0x5395;
  static constexpr Tagged_t knot_equal_string = 0x53a5;
  static constexpr Tagged_t knull_string = 0x53bd;
  static constexpr Tagged_t knull_to_string = 0x53cd;
  static constexpr Tagged_t kNumber_string = 0x53e9;
  static constexpr Tagged_t knumber_string = 0x53fd;
  static constexpr Tagged_t knumber_to_string = 0x5411;
  static constexpr Tagged_t kObject_string = 0x542d;
  static constexpr Tagged_t kobject_string = 0x5441;
  static constexpr Tagged_t kobject_to_string = 0x5455;
  static constexpr Tagged_t kObject_prototype_string = 0x5471;
  static constexpr Tagged_t koffset_string = 0x548d;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x54a1;
  static constexpr Tagged_t kok_string = 0x54c1;
  static constexpr Tagged_t kother_string = 0x54d1;
  static constexpr Tagged_t koverflow_string = 0x54e5;
  static constexpr Tagged_t kownKeys_string = 0x54f9;
  static constexpr Tagged_t kpercent_string = 0x550d;
  static constexpr Tagged_t kplainDate_string = 0x5521;
  static constexpr Tagged_t kplainTime_string = 0x5539;
  static constexpr Tagged_t kposition_string = 0x5551;
  static constexpr Tagged_t kpreventExtensions_string = 0x5565;
  static constexpr Tagged_t kprivate_string = 0x5585;
  static constexpr Tagged_t kprivate_constructor_string = 0x5599;
  static constexpr Tagged_t kPromise_string = 0x55b1;
  static constexpr Tagged_t kpromise_string = 0x55c5;
  static constexpr Tagged_t kproto_string = 0x55d9;
  static constexpr Tagged_t kproxy_string = 0x55f1;
  static constexpr Tagged_t kProxy_string = 0x5605;
  static constexpr Tagged_t kquery_colon_string = 0x5619;
  static constexpr Tagged_t kRangeError_string = 0x5629;
  static constexpr Tagged_t kraw_json_string = 0x5641;
  static constexpr Tagged_t kraw_string = 0x5655;
  static constexpr Tagged_t kReferenceError_string = 0x5665;
  static constexpr Tagged_t kReflectGet_string = 0x5681;
  static constexpr Tagged_t kReflectHas_string = 0x5699;
  static constexpr Tagged_t kRegExp_string = 0x56b1;
  static constexpr Tagged_t kregexp_to_string = 0x56c5;
  static constexpr Tagged_t kreject_string = 0x56e1;
  static constexpr Tagged_t krelativeTo_string = 0x56f5;
  static constexpr Tagged_t kresizable_string = 0x570d;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5725;
  static constexpr Tagged_t kreturn_string = 0x5745;
  static constexpr Tagged_t krevoke_string = 0x5759;
  static constexpr Tagged_t kroundingIncrement_string = 0x576d;
  static constexpr Tagged_t kRuntimeError_string = 0x578d;
  static constexpr Tagged_t kWebAssemblyException_string = 0x57a5;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x57c9;
  static constexpr Tagged_t kScript_string = 0x57e9;
  static constexpr Tagged_t kscript_string = 0x57fd;
  static constexpr Tagged_t ksecond_string = 0x5811;
  static constexpr Tagged_t kseconds_string = 0x5825;
  static constexpr Tagged_t kshort_string = 0x5839;
  static constexpr Tagged_t kSet_string = 0x584d;
  static constexpr Tagged_t ksentence_string = 0x585d;
  static constexpr Tagged_t kset_space_string = 0x5871;
  static constexpr Tagged_t kset_string = 0x5881;
  static constexpr Tagged_t kSetIterator_string = 0x5891;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x58a9;
  static constexpr Tagged_t ksetter_string = 0x58c5;
  static constexpr Tagged_t kShadowRealm_string = 0x58d9;
  static constexpr Tagged_t kSharedArray_string = 0x58f1;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5909;
  static constexpr Tagged_t kSharedStruct_string = 0x5929;
  static constexpr Tagged_t ksign_string = 0x5941;
  static constexpr Tagged_t ksize_string = 0x5951;
  static constexpr Tagged_t ksmallestUnit_string = 0x5961;
  static constexpr Tagged_t ksource_string = 0x5979;
  static constexpr Tagged_t ksourceText_string = 0x598d;
  static constexpr Tagged_t kstack_string = 0x59a5;
  static constexpr Tagged_t kstackTraceLimit_string = 0x59b9;
  static constexpr Tagged_t kstatic_string = 0x59d5;
  static constexpr Tagged_t kstatic_initializer_string = 0x59e9;
  static constexpr Tagged_t ksticky_string = 0x5a09;
  static constexpr Tagged_t kString_string = 0x5a1d;
  static constexpr Tagged_t kstring_string = 0x5a31;
  static constexpr Tagged_t kstring_to_string = 0x5a45;
  static constexpr Tagged_t ksuppressed_string = 0x5a61;
  static constexpr Tagged_t kSuppressedError_string = 0x5a79;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5a95;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5ab1;
  static constexpr Tagged_t kSymbol_replace_string = 0x5acd;
  static constexpr Tagged_t ksymbol_species_string = 0x5ae9;
  static constexpr Tagged_t kSymbol_species_string = 0x5b05;
  static constexpr Tagged_t kSymbol_split_string = 0x5b21;
  static constexpr Tagged_t kSymbol_string = 0x5b39;
  static constexpr Tagged_t ksymbol_string = 0x5b4d;
  static constexpr Tagged_t kSyntaxError_string = 0x5b61;
  static constexpr Tagged_t ktarget_string = 0x5b79;
  static constexpr Tagged_t kthis_function_string = 0x5b8d;
  static constexpr Tagged_t kthis_string = 0x5ba9;
  static constexpr Tagged_t kthrow_string = 0x5bb9;
  static constexpr Tagged_t ktimed_out_string = 0x5bcd;
  static constexpr Tagged_t ktimeZone_string = 0x5be5;
  static constexpr Tagged_t ktoJSON_string = 0x5bf9;
  static constexpr Tagged_t ktoString_string = 0x5c0d;
  static constexpr Tagged_t ktrue_string = 0x5c21;
  static constexpr Tagged_t ktotal_string = 0x5c31;
  static constexpr Tagged_t kTypeError_string = 0x5c45;
  static constexpr Tagged_t kUint16Array_string = 0x5c5d;
  static constexpr Tagged_t kUint32Array_string = 0x5c75;
  static constexpr Tagged_t kUint8Array_string = 0x5c8d;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5ca5;
  static constexpr Tagged_t kundefined_string = 0x5cc5;
  static constexpr Tagged_t kundefined_to_string = 0x5cdd;
  static constexpr Tagged_t kunicode_string = 0x5cfd;
  static constexpr Tagged_t kunicodeSets_string = 0x5d11;
  static constexpr Tagged_t kunit_string = 0x5d29;
  static constexpr Tagged_t kURIError_string = 0x5d39;
  static constexpr Tagged_t kUTC_string = 0x5d4d;
  static constexpr Tagged_t kWeakMap_string = 0x5d5d;
  static constexpr Tagged_t kWeakRef_string = 0x5d71;
  static constexpr Tagged_t kWeakSet_string = 0x5d85;
  static constexpr Tagged_t kweek_string = 0x5d99;
  static constexpr Tagged_t kweeks_string = 0x5da9;
  static constexpr Tagged_t kweekOfYear_string = 0x5dbd;
  static constexpr Tagged_t kwith_string = 0x5dd5;
  static constexpr Tagged_t kword_string = 0x5de5;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5df5;
  static constexpr Tagged_t kyear_string = 0x5e15;
  static constexpr Tagged_t kyears_string = 0x5e25;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5e39;
  static constexpr Tagged_t kHashTableHoleValue = 0x5e45;
  static constexpr Tagged_t kPromiseHoleValue = 0x5e51;
  static constexpr Tagged_t kUninitializedValue = 0x5e5d;
  static constexpr Tagged_t kArgumentsMarker = 0x5e69;
  static constexpr Tagged_t kTerminationException = 0x5e75;
  static constexpr Tagged_t kException = 0x5e81;
  static constexpr Tagged_t kOptimizedOut = 0x5e8d;
  static constexpr Tagged_t kStaleRegister = 0x5e99;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5ea5;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5eb1;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5ebd;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5ecd;
  static constexpr Tagged_t kclass_fields_symbol = 0x5edd;
  static constexpr Tagged_t kclass_positions_symbol = 0x5eed;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5efd;
  static constexpr Tagged_t kerror_message_symbol = 0x5f0d;
  static constexpr Tagged_t kerror_script_symbol = 0x5f1d;
  static constexpr Tagged_t kerror_stack_symbol = 0x5f2d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5f3d;
  static constexpr Tagged_t kfrozen_symbol = 0x5f4d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5f5d;
  static constexpr Tagged_t knative_context_index_symbol = 0x5f6d;
  static constexpr Tagged_t knonextensible_symbol = 0x5f7d;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5f8d;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5f9d;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5fad;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5fbd;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5fcd;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5fdd;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5fed;
  static constexpr Tagged_t ksealed_symbol = 0x5ffd;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x600d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x601d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x602d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x603d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x604d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x605d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x606d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x607d;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x608d;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x609d;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x60ad;
  static constexpr Tagged_t kasync_iterator_symbol = 0x60bd;
  static constexpr Tagged_t kintl_fallback_symbol = 0x60ed;
  static constexpr Tagged_t kmatch_symbol = 0x6125;
  static constexpr Tagged_t ksearch_symbol = 0x614d;
  static constexpr Tagged_t kunscopables_symbol = 0x6179;
  static constexpr Tagged_t kdispose_symbol = 0x61a9;
  static constexpr Tagged_t kasync_dispose_symbol = 0x61d5;
  static constexpr Tagged_t khas_instance_symbol = 0x6205;
  static constexpr Tagged_t kto_string_tag_symbol = 0x6235;
  static constexpr Tagged_t kconstructor_string = 0x62ad;
  static constexpr Tagged_t knext_string = 0x62c5;
  static constexpr Tagged_t kresolve_string = 0x62d5;
  static constexpr Tagged_t kthen_string = 0x62e9;
  static constexpr Tagged_t kvalueOf_string = 0x62f9;
  static constexpr Tagged_t kiterator_symbol = 0x630d;
  static constexpr Tagged_t kmatch_all_symbol = 0x631d;
  static constexpr Tagged_t kreplace_symbol = 0x632d;
  static constexpr Tagged_t kspecies_symbol = 0x633d;
  static constexpr Tagged_t ksplit_symbol = 0x634d;
  static constexpr Tagged_t kto_primitive_symbol = 0x635d;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x636d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x637d;
  static constexpr Tagged_t kEmptySymbolTable = 0x63a1;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x63bd;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x63d1;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x63e5;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x63f1;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x6411;
  static constexpr Tagged_t kNativeScopeInfo = 0x6435;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x644d;
  static constexpr Tagged_t kWasmNullPadding = 0x6465;
...
static constexpr std::array<Tagged_t, 778> StaticReadOnlyRootsPointerTable = {
