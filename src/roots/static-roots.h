...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kaddInitializer_string = 0x426d;
  static constexpr Tagged_t kAggregateError_string = 0x4289;
  static constexpr Tagged_t kalways_string = 0x42a5;
  static constexpr Tagged_t kanonymous_string = 0x42b9;
  static constexpr Tagged_t kapply_string = 0x42d1;
  static constexpr Tagged_t kArguments_string = 0x42e5;
  static constexpr Tagged_t karguments_string = 0x42fd;
  static constexpr Tagged_t karguments_to_string = 0x4315;
  static constexpr Tagged_t kArray_string = 0x4335;
  static constexpr Tagged_t karray_to_string = 0x4349;
  static constexpr Tagged_t kArrayBuffer_string = 0x4365;
  static constexpr Tagged_t kArrayIterator_string = 0x437d;
  static constexpr Tagged_t kaccess_string = 0x4399;
  static constexpr Tagged_t kaccessor_string = 0x43ad;
  static constexpr Tagged_t kas_string = 0x43c1;
  static constexpr Tagged_t kassert_string = 0x43d1;
  static constexpr Tagged_t kasync_string = 0x43e5;
  static constexpr Tagged_t kAtomicsCondition_string = 0x43f9;
  static constexpr Tagged_t kAtomicsMutex_string = 0x4419;
  static constexpr Tagged_t kauto_string = 0x4435;
  static constexpr Tagged_t kBigInt_string = 0x4445;
  static constexpr Tagged_t kbigint_string = 0x4459;
  static constexpr Tagged_t kBigInt64Array_string = 0x446d;
  static constexpr Tagged_t kBigUint64Array_string = 0x4489;
  static constexpr Tagged_t kbind_string = 0x44a5;
  static constexpr Tagged_t kblank_string = 0x44b5;
  static constexpr Tagged_t kBoolean_string = 0x44c9;
  static constexpr Tagged_t kboolean_string = 0x44dd;
  static constexpr Tagged_t kboolean_to_string = 0x44f1;
  static constexpr Tagged_t kbound__string = 0x450d;
  static constexpr Tagged_t kbuffer_string = 0x4521;
  static constexpr Tagged_t kbyte_length_string = 0x4535;
  static constexpr Tagged_t kbyte_offset_string = 0x454d;
  static constexpr Tagged_t kCompileError_string = 0x4565;
  static constexpr Tagged_t kcalendar_string = 0x457d;
  static constexpr Tagged_t kcallee_string = 0x4591;
  static constexpr Tagged_t kcaller_string = 0x45a5;
  static constexpr Tagged_t kcause_string = 0x45b9;
  static constexpr Tagged_t kcharacter_string = 0x45cd;
  static constexpr Tagged_t kclass_string = 0x45e5;
  static constexpr Tagged_t kcode_string = 0x45f9;
  static constexpr Tagged_t kcolumn_string = 0x4609;
  static constexpr Tagged_t kcomputed_string = 0x461d;
  static constexpr Tagged_t kconjunction_string = 0x4635;
  static constexpr Tagged_t kconsole_string = 0x464d;
  static constexpr Tagged_t kconstrain_string = 0x4661;
  static constexpr Tagged_t kconstruct_string = 0x4679;
  static constexpr Tagged_t kcurrent_string = 0x4691;
  static constexpr Tagged_t kDate_string = 0x46a5;
  static constexpr Tagged_t kdate_to_string = 0x46b5;
  static constexpr Tagged_t kdateAdd_string = 0x46d1;
  static constexpr Tagged_t kdateFromFields_string = 0x46e5;
  static constexpr Tagged_t kdateUntil_string = 0x4701;
  static constexpr Tagged_t kday_string = 0x4719;
  static constexpr Tagged_t kdayOfWeek_string = 0x4729;
  static constexpr Tagged_t kdayOfYear_string = 0x4741;
  static constexpr Tagged_t kdays_string = 0x4759;
  static constexpr Tagged_t kdaysInMonth_string = 0x4769;
  static constexpr Tagged_t kdaysInWeek_string = 0x4781;
  static constexpr Tagged_t kdaysInYear_string = 0x4799;
  static constexpr Tagged_t kdefault_string = 0x47b1;
  static constexpr Tagged_t kdefineProperty_string = 0x47c5;
  static constexpr Tagged_t kdeleteProperty_string = 0x47e1;
  static constexpr Tagged_t kdetached_string = 0x47fd;
  static constexpr Tagged_t kdisjunction_string = 0x4811;
  static constexpr Tagged_t kdisposed_string = 0x4829;
  static constexpr Tagged_t kdone_string = 0x483d;
  static constexpr Tagged_t kdot_brand_string = 0x484d;
  static constexpr Tagged_t kdot_catch_string = 0x4861;
  static constexpr Tagged_t kdot_default_string = 0x4875;
  static constexpr Tagged_t kdot_for_string = 0x4889;
  static constexpr Tagged_t kdot_generator_object_string = 0x4899;
  static constexpr Tagged_t kdot_home_object_string = 0x48b9;
  static constexpr Tagged_t kdot_new_target_string = 0x48d1;
  static constexpr Tagged_t knew_target_string = 0x48d1;
  static constexpr Tagged_t kdot_result_string = 0x48e9;
  static constexpr Tagged_t kdot_repl_result_string = 0x48fd;
  static constexpr Tagged_t kdot_static_home_object_string = 0x4915;
  static constexpr Tagged_t kdot_switch_tag_string = 0x4935;
  static constexpr Tagged_t kdotAll_string = 0x494d;
  static constexpr Tagged_t kError_string = 0x4961;
  static constexpr Tagged_t kEvalError_string = 0x4975;
  static constexpr Tagged_t kelement_string = 0x498d;
  static constexpr Tagged_t kepochMicroseconds_string = 0x49a1;
  static constexpr Tagged_t kepochMilliseconds_string = 0x49c1;
  static constexpr Tagged_t kepochNanoseconds_string = 0x49e1;
  static constexpr Tagged_t kepochSeconds_string = 0x49fd;
  static constexpr Tagged_t kera_string = 0x4a15;
  static constexpr Tagged_t keraYear_string = 0x4a25;
  static constexpr Tagged_t kerror_string = 0x4a39;
  static constexpr Tagged_t kerrors_string = 0x4a4d;
  static constexpr Tagged_t kerror_to_string = 0x4a61;
  static constexpr Tagged_t keval_string = 0x4a7d;
  static constexpr Tagged_t kexception_string = 0x4a8d;
  static constexpr Tagged_t kexec_string = 0x4aa5;
  static constexpr Tagged_t kfalse_string = 0x4ab5;
  static constexpr Tagged_t kfield_string = 0x4ac9;
  static constexpr Tagged_t kfields_string = 0x4add;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4af1;
  static constexpr Tagged_t kflags_string = 0x4b11;
  static constexpr Tagged_t kFloat16Array_string = 0x4b25;
  static constexpr Tagged_t kFloat32Array_string = 0x4b3d;
  static constexpr Tagged_t kFloat64Array_string = 0x4b55;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4b6d;
  static constexpr Tagged_t kfrom_string = 0x4b91;
  static constexpr Tagged_t kFunction_string = 0x4ba1;
  static constexpr Tagged_t kfunction_native_code_string = 0x4bb5;
  static constexpr Tagged_t kfunction_string = 0x4be1;
  static constexpr Tagged_t kfunction_to_string = 0x4bf5;
  static constexpr Tagged_t kGenerator_string = 0x4c15;
  static constexpr Tagged_t kget_space_string = 0x4c2d;
  static constexpr Tagged_t kget_string = 0x4c3d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4c4d;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4c71;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4c95;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4cb9;
  static constexpr Tagged_t kgetter_string = 0x4cd5;
  static constexpr Tagged_t kglobal_string = 0x4ce9;
  static constexpr Tagged_t kglobalThis_string = 0x4cfd;
  static constexpr Tagged_t kgroups_string = 0x4d15;
  static constexpr Tagged_t kgrowable_string = 0x4d29;
  static constexpr Tagged_t khas_string = 0x4d3d;
  static constexpr Tagged_t khasIndices_string = 0x4d4d;
  static constexpr Tagged_t khour_string = 0x4d65;
  static constexpr Tagged_t khours_string = 0x4d75;
  static constexpr Tagged_t khoursInDay_string = 0x4d89;
  static constexpr Tagged_t kignoreCase_string = 0x4da1;
  static constexpr Tagged_t kid_string = 0x4db9;
  static constexpr Tagged_t killegal_access_string = 0x4dc9;
  static constexpr Tagged_t killegal_argument_string = 0x4de5;
  static constexpr Tagged_t kinLeapYear_string = 0x4e01;
  static constexpr Tagged_t kindex_string = 0x4e19;
  static constexpr Tagged_t kindices_string = 0x4e2d;
  static constexpr Tagged_t kInfinity_string = 0x4e41;
  static constexpr Tagged_t kinfinity_string = 0x4e55;
  static constexpr Tagged_t kinput_string = 0x4e69;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4e7d;
  static constexpr Tagged_t kInt16Array_string = 0x4ea9;
  static constexpr Tagged_t kInt32Array_string = 0x4ec1;
  static constexpr Tagged_t kInt8Array_string = 0x4ed9;
  static constexpr Tagged_t kisExtensible_string = 0x4ef1;
  static constexpr Tagged_t kiso8601_string = 0x4f09;
  static constexpr Tagged_t kisoDay_string = 0x4f1d;
  static constexpr Tagged_t kisoHour_string = 0x4f31;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4f45;
  static constexpr Tagged_t kisoMillisecond_string = 0x4f61;
  static constexpr Tagged_t kisoMinute_string = 0x4f7d;
  static constexpr Tagged_t kisoMonth_string = 0x4f95;
  static constexpr Tagged_t kisoNanosecond_string = 0x4fa9;
  static constexpr Tagged_t kisoSecond_string = 0x4fc5;
  static constexpr Tagged_t kisoYear_string = 0x4fdd;
  static constexpr Tagged_t kIterator_string = 0x4ff1;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x5005;
  static constexpr Tagged_t kjsMemoryRange_string = 0x5021;
  static constexpr Tagged_t kkeys_string = 0x503d;
  static constexpr Tagged_t kkind_string = 0x504d;
  static constexpr Tagged_t klargestUnit_string = 0x505d;
  static constexpr Tagged_t klastIndex_string = 0x5075;
  static constexpr Tagged_t klet_string = 0x508d;
  static constexpr Tagged_t kline_string = 0x509d;
  static constexpr Tagged_t klinear_string = 0x50ad;
  static constexpr Tagged_t kLinkError_string = 0x50c1;
  static constexpr Tagged_t klong_string = 0x50d9;
  static constexpr Tagged_t kMap_string = 0x50e9;
  static constexpr Tagged_t kMapIterator_string = 0x50f9;
  static constexpr Tagged_t kmax_byte_length_string = 0x5111;
  static constexpr Tagged_t kmedium_string = 0x512d;
  static constexpr Tagged_t kmergeFields_string = 0x5141;
  static constexpr Tagged_t kmessage_string = 0x5159;
  static constexpr Tagged_t kmeta_string = 0x516d;
  static constexpr Tagged_t kmethod_string = 0x517d;
  static constexpr Tagged_t kminus_Infinity_string = 0x5191;
  static constexpr Tagged_t kmicrosecond_string = 0x51a9;
  static constexpr Tagged_t kmicroseconds_string = 0x51c1;
  static constexpr Tagged_t kmillisecond_string = 0x51d9;
  static constexpr Tagged_t kmilliseconds_string = 0x51f1;
  static constexpr Tagged_t kminute_string = 0x5209;
  static constexpr Tagged_t kminutes_string = 0x521d;
  static constexpr Tagged_t kModule_string = 0x5231;
  static constexpr Tagged_t kmonth_string = 0x5245;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5259;
  static constexpr Tagged_t kmonths_string = 0x5279;
  static constexpr Tagged_t kmonthsInYear_string = 0x528d;
  static constexpr Tagged_t kmonthCode_string = 0x52a5;
  static constexpr Tagged_t kmultiline_string = 0x52bd;
  static constexpr Tagged_t kNaN_string = 0x52d5;
  static constexpr Tagged_t knanosecond_string = 0x52e5;
  static constexpr Tagged_t knanoseconds_string = 0x52fd;
  static constexpr Tagged_t knarrow_string = 0x5315;
  static constexpr Tagged_t knative_string = 0x5329;
  static constexpr Tagged_t kNFC_string = 0x533d;
  static constexpr Tagged_t kNFD_string = 0x534d;
  static constexpr Tagged_t kNFKC_string = 0x535d;
  static constexpr Tagged_t kNFKD_string = 0x536d;
  static constexpr Tagged_t knot_equal_string = 0x537d;
  static constexpr Tagged_t knull_string = 0x5395;
  static constexpr Tagged_t knull_to_string = 0x53a5;
  static constexpr Tagged_t kNumber_string = 0x53c1;
  static constexpr Tagged_t knumber_string = 0x53d5;
  static constexpr Tagged_t knumber_to_string = 0x53e9;
  static constexpr Tagged_t kObject_string = 0x5405;
  static constexpr Tagged_t kobject_string = 0x5419;
  static constexpr Tagged_t kobject_to_string = 0x542d;
  static constexpr Tagged_t kObject_prototype_string = 0x5449;
  static constexpr Tagged_t koffset_string = 0x5465;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5479;
  static constexpr Tagged_t kok_string = 0x5499;
  static constexpr Tagged_t kother_string = 0x54a9;
  static constexpr Tagged_t koverflow_string = 0x54bd;
  static constexpr Tagged_t kownKeys_string = 0x54d1;
  static constexpr Tagged_t kpercent_string = 0x54e5;
  static constexpr Tagged_t kplainDate_string = 0x54f9;
  static constexpr Tagged_t kplainTime_string = 0x5511;
  static constexpr Tagged_t kprivate_string = 0x5529;
  static constexpr Tagged_t kposition_string = 0x553d;
  static constexpr Tagged_t kpreventExtensions_string = 0x5551;
  static constexpr Tagged_t kprivate_constructor_string = 0x5571;
  static constexpr Tagged_t kPromise_string = 0x5589;
  static constexpr Tagged_t kpromise_string = 0x559d;
  static constexpr Tagged_t kproto_string = 0x55b1;
  static constexpr Tagged_t kproxy_string = 0x55c9;
  static constexpr Tagged_t kProxy_string = 0x55dd;
  static constexpr Tagged_t kquery_colon_string = 0x55f1;
  static constexpr Tagged_t kRangeError_string = 0x5601;
  static constexpr Tagged_t kraw_json_string = 0x5619;
  static constexpr Tagged_t kraw_string = 0x562d;
  static constexpr Tagged_t kReferenceError_string = 0x563d;
  static constexpr Tagged_t kReflectGet_string = 0x5659;
  static constexpr Tagged_t kReflectHas_string = 0x5671;
  static constexpr Tagged_t kRegExp_string = 0x5689;
  static constexpr Tagged_t kregexp_to_string = 0x569d;
  static constexpr Tagged_t kreject_string = 0x56b9;
  static constexpr Tagged_t krelativeTo_string = 0x56cd;
  static constexpr Tagged_t kresizable_string = 0x56e5;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x56fd;
  static constexpr Tagged_t kreturn_string = 0x571d;
  static constexpr Tagged_t krevoke_string = 0x5731;
  static constexpr Tagged_t kroundingIncrement_string = 0x5745;
  static constexpr Tagged_t kRuntimeError_string = 0x5765;
  static constexpr Tagged_t kWebAssemblyException_string = 0x577d;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x57a1;
  static constexpr Tagged_t kScript_string = 0x57c1;
  static constexpr Tagged_t kscript_string = 0x57d5;
  static constexpr Tagged_t ksecond_string = 0x57e9;
  static constexpr Tagged_t kseconds_string = 0x57fd;
  static constexpr Tagged_t kshort_string = 0x5811;
  static constexpr Tagged_t kSet_string = 0x5825;
  static constexpr Tagged_t ksentence_string = 0x5835;
  static constexpr Tagged_t kset_space_string = 0x5849;
  static constexpr Tagged_t kset_string = 0x5859;
  static constexpr Tagged_t kSetIterator_string = 0x5869;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5881;
  static constexpr Tagged_t ksetter_string = 0x589d;
  static constexpr Tagged_t kShadowRealm_string = 0x58b1;
  static constexpr Tagged_t kSharedArray_string = 0x58c9;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x58e1;
  static constexpr Tagged_t kSharedStruct_string = 0x5901;
  static constexpr Tagged_t ksign_string = 0x5919;
  static constexpr Tagged_t ksize_string = 0x5929;
  static constexpr Tagged_t ksmallestUnit_string = 0x5939;
  static constexpr Tagged_t ksource_string = 0x5951;
  static constexpr Tagged_t ksourceText_string = 0x5965;
  static constexpr Tagged_t kstack_string = 0x597d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5991;
  static constexpr Tagged_t kstatic_string = 0x59ad;
  static constexpr Tagged_t kstatic_initializer_string = 0x59c1;
  static constexpr Tagged_t ksticky_string = 0x59e1;
  static constexpr Tagged_t kString_string = 0x59f5;
  static constexpr Tagged_t kstring_string = 0x5a09;
  static constexpr Tagged_t kstring_to_string = 0x5a1d;
  static constexpr Tagged_t ksuppressed_string = 0x5a39;
  static constexpr Tagged_t kSuppressedError_string = 0x5a51;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5a6d;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5a89;
  static constexpr Tagged_t kSymbol_replace_string = 0x5aa5;
  static constexpr Tagged_t ksymbol_species_string = 0x5ac1;
  static constexpr Tagged_t kSymbol_species_string = 0x5add;
  static constexpr Tagged_t kSymbol_split_string = 0x5af9;
  static constexpr Tagged_t kSymbol_string = 0x5b11;
  static constexpr Tagged_t ksymbol_string = 0x5b25;
  static constexpr Tagged_t kSyntaxError_string = 0x5b39;
  static constexpr Tagged_t ktarget_string = 0x5b51;
  static constexpr Tagged_t kthis_function_string = 0x5b65;
  static constexpr Tagged_t kthis_string = 0x5b81;
  static constexpr Tagged_t kthrow_string = 0x5b91;
  static constexpr Tagged_t ktimed_out_string = 0x5ba5;
  static constexpr Tagged_t ktimeZone_string = 0x5bbd;
  static constexpr Tagged_t ktoJSON_string = 0x5bd1;
  static constexpr Tagged_t ktoString_string = 0x5be5;
  static constexpr Tagged_t ktrue_string = 0x5bf9;
  static constexpr Tagged_t ktotal_string = 0x5c09;
  static constexpr Tagged_t kTypeError_string = 0x5c1d;
  static constexpr Tagged_t kUint16Array_string = 0x5c35;
  static constexpr Tagged_t kUint32Array_string = 0x5c4d;
  static constexpr Tagged_t kUint8Array_string = 0x5c65;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5c7d;
  static constexpr Tagged_t kundefined_string = 0x5c9d;
  static constexpr Tagged_t kundefined_to_string = 0x5cb5;
  static constexpr Tagged_t kunicode_string = 0x5cd5;
  static constexpr Tagged_t kunicodeSets_string = 0x5ce9;
  static constexpr Tagged_t kunit_string = 0x5d01;
  static constexpr Tagged_t kURIError_string = 0x5d11;
  static constexpr Tagged_t kUTC_string = 0x5d25;
  static constexpr Tagged_t kWeakMap_string = 0x5d35;
  static constexpr Tagged_t kWeakRef_string = 0x5d49;
  static constexpr Tagged_t kWeakSet_string = 0x5d5d;
  static constexpr Tagged_t kweek_string = 0x5d71;
  static constexpr Tagged_t kweeks_string = 0x5d81;
  static constexpr Tagged_t kweekOfYear_string = 0x5d95;
  static constexpr Tagged_t kwith_string = 0x5dad;
  static constexpr Tagged_t kword_string = 0x5dbd;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5dcd;
  static constexpr Tagged_t kyear_string = 0x5ded;
  static constexpr Tagged_t kyears_string = 0x5dfd;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5e11;
  static constexpr Tagged_t kHashTableHoleValue = 0x5e1d;
  static constexpr Tagged_t kPromiseHoleValue = 0x5e29;
  static constexpr Tagged_t kUninitializedValue = 0x5e35;
  static constexpr Tagged_t kArgumentsMarker = 0x5e41;
  static constexpr Tagged_t kTerminationException = 0x5e4d;
  static constexpr Tagged_t kException = 0x5e59;
  static constexpr Tagged_t kOptimizedOut = 0x5e65;
  static constexpr Tagged_t kStaleRegister = 0x5e71;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5e7d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5e89;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5e95;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5ea5;
  static constexpr Tagged_t kclass_fields_symbol = 0x5eb5;
  static constexpr Tagged_t kclass_positions_symbol = 0x5ec5;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5ed5;
  static constexpr Tagged_t kerror_message_symbol = 0x5ee5;
  static constexpr Tagged_t kerror_script_symbol = 0x5ef5;
  static constexpr Tagged_t kerror_stack_symbol = 0x5f05;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5f15;
  static constexpr Tagged_t kfrozen_symbol = 0x5f25;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5f35;
  static constexpr Tagged_t knative_context_index_symbol = 0x5f45;
  static constexpr Tagged_t knonextensible_symbol = 0x5f55;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5f65;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5f75;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5f85;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5f95;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5fa5;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5fb5;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5fc5;
  static constexpr Tagged_t ksealed_symbol = 0x5fd5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5fe5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5ff5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x6005;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x6015;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x6025;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x6035;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x6045;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x6055;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x6065;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x6075;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x6085;
  static constexpr Tagged_t kasync_iterator_symbol = 0x6095;
  static constexpr Tagged_t kintl_fallback_symbol = 0x60c5;
  static constexpr Tagged_t kmatch_symbol = 0x60fd;
  static constexpr Tagged_t ksearch_symbol = 0x6125;
  static constexpr Tagged_t kunscopables_symbol = 0x6151;
  static constexpr Tagged_t kdispose_symbol = 0x6181;
  static constexpr Tagged_t kasync_dispose_symbol = 0x61ad;
  static constexpr Tagged_t khas_instance_symbol = 0x61dd;
  static constexpr Tagged_t kto_string_tag_symbol = 0x620d;
  static constexpr Tagged_t kconstructor_string = 0x6285;
  static constexpr Tagged_t knext_string = 0x629d;
  static constexpr Tagged_t kresolve_string = 0x62ad;
  static constexpr Tagged_t kthen_string = 0x62c1;
  static constexpr Tagged_t kvalueOf_string = 0x62d1;
  static constexpr Tagged_t kiterator_symbol = 0x62e5;
  static constexpr Tagged_t kmatch_all_symbol = 0x62f5;
  static constexpr Tagged_t kreplace_symbol = 0x6305;
  static constexpr Tagged_t kspecies_symbol = 0x6315;
  static constexpr Tagged_t ksplit_symbol = 0x6325;
  static constexpr Tagged_t kto_primitive_symbol = 0x6335;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6345;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6355;
  static constexpr Tagged_t kEmptySymbolTable = 0x6379;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6395;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x63a9;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x63bd;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x63c9;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x63e9;
  static constexpr Tagged_t kNativeScopeInfo = 0x640d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6425;
  static constexpr Tagged_t kWasmNullPadding = 0x643d;
...
static constexpr std::array<Tagged_t, 777> StaticReadOnlyRootsPointerTable = {
