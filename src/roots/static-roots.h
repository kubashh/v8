...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kpromise_debug_marker_symbol = 0x5dad;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5dbd;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5dcd;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5ddd;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5ded;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5dfd;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5e0d;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5e1d;
  static constexpr Tagged_t ksealed_symbol = 0x5e2d;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5e3d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5e4d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5e5d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e6d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e7d;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e8d;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e9d;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5ead;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5ebd;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5ecd;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5edd;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5eed;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5f1d;
  static constexpr Tagged_t kmatch_symbol = 0x5f55;
  static constexpr Tagged_t ksearch_symbol = 0x5f7d;
  ...
  static constexpr Tagged_t kmatch_all_symbol = 0x60ed;
  static constexpr Tagged_t kreplace_symbol = 0x60fd;
  static constexpr Tagged_t kspecies_symbol = 0x610d;
  static constexpr Tagged_t ksplit_symbol = 0x611d;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x612d;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x613d;
  static constexpr Tagged_t kEmptySymbolTable = 0x6161;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x617d;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6191;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x61a5;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x61b1;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x61d1;
  static constexpr Tagged_t kNativeScopeInfo = 0x61f5;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x620d;
  static constexpr Tagged_t kEmptyExternalPointerArray = 0x6225;
  static constexpr Tagged_t kWasmNullPadding = 0x622d;
