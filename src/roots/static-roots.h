...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kglobal_string = 0x4cfd;
  static constexpr Tagged_t kglobalThis_string = 0x4d11;
  static constexpr Tagged_t kgroups_string = 0x4d29;
  static constexpr Tagged_t kgrowable_string = 0x4d3d;
  static constexpr Tagged_t khas_string = 0x4d51;
  static constexpr Tagged_t khasIndices_string = 0x4d61;
  static constexpr Tagged_t khour_string = 0x4d79;
  static constexpr Tagged_t khours_string = 0x4d89;
  static constexpr Tagged_t khoursInDay_string = 0x4d9d;
  static constexpr Tagged_t kignoreCase_string = 0x4db5;
  static constexpr Tagged_t kid_string = 0x4dcd;
  static constexpr Tagged_t killegal_access_string = 0x4ddd;
  static constexpr Tagged_t killegal_argument_string = 0x4df9;
  static constexpr Tagged_t kinLeapYear_string = 0x4e15;
  static constexpr Tagged_t kindex_string = 0x4e2d;
  static constexpr Tagged_t kindices_string = 0x4e41;
  static constexpr Tagged_t kInfinity_string = 0x4e55;
  static constexpr Tagged_t kinfinity_string = 0x4e69;
  static constexpr Tagged_t kinput_string = 0x4e7d;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4e91;
  static constexpr Tagged_t kInt16Array_string = 0x4ebd;
  static constexpr Tagged_t kInt32Array_string = 0x4ed5;
  static constexpr Tagged_t kInt8Array_string = 0x4eed;
  static constexpr Tagged_t kisExtensible_string = 0x4f05;
  static constexpr Tagged_t kiso8601_string = 0x4f1d;
  static constexpr Tagged_t kisoDay_string = 0x4f31;
  static constexpr Tagged_t kisoHour_string = 0x4f45;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4f59;
  static constexpr Tagged_t kisoMillisecond_string = 0x4f75;
  static constexpr Tagged_t kisoMinute_string = 0x4f91;
  static constexpr Tagged_t kisoMonth_string = 0x4fa9;
  static constexpr Tagged_t kisoNanosecond_string = 0x4fbd;
  static constexpr Tagged_t kisoSecond_string = 0x4fd9;
  static constexpr Tagged_t kisoYear_string = 0x4ff1;
  static constexpr Tagged_t kIterator_string = 0x5005;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x5019;
  static constexpr Tagged_t kjsMemoryRange_string = 0x5035;
  static constexpr Tagged_t kkeys_string = 0x5051;
  static constexpr Tagged_t kkind_string = 0x5061;
  static constexpr Tagged_t klargestUnit_string = 0x5071;
  static constexpr Tagged_t klastIndex_string = 0x5089;
  static constexpr Tagged_t klet_string = 0x50a1;
  static constexpr Tagged_t kline_string = 0x50b1;
  static constexpr Tagged_t klinear_string = 0x50c1;
  static constexpr Tagged_t kLinkError_string = 0x50d5;
  static constexpr Tagged_t klong_string = 0x50ed;
  static constexpr Tagged_t kMap_string = 0x50fd;
  static constexpr Tagged_t kMapIterator_string = 0x510d;
  static constexpr Tagged_t kmax_byte_length_string = 0x5125;
  static constexpr Tagged_t kmedium_string = 0x5141;
  static constexpr Tagged_t kmergeFields_string = 0x5155;
  static constexpr Tagged_t kmessage_string = 0x516d;
  static constexpr Tagged_t kmeta_string = 0x5181;
  ...
  static constexpr Tagged_t kShadowRealm_string = 0x589d;
  static constexpr Tagged_t kSharedArray_string = 0x58b5;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x58cd;
  static constexpr Tagged_t kSharedStruct_string = 0x58ed;
  static constexpr Tagged_t ksign_string = 0x5905;
  static constexpr Tagged_t ksize_string = 0x5915;
  static constexpr Tagged_t ksmallestUnit_string = 0x5925;
  static constexpr Tagged_t ksource_string = 0x593d;
  static constexpr Tagged_t ksourceText_string = 0x5951;
  static constexpr Tagged_t kstack_string = 0x5969;
  static constexpr Tagged_t kstackTraceLimit_string = 0x597d;
  static constexpr Tagged_t kstatic_string = 0x5999;
  static constexpr Tagged_t kstatic_initializer_string = 0x59ad;
  static constexpr Tagged_t ksticky_string = 0x59cd;
  static constexpr Tagged_t kString_string = 0x59e1;
  static constexpr Tagged_t kstring_string = 0x59f5;
  static constexpr Tagged_t kstring_to_string = 0x5a09;
  static constexpr Tagged_t ksuppressed_string = 0x5a25;
  static constexpr Tagged_t kSuppressedError_string = 0x5a3d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5a59;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5a75;
  static constexpr Tagged_t kSymbol_replace_string = 0x5a91;
  static constexpr Tagged_t ksymbol_species_string = 0x5aad;
  static constexpr Tagged_t kSymbol_species_string = 0x5ac9;
  static constexpr Tagged_t kSymbol_split_string = 0x5ae5;
  static constexpr Tagged_t kSymbol_string = 0x5afd;
  static constexpr Tagged_t ksymbol_string = 0x5b11;
  static constexpr Tagged_t kSyntaxError_string = 0x5b25;
  static constexpr Tagged_t ktarget_string = 0x5b3d;
  static constexpr Tagged_t kthis_function_string = 0x5b51;
  static constexpr Tagged_t kthis_string = 0x5b6d;
  static constexpr Tagged_t kthrow_string = 0x5b7d;
  static constexpr Tagged_t ktimed_out_string = 0x5b91;
  static constexpr Tagged_t ktimeZone_string = 0x5ba9;
  static constexpr Tagged_t ktoJSON_string = 0x5bbd;
  static constexpr Tagged_t ktoString_string = 0x5bd1;
  static constexpr Tagged_t ktrue_string = 0x5be5;
  static constexpr Tagged_t ktotal_string = 0x5bf5;
  static constexpr Tagged_t kTypeError_string = 0x5c09;
  static constexpr Tagged_t kUint16Array_string = 0x5c21;
  static constexpr Tagged_t kUint32Array_string = 0x5c39;
  static constexpr Tagged_t kUint8Array_string = 0x5c51;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5c69;
  static constexpr Tagged_t kundefined_string = 0x5c89;
  static constexpr Tagged_t kundefined_to_string = 0x5ca1;
  static constexpr Tagged_t kunicode_string = 0x5cc1;
  static constexpr Tagged_t kunicodeSets_string = 0x5cd5;
  static constexpr Tagged_t kunit_string = 0x5ced;
  static constexpr Tagged_t kURIError_string = 0x5cfd;
  static constexpr Tagged_t kUTC_string = 0x5d11;
  static constexpr Tagged_t kWeakMap_string = 0x5d21;
  static constexpr Tagged_t kWeakRef_string = 0x5d35;
  static constexpr Tagged_t kWeakSet_string = 0x5d49;
  static constexpr Tagged_t kweek_string = 0x5d5d;
  static constexpr Tagged_t kweeks_string = 0x5d6d;
  static constexpr Tagged_t kweekOfYear_string = 0x5d81;
  static constexpr Tagged_t kwith_string = 0x5d99;
  static constexpr Tagged_t kword_string = 0x5da9;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5db9;
  static constexpr Tagged_t kyear_string = 0x5dd9;
  static constexpr Tagged_t kyears_string = 0x5de9;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5dfd;
  static constexpr Tagged_t kHashTableHoleValue = 0x5e09;
  static constexpr Tagged_t kPromiseHoleValue = 0x5e15;
  static constexpr Tagged_t kUninitializedValue = 0x5e21;
  static constexpr Tagged_t kArgumentsMarker = 0x5e2d;
  static constexpr Tagged_t kTerminationException = 0x5e39;
  static constexpr Tagged_t kException = 0x5e45;
  static constexpr Tagged_t kOptimizedOut = 0x5e51;
  static constexpr Tagged_t kStaleRegister = 0x5e5d;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5e69;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5e75;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5e81;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5e91;
  static constexpr Tagged_t kclass_fields_symbol = 0x5ea1;
  static constexpr Tagged_t kclass_positions_symbol = 0x5eb1;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5ec1;
  static constexpr Tagged_t kerror_message_symbol = 0x5ed1;
  static constexpr Tagged_t kerror_script_symbol = 0x5ee1;
  static constexpr Tagged_t kerror_stack_symbol = 0x5ef1;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5f01;
  static constexpr Tagged_t kfrozen_symbol = 0x5f11;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5f21;
  static constexpr Tagged_t knative_context_index_symbol = 0x5f31;
  static constexpr Tagged_t knonextensible_symbol = 0x5f41;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5f51;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5f61;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5f71;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5f81;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5f91;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5fa1;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5fb1;
  static constexpr Tagged_t ksealed_symbol = 0x5fc1;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5fd1;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5fe1;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5ff1;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x6001;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x6011;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x6021;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x6031;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x6041;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x6051;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x6061;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x6071;
  static constexpr Tagged_t kasync_iterator_symbol = 0x6081;
  static constexpr Tagged_t kintl_fallback_symbol = 0x60b1;
  static constexpr Tagged_t kmatch_symbol = 0x60e9;
  static constexpr Tagged_t ksearch_symbol = 0x6111;
  static constexpr Tagged_t kunscopables_symbol = 0x613d;
  static constexpr Tagged_t kdispose_symbol = 0x616d;
  static constexpr Tagged_t kasync_dispose_symbol = 0x6199;
  static constexpr Tagged_t khas_instance_symbol = 0x61c9;
  static constexpr Tagged_t kto_string_tag_symbol = 0x61f9;
  static constexpr Tagged_t kconstructor_string = 0x6271;
  static constexpr Tagged_t knext_string = 0x6289;
  static constexpr Tagged_t kresolve_string = 0x6299;
  static constexpr Tagged_t kthen_string = 0x62ad;
  static constexpr Tagged_t kvalueOf_string = 0x62bd;
  static constexpr Tagged_t kiterator_symbol = 0x62d1;
  static constexpr Tagged_t kmatch_all_symbol = 0x62e1;
  static constexpr Tagged_t kreplace_symbol = 0x62f1;
  static constexpr Tagged_t kspecies_symbol = 0x6301;
  static constexpr Tagged_t ksplit_symbol = 0x6311;
  static constexpr Tagged_t kto_primitive_symbol = 0x6321;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6331;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6341;
  static constexpr Tagged_t kEmptySymbolTable = 0x6365;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6381;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6395;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x63a9;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x63b5;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x63d5;
  static constexpr Tagged_t kNativeScopeInfo = 0x63f9;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6411;
  static constexpr Tagged_t kWasmNullPadding = 0x6429;
