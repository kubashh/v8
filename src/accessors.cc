...
void Accessors::ReconfigureToDataProperty(
  ...
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
...
void Accessors::ArrayLengthGetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::ArrayLengthGetter);
  DisallowHeapAllocation no_allocation;
  HandleScope scope(isolate);
...
void Accessors::ArrayLengthSetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::ArrayLengthSetter);
  HandleScope scope(isolate);
...
void Accessors::StringLengthGetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::StringLengthGetter);
  DisallowHeapAllocation no_allocation;
  HandleScope scope(isolate);
...
void Accessors::FunctionPrototypeGetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::FunctionPrototypeGetter);
  HandleScope scope(isolate);
  Handle<JSFunction> function =
...
void Accessors::FunctionPrototypeSetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::FunctionPrototypeSetter);
  HandleScope scope(isolate);
  Handle<Object> value = Utils::OpenHandle(*val);
...
void Accessors::BoundFunctionNameGetter(
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(info.GetIsolate());
  RuntimeCallTimerScopeWithEnteringBlinkCheck timer(
      isolate, &RuntimeCallStats::BoundFunctionNameGetter);
  HandleScope scope(isolate);
  Handle<JSBoundFunction> function =
      Handle<JSBoundFunction>::cast(Utils::OpenHandle(*info.Holder()));
  Handle<Object> result;
