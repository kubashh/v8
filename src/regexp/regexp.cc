...
Tagged<Object> GetIfWeakOtherwiseZero(Tagged<WeakFixedArray> array, int index) {
  Tagged<HeapObject> heap_object;
...
Tagged<Object> RegExpResultsCache::Lookup(Heap* heap, Tagged<String> key_string,
  ...
  if (GetIfWeakOtherwiseZero(cache, index + kStringOffset) != key_string ||
      GetIfWeakOtherwiseZero(cache, index + kPatternOffset) != key_pattern) {
