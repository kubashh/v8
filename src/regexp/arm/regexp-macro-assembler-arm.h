...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerARM
 ...
 private:
  ...
  static constexpr int kReturnAddressOffset =
      kStoredRegistersOffset + 8 * kPointerSize;
  // Stack parameters placed by caller.
  static constexpr int kRegisterOutputOffset =
      kReturnAddressOffset + kPointerSize;
  static constexpr int kNumOutputRegistersOffset =
      kRegisterOutputOffset + kPointerSize;
  static constexpr int kDirectCallOffset =
      kNumOutputRegistersOffset + kPointerSize;
  static constexpr int kIsolateOffset = kDirectCallOffset + kPointerSize;

  // Below the frame pointer - the stack frame type marker and locals.
  static constexpr int kFrameTypeOffset = kFramePointerOffset - kPointerSize;
  static_assert(kFrameTypeOffset ==
                CommonFrameConstants::kContextOrFrameTypeOffset);
  // Register parameters stored by setup code.
  static constexpr int kInputEndOffset = kFrameTypeOffset - kPointerSize;
  static constexpr int kInputStartOffset = kInputEndOffset - kPointerSize;
  static constexpr int kStartIndexOffset = kInputStartOffset - kPointerSize;
  static constexpr int kInputStringOffset = kStartIndexOffset - kPointerSize;
  // When adding local variables remember to push space for them in
  // the frame in GetCode.
  static constexpr int kSuccessfulCapturesOffset =
      kInputStringOffset - kPointerSize;
  static constexpr int kStringStartMinusOneOffset =
      kSuccessfulCapturesOffset - kPointerSize;
