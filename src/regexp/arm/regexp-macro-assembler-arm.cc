...
Handle<HeapObject> RegExpMacroAssemblerARM::GetCode(Handle<String> source) {
  ...
  static_assert(kFrameTypeOffset == kFramePointerOffset - kPointerSize);
  static_assert(kInputEndOffset == kFrameTypeOffset - kPointerSize);
  static_assert(kInputStartOffset == kInputEndOffset - kPointerSize);
  static_assert(kStartIndexOffset == kInputStartOffset - kPointerSize);
  static_assert(kInputStringOffset == kStartIndexOffset - kPointerSize);
