...
V8_EXPORT_PRIVATE int32_t float32_to_int64_sat_wrapper(Address data);

V8_EXPORT_PRIVATE int32_t float32_to_uint64_sat_wrapper(Address data);

V8_EXPORT_PRIVATE int32_t float64_to_int64_sat_wrapper(Address data);

V8_EXPORT_PRIVATE int32_t float64_to_uint64_sat_wrapper(Address data);
