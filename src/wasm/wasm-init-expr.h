...
class WasmInitExpr : public ZoneObject {
 ...
 private:
  explicit WasmInitExpr(Zone* zone)
      : kind_(kNone), operands_(zone->New<ZoneVector<WasmInitExpr>>(zone)) {}
  Immediate immediate_;
  Operator kind_;
  ZoneVector<WasmInitExpr>* operands_;
};
