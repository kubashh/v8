...
void PrepareFunctionData(i::Isolate* isolate,
  ...
  function_data->set_packed_args_size(i::wasm::ArgumentsPacker::TotalSize(sig));
...
auto Func::call(const Val args[], Val results[]) const -> own<Trap*> {
  ...
  i::wasm::ArgumentsPacker packer(function_data->packed_args_size());
