...
class CompilationStateImpl {
 public:
  ...
  void CommitCompilationUnits(
      ...
      base::Vector<WasmCompilationUnit> top_tier_units,
      base::Vector<std::unique_ptr<JSToWasmWrapperCompilationUnit>>
 ...
 private:
  ...
  // Wrapper compilation units are stored as unique_ptrs because they hold the
  // compilation job as unique_ptr.
  std::vector<std::unique_ptr<JSToWasmWrapperCompilationUnit>>
...
class CompilationUnitBuilder {
 public:
  ...
  void AddJSToWasmWrapperUnit(
      std::unique_ptr<JSToWasmWrapperCompilationUnit> unit) {
...
CompilationStateImpl::GetJSToWasmWrapperCompilationUnit(size_t index) {
  ...
  return js_to_wasm_wrapper_units_[index].get();
}
