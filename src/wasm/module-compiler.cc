...
class CompilationState {
 ...
 private:
  ...
  // accessed concurrently (compilation_units_, executed_units_,
  // finisher_is_running_, num_background_tasks_, failed_).
...
void CompilationState::SetNumberOfFunctionsToCompile(size_t num_functions) {
  // This is being called before spawning background tasks, hence no lock.
  if (!failed_) {
