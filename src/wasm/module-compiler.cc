...
class CompilationStateImpl {
 public:
  ...
  int failed() const { return compile_failed_.load(std::memory_order_relaxed); }
 ...
 private:
  ...
  // Compilation error, atomically updated. If no further synchronization is
  // required, this flag can be updated and read using relaxed semantics.
