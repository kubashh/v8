...
class AsyncCompileJob::PrepareAndStartCompile : public CompileStep {
 ...
 private:
  ...
  void RunInForeground() override {
    ...
    // this object.
    ModuleEnv env = CreateDefaultModuleEnv(job_->module_.get());
    job_->compiled_module_ =
        NewCompiledModule(job_->isolate_, job_->module_.get(), env);
    ...
    if (start_compilation_) {
      ...
      InitializeCompilationUnits(job_->module_->functions, job_->wire_bytes_,
                                 env.module,
