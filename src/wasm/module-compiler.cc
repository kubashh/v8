...
// TODO(kimanh): we can remove this enum and its use by checking if callbacks
// are registered.
...
void CompileInParallel(Isolate* isolate, NativeModule* native_module,
  ...
  //    background threads.
  InitializeCompilationUnits(module->functions, wire_bytes, module,
...
MaybeHandle<WasmModuleObject> CompileToModuleObjectInternal(
  ...
  ModuleEnv env = CreateDefaultModuleEnv(nullptr);
