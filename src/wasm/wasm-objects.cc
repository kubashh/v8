...
#if V8_ENABLE_DRUMBRAKE
    target_func_index_ =
        trusted_target_instance_data->imported_function_indices()->get(
            target_func_index);
#endif  // V8_ENABLE_DRUMBRAKE
  } else {
...
#if V8_ENABLE_DRUMBRAKE
  trusted_instance_data->imported_function_indices()->set(index_, -1);
#endif  // V8_ENABLE_DRUMBRAKE
}
...
void ImportedFunctionEntry::SetWasmToWasm(
  ...
  trusted_instance_data->imported_function_indices()->set(
