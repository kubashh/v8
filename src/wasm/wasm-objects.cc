...
void ImportedFunctionEntry::SetWasmToJs(Isolate* isolate,
  ...
  // Signatures are checked statically for imports.
  static constexpr int kUnusedSigId = -1;
  trusted_instance_data->dispatch_table_for_imports()->Set(
      index_, *ref, wrapper, kUnusedSigId);
}
