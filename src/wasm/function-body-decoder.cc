...
class WasmGraphBuildingConsumer
    : public ConsumerTemplate<true, WasmGraphBuildingConsumer> {
 public:
  struct CValue {
    TFNode* node;
 ...
 private:
  ...
  void DoCall(WasmFullDecoder<true, WasmGraphBuildingConsumer>* decoder,
