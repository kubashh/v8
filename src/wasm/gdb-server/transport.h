...
#ifndef V8_WASM_GDB_SERVER_TRANSPORT_H_
#define V8_WASM_GDB_SERVER_TRANSPORT_H_
...
class SocketBinding {
 public:
  ...
  static std::unique_ptr<SocketBinding> Bind(uint16_t tcp_port);
...
#endif  // V8_WASM_GDB_SERVER_TRANSPORT_H_
