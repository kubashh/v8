...
inline FPUCondition LiftoffConditionToConditionCmpFPU(
    LiftoffCondition liftoff_cond, bool* predicate) {
  switch (liftoff_cond) {
    case kEqual:
      *predicate = true;
      return EQ;
...
void LiftoffAssembler::emit_f32_set_cond(LiftoffCondition liftoff_cond,
  ...
  bool predicate;
  FPUCondition fcond =
      liftoff::LiftoffConditionToConditionCmpFPU(liftoff_cond, &predicate);
