...
void LiftoffAssembler::emit_i32_divs(Register dst, Register lhs, Register rhs,
  ...
  xor_(kScratchReg2, kScratchReg2, kScratchReg2);
  movz(kScratchReg2, rhs, kScratchReg);
  addiu(kScratchReg2, kScratchReg2, 1);
...
bool LiftoffAssembler::emit_i64_divs(LiftoffRegister dst, LiftoffRegister lhs,
  ...
  xori(kScratchReg, kScratchReg, 1);
  xor_(kScratchReg2, kScratchReg2, kScratchReg2);
  movz(kScratchReg2, rhs.gp(), kScratchReg);
  daddiu(kScratchReg2, kScratchReg2, 1);
  MacroAssembler::Branch(trap_div_unrepresentable, eq, kScratchReg2,
                         Operand(zero_reg));
