...
void LiftoffAssembler::emit_f64x2_extract_lane(
...
void LiftoffAssembler::emit_f32x4_extract_lane(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i64x2_extract_lane(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i32x4_extract_lane(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i16x8_extract_lane_u(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i16x8_extract_lane_s(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i8x16_extract_lane_u(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
...
void LiftoffAssembler::emit_i8x16_extract_lane_s(
    LiftoffRegister dst, LiftoffRegister lhs uint8_t imm_lane_idx) {
  // TODO(mips): Support this on loongson 3a4000. Currently, the main MIPS
  // CPU, Loongson 3a3000 does not support MSA(simd128), but the upcoming
  // 3a4000 support MSA.
