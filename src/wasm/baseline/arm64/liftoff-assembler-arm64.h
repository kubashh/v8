...
void LiftoffAssembler::LoadTaggedPointer(Register dst, Register src_addr,
                                         Register offset_reg,
                                         int32_t offset_imm, bool scale) {
  UseScratchRegisterScope temps(this);
  unsigned shift_amount = scale ? COMPRESS_POINTERS_BOOL ? 2 : 3 : 0;
...
namespace {
unsigned LoadTypeShiftAmount(LoadType::LoadTypeValue type) {
  switch (type) {
...
void LiftoffAssembler::Load(LiftoffRegister dst, Register src_addr,
                            ...
                            bool as_index) {
  UseScratchRegisterScope temps(this);
  unsigned shift_amount = as_index ? LoadTypeShiftAmount(type.value()) : 0;
  MemOperand src_op = liftoff::GetMemOp(this, &temps, src_addr, offset_reg,
