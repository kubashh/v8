...
class LiftoffCompiler {
 public:
  ...
  void I32UnOpWithCFallback(bool (LiftoffAssembler::*emit_fn)(Register,
                                                              Register),
...
#define CASE_I32_UNOP(opcode, fn)                                      \
  case WasmOpcode::kExpr##opcode:                                      \
    ...
    break;
#define CASE_F32_UNOP(opcode, fn)                                      \
  case WasmOpcode::kExpr##opcode:                                      \
    EmitUnOp<kWasmF32>([=](LiftoffRegister dst, LiftoffRegister src) { \
    ...
    switch (opcode) {
      ...
      case kExprI32Popcnt:
        I32UnOpWithCFallback(&LiftoffAssembler::emit_i32_popcnt,
