...
class LiftoffCompiler {
 public:
  ...
  void Rethrow(FullDecoder* decoder, Control* try_block) {
    ...
    auto rethrow_sig = MakeSig<ValueKind>().Param(kPointerKind);
  ...
  void EmitFloatUnOpWithCFallback(
    ...
    auto emit_with_c_fallback = [=](LiftoffRegister dst, LiftoffRegister src) {
      ...
      auto sig = MakeSig<ValueKind>().Param(kind);
  ...
  void EmitTypeConversion(FullDecoder* decoder, WasmOpcode opcode,
    ...
    if (!__ emit_type_conversion(opcode, dst, src, trap)) {
      ...
      if (can_trap) {
        ...
        auto sig = MakeSig<ValueKind>().Return(kI32).Param(src_kind);
      ...
      case kExprI32Popcnt:
        return EmitUnOp<kI32, kI32>(
            [=](LiftoffRegister dst, LiftoffRegister src) {
              ...
              auto sig = MakeSig<ValueKind>().Return(kI32).Param(kI32);
      ...
      case kExprI64Popcnt:
        return EmitUnOp<kI64, kI64>(
            [=](LiftoffRegister dst, LiftoffRegister src) {
              ...
              auto sig = MakeSig<ValueKind>().Return(kI32).Param(kI64);
...
#undef CASE_TYPE_CONVERSION
  ...
  void EmitDivOrRem64CCall(LiftoffRegister dst, LiftoffRegister lhs,
    ...
    auto sig = MakeSig<ValueKind>().Return(kI32).Params(kI64, kI64);
...
#undef CASE_CCALL_BINOP
  ...
  void RefFunc(FullDecoder* decoder, uint32_t function_index, Value* result) {
    ...
    auto sig = MakeSig<ValueKind>().Return(kRef).Param(kI32);
  ...
  void EmitSimdFloatRoundingOpWithCFallback(
    ...
    if (!(asm_.*emit_fn)(dst, src)) {
      ...
      auto sig_v_s = MakeSig<ValueKind>().Param(kS128);
...
#undef CASE_SIMD_REPLACE_LANE_OP
  ...
  void Throw(FullDecoder* decoder, const ExceptionIndexImmediate<validate>& imm,
    ...
    auto create_values_sig =
        MakeSig<ValueKind>().Return(kPointerKind).Param(kPointerKind);
    ...
    auto throw_sig = MakeSig<ValueKind>().Params(kPointerKind, kPointerKind);
  ...
  void AtomicNotify(FullDecoder* decoder,
    ...
    auto sig = MakeSig<ValueKind>().Return(kI32).Params(kPointerKind, kI32);
...
#undef ATOMIC_COMPARE_EXCHANGE_LIST
  ...
  void TableInit(FullDecoder* decoder, const TableInitImmediate<validate>& imm,
    ...
    auto sig =
        MakeSig<ValueKind>().Params(kI32, kI32, kI32, kSmiKind, kSmiKind);
  ...
  void TableGrow(FullDecoder* decoder, const TableIndexImmediate<validate>& imm,
    ...
    auto sig = MakeSig<ValueKind>().Return(kSmiKind).Params(kSmiKind, kI32,
                                                            kTaggedKind);
  ...
  void TableFill(FullDecoder* decoder, const TableIndexImmediate<validate>& imm,
    ...
    auto sig = MakeSig<ValueKind>().Params(kSmiKind, kI32, kI32, kTaggedKind);
  ...
  void StructNew(FullDecoder* decoder,
    ...
    compiler::CallDescriptor* call_descriptor =
        GetBuiltinCallDescriptor<WasmAllocateStructWithRttDescriptor>(
            compilation_zone_);
    auto sig = MakeSig<ValueKind>().Return(kRef).Param(rtt.type.kind());
...

    {
      ...
      compiler::CallDescriptor* builtin_call_descriptor =
          GetBuiltinCallDescriptor<WasmAllocatePairDescriptor>(
              compilation_zone_);
      auto builtin_sig =
          MakeSig<ValueKind>().Return(kOptRef).Params(kOptRef, kOptRef);
