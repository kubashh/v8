...
#undef CASE_CCALL_BINOP
  ...
  void TableGet(FullDecoder* decoder, const Value&, Value*,
    ...
    LiftoffAssembler::VarState index = __ cache_state()->stack_state.end()[-1];
    ...
    ValueType sig_reps[] = {env_->module->tables[imm.index].type, kWasmI32,
                            kWasmI32};
  ...
  void TableSet(FullDecoder* decoder, const Value&, const Value&,
    ...
    WasmValue table_index_val(imm.index);
