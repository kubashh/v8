...
#define CASE_TYPE_CONVERSION(opcode, dst_type, src_type, ext_ref, may_trap) \
  case WasmOpcode::kExpr##opcode:                                           \
    ...
    switch (opcode) {
      ...
      CASE_TYPE_CONVERSION(I32ConvertI64, I32, I64, nullptr, false)
      CASE_TYPE_CONVERSION(I32SConvertF32, I32, F32, nullptr, true)
      CASE_TYPE_CONVERSION(I32UConvertF32, I32, F32, nullptr, true)
      CASE_TYPE_CONVERSION(I32SConvertF64, I32, F64, nullptr, true)
      CASE_TYPE_CONVERSION(I32UConvertF64, I32, F64, nullptr, true)
      ...
      CASE_TYPE_CONVERSION(F32SConvertI64, F32, I64,
                           &ExternalReference::wasm_int64_to_float32, false)
      CASE_TYPE_CONVERSION(F32UConvertI64, F32, I64,
                           &ExternalReference::wasm_uint64_to_float32, false)
      CASE_TYPE_CONVERSION(F32ConvertF64, F32, F64, nullptr, false)
      CASE_TYPE_CONVERSION(F32ReinterpretI32, F32, I32, nullptr, false)
      CASE_TYPE_CONVERSION(F64SConvertI32, F64, I32, nullptr, false)
      CASE_TYPE_CONVERSION(F64UConvertI32, F64, I32, nullptr, false)
      CASE_TYPE_CONVERSION(F64SConvertI64, F64, I64,
                           &ExternalReference::wasm_int64_to_float64, false)
      CASE_TYPE_CONVERSION(F64UConvertI64, F64, I64,
                           &ExternalReference::wasm_uint64_to_float64, false)
      CASE_TYPE_CONVERSION(F64ConvertF32, F64, F32, nullptr, false)
      CASE_TYPE_CONVERSION(F64ReinterpretI64, F64, I64, nullptr, false)
      case kExprI32Popcnt:
