  ...
  void SimdOp(FullDecoder* decoder, WasmOpcode opcode, Vector<Value> args,
    ...
    switch (opcode) {
      ...
      case wasm::kExprF64x2Neg:
        EmitUnOp<ValueType::kS128, ValueType::kS128>(
            [=](LiftoffRegister dst, LiftoffRegister src) {
              __ emit_f64x2_neg(dst, src);
            });
        break;
