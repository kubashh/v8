...
// on the chromium side needs to be updated. Deprecating entries is always fine.
// Repurposing works if you don't care about temporary mix-ups. Adding new ones
// is more tricky, and might require introducing a new (updated) histogram.
