...
// Deprecating entries is always fine, as well as repurposing them. Adding the
// ones is more tricky, and might require introducing a new (updated) histogram.
enum LiftoffBailoutReason : int8_t {
  ...
  // Unused reasons, for forward compatibility.
  kUnused2 = 13,
  kUnused3 = 14,
  kUnused4 = 15,
