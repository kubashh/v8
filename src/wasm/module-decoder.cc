...
#undef BYTES
 ...
 private:
  ...
  WasmInitExpr consume_init_expr(WasmModule* module, ValueType expected) {
    ...
    switch (opcode) {
      case kExprGetGlobal: {
        GlobalIndexOperand<Decoder::kChecked> operand(this, pc() - 1);
      ...
      case kExprI32Const: {
        ImmI32Operand<Decoder::kChecked> operand(this, pc() - 1);
      ...
      case kExprF32Const: {
        ImmF32Operand<Decoder::kChecked> operand(this, pc() - 1);
      ...
      case kExprI64Const: {
        ImmI64Operand<Decoder::kChecked> operand(this, pc() - 1);
      ...
      case kExprF64Const: {
        ImmF64Operand<Decoder::kChecked> operand(this, pc() - 1);
