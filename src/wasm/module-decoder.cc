...
#undef BYTES
 ...
 private:
  ...
  // Instruction traces are decoded in DecodeInstTraceSection
  // as tuple<function_index, function_offset, mark_id>.
  // In DecodeCodeSection, after the functions have been decoded this is
  // translated to module_->inst_traces, which holds pair<module_offset,
  // mark_id>
