...
// executable). At the scope's destruction, the code space is not writable.
...
// concurrent compilation and execution). This is slow and process-wide.
...
// We currently switch permissions for the entire module's memory:
...
class V8_NODISCARD CodeSpaceWriteScope final {
 ...
 private:
  ...
  static thread_local int code_space_write_nesting_level_ = 0;
