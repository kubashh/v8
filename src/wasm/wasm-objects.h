...
class V8_EXPORT_PRIVATE WasmTrustedInstanceData : public ExposedTrustedObject {
 public:
  ...
  // interpreter.
  DECL_ACCESSORS(imported_function_indexes, Tagged<FixedInt32Array>)
#endif  // V8_WASM_INTERPRETER
...
#define FIELD_LIST(V)                                                     \
  ...
  V(kImportedFunctionIndexesOffset, kTaggedSize)                          \
  ...
  V(kInterpreterObjectOffset, kTaggedSize)                                \
...
#define WASM_TAGGED_INSTANCE_DATA_FIELDS(V)                                   \
  ...
  V(kInterpreterObjectOffset, "interpreter_object")                           \
  ...
  V(kImportedFunctionIndexesOffset, "imported_function_indexes")              \
...
class WasmDispatchTable : public TrustedObject {
 public:
  ...
  static constexpr size_t kFunctionIndexBias = kSigBias + kTaggedSize;
  static constexpr size_t kEntryPaddingOffset = kFunctionIndexBias + kInt32Size;
#endif  // !V8_WASM_INTERPRETER
