...
using ManagedNativeModule = Managed<NativeModule, kWasmNativeModuleTag>;
using ManagedGlobalWasmCodeRef =
    Managed<GlobalWasmCodeRef, kWasmGlobalWasmCodeRefTag>;
using ManagedStackMemory = Managed<StackMemory, kWasmStackMemoryTag>;
}  // namespace wasm
