...
#define FIELD_OFFSET(offset, _) offset,
      WASM_TAGGED_INSTANCE_OBJECT_FIELDS(FIELD_OFFSET)
#undef FIELD_OFFSET
  };

  static constexpr std::array<const char*, 24> kTaggedFieldNames = {
#define FIELD_NAME(_, name) name,
      WASM_TAGGED_INSTANCE_OBJECT_FIELDS(FIELD_NAME)
#undef FIELD_NAME
  };
