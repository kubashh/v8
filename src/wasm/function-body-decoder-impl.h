...
#undef BUILD_SIMPLE_OPCODE
        ...
        case kExprLet: {
          ...
          ArgVector let_local_values =
              PopArgs(Vector<ValueType>(local_type_vec_.data(), locals_count));
          ArgVector args = PopArgs(imm.sig);
          ...
          Vector<Value> let_local_values_vec =
              Vector<Value>(let_local_values.data(), let_local_values.size());
          CALL_INTERFACE_IF_REACHABLE(AllocateLocals, let_local_values_vec);
          break;
        }
        case kExprLoop: {
          BlockTypeImmediate<validate> imm(this->enabled_, this, this->pc_);
