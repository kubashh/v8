...
#undef DECODE_IMPL2
  ...
  V8_INLINE void ValidateParameters(const FunctionSig* sig) {
    ...
    Value* param_base = stack_value(num_params);
  ...
  // Pops arguments as required by signature. Returns a pointer to the first
  // popped argument. Note that the value behind this pointer will be
