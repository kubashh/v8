  ...
  void DoReturn(FullDecoder* decoder, uint32_t drop_values) {
    ...
    if (v8_flags.trace_wasm) {
      ...
      if (return_count == 1) {
        ...
        asm_.Store(
            info, return_values[0], StoreOp::Kind::RawUnaligned(),
  ...
  OpIndex UnOpImpl(FullDecoder* decoder, WasmOpcode opcode, OpIndex arg) {
    switch (opcode) {
      ...
      case kExprI32SConvertSatF32: {
        ...
        IF (asm_.Float32Equal(truncated, converted_back)) {
          GOTO(done, converted);
        }
        ELSE {
          // Overflow.
      ...
      case kExprI32SConvertSatF64: {
        ...
        IF (asm_.Float64Equal(truncated, converted_back)) {
          GOTO(done, converted);
        }
        ELSE {
          // Overflow.
      ...
      case kExprI64SConvertSatF32: {
        ...
        IF (asm_.Projection(converted, 1, RegisterRepresentation::Word32())) {
          GOTO(done,
