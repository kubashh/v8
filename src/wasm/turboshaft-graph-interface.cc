...
#undef CASE_STORE
  ...
  void ArrayGet(FullDecoder* decoder, const Value& array_obj,
    ...
    result->op =
        __ ArrayGet(V<HeapObject>::Cast(array_obj.op),
                    V<Word32>::Cast(index.op), imm.array_type, is_signed);
  }
  ...
  void ArraySet(FullDecoder* decoder, const Value& array_obj,
                ...
                const Value& value) {
    BoundsCheckArray(array_obj.op, index.op, array_obj.type);
    __ ArraySet(V<HeapObject>::Cast(array_obj.op), V<Word32>::Cast(index.op),
  ...
  void ArrayCopy(FullDecoder* decoder, const Value& dst, const Value& dst_index,
    ...
    V<HeapObject> src_array = V<HeapObject>::Cast(src.op);
    V<HeapObject> dst_array = V<HeapObject>::Cast(dst.op);
  ...
  void ArrayFill(FullDecoder* decoder, ArrayIndexImmediate& imm,
    ...
    BoundsCheckArrayWithLength(array.op, index.op, length.op,
                               array.type.is_nullable()
                                   ? compiler::kWithNullCheck
                                   : compiler::kWithoutNullCheck);
    ArrayFillImpl(V<HeapObject>::Cast(array.op), V<Word32>::Cast(index.op),
 ...
 private:
  ...
  void ArrayFillImpl(V<HeapObject> array, V<Word32> index, V<Any> value,
