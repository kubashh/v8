...
class WasmGraphBuildingInterface {
 public:
  ...
  void StringNewWtf8(FullDecoder* decoder,
                     ...
                     const Value& index_val, const Value& bytes_val,
                     Value* result_val) {
    UNIMPLEMENTED();
  }
  ...
  void StringNewWtf16(FullDecoder* decoder,
                      const MemoryIndexImmediate<validate>& imm,
                      const Value& index_val, const Value& codeunits_val,
                      Value* result_val) {
    UNIMPLEMENTED();
  }
  ...
  void StringAsWtf8(FullDecoder* decoder, const Value& str, Value* result_val) {
    UNIMPLEMENTED();
  }
  ...
  void StringAsIter(FullDecoder* decoder, const Value& str, Value* result_val) {
    UNIMPLEMENTED();
  }
