...
bool v8::Array::CopyAndConvertArrayToCppBuffer(T* dst, uint32_t max_length) {
  static_assert(
      i::CTypeMatcher<T, CTypeInfo::Type(type_info)>::template CTypeMatchesInfo<
          typename std::remove_reference<decltype(*dst)>::type>(),
