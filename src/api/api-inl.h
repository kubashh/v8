...
inline bool HasCustomIterator(i::Context ctx, i::Isolate* isolate,
                              i::JSArray array) {
  // Check that we have the original ArrayPrototype.
  auto initial_array_prototype = ctx.native_context().initial_array_prototype();
...
inline bool CopyAndConvertArrayToCppBuffer(Local<Array> src, T* dst,
  ...
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(src->GetIsolate());
  i::HandleScope handle_scope(isolate);

  i::Context context = *reinterpret_cast<i::Context*>(*src->CreationContext());
  if (HasCustomIterator(context, isolate, obj)) {
