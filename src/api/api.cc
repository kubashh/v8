...
SharedValueConveyor::SharedValueConveyor(Isolate* v8_isolate)
    : private_(new i::SharedObjectConveyorHandles(
          reinterpret_cast<i::Isolate*>(v8_isolate))) {}

SharedValueConveyor::~SharedValueConveyor() {
  delete reinterpret_cast<i::SharedObjectConveyorHandles*>(private_);
}

// static
i::SharedObjectConveyorHandles* Utils::OpenSharedValueConveyor(
    SharedValueConveyor& conveyor) {
  return reinterpret_cast<i::SharedObjectConveyorHandles*>(conveyor.private_);
}

// static
const i::SharedObjectConveyorHandles* Utils::OpenSharedValueConveyor(
