...
namespace {
i::ValueHelper::InternalType GetSerializedDataFromFixedArray(
  ...
  if (index < static_cast<size_t>(list->length())) {
    ...
    if (!IsTheHole(object, i_isolate)) {
      ...
      return i::Handle<i::Object>(object, i_isolate).internal();
    }
  }
  return i::ValueHelper::EmptyInternal;
}
}  // anonymous namespace

i::ValueHelper::InternalType Context::GetDataFromSnapshotOnce(size_t index) {
  auto context = Utils::OpenHandle(this);
  i::Isolate* i_isolate = context->GetIsolate();
...
i::ValueHelper::InternalType Isolate::GetDataFromSnapshotOnce(size_t index) {
  i::Isolate* i_isolate = reinterpret_cast<i::Isolate*>(this);
