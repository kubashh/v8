...
void FunctionTemplate::SetCallHandler(
  ...
  if (c_function_overloads.size() > 0) {
    ...
    for (int i = 0; i < function_count; i++) {
      ...
      i::Handle<i::Object> address = FromCData<i::kCFunctionForeignTag>(
          i_isolate, c_function.GetAddress());
      function_overloads->set(
          i::FunctionTemplateInfo::kFunctionOverloadEntrySize * i, *address);
      i::Handle<i::Object> signature = FromCData<i::kCFunctionInfoForeignTag>(
          i_isolate, c_function.GetTypeInfo());
      function_overloads->set(
