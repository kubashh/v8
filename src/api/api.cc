...
void v8::AsyncContext::Variable::CheckCast(Value* that) {
  i::Handle<i::Object> obj = Utils::OpenHandle(that);
  Utils::ApiCheck(obj->IsJSAsyncContextVariable(), "v8::AsyncLocal::Cast",
                  "Value is not an AsyncLocal");
}

v8::AsyncContext::Variable::Scope::Scope(
    Local<AsyncContext::Variable> async_local, Local<Value> value) {
  CHECK(i::v8_flags.harmony_async_context);
  i::Handle<i::JSAsyncContextVariable> js_async_variable =
      Utils::OpenHandle(*async_local);
...
void v8::AsyncContext::Snapshot::CheckCast(Value* that) {
  i::Handle<i::Object> obj = Utils::OpenHandle(that);
  Utils::ApiCheck(obj->IsJSAsyncContextSnapshot(), "v8::AsyncSnapshot::Cast",
                  "Value is not an AsyncSnapshot");
}

v8::AsyncContext::Snapshot::Scope::Scope(
