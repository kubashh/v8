...
void* v8::Object::GetCreationContextAndAlignedPointerFromEmbedderData(
    int index) {
  const char* location =
      "v8::Object::GetCreationContextAndAlignedPointerFromEmbedderData()";
  auto self = Utils::OpenHandle(this);
  ...
  bool ok = Utils::ApiCheck(index >= 0, location, "Negative index") &&
