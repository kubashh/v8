...
namespace {
i::ValueHelper::RepresentationType GetSerializedDataFromFixedArray(
...
i::ValueHelper::RepresentationType Context::GetDataFromSnapshotOnce(
    size_t index) {
  auto context = Utils::OpenHandle(this);
  i::Isolate* i_isolate = context->GetIsolate();
...
i::ValueHelper::RepresentationType Isolate::GetDataFromSnapshotOnce(
    size_t index) {
  i::Isolate* i_isolate = reinterpret_cast<i::Isolate*>(this);
