...
#define TO_LOCAL_LIST(V)                                     \
  ...
  V(ToLocal, JSAsyncContextVariable, AsyncContext::Variable) \
  V(ToLocal, JSAsyncContextSnapshot, AsyncContext::Snapshot) \
...
#define OPEN_HANDLE_LIST(V)                         \
  ...
  V(Map, JSMap)                                     \
  V(Set, JSSet)                                     \
  V(AsyncContext::Variable, JSAsyncContextVariable) \
  V(AsyncContext::Snapshot, JSAsyncContextSnapshot) \
