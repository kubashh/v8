...
#undef DEFINE_MODE_MASK
  ...
  // In addition to modes covered by the apply mask (which is applied applied
  // at GC time, among others), this covers all modes that
  // are relocated by Code::CopyFromNoFlush after codegen.
