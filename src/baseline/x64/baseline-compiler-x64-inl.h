...
static constexpr Register kScratchRegisters[] = {
    kScratchRegister,
    // We can safely use the interpreter registers as scratch registers.
    kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister,
    kInterpreterDispatchTableRegister,
    // I guess we can use this one too.
