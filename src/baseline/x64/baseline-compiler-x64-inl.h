...
template <>
struct PushHelper<ForceAlignmentMarker> {
  static int Push(BaselineAssembler* basm, ForceAlignmentMarker) { return 0; }
  static int PushReverse(BaselineAssembler* basm, ForceAlignmentMarker) {
    return 0;
  }
};
...
int BaselineAssembler::Push(T... vals) {
  return PushAllHelper<T...>::Push(this, vals...);
}

template <typename... T>
void BaselineAssembler::PushReverse(T... vals) {
  PushAllHelper<T...>::PushReverse(this, vals...);
}
