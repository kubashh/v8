...
#ifndef V8_BASELINE_MIPS64_BASELINE_COMPILER_MIPS64_H_
#define V8_BASELINE_MIPS64_BASELINE_COMPILER_MIPS64_H_
...
Operand BaselineAssembler::RegisterFrameOperand(
    interpreter::Register interpreter_register) {
  return Operand(rbp, interpreter_register.ToOperand() * kSystemPointerSize);
}
...
#endif  // V8_BASELINE_MIPS64_BASELINE_COMPILER_MIPS64_H_
