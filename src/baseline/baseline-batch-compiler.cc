 ...
 public:
  ...
  void Run() {
    ...
    *output_ = compiler;
    ...
    compiler->AttachPersistentHandles(
...
BaselineBatchCompiler::BaselineBatchCompiler(Isolate* isolate)
    : isolate_(isolate),
      ...
      enabled_(true) {
  // TODO(victorgomes): Do a small study to decide an optimal
  // size to reserve here.
  compilers_.resize(20, nullptr);
}
