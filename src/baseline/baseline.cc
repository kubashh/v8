...
void BaselineCompiler::VisitConstruct() {
  ...
  // TODO(victor): somehow feedback_vector is being clobbered, so using r8
  // temporarily. Register feedback_vector = descriptor.GetRegisterParameter(
  //     CallWithSpread_WithFeedbackDescriptor::kMaybeFeedbackVector);
...
void BaselineCompiler::VisitCreateMappedArguments() {
  // TODO(pthier): Check for duplicate parameters.
  CallBuiltin(Builtins::kFastNewSloppyArguments);
}
void BaselineCompiler::VisitCreateUnmappedArguments() {
  CallBuiltin(Builtins::kFastNewStrictArguments);
}
