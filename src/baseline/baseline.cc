...
// struct CheckArgHelper {
//   static bool Check(BaselineAssembler* masm, CallInterfaceDescriptor descriptor,
//                   int i, Arg arg) {
//     return true;
//   }
// };
...
// template <>
// struct CheckArgHelper<Smi> {
//   static bool Check(BaselineAssembler* masm, CallInterfaceDescriptor descriptor,
//                   int i, Smi arg) {
//     return descriptor.GetParameterType(i).IsTagged() || descriptor.GetParameterType(i).IsTaggedSigned();
//   }
// };
...
#undef DECLARE_VISITOR
  ...
  void CallBuiltin(Builtins::Name builtin, Args... args) {
    ...
    // TODO(leszeks): Check parameter count and types.
