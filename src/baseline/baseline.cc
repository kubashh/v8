...
void BaselineCompiler::VisitLdar() { LoadRegister(rax, 0); }
void BaselineCompiler::VisitStar() { StoreRegister(0, rax); }
...
void BaselineCompiler::VisitLdaNamedPropertyFromSuper() {
  ...
  __ LoadPrototype(
      LoadWithReceiverAndVectorDescriptor::LookupStartObjectRegister(), rax);
