...
Handle<Code> CompileWithBaseline(Isolate* isolate,
  ...
  if (shared->script().IsScript()) {
    Compiler::LogFunctionCompilation(isolate, 
      CodeEventListener::LAZY_COMPILE_TAG, shared, 
      handle(Script::cast(shared->script()), isolate), 
      Handle<AbstractCode>::cast(code), false, timer.Elapsed().InMillisecondsF());
  }
