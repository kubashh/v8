...
void BaselineCompiler::VisitAdd() {
  Register feedback_vector =
      Builtins::CallInterfaceDescriptorFor(Builtins::kAdd_WithFeedback)
          .GetRegisterParameter(Builtin_Add_WithFeedback_InterfaceDescriptor::
                                    kMaybeFeedbackVector);
  LoadFeedbackVector(feedback_vector);
  CallBuiltin(Builtins::kAdd_WithFeedback, RegisterOperand(0),  // lhs
