...
Operand BaselineAssembler::RegisterFrameOperand(int register_index) {
...
void BaselineAssembler::LoadMapBitField(Register bitfield, Register map) {
  LoadAnyTaggedField(bitfield, FieldOperand(map, Map::kBitFieldOffset));
}
Immediate BaselineAssembler::AsSmiImmediate(int32_t value) {
  return Immediate(static_cast<int32_t>(Smi::FromInt(value).ptr()));
}
void BaselineAssembler::AddSmi(Register lhs, int32_t rhs) {
  addl(lhs, AsSmiImmediate(rhs));
}
void BaselineAssembler::AddSmi(Register lhs, Register rhs) { addl(lhs, rhs); }
void BaselineAssembler::SubSmi(Register lhs, int32_t rhs) {
  subl(lhs, AsSmiImmediate(rhs));
}
...
void BaselineAssembler::BitwiseOrSmi(Register lhs, int32_t rhs) {
  orl(lhs, AsSmiImmediate(rhs));
}
void BaselineAssembler::BitwiseOrSmi(Register lhs, Register rhs) {
  orl(lhs, rhs);
}
void BaselineAssembler::BitwiseXorSmi(Register lhs, int32_t rhs) {
  xorl(lhs, AsSmiImmediate(rhs));
}
void BaselineAssembler::BitwiseXorSmi(Register lhs, Register rhs) {
  xorl(lhs, rhs);
}
void BaselineAssembler::BitwiseAndSmi(Register lhs, int32_t rhs) {
...
void BaselineAssembler::Compare(Register lhs, Operand rhs) { cmpq(lhs, rhs); }
...
// Specialization for interpreter::Register that turns it into a
...
class BaselineCompiler::SaveAccumulatorScope final {
 public:
...
void BaselineCompiler::Prologue() {
  ...
  PrologueHandleOptimizationState(feedback_vector);
...
void BaselineCompiler::PrologueHandleOptimizationState(
  ...
  Label no_marker;
  __ j(zero, &no_marker);
  __ TailCallBuiltin(Builtins::kBaselineHandleOptimizationMarker);
  __ bind(&no_marker);
  __ RecordComment("]");
}

void BaselineCompiler::Epilogue() { EpilogueReturn(); }

void BaselineCompiler::EpilogueReturn() {
  __ bind(&return_);
...
Operand BaselineCompiler::RegisterOperand(interpreter::Register reg) {
  return __ RegisterFrameOperand(reg);
}
Operand BaselineCompiler::RegisterOperand(int operand_index) {
  return RegisterOperand(accessor().GetRegisterOperand(operand_index));
}
Operand BaselineCompiler::UndefinedOperand() {
  return Operand(kRootRegister,
                 __ RootRegisterOffsetForRootIndex(RootIndex::kUndefinedValue));
}

void BaselineCompiler::LoadRegister(Register output,
...
void BaselineCompiler::StoreRegister(interpreter::Register output,
                                     Register value) {
...
void BaselineCompiler::LoadAccumulator(Register output) {
  __ movq(output, kInterpreterAccumulatorRegister);
}
void BaselineCompiler::PushAccumulator() {
  __ Push(kInterpreterAccumulatorRegister);
}
void BaselineCompiler::PopAccumulator() {
  __ Pop(kInterpreterAccumulatorRegister);
}
void BaselineCompiler::LoadContext(Register output) {
  __ movq(output, __ ContextOperand());
}
void BaselineCompiler::LoadFunction(Register output) {
  __ movq(output, __ FunctionOperand());
}
void BaselineCompiler::StoreContext(Register context) {
  __ movq(__ ContextOperand(), context);
}
...
void BaselineCompiler::LoadTaggedPointerField(Register output, Register source,
                                              int offset) {
  __ LoadTaggedPointerField(output, FieldOperand(source, offset));
}
void BaselineCompiler::LoadTaggedSignedField(Register output, Register source,
                                             int offset) {
  __ LoadTaggedSignedField(output, FieldOperand(source, offset));
}
void BaselineCompiler::LoadTaggedAnyField(Register output, Register source,
                                          int offset) {
  __ LoadAnyTaggedField(output, FieldOperand(source, offset));
}
void BaselineCompiler::StoreTaggedSignedField(Register target, int offset,
                                              Smi value) {
  __ StoreTaggedField(FieldOperand(target, offset), Immediate(value));
}
void BaselineCompiler::StoreTaggedFieldWithWriteBarrier(Register target,
                                                        int offset,
                                                        Register value,
                                                        Register scratch) {
...
void BaselineCompiler::StoreTaggedFieldNoWriteBarrier(Register target,
                                                      int offset,
                                                      Register value) {
  __ StoreTaggedField(FieldOperand(target, offset), value);
}

Operand BaselineCompiler::FeedbackVector() {
...
void BaselineCompiler::LoadClosureFeedbackArray(Register output,
                                                Register closure) {
  __ Move(output, FeedbackVector());
  LoadTaggedPointerField(output, output,
                         FeedbackVector::kClosureFeedbackCellArrayOffset);
}
void BaselineCompiler::LoadFixedArrayElement(Register output, Register array,
                                             int32_t index) {
...
void BaselineCompiler::VisitLdaGlobal() {
  CallBuiltin(Builtins::kLoadGlobalIC,
              ...
              __ FeedbackVectorOperand());  // vector
}
...
void BaselineCompiler::VisitStaModuleVariable() {
  ...
  if (cell_index > 0) {
    ...
    LoadFixedArrayElement(kScratchRegister, kScratchRegister, cell_index);
    SaveAccumulatorScope save_accumulator(this);
    StoreTaggedFieldWithWriteBarrier(kScratchRegister, Cell::kValueOffset,
...
void BaselineCompiler::UpdateFeedback(int operand_index, int bit, Label* done) {
  ...
  StoreTaggedFieldNoWriteBarrier(feedback_vector, slot_offset,
                                 kScratchRegister);
  __ jmp(done);
  __ RecordComment("]");
}
...
void BaselineCompiler::VisitCallJSRuntime() {
  ...
  // Load context into rsi, for LoadNativeContextSlot.
  LoadContext(rsi);
...
void BaselineCompiler::VisitCreateClosure() {
  ...
  if (interpreter::CreateClosureFlags::FastNewClosureBit::decode(flags)) {
    LoadFixedArrayElement(kScratchRegister, r11, Index(1));
    ...
    Runtime::FunctionId function_id =
        interpreter::CreateClosureFlags::PretenuredBit::decode(flags)
            ...
            : Runtime::kNewClosure;
    LoadFixedArrayElement(kInterpreterAccumulatorRegister, r11, Index(1));
...
void BaselineCompiler::VisitJumpLoop() {
  ...
  LoadRegister(osr_level, interpreter::Register::bytecode_array());
  __ movb(osr_level,
...
void BaselineCompiler::VisitSwitchOnGeneratorState() {
  ...
  LoadTaggedAnyField(r11, generator_object,
                     JSGeneratorObject::kContinuationOffset);
  StoreTaggedSignedField(generator_object,
                         JSGeneratorObject::kContinuationOffset,
...
void BaselineCompiler::VisitSuspendGenerator() {
  ...
  LoadContext(kScratchRegister);
  StoreTaggedFieldWithWriteBarrier(generator_object,
                                   JSGeneratorObject::kContextOffset,
                                   kScratchRegister, r14);
