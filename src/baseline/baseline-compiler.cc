...
bool Clobbers(Register target, ForceAlignmentMarker) { return false; }
...
bool MachineTypeMatches(MachineType type, ForceAlignmentMarker) {
  UNREACHABLE();
}
...
void BaselineCompiler::VisitLdaNamedProperty() {
  ...
  // Check FBV valid on arm64.
  LoadFeedbackVector(x15);
#endif
...
void BaselineCompiler::VisitConstruct() {
  ...
  CallBuiltin(Builtins::kConstruct_WithFeedback,
              ...
              Index(3),                         // kSlot
              FeedbackVector(),                 // kMaybeFeedbackVector
              kForceAlignment,                  // Force stack alignment
              RootIndex::kUndefinedValue,       // kReceiver
              args);
}
