...
void BaselineAssembler::Assert(Condition condition, AbortReason reason) {
  __ Assert(AsMasmCondition(condition), reason);
}
...
void BaselineCompiler::VisitCreateMappedArguments() {
  ...
  __ LoadTaggedPointerField(scratch, scratch,
                            JSFunction::kSharedFunctionInfoOffset);
  __ LoadTaggedPointerField(scratch, scratch, SharedFunctionInfo::kFlagsOffset);
  __ TestAndBranchIfAllClear(
      scratch, SharedFunctionInfo::HasDuplicateParametersBit::kMask,
...
void BaselineCompiler::VisitThrowIfNotSuperConstructor() {
  ...
  __ LoadByteField(mask_bit_field, mask_bit_field, Map::kBitFieldOffset);
  Label done;
