...
void BaselineCompiler::TraceBytecode(Runtime::FunctionId function_id) {
  ...
  CallRuntime(function_id, bytecode_,
              Smi::FromInt(BytecodeArray::kHeaderSize - kHeapObjectTag +
                           accessor().current_offset()),
              kInterpreterAccumulatorRegister, Smi::FromInt(1));
  __ RecordComment("]");
}
#endif
...
void BaselineCompiler::VisitAdd() {
  CallBuiltin(Builtins::kAddBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitSub() {
  CallBuiltin(Builtins::kSubtractBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitMul() {
  CallBuiltin(Builtins::kMultiplyBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitDiv() {
  CallBuiltin(Builtins::kDivideBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitMod() {
  CallBuiltin(Builtins::kModulusBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitExp() {
  CallBuiltin(Builtins::kExponentiateBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitBitwiseOr() {
  CallBuiltin(Builtins::kBitwiseOrBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitBitwiseXor() {
  CallBuiltin(Builtins::kBitwiseXorBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitBitwiseAnd() {
  CallBuiltin(Builtins::kBitwiseAndBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitShiftLeft() {
  CallBuiltin(Builtins::kShiftLeftBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitShiftRight() {
  CallBuiltin(Builtins::kShiftRightBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
void BaselineCompiler::VisitShiftRightLogical() {
  CallBuiltin(Builtins::kShiftRightLogicalBaseline, RegisterOperand(0),
              kInterpreterAccumulatorRegister, Index(1));
}
...
void BaselineCompiler::VisitAddSmi() {
  BuildBinopWithConstant(Builtins::kAddBaseline);
}
void BaselineCompiler::VisitSubSmi() {
  BuildBinopWithConstant(Builtins::kSubtractBaseline);
}
void BaselineCompiler::VisitMulSmi() {
  BuildBinopWithConstant(Builtins::kMultiplyBaseline);
}
void BaselineCompiler::VisitDivSmi() {
  BuildBinopWithConstant(Builtins::kDivideBaseline);
}
void BaselineCompiler::VisitModSmi() {
  BuildBinopWithConstant(Builtins::kModulusBaseline);
}
void BaselineCompiler::VisitExpSmi() {
  BuildBinopWithConstant(Builtins::kExponentiateBaseline);
}
void BaselineCompiler::VisitBitwiseOrSmi() {
  BuildBinopWithConstant(Builtins::kBitwiseOrBaseline);
}
void BaselineCompiler::VisitBitwiseXorSmi() {
  BuildBinopWithConstant(Builtins::kBitwiseXorBaseline);
}
void BaselineCompiler::VisitBitwiseAndSmi() {
  BuildBinopWithConstant(Builtins::kBitwiseAndBaseline);
}
void BaselineCompiler::VisitShiftLeftSmi() {
  BuildBinopWithConstant(Builtins::kShiftLeftBaseline);
}
void BaselineCompiler::VisitShiftRightSmi() {
  BuildBinopWithConstant(Builtins::kShiftRightBaseline);
}
void BaselineCompiler::VisitShiftRightLogicalSmi() {
  BuildBinopWithConstant(Builtins::kShiftRightLogicalBaseline);
}
...
void BaselineCompiler::VisitInc() { BuildUnop(Builtins::kIncrementBaseline); }
void BaselineCompiler::VisitDec() { BuildUnop(Builtins::kDecrementBaseline); }
void BaselineCompiler::VisitNegate() { BuildUnop(Builtins::kNegateBaseline); }
void BaselineCompiler::VisitBitwiseNot() {
  BuildUnop(Builtins::kBitwiseNotBaseline);
}
...
void BaselineCompiler::BuildCall(ConvertReceiverMode mode, uint32_t slot,
  ...
  switch (mode) {
    case ConvertReceiverMode::kAny:
      builtin = Builtins::kCall_ReceiverIsAnyBaseline;
      break;
    case ConvertReceiverMode::kNullOrUndefined:
      builtin = Builtins::kCall_ReceiverIsNullOrUndefinedBaseline;
      break;
    case ConvertReceiverMode::kNotNullOrUndefined:
      builtin = Builtins::kCall_ReceiverIsNotNullOrUndefinedBaseline;
      break;
    default:
      UNREACHABLE();
  }
...
void BaselineCompiler::VisitCallWithSpread() {
  ...
  CallBuiltin(Builtins::kCallWithSpreadBaseline,
              RegisterOperand(0),  // kFunction
              arg_count,           // kActualArgumentsCount
...
void BaselineCompiler::VisitIntrinsicIsJSReceiver(
  ...
  SelectBooleanConstant(
      ...
      [&](Label* is_true, Label::Distance distance) {
        ...
        // TODO(leszeks): If we ever added more instance types after
...
void BaselineCompiler::VisitConstruct() {
  interpreter::RegisterList args = accessor().GetRegisterListOperand(1);
  uint32_t arg_count = args.register_count();
  CallBuiltin(Builtins::kConstructBaseline,
              RegisterOperand(0),               // kFunction
...
void BaselineCompiler::VisitConstructWithSpread() {
  ...
  Register new_target =
      Builtins::CallInterfaceDescriptorFor(
          Builtins::kConstructWithSpreadBaseline)
          .GetRegisterParameter(
              ConstructWithSpreadBaselineDescriptor::kNewTarget);
  __ Move(new_target, kInterpreterAccumulatorRegister);

  CallBuiltin(Builtins::kConstructWithSpreadBaseline,
              RegisterOperand(0),          // kFunction
...
void BaselineCompiler::VisitTestEqual() {
  BuildCompare(Builtins::kEqualBaseline);
}
void BaselineCompiler::VisitTestEqualStrict() {
  BuildCompare(Builtins::kStrictEqualBaseline);
}
void BaselineCompiler::VisitTestLessThan() {
  BuildCompare(Builtins::kLessThanBaseline);
}
void BaselineCompiler::VisitTestGreaterThan() {
  BuildCompare(Builtins::kGreaterThanBaseline);
}
void BaselineCompiler::VisitTestLessThanOrEqual() {
  BuildCompare(Builtins::kLessThanOrEqualBaseline);
}
void BaselineCompiler::VisitTestGreaterThanOrEqual() {
  BuildCompare(Builtins::kGreaterThanOrEqualBaseline);
}
...
void BaselineCompiler::VisitTestInstanceOf() {
  Register callable =
      Builtins::CallInterfaceDescriptorFor(Builtins::kInstanceOfBaseline)
          .GetRegisterParameter(CompareBaselineDescriptor::kRight);
  __ Move(callable, kInterpreterAccumulatorRegister);
  CallBuiltin(Builtins::kInstanceOfBaseline,
              RegisterOperand(0),  // object
              callable,            // callable
              Index(1));           // slot
}
...
void BaselineCompiler::VisitResumeGenerator() {
  ...
  // TODO(leszeks): Just load the known InputOrDebugPosOffset value directly.
