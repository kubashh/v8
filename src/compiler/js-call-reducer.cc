 ...
 public:
  ...
  class SelectBuilder {
   public:
    ...
    SelectBuilder& ExpectTrue() {
      hint_ = BranchHint::kTrue;
      return *this;
    }

    SelectBuilder& ExpectFalse() {
      hint_ = BranchHint::kFalse;
      return *this;
    }

    SelectBuilder& Then(const NodeGenerator& body) {
      then_body_ = body;
      return *this;
    }
    SelectBuilder& Else(const NodeGenerator& body) {
      else_body_ = body;
      return *this;
    }
    ...
    TNode<Object> Value() {
      DCHECK(then_body_);
      DCHECK(else_body_);
      auto if_true = (hint_ == BranchHint::kTrue) ? gasm_->MakeLabel()
                                                  : gasm_->MakeDeferredLabel();
      auto if_false = (hint_ == BranchHint::kFalse)
                          ? gasm_->MakeLabel()
                          : gasm_->MakeDeferredLabel();
   ...
   private:
    ...
    BranchHint hint_ = BranchHint::kTrue;
