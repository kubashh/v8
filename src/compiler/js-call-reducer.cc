...
class JSCallReducerAssembler : public GraphAssembler {
 public:
  ...
  VNode<Any> ReduceMathUnary(const Operator* op);
  VNode<Any> ReduceMathBinary(const Operator* op);
  VNode<String> ReduceStringPrototypeSubstring();
  VNode<String> ReduceStringPrototypeSlice();
...
VNode<Any> JSCallReducerAssembler::ReduceMathUnary(const Operator* op) {
...
VNode<Any> JSCallReducerAssembler::ReduceMathBinary(const Operator* op) {
