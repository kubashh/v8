...
// Inlines 'Math.hypot(v1,...,vn)' into optimized code assuming that v1,...,vn
// are already numbers. This inlining follows the C++ implementation and thus
// uses Kahan summation to avoid rounding errors.
