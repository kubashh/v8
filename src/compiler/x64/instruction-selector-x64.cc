...
void InstructionSelector::VisitInt64AtomicBinaryOperation(
...
#define VISIT_ATOMIC_BINOP(op)                                         \
  void InstructionSelector::VisitInt64Atomic##op(Node* node) {         \
    VisitInt64AtomicBinaryOperation(                                   \
        node, kX64Int64Atomic##op##Uint8, kX64Int64Atomic##op##Uint16, \
        kX64Int64Atomic##op##Uint32, kX64Int64Atomic##op##Uint64);     \
  }
VISIT_ATOMIC_BINOP(Add)
VISIT_ATOMIC_BINOP(Sub)
VISIT_ATOMIC_BINOP(And)
