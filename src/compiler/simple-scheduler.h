...
#ifndef V8_COMPILER_SIMPLE_SCHEDULER_H_
#define V8_COMPILER_SIMPLE_SCHEDULER_H_
...
// basic block without actually building
class V8_EXPORT_PRIVATE SimpleScheduler {
 public:
  explicit SimpleScheduler(Zone* zone, Graph* graph);
...
#endif  // V8_COMPILER_SIMPLE_SCHEDULER_H_
