...
Node* RawMachineAssembler::CallCFunction1WithCallerRegisters(
  ...
  return AddNode(common()->CallWithCallerRegisters(descriptor), function, arg0);
}
...
Node* RawMachineAssembler::CallCFunction3WithCallerRegisters(
