...
class V8_EXPORT_PRIVATE CompilationDependencies : public ZoneObject {
 public:
  ...
  // If PropertyKind is kData, |constant| is the property in question. In case
  // of PropertyKind::kAccessor, |constant| is the accessor function (i.e.,
  // getter or setter) itself, not the overall AccessorPair.
