  ...
  void Run(PipelineData* data, Zone* temp_zone) {
    {
      ...
      TraceSchedule(data->info(), data->GetCodeTracer(), schedule,
...
MaybeHandle<Code> Pipeline::GenerateCodeForCodeStub(
  ...
  TraceSchedule(data.info(), data.GetCodeTracer(), data.schedule(), "schedule");
...
void PipelineImpl::ComputeScheduledGraph() {
  ...
  TraceSchedule(data->info(), data->GetCodeTracer(), data->schedule(),
                "schedule");
}
