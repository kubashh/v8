...
class SerializerForBackgroundCompilation {
 public:
  ...
  SerializerForBackgroundCompilation(JSHeapBroker* broker, Zone* zone,
                                     Handle<JSFunction> closure, int arg_count,
                                     const Hints& receiver_state,
...
#undef DECLARE_VISIT_BYTECODE
  ...
  void ProcessCall(const Hints& callee_state, const Hints& receiver_state,
                   const HintsVector& parameters_state, int arg_count);
  void RecurseOnCallee(const Hints& receiver_state,
                       const HintsVector& parameters_state, int arg_count,
