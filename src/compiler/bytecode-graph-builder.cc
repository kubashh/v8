...
void BytecodeGraphBuilder::VisitBytecodes() {
  ...
  // TODO(solanes): StackCheck has to happen after OSR for the virtual registers
  // to be correct.
...
void BytecodeGraphBuilder::VisitStackCheck() {
  ...
  // TODO(solanes): Create bug and assign.
  // In Osr we don't generate a FunctionEntry. However, we visit the osr
  // bytecodes. These bytecodes will contain a JumpLoop which will have an
  // IterationBody stack check. In Non-Osr we guarantee that we have visited the
  // FunctionEntry StackCheck before visiting the IterationBody ones.
