...
// DecompressionAvoider will run only when pointer compression is enabled. For
...
// The phase needs to be run when Machine nodes appear in the graph, i.e at the
// very end of the pipeline since it them to be present. Also, since this phase
// may change the load's MachineRepresentation from Tagged to Compressed, it's
// best to run it as late as possible in order to keep the phases that
// know about Compressed representation to a minimum.
