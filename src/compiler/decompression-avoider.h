...
// The phase needs to be run when machine nodes at the very end of the pipeline,
// since it needs Machine nodes to be present. Also, since this phase may change
// the loads MachineRepresentation from Tagged to Compressed, it's best to run
// this phase as late as possible in order to keep the phases that know about
// Compressed representation to a minimum.
