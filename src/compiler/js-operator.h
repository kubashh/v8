...
class CallParameters final {
 public:
  CallParameters(size_t arity, CallFrequency frequency,
                 VectorSlotPair const& feedback,
                 ConvertReceiverMode convert_mode, bool noOptimizeFlag)
      : bit_field_(ArityField::encode(arity) |
                   NoOptimizeFlag::encode(noOptimizeFlag) |
  ...
  bool GetNoOptimizeFlag() const { return NoOptimizeFlag::decode(bit_field_); }
 ...
 private:
  ...
  typedef BitField<bool, 28, 1> NoOptimizeFlag;
