...
class V8_EXPORT_PRIVATE SimplifiedLowering final {
 ...
 private:
  ...
  // SimplifiedLowering code should call RepresentationSelector::ChangeOp
  // instead, in order to notify the changes to ObserveNodeManager and support
  // the %ObserveNode intrinsic.
