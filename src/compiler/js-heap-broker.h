...
class V8_EXPORT_PRIVATE JSHeapBroker : public NON_EXPORTED_BASE(ZoneObject) {
 public:
  ...
  bool IsArrayPrototype(const JSObjectRef& object) const;
  bool IsObjectPrototype(const JSObjectRef& object) const;
 ...
 private:
  ...
  RefsMap* refs_;
  ZoneSet<Handle<JSObject>, Handle<JSObject>::less_than> array_prototypes_;
  ZoneSet<Handle<JSObject>, Handle<JSObject>::less_than> object_prototypes_;
