...
class LiveRangeSeparator final : public ZoneObject {
 public:
  LiveRangeSeparator(RegisterAllocatorData* data, Zone* zone)
      : data_(data), zone_(zone) {}

  void Splinter();

 private:
  RegisterAllocatorData* data() const { return data_; }
  Zone* zone() const { return zone_; }

  RegisterAllocatorData* const data_;
  Zone* const zone_;
...
class LiveRangeMerger final : public ZoneObject {
 public:
  LiveRangeMerger(RegisterAllocatorData* data, Zone* zone)
      : data_(data), zone_(zone) {}
