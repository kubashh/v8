...
class LiveRangeBuilder final : public ZoneObject {
 ...
 private:
  ...
  // Presplit ranges for deferred fixed registers
  void PreSplitDeferredFixedUses();
...
class LinearScanAllocator final : public RegisterAllocator {
 ...
 private:
  ...
  void AddPresplitToUnhandled(TopLevelLiveRange* range);
  ...
  void SpillBetweenUntil(LiveRange* range, LifetimePosition start,
                         ...
                         SpillMode spill_mode);
  void EvictConflictingLiveRangeFor(LiveRange* current, SpillMode spill_mode);
