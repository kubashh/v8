...
void InstructionSelector::VisitI32x4AnyTrue(Node* node) { UNIMPLEMENTED(); }

void InstructionSelector::VisitI32x4AllTrue(Node* node) { UNIMPLEMENTED(); }

void InstructionSelector::VisitI16x8AnyTrue(Node* node) { UNIMPLEMENTED(); }

void InstructionSelector::VisitI16x8AllTrue(Node* node) { UNIMPLEMENTED(); }

void InstructionSelector::VisitI8x16AnyTrue(Node* node) { UNIMPLEMENTED(); }

void InstructionSelector::VisitI8x16AllTrue(Node* node) { UNIMPLEMENTED(); }
