...
class OperandGeneratorT : public Adapter {
 public:
  ...
  explicit OperandGeneratorT(InstructionSelectorT<Adapter>* selector)
      : selector_(selector) {
    Adapter::SetSchedule(selector->schedule());
  }
  ...
  template <typename T>
  InstructionOperand DefineAsRegister(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  InstructionOperand DefineSameAsInput(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand DefineSameAsFirst(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename... Args>
  InstructionOperand DefineAsFixed(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand DefineAsConstant(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename... Args>
  InstructionOperand DefineAsLocation(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename... Args>
  InstructionOperand DefineAsDualLocation(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseAnyAtEnd(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseRegisterOrSlotOrConstant(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseRegister(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseUniqueSlot(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseUnique(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseUniqueRegister(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename... Args>
  InstructionOperand UseRegister(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }

  template <typename... Args>
  InstructionOperand UseFixed(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename T>
  InstructionOperand UseImmediate(T* node) {
    UNREACHABLE(/*REMOVE*/);
  }

  template <typename T>
  InstructionOperand UseNegatedImmediate(T*) {
    UNREACHABLE(/*REMOVE*/);
  }
  ...
  template <typename... Args>
  InstructionOperand UseLocation(Args...) {
    UNREACHABLE(/*REMOVE*/);
  }
