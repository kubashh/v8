...
class FrameStateDescriptor : public ZoneObject {
 public:
  ...
  // Returns a conservative overapproximation of the *real* unoptimized stack
  // frame size in bytes, as later produced by the deoptimizer. Considers both
  // this and the chain of outer states.
