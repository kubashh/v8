...
#undef ATOMIC_CASE
    ...
    case IrOpcode::kI8x16RelaxedSwizzle:
      return MarkAsSimd128(node), VisitI8x16RelaxedSwizzle(node);
...
void InstructionSelector::VisitI8x16RelaxedSwizzle(Node* node) {
  UNIMPLEMENTED();
}
void InstructionSelector::VisitI8x16RelaxedSwizzle(node) { UNIMPLEMENTED(); }
void InstructionSelector::VisitI16x8RelaxedSwizzle(node) { UNIMPLEMENTED(); }
void InstructionSelector::VisitI32x4RelaxedSwizzle(node) { UNIMPLEMENTED(); }
void InstructionSelector::VisitI64x2RelaxedSwizzle(node) { UNIMPLEMENTED(); }
