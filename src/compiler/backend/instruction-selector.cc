...
// template<>
// const std::map<NodeId, int> EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE)
// InstructionSelectorT<TurbofanAdapter>::GetVirtualRegistersForTesting() const;
//
// template<>
// const std::map<NodeId, int> EXPORT_TEMPLATE_DEFINE(V8_EXPORT_PRIVATE)
// InstructionSelectorT<TurboshaftAdapter>::GetVirtualRegistersForTesting()
// const;

const std::map<NodeId, int> GetVirtualRegistersForTesting(
    const InstructionSelectorT<TurbofanAdapter>* selector) {
  return selector->GetVirtualRegistersForTesting();
}
const std::map<NodeId, int> GetVirtualRegistersForTesting(
    const InstructionSelectorT<TurboshaftAdapter>* selector) {
  return selector->GetVirtualRegistersForTesting();
}
