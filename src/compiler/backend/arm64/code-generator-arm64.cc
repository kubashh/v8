...
#define SIMD_BINOP_CASE(Op, Instr, FORMAT)           \
  case Op:                                           \
    ...
    case kArm64S1x2AllTrue: {
      ...
      VRegister temp3 = scope.AcquireV(kFormatS);

      __ Eor(temp1.V16B(), temp1.V16B(), temp1.V16B());
      __ Cmhi(temp1, i.InputSimd128Register(0).V2D(), temp1);
      __ Umaxv(temp3, temp1.V4S());
      __ Umov(i.OutputRegister32(), temp3, 0);
