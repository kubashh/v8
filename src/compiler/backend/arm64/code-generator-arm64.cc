...
CodeGenerator::CodeGenResult CodeGenerator::AssembleArchInstruction(
  ...
  switch (arch_opcode) {
    ...
    case kArm64DecompressPointer: {
      __ Ldrsw(i.OutputRegister(), i.MemoryOperand());
      __ Add(i.OutputRegister(), kRootRegister, i.OutputRegister());
      break;
    }
    case kArm64DecompressAny: {
      ...
      __ Sbfx(masked_root, i.OutputRegister(), 0, kSmiTagSize);
      ...
      __ Add(i.OutputRegister(), masked_root, i.OutputRegister());
      break;
    }
    ...
    // The Str instruction is the conservative way for the moment.
