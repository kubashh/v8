 ...
 public:
  ...
  void Generate() final {
    ...
    if (mode_ == RecordWriteMode::kValueIsEphemeronKey) {
      ...
      __ CallRecordWriteStubSaveRegisters(
          object_, scratch1_, save_fp_mode, StubCallMode::kCallBuiltinPointer,
          SlotDescriptor::ForIndirectPointerSlot(indirect_pointer_tag_));
#if V8_ENABLE_WEBASSEMBLY
