...
#undef ATOMIC_BINOP_CASE
    ...
    case kS390_I32x4ReplaceLane: {
      if (instr->InputAt(2)->IsRegister()) {
        ...
        __ vlef(i.OutputSimd128Register(), i.InputStackSlot(2),
    ...
    case kS390_I16x8ReplaceLane: {
      if (instr->InputAt(2)->IsRegister()) {
        ...
        __ vleh(i.OutputSimd128Register(), i.InputStackSlot(2),
                Condition(i.InputInt8(1)));
      }
      break;
    }
    case kS390_I8x16ReplaceLane: {
      if (instr->InputAt(2)->IsRegister()) {
        ...
        __ vleb(i.OutputSimd128Register(), i.InputStackSlot(2),
                Condition(i.InputInt8(1)));
      }
      break;
    }
    ...
    case kS390_F32x4Splat: {
      __ vrep(i.OutputSimd128Register(), i.InputDoubleRegister(0),
              Operand(1), Condition(2));
      break;
    }
