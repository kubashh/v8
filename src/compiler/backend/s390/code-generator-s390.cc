...
#define BINOP_SATURATE_S(op, size, limit, condition) {            \
  ...
  for (int index = 0; index < size; index++) {                    \
    ...
    case kS390_I16x8AddSaturateS: {
      BINOP_SATURATE_S(ar, 8, INT16_MAX, 1);
      break;
    }
    case kS390_I16x8SubSaturateS: {
      BINOP_SATURATE_S(sr, 8, INT16_MAX, 1);
      break;
    }
    case kS390_I8x16AddSaturateS: {
      BINOP_SATURATE_S(ar, 16, INT8_MAX, 0);
      break;
    }
    case kS390_I8x16SubSaturateS: {
      BINOP_SATURATE_S(sr, 16, INT8_MAX, 0);
      break;
    }
