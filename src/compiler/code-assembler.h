...
template <class U>
struct types_have_common_values<U, MaybeObject> {
  static const bool value = types_have_common_values<Object, U>::value;
};
...
#ifdef DEBUG
  void GenerateMaybeObjectCheck(Node* node, const char* location);
#endif
