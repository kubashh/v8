...
struct MachineTypeOf<
    TaggedType,
    typename std::enable_if<std::is_base_of<Object, TaggedType>::value>::type> {
  static constexpr MachineType value =
      std::is_same<TaggedType, Object>::value
          ? MachineType::AnyTagged()
          : std::is_same<TaggedType, Smi>::value ? MachineType::TaggedSigned()
                                                 : MachineType::TaggedPointer();
};

template <class TaggedType>
constexpr MachineType MachineTypeOf<
    TaggedType, typename std::enable_if<
                    std::is_base_of<Object, TaggedType>::value>::type>::value;
...
#define CODE_ASSEMBLER_BINARY_OP_LIST(V)                              \
  ...
  V(IntPtrAddWithOverflow, (PairT<IntPtrT, BoolT>), IntPtrT, IntPtrT) \
  V(IntPtrSubWithOverflow, (PairT<IntPtrT, BoolT>), IntPtrT, IntPtrT) \
  V(Int32Add, Word32T, Word32T, Word32T)                              \
  V(Int32AddWithOverflow, (PairT<Int32T, BoolT>), Int32T, Int32T)     \
  V(Int32Sub, Word32T, Word32T, Word32T)                              \
  V(Int32Mul, Word32T, Word32T, Word32T)                              \
  V(Int32MulWithOverflow, (PairT<Int32T, BoolT>), Int32T, Int32T)     \
...
#define CODE_ASSEMBLER_UNARY_OP_LIST(V)                      \
  ...
  V(Int32AbsWithOverflow, (PairT<Int32T, BoolT>), Int32T)    \
  V(Int64AbsWithOverflow, (PairT<Int64T, BoolT>), Int64T)    \
  V(IntPtrAbsWithOverflow, (PairT<IntPtrT, BoolT>), IntPtrT) \
