...
template <class T1, class T2>
struct is_valid_type_tag<PairNode<T1, T2>> {
...
// ExternalReference - PairNode<T1, T2> a turbofan node returning two values, of
...
#define CODE_ASSEMBLER_BINARY_OP_LIST(V)                                 \
  ...
  V(IntPtrAddWithOverflow, (PairNode<IntPtrT, BoolT>), IntPtrT, IntPtrT) \
  V(IntPtrSubWithOverflow, (PairNode<IntPtrT, BoolT>), IntPtrT, IntPtrT) \
  V(Int32Add, Word32T, Word32T, Word32T)                                 \
  V(Int32AddWithOverflow, (PairNode<Int32T, BoolT>), Int32T, Int32T)     \
  V(Int32Sub, Word32T, Word32T, Word32T)                                 \
  V(Int32Mul, Word32T, Word32T, Word32T)                                 \
  V(Int32MulWithOverflow, (PairNode<Int32T, BoolT>), Int32T, Int32T)     \
...
#define CODE_ASSEMBLER_UNARY_OP_LIST(V)                         \
  ...
  V(Int32AbsWithOverflow, (PairNode<Int32T, BoolT>), Int32T)    \
  V(Int64AbsWithOverflow, (PairNode<Int64T, BoolT>), Int64T)    \
  V(IntPtrAbsWithOverflow, (PairNode<IntPtrT, BoolT>), IntPtrT) \
...
#undef DECLARE_CODE_ASSEMBLER_UNARY_OP
  ...
  Projection(TNode<PairNode<T1, T2>> value) {
