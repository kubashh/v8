...
void SimdScalarLowering::LowerConvert(Node* node, SimdType input_rep_type,
  ...
  if (output_rep_type == SimdType::kInt32x4) {
    DCHECK(input_rep_type == SimdType::kInt16x8);
    shift_val = kShift16;
  } else {
    DCHECK(input_rep_type == SimdType::kInt8x16 &&
           output_rep_type == SimdType::kInt16x8);
    shift_val = kShift8;
  }
...
#undef I32X4_BINOP_CASE
    ...
    case IrOpcode::kI32x4SConvertI16x8High: {
      LowerConvert(node, SimdType::kInt16x8, SimdType::kInt32x4, true);
      break;
    }
    case IrOpcode::kI32x4UConvertI16x8Low:
    case IrOpcode::kI32x4UConvertI16x8High: {
      LowerConvert(node, SimdType::kInt16x8, SimdType::kInt32x4, false);
      break;
    }
    case IrOpcode::kI16x8SConvertI8x16Low:
    case IrOpcode::kI16x8SConvertI8x16High: {
      LowerConvert(node, SimdType::kInt8x16, SimdType::kInt16x8, true);
      break;
    }
    case IrOpcode::kI16x8UConvertI8x16Low:
    case IrOpcode::kI16x8UConvertI8x16High: {
      LowerConvert(node, SimdType::kInt8x16, SimdType::kInt16x8, false);
      break;
    }
    case IrOpcode::kI16x8SConvertI32x4: {
