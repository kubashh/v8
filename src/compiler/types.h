...
#undef DECLARE_TYPE
  ...
  static bitset Lub(i::Isolate* isolate, i::Map* map);
  static bitset Lub(i::Isolate* isolate, i::Object* value);
...
#undef DEFINE_TYPE_CONSTRUCTOR
  ...
  static Type HeapConstant(i::Isolate* isolate, i::Handle<i::HeapObject> value,
                           Zone* zone);
  ...
  static Type NewConstant(i::Isolate* isolate, i::Handle<i::Object> value,
                          Zone* zone);
  ...
  static Type Of(i::Isolate* isolate, i::Object* value, Zone* zone) {
    return NewBitset(
        BitsetType::ExpandInternals(BitsetType::Lub(isolate, value)));
  }
  static Type Of(i::Isolate* isolate, i::Handle<i::Object> value, Zone* zone) {
    return Of(isolate, *value, zone);
  }

  static Type For(i::Isolate* isolate, i::Map* map) {
    return NewBitset(
        BitsetType::ExpandInternals(BitsetType::Lub(isolate, map)));
  }
  static Type For(i::Isolate* isolate, i::Handle<i::Map> map) {
...
class V8_EXPORT_PRIVATE HeapConstantType : public NON_EXPORTED_BASE(TypeBase) {
 ...
 private:
  ...
  static HeapConstantType* New(i::Isolate* isolate,
