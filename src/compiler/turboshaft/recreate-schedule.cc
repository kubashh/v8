...
Node* ScheduleBuilder::ProcessOperation(const OverflowCheckedBinaryOp& op) {
  const Operator* o;
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      switch (op.kind) {
        case OverflowCheckedBinaryOp::Kind::kSignedAdd:
          o = machine.Int32AddWithOverflow();
          break;
        case OverflowCheckedBinaryOp::Kind::kSignedSub:
          o = machine.Int32SubWithOverflow();
          break;
        case OverflowCheckedBinaryOp::Kind::kSignedMul:
