...
Node* ScheduleBuilder::ProcessOperation(const AddOp& op) {
  ...
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      switch (op.kind) {
        case AddOp::Kind::kWithOverflowBit:
          o = machine.Int32AddWithOverflow();
          break;
        case AddOp::Kind::kWithoutOverflowBit:
          o = machine.Int32Add();
          break;
      }
      break;
    ...
    case MachineRepresentation::kFloat32:
      DCHECK(op.kind == AddOp::Kind::kWithoutOverflowBit);
  ...
  if (op.kind == AddOp::Kind::kWithOverflowBit) {
...
Node* ScheduleBuilder::ProcessOperation(const SubOp& op) {
  ...
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      switch (op.kind) {
        case SubOp::Kind::kWithOverflowBit:
          o = machine.Int32SubWithOverflow();
          break;
        case SubOp::Kind::kWithoutOverflowBit:
          o = machine.Int32Sub();
          break;
      }
      break;
    case MachineRepresentation::kWord64:
      ...
      break;
    case MachineRepresentation::kFloat32:
      DCHECK(op.kind == SubOp::Kind::kWithoutOverflowBit);
  ...
  Node* node = AddNode(o, {GetNode(op.left()), GetNode(op.right())});
  if (op.kind == SubOp::Kind::kWithOverflowBit) {
    node = AddNode(common.Projection(0), {node});
  }
  return node;
}
Node* ScheduleBuilder::ProcessOperation(const MulOp& op) {
  const Operator* o;
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      switch (op.kind) {
        case MulOp::Kind::kWithOverflowBit:
          o = machine.Int32MulWithOverflow();
          break;
        case MulOp::Kind::kWithoutOverflowBit:
          o = machine.Int32Mul();
          break;
      }
      break;
    case MachineRepresentation::kWord64:
      DCHECK(op.kind == MulOp::Kind::kWithoutOverflowBit);
      o = machine.Int64Mul();
      break;
    case MachineRepresentation::kFloat32:
      DCHECK(op.kind == MulOp::Kind::kWithoutOverflowBit);
  ...
  Node* node = AddNode(o, {GetNode(op.left()), GetNode(op.right())});
  if (op.kind == MulOp::Kind::kWithOverflowBit) {
    node = AddNode(common.Projection(0), {node});
  }
  return node;
}
...
Node* ScheduleBuilder::ProcessOperation(const BitwiseOrOp& op) {
  const Operator* o;
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      o = machine.Word32Or();
...
Node* ScheduleBuilder::ProcessOperation(const BitwiseXorOp& op) {
  const Operator* o;
  switch (op.rep) {
    case MachineRepresentation::kWord32:
      o = machine.Word32Xor();
