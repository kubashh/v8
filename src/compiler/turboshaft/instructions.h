...
struct BitwiseAndInstr : InstructionT<BitwiseAndInstr> {
  MachineRepresentation rep;
  InstrIndex inputs[2];
  ...
  BitwiseAndInstr(InstrIndex left, InstrIndex right, MachineRepresentation rep)
      : rep(rep), inputs{left, right} {}
};

struct EqualInstr : InstructionT<EqualInstr> {
  MachineRepresentation rep;
  InstrIndex inputs[2];
  ...
  EqualInstr(InstrIndex left, InstrIndex right, MachineRepresentation rep)
      : rep(rep), inputs{left, right} {}
};
