...
class WasmLoweringReducer : public Next {
 public:
  ...
  V<Any> REDUCE(ArrayGet)(V<HeapObject> array, V<Word32> index,
  ...
  V<None> REDUCE(ArraySet)(V<HeapObject> array, V<Word32> index, V<Any> value,
  ...
  V<Word32> REDUCE(ArrayLength)(V<HeapObject> array, CheckForNull null_check) {
