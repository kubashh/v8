...
class SnapshotTable {
 private:
  using TableEntry = detail::SnapshotTableEntry<Value, KeyData>;
  struct LogEntry;
  struct SnapshotData;

 public:
  using Key = detail::SnapshotTableKey<Value, KeyData>;
 ...
 private:
  ...
  static constexpr uint32_t kNoMergeOffset = TableEntry::kNoMergeOffset;
  static constexpr uint32_t kNoMergedPredecessor =
      TableEntry::kNoMergedPredecessor;
};
