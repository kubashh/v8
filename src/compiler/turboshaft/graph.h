...
class Graph {
 public:
  ...
  absl::flat_hash_set<uint32_t>& stack_checks_to_remove() {
    return stack_checks_to_remove_;
  }
  const absl::flat_hash_set<uint32_t>& stack_checks_to_remove() const {
    return stack_checks_to_remove_;
  }
 ...
 private:
  ...
  absl::flat_hash_set<uint32_t> stack_checks_to_remove_;
};
