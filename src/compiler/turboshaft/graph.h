...
class Graph {
 public:
  ...
  base::iterator_range<OperationIterator<false>> operations(
      const Block& block) {
    return operations(block.begin, block.end);
  }
  ...
  base::iterator_range<OperationIterator<true>> operations(OpIndex begin,
                                                           OpIndex end) const {
    return {OperationIterator<true>(begin, this),
            OperationIterator<true>(end, this)};
  }

  base::iterator_range<OperationIterator<false>> operations(OpIndex begin,
                                                            OpIndex end) {
    return {OperationIterator<false>(begin, this),
            OperationIterator<false>(end, this)};
  }
...
std::ostream& operator<<(std::ostream& os, AsBlockHeader block);
