...
#undef CHECK_OBJECT_IS_CASE
    ...
    case IrOpcode::kPlainPrimitiveToWord32:
      return __ ConvertJSPrimitiveToUntagged(
          Map(node->InputAt(0)), ConvertJSPrimitiveToUntaggedOp::Kind::kInt32,
          ConvertJSPrimitiveToUntaggedOp::InputAssumptions::kPlainPrimitive);
    case IrOpcode::kPlainPrimitiveToFloat64:
      return __ ConvertJSPrimitiveToUntagged(
          Map(node->InputAt(0)), ConvertJSPrimitiveToUntaggedOp::Kind::kFloat64,
          ConvertJSPrimitiveToUntaggedOp::InputAssumptions::kPlainPrimitive);
...
#define CONVERT_PRIMITIVE_TO_OBJECT_CASE(name, kind, input_type,              \
  ...
  case IrOpcode::k##name:                                                     \
    return __ ConvertUntaggedToJSPrimitive(                                   \
        Map(node->InputAt(0)), ConvertUntaggedToJSPrimitiveOp::Kind::k##kind, \
        V<input_type>::rep,                                                   \
    ...
    case IrOpcode::kChangeFloat64ToTagged:
      return __ ConvertUntaggedToJSPrimitive(
          Map(node->InputAt(0)), ConvertUntaggedToJSPrimitiveOp::Kind::kNumber,
...
#define CONVERT_PRIMITIVE_TO_OBJECT_OR_DEOPT_CASE(name, kind, input_type, \
  ...
  case IrOpcode::k##name: {                                               \
    ...
    return __ ConvertUntaggedToJSPrimitiveOrDeopt(                        \
        ...
        ConvertUntaggedToJSPrimitiveOrDeoptOp::Kind::k##kind,             \
        V<input_type>::rep,                                               \
...
#define CONVERT_OBJECT_TO_PRIMITIVE_CASE(name, kind, input_assumptions)       \
  case IrOpcode::k##name:                                                     \
    return __ ConvertJSPrimitiveToUntagged(                                   \
        Map(node->InputAt(0)), ConvertJSPrimitiveToUntaggedOp::Kind::k##kind, \
...
#define TRUNCATE_OBJECT_TO_PRIMITIVE_CASE(name, kind, input_assumptions)       \
  case IrOpcode::k##name:                                                      \
    return __ TruncateJSPrimitiveToUntagged(                                   \
        Map(node->InputAt(0)), TruncateJSPrimitiveToUntaggedOp::Kind::k##kind, \
...
#undef TRUNCATE_OBJECT_TO_PRIMITIVE_CASE
    ...
    case IrOpcode::kCheckedTruncateTaggedToWord32:
      ...
      return __ TruncateJSPrimitiveToUntaggedOrDeopt(
          Map(node->InputAt(0)), dominating_frame_state,
          TruncateJSPrimitiveToUntaggedOrDeoptOp::Kind::kInt32,
          input_requirement,
...
#undef CHANGE_OR_DEOPT_INT_CASE
    ...
    case IrOpcode::kCheckedTaggedToInt32: {
      ...
      return __ ConvertJSPrimitiveToUntaggedOrDeopt(
          ...
          ConvertJSPrimitiveToUntaggedOrDeoptOp::PrimitiveKind::kInt32,
          params.mode(), params.feedback());
    }
    ...
    case IrOpcode::kCheckedTaggedToInt64: {
      ...
      return __ ConvertJSPrimitiveToUntaggedOrDeopt(
          Map(node->InputAt(0)), dominating_frame_state,
          ConvertJSPrimitiveToUntaggedOrDeoptOp::ObjectKind::kNumber,
          ConvertJSPrimitiveToUntaggedOrDeoptOp::PrimitiveKind::kInt64,
          params.mode(), params.feedback());
    }
...
#define CASE(mode)                                                          \
  case CheckTaggedInputMode::k##mode:                                       \
    from_kind = ConvertJSPrimitiveToUntaggedOrDeoptOp::ObjectKind::k##mode; \
    break;
        CASE(Number)
...
#undef CASE
      ...
      return __ ConvertJSPrimitiveToUntaggedOrDeopt(
          ...
          ConvertJSPrimitiveToUntaggedOrDeoptOp::PrimitiveKind::kFloat64,
    ...
    case IrOpcode::kCheckedTaggedToArrayIndex: {
      ...
      return __ ConvertJSPrimitiveToUntaggedOrDeopt(
          ...
          ConvertJSPrimitiveToUntaggedOrDeoptOp::PrimitiveKind::kArrayIndex,
