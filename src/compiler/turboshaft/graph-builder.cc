...
OpIndex GraphBuilder::Process(Node* node, BasicBlock* block) {
  ...
  switch (op->opcode()) {
    ...
    case IrOpcode::kInt64Constant:
      return Emit<ConstantOp>(ConstantOp::Kind::kWord64,
                              OpParameter<int64_t>(op));
    case IrOpcode::kInt32Constant:
      return Emit<ConstantOp>(ConstantOp::Kind::kWord32,
                              OpParameter<int32_t>(op));
    case IrOpcode::kHeapConstant:
      return Emit<ConstantOp>(ConstantOp::Kind::kHeapObject,
                              HeapConstantOf(op));
    case IrOpcode::kCompressedHeapConstant:
      return Emit<ConstantOp>(ConstantOp::Kind::kCompressedHeapObject,
                              HeapConstantOf(op));
    case IrOpcode::kExternalConstant:
      return Emit<ConstantOp>(ConstantOp::Kind::kExternal,
    ...
    case IrOpcode::kLoad:
      return Emit<LoadOp>(LoadOp::Kind::kRaw, LoadRepresentationOf(op),
                          Map(node->InputAt(0)));
    ...
    case IrOpcode::kCall: {
      ...
      OpIndex checkpoint = Emit<CheckpointOp>(base::VectorOf<OpIndex>({}));
    ...
    case IrOpcode::kReturn: {
      ...
      return Emit<ReturnOp>(base::VectorOf(return_values),
