...
struct AssemblerData {
  ...
  AssemblerData(DataComponentProvider* data_provider, Graph& input_graph, Graph& output_graph, Zone* phase_zone)
...
class Assembler : public AssemblerData,
 ...
 public:
  Assembler(DataComponentProvider* data_provider, Graph& input_graph, Graph& output_graph, Zone* phase_zone)
      : AssemblerData(data_provider, input_graph, output_graph, phase_zone), Stack() {
