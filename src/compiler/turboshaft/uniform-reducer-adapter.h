...
//      ReduceInputGraphOperation) is not visited for OperationXyz.
...
//
// InputGraph
//            OpA                     OpB     ____________________________
//             |                       |     |  ___                       |
//             |                       |     | |   |                      |
// R1          v                       v     | |   v                      v
//           RIGOpA                  RIGOpB  | |  ROpA                   ROpB
//             |                       |     | |   |                      |
//             |     __          __    |     | |   |    ___        ___    |
//             |    |  |        |  |   |     | |   |   |   |      |   |   |
// MyReducer   |    |  v        v  |   |     | |   |   |   v      v   |   |
//             v    | RIGOperation |   v     | |   v   |  ROperation  |   v
// (Adapter) RIGOpA |      v       | RIGOpB  | |  ROpA |      v       | RIGOpB
//             |____| Continuation |___|     | |   |___| Continuation |___|
//                     |        |            | |          |        |
//                     |        |            | |          |        |
