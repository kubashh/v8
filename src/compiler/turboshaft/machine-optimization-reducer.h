 ...
 public:
  ...
  OpIndex REDUCE(Change)(OpIndex input, ChangeOp::Kind kind,
    ...
    if (uint64_t value;
      ...
      using RR = RegisterRepresentation;
      switch (multi(kind, from, to)) {
        case multi(Kind::kSignExtend, RR::Word32(), RR::Word64()):
          return __ Word64Constant(int64_t{static_cast<int32_t>(value)});
        case multi(Kind::kZeroExtend, RR::Word32(), RR::Word64()):
        case multi(Kind::kBitcast, RR::Word32(), RR::Word64()):
          return __ Word64Constant(uint64_t{static_cast<uint32_t>(value)});
        case multi(Kind::kBitcast, RR::Word32(), RR::Float32()):
          return __ Float32Constant(
              base::bit_cast<float>(static_cast<uint32_t>(value)));
        case multi(Kind::kBitcast, RR::Word64(), RR::Float64()):
          return __ Float64Constant(base::bit_cast<double>(value));
        case multi(Kind::kSignedToFloat, RR::Word32(), RR::Float64()):
          return __ Float64Constant(
              static_cast<double>(static_cast<int32_t>(value)));
        case multi(Kind::kSignedToFloat, RR::Word64(), RR::Float64()):
          return __ Float64Constant(
              static_cast<double>(static_cast<int64_t>(value)));
        case multi(Kind::kUnsignedToFloat, RR::Word32(), RR::Float64()):
          return __ Float64Constant(
              static_cast<double>(static_cast<uint32_t>(value)));
        case multi(Kind::kTruncate, RR::Word64(), RR::Word32()):
    ...
    if (matcher.Is<ConstantOp>(rhs)) {
      ...
      if (kind == Kind::kPower) {
        ...
        if (matcher.MatchFloat(rhs, 0.5)) {
          ...
          Block* if_neg_infinity = __ NewBlock();
          Block* otherwise = __ NewBlock();
          Block* merge = __ NewBlock();
          __ Branch(__ FloatLessThanOrEqual(
          ...
          if (__ Bind(if_neg_infinity)) {
            infty = __ FloatConstant(V8_INFINITY, rep);
            __ Goto(merge);
          }

          if (__ Bind(otherwise)) {
            sqrt = __ FloatSqrt(lhs, rep);
            __ Goto(merge);
          }

          __ BindReachable(merge);
          if (infty.valid() && sqrt.valid()) {
            return __ Phi(base::VectorOf({infty, sqrt}), rep);
          } else if (infty.valid()) {
            return infty;
          } else {
            DCHECK(sqrt.valid());
