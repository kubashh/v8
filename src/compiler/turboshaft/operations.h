...
struct OperationT : Operation {
  ...
  bool operator==(const Derived& other) const {
    ...
    return static_cast<const Derived*>(this)->options() == other.options();
  }
  size_t hash_value() const {
    return base::hash_combine(opcode, inputs(),
                              static_cast<const Derived*>(this)->options());
  }

  void PrintOptions(std::ostream& os) const {
    auto options = static_cast<const Derived*>(this)->options();
    constexpr size_t options_count = std::tuple_size<decltype(options)>::value;
    if (options_count == 0) {
      return;
    }
 ...
 private:
  ...
  static void PrintOptionsHelper(std::ostream& os,
    ...
    os << "[";
    bool first = true;
    ITERATE_PACK(first ? (first = false, os << std::get<I>(options))
...
struct BinaryOp : FixedOperationT<2, BinaryOp> {
  ...
  BinaryOp(OpIndex left, OpIndex right, Kind kind, MachineRepresentation rep)
      : Base({left, right}), kind(kind), rep(rep) {}
  auto options() const { return std::make_tuple(kind, rep); }
  void PrintOptions(std::ostream& os) const;
};

struct OverflowCheckedBinaryOp : FixedOperationT<2, OverflowCheckedBinaryOp> {
  enum class Kind : uint8_t {
    kSignedAdd,
    kSignedMul,
    kSignedSub,
  ...
  OverflowCheckedBinaryOp(OpIndex left, OpIndex right, Kind kind,
                          MachineRepresentation rep)
      : Base({left, right}), kind(kind), rep(rep) {}
  auto options() const { return std::make_tuple(kind, rep); }
  void PrintOptions(std::ostream& os) const;
...
inline std::ostream& operator<<(std::ostream& os, FloatUnaryOp::Kind kind) {
  switch (kind) {
...
inline std::ostream& operator<<(std::ostream& os, ShiftOp::Kind kind) {
  switch (kind) {
...
struct EqualOp : FixedOperationT<2, EqualOp> {
  ...
  auto options() const { return std::make_tuple(rep); }
};
...
inline std::ostream& operator<<(std::ostream& os, ComparisonOp::Kind kind) {
  switch (kind) {
...
struct ChangeOp : FixedOperationT<1, ChangeOp> {
  ...
  auto options() const { return std::make_tuple(kind, from, to); }
};

inline std::ostream& operator<<(std::ostream& os, ChangeOp::Kind kind) {
  switch (kind) {
...
struct TaggedBitcastOp : FixedOperationT<1, TaggedBitcastOp> {
  ...
  auto options() const { return std::make_tuple(from, to); }
};
...
struct LoadOp : FixedOperationT<1, LoadOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const { return std::make_tuple(kind, loaded_rep, offset); }
};
...
struct IndexedLoadOp : FixedOperationT<2, IndexedLoadOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const {
    return std::make_tuple(kind, loaded_rep, element_scale, offset);
  }
};
...
struct StoreOp : FixedOperationT<2, StoreOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const {
    return std::make_tuple(kind, stored_rep, write_barrier, offset);
  }
};
...
struct IndexedStoreOp : FixedOperationT<3, IndexedStoreOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const {
    return std::make_tuple(kind, stored_rep, write_barrier, element_scale,
                           offset);
  }
};
...
struct StackPointerGreaterThanOp
  ...
  auto options() const { return std::make_tuple(kind); }
};
...
struct FrameStateOp : OperationT<FrameStateOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const { return std::make_tuple(inlined, data); }
};
...
struct DeoptimizeOp : FixedOperationT<1, DeoptimizeOp> {
  ...
  auto options() const { return std::make_tuple(parameters); }
};
...
struct DeoptimizeIfOp : FixedOperationT<2, DeoptimizeIfOp> {
  ...
  auto options() const { return std::make_tuple(negated, parameters); }
};
...
struct ParameterOp : FixedOperationT<0, ParameterOp> {
  ...
  auto options() const { return std::make_tuple(parameter_index, debug_name); }
  void PrintOptions(std::ostream& os) const;
};
...
struct CallOp : OperationT<CallOp> {
  ...
  auto options() const { return std::make_tuple(descriptor); }
};
...
struct ReturnOp : OperationT<ReturnOp> {
  ...
  auto options() const { return std::make_tuple(pop_count); }
};
...
struct GotoOp : FixedOperationT<0, GotoOp> {
  ...
  auto options() const { return std::make_tuple(destination); }
};
...
struct BranchOp : FixedOperationT<1, BranchOp> {
  ...
  auto options() const { return std::make_tuple(if_true, if_false); }
};
...
struct SwitchOp : FixedOperationT<1, SwitchOp> {
  ...
  void PrintOptions(std::ostream& os) const;
  auto options() const { return std::make_tuple(cases, default_case); }
};
...
inline std::ostream& operator<<(std::ostream& os, ProjectionOp::Kind kind) {
  switch (kind) {
