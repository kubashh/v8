...
#undef DEFINE_KIND
  ...
  void Validate(const Graph& graph) const {
    DCHECK(ValidOpInputRep(graph, input(), RegisterRepresentation::Simd128()));
    DCHECK(ValidOpInputRep(graph, shift(), RegisterRepresentation::Word32()));
  }
...
#undef DEFINE_KIND
  ...
  void Validate(const Graph& graph) const {
    ...
    switch (kind) {
      ...
      case Kind::kI16x8:
      case Kind::kI32x4:
        input_rep = RegisterRepresentation::Word32();
        break;
      case Kind::kI64x2:
        input_rep = RegisterRepresentation::Word64();
        break;
      case Kind::kF32x4:
        input_rep = RegisterRepresentation::Float32();
        break;
      case Kind::kF64x2:
        input_rep = RegisterRepresentation::Float64();
        break;
...
#undef DEFINE_KIND
  ...
  void Validate(const Graph& graph) const {
    DCHECK(ValidOpInputRep(graph, first(), RegisterRepresentation::Simd128()));
    DCHECK(ValidOpInputRep(graph, second(), RegisterRepresentation::Simd128()));
    DCHECK(ValidOpInputRep(graph, third(), RegisterRepresentation::Simd128()));
  }
