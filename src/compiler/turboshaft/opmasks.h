...
#define SIMD_SIGN_EXNTENSION_UNARY_MASK(kind) \
  using kSimd128##kind = Simd128UnaryMask::For<Simd128UnaryOp::Kind::k##kind>;
FOREACH_SIMD_128_UNARY_SIGN_EXTENSION_OPCODE(SIMD_SIGN_EXNTENSION_UNARY_MASK)
#undef SIMD_SIGN_EXNTENSION_UNARY_MASK
