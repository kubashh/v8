...
bool CallOp::IsStackCheck(const Graph& graph, JSHeapBroker* broker,
  ...
  auto is_this_builtin = [&](int input_index) {
    ...
    std::cout << "Not right builtin at index " << input_index << "\n";
    return false;
  };
