...
// TODO(solanes, v8:10866): Remove once we remove the FLAG_local_heap and the
// special casing for concurrent_inlining off.
...
// should only be used with concurrent inlining off.
