...
Reduction JSTypedLowering::ReduceJSLoadNamedFromSuper(Node* node) {
...
Reduction JSTypedLowering::ReduceJSStoreNamed(Node* node) {
...
Reduction JSTypedLowering::ReduceJSStoreNamedOwn(Node* node) {
...
Reduction JSTypedLowering::ReduceJSHasProperty(Node* node) {
...
Reduction JSTypedLowering::ReduceJSStoreDataPropertyInLiteral(Node* node) {
...
Reduction JSTypedLowering::ReduceJSStoreInArrayLiteral(Node* node) {
...
Reduction JSTypedLowering::ReducePropertyAccess(
...
Reduction JSTypedLowering::ReduceMinimorphicPropertyAccess(
