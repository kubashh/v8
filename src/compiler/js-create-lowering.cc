...
Reduction JSCreateLowering::ReduceJSCreateArguments(Node* node) {
  ...
  SharedFunctionInfoRef shared = js_heap_broker()->SharedFunctionInfoRef(
...
Reduction JSCreateLowering::ReduceJSCreateArray(Node* node) {
  ...
  if (!p.site().is_null()) {
    site = js_heap_broker()->AllocationSiteRef(p.site());
  }
...
Reduction JSCreateLowering::ReduceJSCreateBoundFunction(Node* node) {
  ...
  int const arity = static_cast<int>(p.arity());
  MapRef map = js_heap_broker()->MapRef(p.map());
...
Reduction JSCreateLowering::ReduceJSCreateClosure(Node* node) {
  ...
  SharedFunctionInfoRef shared =
      js_heap_broker()->SharedFunctionInfoRef(p.shared_info());
  HeapObjectRef feedback_cell =
      js_heap_broker()->HeapObjectRef(p.feedback_cell());
  ...
  if (!feedback_cell.map().equals(
          js_heap_broker()->MapRef(factory()->many_closures_cell_map()))) {
    return NoChange();
  }
...
Reduction JSCreateLowering::ReduceJSCreateLiteralArrayOrObject(Node* node) {
  ...
  FeedbackVectorRef vector =
      js_heap_broker()->FeedbackVectorRef(p.feedback().vector());
...
Reduction JSCreateLowering::ReduceJSCreateFunctionContext(Node* node) {
  ...
  ScopeInfoRef scope_info =
      js_heap_broker()->ScopeInfoRef(parameters.scope_info());
...
Reduction JSCreateLowering::ReduceJSCreateWithContext(Node* node) {
  ...
  ScopeInfoRef scope_info =
      js_heap_broker()->ScopeInfoRef(ScopeInfoOf(node->op()));
...
NativeContextRef JSCreateLowering::native_context_ref() const {
  ...
  return js_heap_broker()->NativeContextRef(native_context());
}
