...
// To handle dead code, it is important that UpdateEffectPhi() is only executed
// after the control inputs and the normal phis of the corresponding block have
// been processed.
void UpdateEffectPhi(Node* node, BasicBlock* block,
  ...
  for (int i = 0; i < node->op()->EffectInputCount(); i++) {
    ...
    BlockEffectControlData* block_effect =
