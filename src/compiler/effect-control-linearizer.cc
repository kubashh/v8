...
Node* EffectControlLinearizer::LowerCheckedTaggedToArrayIndex(
  ...
  Node* object_to_int32_function =
      __ ExternalConstant(ExternalReference::object_to_int32_slow_function());
  auto call_descriptor =
      Linkage::GetSimplifiedCDescriptor(graph()->zone(), builder.Build());
  Node* index =
      __ Call(common()->Call(call_descriptor), object_to_int32_function, value);
