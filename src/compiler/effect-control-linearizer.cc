...
constexpr int64_t kMinusZeroBits = static_cast<int64_t>(1) << 63;
constexpr int32_t kMinusZeroLoBits = static_cast<int32_t>(kMinusZeroBits);
constexpr int32_t kMinusZeroHiBits = static_cast<int32_t>(kMinusZeroBits >> 32);
