...
class V8_EXPORT_PRIVATE CommonOperatorBuilder final
 ...
 public:
  ...
  const Operator* DelayedStringConstant(Zone* shared_zone, Handle<String> str);
  const Operator* DelayedStringConstant(Zone* shared_zone, double num);
  const Operator* DelayedStringConstant(Zone* shared_zone,
                                        const StringConstantBase* lhs,
