...
class LinkageLocationAllocator {
 public:
  explicit constexpr LinkageLocationAllocator(wasm::LinkageAllocator allocator)
...
CallDescriptor* GetWasmCallDescriptor(Zone* zone, wasm::FunctionSig* fsig,
  ...
  LinkageLocationAllocator params(wasm::kParamRegisters);
  ...
  LinkageLocationAllocator rets(wasm::kReturnRegisters);
