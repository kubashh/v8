...
void WasmGraphBuilder::TypeCheck(Node* object, Node* rtt,
                                 WasmTypeCheckConfig config, bool null_succeeds,
                                 Callbacks callbacks) {
  callbacks.fail_if_not(gasm_->WasmTypeCheck(object, rtt, config),
                        BranchHint::kTrue);
}
