...
struct WasmGraphBuilder::IntConvertOps {
 ...
 protected:
  ...
  explicit IntConvertOps(MachineRepresentation word_rep, wasm::WasmOpcode ne_op)
      : word_rep_(word_rep), ne_op_(ne_op) {}
...
struct Int64ConvertOps : public WasmGraphBuilder::IntConvertOps {
 ...
 protected:
  Int64ConvertOps()
      : IntConvertOps(MachineRepresentation::kWord64, wasm::kExprI64Ne) {}
