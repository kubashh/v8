...
// Clarifies in function signatures that a method is thread-safe (for
// background serialization).
class ThreadSafeTag final {
 public:
  ThreadSafeTag() {}
};
...
class PropertyCellRef : public HeapObjectRef {
 public:
  ...
  V8_WARN_UNUSED_RESULT bool Serialize(ThreadSafeTag tag = {}) const;
  void SerializeAsProtector(ThreadSafeTag tag = {}) const {
    bool serialized = Serialize(tag);
