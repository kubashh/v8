...
class V8_EXPORT_PRIVATE ObjectRef {
 public:
  ...
  ObjectRef(JSHeapBroker* broker, Handle<Object> object, bool check_type = true)
      : ObjectRef(broker, object, BackgroundSerialization::kDisallowed,
                  check_type) {}
