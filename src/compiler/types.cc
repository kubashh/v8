...
Type::bitset BitsetType::Lub(i::Isolate* isolate, i::Map* map) {
  DisallowHeapAllocation no_allocation;
...
Type::bitset BitsetType::Lub(i::Isolate* isolate, i::Object* value) {
  DisallowHeapAllocation no_allocation;
  if (value->IsNumber()) {
...
Type Type::NewConstant(i::Isolate* isolate, i::Handle<i::Object> value,
                       Zone* zone) {
  if (IsInteger(*value)) {
...
// static
Type Type::HeapConstant(i::Isolate* isolate, i::Handle<i::HeapObject> value,
                        Zone* zone) {
