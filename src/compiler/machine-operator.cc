...
#undef ATOMIC_COMPARE_EXCHANGE
  ...
  struct Word32AtomicPairLoadOperator : public Operator1<AtomicMemoryOrder> {
    explicit Word32AtomicPairLoadOperator(AtomicMemoryOrder order)
        : Operator1<AtomicMemoryOrder>(IrOpcode::kWord32AtomicPairLoad,
                                       Operator::kNoDeopt | Operator::kNoThrow,
                                       "Word32AtomicPairLoad", 2, 1, 1, 2, 1, 0,
                                       order) {}
  };
  struct Word32AcquirePairLoadOperator final
      : public Word32AtomicPairLoadOperator {
    Word32AcquirePairLoadOperator()
        : Word32AtomicPairLoadOperator(AtomicMemoryOrder::kAcqRel) {}
  };
  struct Word32SeqCstPairLoadOperator final
      : public Word32AtomicPairLoadOperator {
    Word32SeqCstPairLoadOperator()
        : Word32AtomicPairLoadOperator(AtomicMemoryOrder::kSeqCst) {}
  };
  Word32AcquirePairLoadOperator kWord32AcquirePairLoad;
  Word32SeqCstPairLoadOperator kWord32SeqCstPairLoad;

  struct Word32AtomicPairStoreOperator : public Operator1<AtomicMemoryOrder> {
    explicit Word32AtomicPairStoreOperator(AtomicMemoryOrder order)
        : Operator1<AtomicMemoryOrder>(IrOpcode::kWord32AtomicPairStore,
                                       Operator::kNoDeopt | Operator::kNoThrow,
                                       "Word32AtomicPairStore", 4, 1, 1, 0, 1,
                                       0, order) {}
  };
  struct Word32ReleasePairStoreOperator final
      : public Word32AtomicPairStoreOperator {
    Word32ReleasePairStoreOperator()
        : Word32AtomicPairStoreOperator(AtomicMemoryOrder::kAcqRel) {}
  };
  struct Word32SeqCstPairStoreOperator final
      : public Word32AtomicPairStoreOperator {
    Word32SeqCstPairStoreOperator()
        : Word32AtomicPairStoreOperator(AtomicMemoryOrder::kSeqCst) {}
  };
  Word32ReleasePairStoreOperator kWord32ReleasePairStore;
...
const Operator* MachineOperatorBuilder::Word32AtomicPairLoad(
  ...
  if (order == AtomicMemoryOrder::kAcqRel) {
    return &cache_.kWord32AcquirePairLoad;
  }
...
const Operator* MachineOperatorBuilder::Word32AtomicPairStore(
    AtomicMemoryOrder order) {
  if (order == AtomicMemoryOrder::kAcqRel) {
    return &cache_.kWord32ReleasePairStore;
  }
  DCHECK_EQ(order, AtomicMemoryOrder::kSeqCst);
