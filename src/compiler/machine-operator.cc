...
#define MACHINE_PURE_OP_LIST(V)                                            \
  ...
  V(I64x2AnyTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I64x2AllTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I32x4AnyTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I32x4AllTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I16x8AnyTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I16x8AllTrue, Operator::kNoProperties, 1, 0, 1)                        \
  V(I8x16AnyTrue, Operator::kNoProperties, 1, 0, 1)                        \
