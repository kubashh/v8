...
#define STACK_POINTER_GREATER_THAN(Kind)                              \
  ...
  STACK_POINTER_GREATER_THAN(FunctionEntry)
  STACK_POINTER_GREATER_THAN(IterationBody)
  STACK_POINTER_GREATER_THAN(Unknown)
...
const Operator* MachineOperatorBuilder::StackPointerGreaterThan(
  ...
  switch (kind) {
    case StackCheckKind::kFunctionEntry:
      return &cache_.kStackPointerGreaterThanFunctionEntry;
    case StackCheckKind::kIterationBody:
      return &cache_.kStackPointerGreaterThanIterationBody;
    case StackCheckKind::kUnknown:
      return &cache_.kStackPointerGreaterThanUnknown;
  }
  UNREACHABLE();
}
