...
EVALUATE(VLGV) {
  ...
  switch (m4) {
    case 0:
      set_register(r1, get_simd_register_by_lane<int8_t>(r3, index));
      break;
    case 1:
      set_register(r1, get_simd_register_by_lane<int16_t>(r3, index));
      break;
    case 2:
      set_register(r1, get_simd_register_by_lane<int32_t>(r3, index));
      break;
    default:
      UNREACHABLE();
      break;
...
void vsum(void* dst, void* src1, void* src2) {
  D value = 0;
...
EVALUATE(VSUM) {
  ...
  switch (m4) {
    case 0:
      vsum<int8_t, int32_t>(&get_simd_register(r1), &src1, &src2);
      break;
    case 1:
      vsum<int16_t, int32_t>(&get_simd_register(r1), &src1, &src2);
      break;
    default:
      UNREACHABLE();
      break;
...
EVALUATE(VSUMG) {
  ...
  switch (m4) {
    case 1:
      vsum<int16_t, int64_t>(&get_simd_register(r1), &src1, &src2);
      break;
    case 2:
      vsum<int32_t, int64_t>(&get_simd_register(r1), &src1, &src2);
      break;
    default:
      UNREACHABLE();
      break;
...
template<class S, class D>
void vector_pack(void* dst, void* src1, void* src2, bool saturate,
...
EVALUATE(VPK) {
  ...
  switch (m4) {
    case 1:
      vector_pack<int16_t, int8_t>(&get_simd_register(r1), &src1, &src2,
                                   false);
      break;
    case 2:
      vector_pack<int32_t, int16_t>(&get_simd_register(r1), &src1, &src2,
                                    false);
      break;
    case 3:
      vector_pack<int64_t, int32_t>(&get_simd_register(r1), &src1, &src2,
                                    false);
      break;
    default:
      UNREACHABLE();
