...
Node* CodeStubAssembler::Float64Max(Node* a, Node* b) {
  return SelectConstant(Float64LessThan(a, b), b, a,
                        MachineRepresentation::kFloat64);
}

Node* CodeStubAssembler::Float64Min(Node* a, Node* b) {
  return SelectConstant(Float64LessThan(a, b), a, b,
                        MachineRepresentation::kFloat64);
}

Node* CodeStubAssembler::NumberMax(Node* a, Node* b) {
...
Node* CodeStubAssembler::NumberMin(Node* a, Node* b) {
  VARIABLE(result, MachineRepresentation::kTagged);
  Label done(this), greater_than_equal(this);
  GotoUnlessNumberLessThan(a, b, &greater_than_equal);
  result.Bind(a);
