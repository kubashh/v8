...
Node* CodeStubAssembler::StringToNumber(Node* context, Node* input) {
  ...
  GotoIf(IsSetWord32(hash, String::kContainsNoCachedArrayIndexMask), &runtime);
...
void CodeStubAssembler::TryToName(Node* key, Label* if_keyisindex,
  ...
  GotoIf(IsClearWord32(hash, Name::kContainsNoCachedArrayIndexMask),
         &if_hascachedindex);
        ...
        BIND(&if_rhsisnotsmi);
        {
          ...
          BIND(&if_lhsisoddball);
          {
            ...
            BIND(&if_lhsisnotboolean);
            {
              ...
              Branch(IsUndetectableMap(rhs_map), &if_notequal, &if_equal);
            }
          }
          ...
          BIND(&if_lhsisreceiver);
          {
            ...
            BIND(&if_rhsisnotreceiver);
            {
              ...
              { Branch(IsUndetectableMap(lhs_map), &if_notequal, &if_equal); }
