...
TNode<Code> CodeStubAssembler::GetSharedFunctionInfoCode(
  ...
  Label check_is_uncompiled_data_without_scope(this);
  Label check_is_uncompiled_data_with_scope(this);
  Label check_is_function_template_info(this);
  Label check_is_interpreter_data(this);
  Label* case_labels[] = {&check_is_bytecode_array,
                          &check_is_exported_function_data,
                          &check_is_fixed_array,
                          &check_is_uncompiled_data_without_scope,
                          &check_is_uncompiled_data_with_scope,
  ...
  // IsUncompiledDataWithScope | IsUncompiledDataWithoutScope: Compile lazy
  BIND(&check_is_uncompiled_data_with_scope);
  Goto(&check_is_uncompiled_data_without_scope);
  BIND(&check_is_uncompiled_data_without_scope);
