...
TNode<Object> CodeStubAssembler::LoadJSObjectWithLength(
    SloppyTNode<JSObjectWithLength> array) {
  return LoadObjectField(array, JSObjectWithLength::kLengthOffset);
}
