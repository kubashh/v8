...
TNode<IntPtrT> CodeStubAssembler::EntryIndexToIndex(
  ...
  Node* descriptor_size = Int32Constant(Array::kEntrySize);
  Node* index = Int32Mul(entry_index, descriptor_size);
...
void CodeStubAssembler::LookupBinary(TNode<Name> unique_name,
  ...
  BIND(&scan_loop);
  {
    ...
    GotoIf(Int32GreaterThanOrEqual(sort_index, number_of_valid_entries),
           if_not_found);
