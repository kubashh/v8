...
TNode<Object> CodeStubAssembler::GetHeapObject(TNode<MaybeObject> value) {
  return UncheckedCast<Object>(BitcastWordToTagged(WordAnd(
      BitcastMaybeObjectToWord(value), IntPtrConstant(~kWeakHeapObjectMask))));
}

TNode<Object> CodeStubAssembler::ToStrongHeapObject(TNode<MaybeObject> value) {
  AssertIsStrongHeapObject(value);
  return UncheckedCast<Object>(
      BitcastWordToTagged(BitcastMaybeObjectToWord(value)));
}
