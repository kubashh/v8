...
#undef NATIVE_CONTEXT_FIELD_ACCESSOR
  ...
  //
  // Theorem. The module with the largest vended ordinal finishing evaluation
  // implies all modules that depend on still-evaluating async modules are
  // finished evaluating.
  //
  // For an async module that participates in a single module graph (i.e. a
  // single call in the specification to an Evaluate() call),
  //
  // https://tc39.es/ecma262/#sec-moduleevaluation
  inline void DidFinishModuleAsyncEvaluation(int ordinal);
