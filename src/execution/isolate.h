...
class V8_EXPORT_PRIVATE Isolate final : private HiddenFactory {
 ...
 public:
  ...
  static PerIsolateThreadData* CurrentPerIsolateThreadData() {
    return current_per_isolate_thread_data_;
  }

  // Returns the isolate inside which the current thread is running or nullptr.
  V8_INLINE static Isolate* TryGetCurrent() { return current_isolate_; }
...
#undef NATIVE_CONTEXT_FIELD_ACCESSOR
 ...
 private:
  ...
  static thread_local PerIsolateThreadData* current_per_isolate_thread_data_;
  static thread_local Isolate* current_isolate_;
