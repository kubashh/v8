...
// Sign {pc} using {sp}.
V8_INLINE Address PointerAuthentication::SignAndCheckPC(
    Address embedded_blob_code, Address pc, Address sp) {
  uint64_t offset64 = pc - embedded_blob_code;
  CHECK(is_uint32(offset64));
