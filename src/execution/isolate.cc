...
Isolate* g_global_main_isolate_ V8_CONSTINIT = nullptr;
...
void Isolate::SetIsolateThreadLocals(Isolate* isolate,
  ...
  if (g_global_main_isolate_ == nullptr) g_global_main_isolate_ = isolate;
#ifdef V8_ENABLE_HANDLE_STATISTICS
...
void Isolate::IAmADummy() { std::cout << "yepyep\n"; }
#ifdef V8_ENABLE_HANDLE_STATISTICS
