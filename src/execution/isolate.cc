...
thread_local Isolate::PerIsolateThreadData* current_per_isolate_thread_data{
    nullptr};
thread_local Isolate* current_isolate{nullptr};
}  // namespace

// static
Isolate::PerIsolateThreadData* Isolate::CurrentPerIsolateThreadData() {
  return current_per_isolate_thread_data;
}

// static
Isolate* Isolate::TryGetCurrent() { return current_isolate; }
...
void Isolate::SetIsolateThreadLocals(Isolate* isolate,
  ...
  current_per_isolate_thread_data = data;
}
