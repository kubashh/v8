...
Handle<NativeContext> Isolate::GetIncumbentContextSlow() {
  ...
  DCHECK_EQ(entered_context.IsEmpty(), incumbent_context().is_null());
...
// SaveAndSwitchIncumbentContext::SaveAndSwitchIncumbentContext(
//     Isolate* isolate, Tagged<Context> new_incumbent_context)
//     : isolate_(isolate) {
//   HandleScopeImplementer* impl = isolate->handle_scope_implementer();
//   impl->SaveContext(isolate->incumbent_context());
//   isolate->set_incumbent_context(new_incumbent_context);
// }
