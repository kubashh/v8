...
inline bool IsAsyncGeneratorYieldOrYieldStar(SuspendFlags flags) {
  return flags == SuspendFlags::kAsyncGeneratorYield ||
         flags == SuspendFlags::kAsyncGeneratorYieldStar;
}
