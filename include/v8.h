...
class V8_EXPORT Isolate {
 public:
  ...
  V8_DEPRECATE_SOON(
      "Use Isolate::SetModifyCodeGenerationFromStringsCallback2 instead. "
      "See http://crbug.com/1096017 and TC39 Dynamic Code Band Checks proposal "
      "at https://github.com/tc39/proposal-dynamic-code-brand-checks.")
  void SetModifyCodeGenerationFromStringsCallback(
      ModifyCodeGenerationFromStringsCallback callback);
  void SetModifyCodeGenerationFromStringsCallback2(
