...
constexpr size_t kVirtualMemoryCageSize = 1UL * TB;
...
// of 64-bit values.
constexpr size_t kVirtualMemoryCageGuardRegionSize = 32UL * GB;
...
constexpr size_t kVirtualMemoryCageMinimumSize = 32UL * GB;
...
constexpr size_t kFakeVirtualMemoryCageMinReservationSize = 8UL * GB;
