...
constexpr size_t kVirtualMemoryCageSize = 1 * TB;
...
// of 64-bit values.
constexpr size_t kVirtualMemoryCageGuardRegionSize = 32 * GB;
...
constexpr size_t kVirtualMemoryCageMinimumSize = 32 * GB;
...
constexpr size_t kFakeVirtualMemoryCageMinReservationSize = 8 * GB;
