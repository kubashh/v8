...
#define FOREIGN_EXTERNAL_POINTER_TAGS(V)                                      \
  ...
  V(kWasmTypeInfoTag,                        unsandboxed, 0b1010000010111111) \
  V(kWasmExportedFunctionDataSigTag,         unsandboxed, 0b1010000011011111) \
  V(kWasmInternalFunctionTag,                unsandboxed, 0b1010000011101111) \
  V(kWasmContinuationObjectJmpbufTag,        unsandboxed, 0b1010000011110111) \
  ...
  V(kCFunctionTag,                           unsandboxed, 0b1010000011111110) \
  V(kCFunctionInfoTag,                       unsandboxed, 0b1010000100111111) \
...
#define MANAGED_EXTERNAL_POINTER_TAGS(V)                                      \
  ...
  V(kIcuBreakIteratorTag,                    unsandboxed, 0b1001000010111111) \
  V(kIcuUnicodeStringTag,                    unsandboxed, 0b1001000011011111) \
  V(kIcuListFormatterTag,                    unsandboxed, 0b1001000011101111) \
  V(kIcuLocaleTag,                           unsandboxed, 0b1001000011110111) \
  V(kIcuSimpleDateFormatTag,                 unsandboxed, 0b1001000011111011) \
  V(kIcuDateIntervalFormatTag,               unsandboxed, 0b1001000011111101) \
  V(kIcuRelativeDateTimeFormatterTag,        unsandboxed, 0b1001000011111110) \
  V(kIcuLocalizedNumberFormatterTag,         unsandboxed, 0b1001000100111111) \
  V(kIcuPluralRulesTag,                      unsandboxed, 0b1001000101011111) \
  V(kIcuCollatorTag,                         unsandboxed, 0b1001000101101111) \
  V(kDisplayNamesInternalTag,                unsandboxed, 0b1001000101110111) \
  V(kWasmNativeModuleTag,                    unsandboxed, 0b1001000101111011) \
  V(kWasmGlobalWasmCodeRefTag,               unsandboxed, 0b1001000101111101) \
  V(kWasmStackMemoryTag,                     unsandboxed, 0b1001000101111110) \
