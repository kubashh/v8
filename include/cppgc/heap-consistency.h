...
class HeapConsistency final {
 public:
   ...
   * \param result Result that may be used for actual write barrier calls. Only
   *   filled if return value indicates that a write barrier is needed. The
   *   contents of the `result` are an implementation detail.
