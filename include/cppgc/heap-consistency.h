...
class HeapConsistency final {
 public:
  ...
  //  *   necessary.
  //  * \param first_element Pointer to the first element that should be
  //  processed.
  ...
  //  * been processed.
  //  *
  //  * \param object The pointer to the object which must point to an object
  //  that
  //  *   has been allocated using `MakeGarbageCollected()`. Interior pointers
  //  are
  //  *   not supported.
  //  */
