...
class V8_EXPORT WriteBarrier final {
 public:
  ...
  static V8_INLINE Type
  GetWriteBarrierTypeForExternalReference(const void* value, Params& params);
...
class WriteBarrierTypeForCagedHeapPolicy final {
 public:
  ...
  static V8_INLINE WriteBarrier::Type GetForExternal(
...
// static
WriteBarrier::Type WriteBarrier::GetWriteBarrierTypeForExternalReference(
    const void* value, Params& params) {
  return WriteBarrierTypePolicy::GetForExternal(value, params);
}
