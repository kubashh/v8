...
class V8_EXPORT CpuProfiler {
 public:
   ...
   *
   * |context| (if set) specifies a context to filter with. Any stack frames
   * captured that do not have an incumbent context equal to this will be
   * discarded from profiles.
   */
