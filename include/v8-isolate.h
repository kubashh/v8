...
class V8_EXPORT ResourceConstraints {
 public:
   ...
   *
   * When V8_COMPRESS_POINTERS is defined, there is a shared process-wide code
   * range that is lazily initialized. This value is used to configure that
   * shared code range when the first Isolate is created. Subsequent Isolates
   * ignore this value.
   */
