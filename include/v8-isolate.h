...
class V8_EXPORT IsolateGroup {
 public:
  ...
  /**
   * Attempt to create a new isolate group.  If this V8's build configuration
   * only supports a single group, as is the case when the sandbox is enabled,
   * instead return a reference to that global group.
   */
