 ...
 * and serves as a precise annotation of the scope that may/will block. When a
 * ScopedBlockingCall is instantiated, it asserts that blocking calls are
 * allowed in its scope. CPU usage should be minimal within that scope. Nested
