...
class LocalVector {
 ...
 private:
  ...
  static constexpr iterator to_iter(vector_type::iterator it) { return &*it; }
  static constexpr const_iterator to_iter(vector_type::const_iterator it) {
    return &*it;
  }
  constexpr vector_type::iterator from_iter(iterator it) {
    return backing_.begin() + (it - begin());
  }
  constexpr vector_type::const_iterator from_iter(const_iterator it) {
    return backing_.begin() + (it - begin());
  }
