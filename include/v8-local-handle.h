...
#include "v8-iterator.h"     // NOLINT(build/include_directory)
...
class LocalVector {
 ...
 public:
  ...
  using iterator = WrappedIterator<typename vector_type::iterator, Local<T>>;
  using const_iterator =
      WrappedIterator<typename vector_type::const_iterator, const Local<T>>;
