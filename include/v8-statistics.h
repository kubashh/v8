...
class V8_EXPORT MeasureMemoryDelegate {
 public:
   ...
   */
  V8_DEPRECATE_SOON("Please use the version that takes a Result_v2 struct")
  ...
  struct V8_DEPRECATE_SOON("Please use Result_v2") Result {
    /**
  ...
  virtual void MeasurementComplete(Result_v2 result) {}
