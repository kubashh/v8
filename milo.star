...
load("//definitions.star", "beta_re", "stable_re", "previous_re")
...
branch_console_view("br.previous", "Previous Main", previous_re)
branch_console_view("br.previous.ports", "Previous Ports", previous_re)
