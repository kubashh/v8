...
//var multiLocale =
//    Intl.RelativeTimeFormat.supportedLocalesOf(['sr-Thai-RS', 'de', 'zh-CN']);
//assertEquals('sr-Thai-RS', multiLocale[0]);
//assertEquals('de', multiLocale[1]);
//assertEquals('zh-CN', multiLocale[2]);

//var multiLocale2 =
//    Intl.RelativeTimeFormat.supportedLocalesOf(['sr-Thai-RS', 'de', 'xyzabc', 'zh-CN']);
//assertEquals('sr-Thai-RS', multiLocale2[0]);
