...
assertEquals('en', longAuto.resolvedOptions().locale);
assertEquals('long', longAuto.resolvedOptions().style);
assertEquals('auto', longAuto.resolvedOptions().numeric);
...
assertEquals('en', shortAuto.resolvedOptions().locale);
assertEquals('short', shortAuto.resolvedOptions().style);
assertEquals('auto', shortAuto.resolvedOptions().numeric);
...
assertEquals('en', narrowAuto.resolvedOptions().locale);
assertEquals('narrow', narrowAuto.resolvedOptions().style);
assertEquals('auto', narrowAuto.resolvedOptions().numeric);
...
assertEquals('en', longAlways.resolvedOptions().locale);
assertEquals('long', longAlways.resolvedOptions().style);
assertEquals('always', longAlways.resolvedOptions().numeric);
...
assertEquals('en', shortAlways.resolvedOptions().locale);
assertEquals('short', shortAlways.resolvedOptions().style);
assertEquals('always', shortAlways.resolvedOptions().numeric);
...
assertEquals('en', narrowAlways.resolvedOptions().locale);
assertEquals('narrow', narrowAlways.resolvedOptions().style);
assertEquals('always', narrowAlways.resolvedOptions().numeric);
