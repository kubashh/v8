...
// should be done in the base locale (i.e. en or en-GB instead of en-u-ca-chinese
// or en-GB-u-ca-chinese). Otherwise, {year: 'numeric'} would lead to '35
// (wu-su)' where 'wu-su' is the designation for year 35 in the 60-year cycle.
