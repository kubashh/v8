...
TEST(Torque, SpecializationRequesters) {
  ExpectFailingCompilation(
    ...
    macro D() {
      ...
      SubstrVector{
          ...
          SubstrTester("Note: specialization B<Smi> requested here", 7, 7),
          SubstrTester("Note: specialization C<Smi> requested here", 10, 7)});
  ...
  ExpectFailingCompilation(
    ...
    builtin D(implicit context: Context)(): Object {
      ...
      SubstrVector{
          ...
          SubstrTester("Note: specialization B<Smi> requested here", 10, 14),
          SubstrTester("Note: specialization C<Smi> requested here", 13, 14)});
  ...
  ExpectFailingCompilation(
    ...
    struct D {
      ...
      SubstrVector{
          ...
          SubstrTester("Note: specialization struct B<Smi> requested here", 7,
                       10),
          SubstrTester("Note: specialization struct C<Smi> requested here", 10,
                       10)});
  ...
  ExpectFailingCompilation(
    ...
    macro D(_b: C<Smi>) {}
      ...
      SubstrVector{
          SubstrTester("cannot find suitable callable", 4, 7),
          SubstrTester("Note: specialization B<Smi> requested here", 8, 9),
          SubstrTester("Note: specialization struct C<Smi> requested here", 11,
                       5)});
}
