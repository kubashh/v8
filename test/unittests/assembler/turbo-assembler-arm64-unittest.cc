...
template <typename T>
class TurboAssemblerDeathTestWithParam
    : public TurboAssemblerDeathTest,
      public ::testing::WithParamInterface<T> {};

using TurboAssemblerDeathTestMoveObjectAndSlot =
    TurboAssemblerDeathTestWithParam<MoveObjectAndSlotTestCase>;

TEST_P(TurboAssemblerDeathTestMoveObjectAndSlot, MoveObjectAndSlot) {
...
INSTANTIATE_TEST_SUITE_P(TurboAssemblerDeathTest,
                         TurboAssemblerDeathTestMoveObjectAndSlot,
