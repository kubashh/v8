...
#define INTERSECTION_M(type1, type2, type_result, module_result) \
  ...
  for (WasmModule* module : {module1, module2}) {
    ...
    UNION(kWasmImportedStringRef.AsNonNull(), kWasmNullExternRef, kWasmBottom);
    ...
    INTERSECTION(kWasmImportedStringRef.AsNonNull(), kWasmNullExternRef,
                 kWasmBottom);
    INTERSECTION(kWasmImportedStringRef, kWasmExternRef, kWasmExternRef);
    INTERSECTION(kWasmImportedStringRef.AsNonNull(), kWasmExternRef,
