...
class InterpreterAssemblerState : public compiler::CodeAssemblerState {
 public:
  InterpreterAssemblerState(InterpreterAssemblerDeathTest* test,
                            Bytecode bytecode);
};
  ...
  class InterpreterAssemblerForTest final : public InterpreterAssembler {
   public:
    InterpreterAssemblerForTest(
        InterpreterAssemblerState* state, Bytecode bytecode,
