...
TEST_F(GCTracerTest, AllocationThroughput) {
  ...
  SampleAndAddAllocation(tracer, base::TimeTicks::FromTicksForTesting(time1),
                         counter1);
  const int time2 = 200;
  const size_t counter2 = 2000;
  SampleAndAddAllocation(tracer, base::TimeTicks::FromTicksForTesting(time2),
                         counter2);
  ...
  SampleAndAddAllocation(tracer, base::TimeTicks::FromTicksForTesting(time3),
                         counter3);
...
TEST_F(GCTracerTest, MutatorUtilization) {
  ...
  tracer->RecordMutatorUtilization(base::TimeTicks::FromTicksForTesting(200),
                                   base::TimeDelta::FromMilliseconds(100));
  ...
  tracer->RecordMutatorUtilization(base::TimeTicks::FromTicksForTesting(400),
                                   base::TimeDelta::FromMilliseconds(100));
  ...
  tracer->RecordMutatorUtilization(base::TimeTicks::FromTicksForTesting(600),
  ...
  tracer->RecordMutatorUtilization(base::TimeTicks::FromTicksForTesting(800),
                                   base::TimeDelta());
