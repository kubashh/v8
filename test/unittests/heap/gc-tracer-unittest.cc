...
TEST_F(GCTracerTest, MutatorUtilization) {
  ...
  EXPECT_DOUBLE_EQ(0, tracer->CurrentMutatorUtilization());
  EXPECT_DOUBLE_EQ(0, tracer->AverageMutatorUtilization());
  ...
  EXPECT_DOUBLE_EQ(0.5, tracer->CurrentMutatorUtilization());
  EXPECT_DOUBLE_EQ(0.5, tracer->AverageMutatorUtilization());
  ...
  EXPECT_DOUBLE_EQ(0.0, tracer->CurrentMutatorUtilization());
  EXPECT_DOUBLE_EQ(50.0 / 200.0, tracer->AverageMutatorUtilization());
  ...
  EXPECT_DOUBLE_EQ(1.0, tracer->CurrentMutatorUtilization());
  EXPECT_DOUBLE_EQ(125.0 / 200.0, tracer->AverageMutatorUtilization());
}
