...
TEST_F(MemberHeapDeathTest, OffHeapMemberCreatesStateOnFirstAssignment) {
...
TEST_F(MemberHeapDeathTest, CheckForOnStackMemberFindsReassignment) {
...
TEST_F(MemberHeapDeathTest, CheckForOnHeapMemberFindsInitialAssignment) {
