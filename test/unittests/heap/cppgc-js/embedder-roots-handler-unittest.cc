...
void ConstructDroppableJSObject(v8::Isolate* isolate,
                                v8::Local<v8::Context> context,
                                v8::TracedReference<v8::Object>* handle) {
  v8::HandleScope scope(isolate);
  v8::Local<v8::Object> object(v8::Object::New(isolate));
  ...
  *handle = v8::TracedReference<v8::Object>(
      isolate, object, v8::TracedReference<v8::Object>::IsDroppable{});
  EXPECT_FALSE(handle->IsEmpty());
}
...
TEST_F(
    ...
    FullGC_UnreachableTracedReferenceToNonDroppableDiesEvenWhenPointeeIsHeldAlive) {
