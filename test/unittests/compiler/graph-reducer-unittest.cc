...
static TestOperator kOpB0(kOpcodeB0, Operator::kNoWrite, "opa0", 0, 1);
static TestOperator kOpB1(kOpcodeB1, Operator::kNoWrite, "opa1", 1, 1);
static TestOperator kOpB2(kOpcodeB2, Operator::kNoWrite, "opa2", 2, 1);
