...
TEST_F(DecompressionAvoiderTest, BasicDecompressionCompression) {
  ...
  for (size_t i = 0; i < arraysize(types); ++i) {
    // Create the graph.
    Node* value = graph()->NewNode(machine()->Load(types[i]), object, index,
                                   effect, control);
...
// TEST_F(DecompressionAvoiderTest, BasicCompressionDecompression) {
...
//     // Create the graph.
//     Node* load =
//     graph()->NewNode(simplified()->LoadElement(accesses[i].first),
...
//                               object, index, change_to_tagged, effect,
//                               control);
...
// TEST_F(DecompressionAvoiderTest, CompressionAfterInt64Constant) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
//       // Create the graph.
//       Node* constant =
//       graph()->NewNode(common()->Int64Constant(constants[j])); Node*
//       change_to_compressed = graph()->NewNode(
...
// TEST_F(DecompressionAvoiderTest, CompressionAfterHeapConstant) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
//       Reduction r = Reduce(change_to_compressed);
//       ASSERT_TRUE(r.Changed());
//       EXPECT_EQ(r.replacement()->opcode(),
...
// TEST_F(DecompressionAvoiderTest, PhiOneDecompress) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
//         graph()->NewNode(DecompressionOpFromAccess(element_accesses[i]),
//         load);
...
//     // Get the actual decompress after the Phi, and check against the
//     expected
//     // one.
//     Node* decompress = GetUniqueValueUse(phi);
//     EXPECT_EQ(DecompressionOpFromAccess(element_accesses[i]),
//     decompress->op());
//   }
// }

// TEST_F(DecompressionAvoiderTest, PhiThreeDecompressSameRepresentation) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, PhiThreeDecompressOneAnyRepresentation) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
//     // Create the graph.
//     Node* load1 =
//         graph()->NewNode(simplified()->LoadElement(not_any_accesses[i]),
//         object,
//                          index, effect, control);
//     Node* load2 =
//         graph()->NewNode(simplified()->LoadElement(not_any_accesses[i]),
...
//                                    object, index, effect, control);
//     Node* change_to_tagged_1 =
//         graph()->NewNode(DecompressionOpFromAccess(not_any_accesses[i]),
//         load1);
//     Node* change_to_tagged_2 =
//         graph()->NewNode(DecompressionOpFromAccess(not_any_accesses[i]),
//         load2);
...
// TEST_F(DecompressionAvoiderTest, PhiThreeInputsOneNotDecompressed) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, PhiTwoDecompressesOneSignedOnePointer) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TypedStateValuesOneDecompress) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TypedStateValuesTwoDecompresses) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TypedStateValuesAllDecompresses) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TypedStateValuesNoDecompresses) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TwoDecompressionWord64Equal) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, TwoDecompressionWord64EqualSameInput) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
// TEST_F(DecompressionAvoiderTest, DecompressionConstantWord64Equal) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
...
//         Node* comparison = graph()->NewNode(machine()->Word64Equal(), lhs,
//         rhs);
//         // Reduce.
//         Reduction r = Reduce(comparison);
//         ASSERT_TRUE(r.Changed());
...
// TEST_F(DecompressionAvoiderTest, DecompressionHeapConstantWord64Equal) {
//   // Skip test if pointer compression is not enabled.
//   if (!COMPRESS_POINTERS_BOOL) {
//     return;
//   }
