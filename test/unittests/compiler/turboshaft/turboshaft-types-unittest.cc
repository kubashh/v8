...
TEST_F(TurboshaftTypesTest, Word64LeastUpperBound) {
...

  {
    ...
    CheckLubIs(lhs, Word64Type::Constant(1119),
               Word64Type::Range(18, 1119, zone()));
    CheckLubIs(lhs, Word64Type::Constant(0), Word64Type::Range(0, 18, zone()));
    ...
    CheckLubIs(lhs, Word64Type::Range(0, 3, zone()),
               Word64Type::Range(0, 18, zone()));
    CheckLubIs(
        lhs, Word64Type::Constant(std::numeric_limits<uint64_t>::max()),
        Word64Type::Range(18, std::numeric_limits<uint64_t>::max(), zone()));
  }
}
#if 0
