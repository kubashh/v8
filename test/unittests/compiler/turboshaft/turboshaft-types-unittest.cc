...
TEST_F(TurboshaftTypesTest, Word32) {
  ...
  // Non-wrapping range
  {
    Type t = Word32Type::Range(100, 400);
    CheckIs(t, Kind::kWord32);
    const auto& w32 = t.AsWord32();
  ...
  // Wrapping range
  {
    Type t = Word32Type::Range(static_cast<uint32_t>(-1), 1);
    CheckIs(t, Kind::kWord32);
    const auto& w32 = t.AsWord32();
...
TEST_F(TurboshaftTypesTest, Word64) {
  ...
  // Non-wrapping range
  {
    Type t = Word64Type::Range(100UL * (2UL << 32UL), 400UL * (2UL << 36UL));
    CheckIs(t, Kind::kWord64);
    const auto& w64 = t.AsWord64();
    CHECK_EQ(100UL * (2UL << 32UL), w64.range_from());
    CHECK_EQ(400UL * (2UL << 36UL), w64.range_to());
    CHECK(!w64.is_complete());
    CHECK(!w64.is_constant());
    CHECK(!w64.is_wrapping());
  }
  ...
  // Wrapping range
  {
    Type t = Word64Type::Range(static_cast<uint64_t>(-1), 1);
    CheckIs(t, Kind::kWord64);
    const auto& w64 = t.AsWord64();
  ...
  // Constant
  {
    Type t = Word64Type::Constant(42UL * (2UL << 50UL));
    CheckIs(t, Kind::kWord64);
    const auto& w64 = t.AsWord64();
    CHECK_EQ(42UL * (2UL << 50UL), w64.range_from());
    CHECK_EQ(42UL * (2UL << 50UL), w64.range_to());
    CHECK(!w64.is_complete());
    CHECK(w64.is_constant());
    CHECK(!w64.is_wrapping());
  }
...
TEST_F(TurboshaftTypesTest, Equals) {
  Type none = Type::None();
  Type any = Type::Any();
  Type w32 = Word32Type::Complete();
  Type w32c = Word32Type::Constant(1084);
  Type w32r = Word32Type::Range(1000, 0);
  Type w64 = Word64Type::Complete();
  Type w64c = Word64Type::Constant(1084);
  Type w64r = Word64Type::Range(1000, 0);
  Type f32 = Type::Float32(false);
  Type f32n = Type::Float32();
  Type f32c = Type::Float32(0.133f);
  Type f32cn = Type::Float32(0.133f, true);
  Type f32r = Type::Float32(-13.99f, 18.02f);
  Type f32rn = Type::Float32(-13.99f, 18.02f, true);
  Type f64 = Type::Float64(false);
  Type f64n = Type::Float64(true);
  Type f64c = Type::Float64(0.133);
  Type f64cn = Type::Float64(0.133, true);
  Type f64r = Type::Float64(-13.99, 18.02);
  Type f64rn = Type::Float64(-13.99, 18.02, true);
  Type all_types[] = {
  ...
  // Word32
  {
    CHECK(w32.Equals(Word32Type::Complete()));
  ...
  // Word64Type::
  {
    CHECK(w64.Equals(Word64Type::Complete()));
    ...
    CHECK(!w64c.Equals(Word64Type::Constant(1084UL + (2UL << 40UL))));
...
TEST_F(TurboshaftTypesTest, Word32LeastUpperBound) {
  ...
  {
    const auto lhs = Word32Type::Range(100, 400);
    CheckLubIs(lhs, lhs, lhs);
    CheckLubIs(lhs, Word32Type::Range(50, 350), Word32Type::Range(50, 400));
    CheckLubIs(lhs, Word32Type::Range(150, 600), Word32Type::Range(100, 600));
    CheckLubIs(lhs, Word32Type::Range(150, 350), lhs);
    CheckLubIs(lhs, Word32Type::Range(350, 0), Word32Type::Range(100, 0));
    CheckLubIs(lhs, Word32Type::Range(400, 100), Word32Type::Complete());
    CheckLubIs(lhs, Word32Type::Range(600, 0), Word32Type::Range(600, 400));
    CheckLubIs(lhs, Word32Type::Range(300, 150), Word32Type::Complete());
  }

  {
    const auto lhs = Word32Type::Constant(18);
    CheckLubIs(lhs, lhs, lhs);
    CheckLubIs(lhs, Word32Type::Constant(1119), Word32Type::Range(18, 1119));
    CheckLubIs(lhs, Word32Type::Constant(0), Word32Type::Range(0, 18));
    CheckLubIs(lhs, Word32Type::Range(40, 100), Word32Type::Range(18, 100));
    CheckLubIs(lhs, Word32Type::Range(4, 90), Word32Type::Range(4, 90));
    CheckLubIs(lhs, Word32Type::Range(0, 3), Word32Type::Range(0, 18));
    CheckLubIs(lhs, Word32Type::Constant(std::numeric_limits<uint32_t>::max()),
               Word32Type::Range(18, std::numeric_limits<uint32_t>::max()));
  }
}
...
TEST_F(TurboshaftTypesTest, Word64LeastUpperBound) {
  ...
  {
    const auto lhs = Word64Type::Range(100, 400);
    CheckLubIs(lhs, lhs, lhs);
    CheckLubIs(lhs, Word64Type::Range(50, 350), Word64Type::Range(50, 400));
    CheckLubIs(lhs, Word64Type::Range(150, 600), Word64Type::Range(100, 600));
    CheckLubIs(lhs, Word64Type::Range(150, 350), lhs);
    CheckLubIs(lhs, Word64Type::Range(350, 0), Word64Type::Range(100, 0));
    CheckLubIs(lhs, Word64Type::Range(400, 100), Word64Type::Complete());
    CheckLubIs(lhs, Word64Type::Range(600, 0), Word64Type::Range(600, 400));
    CheckLubIs(lhs, Word64Type::Range(300, 150), Word64Type::Complete());
  }

  {
    const auto lhs = Word64Type::Constant(18);
    CheckLubIs(lhs, lhs, lhs);
    CheckLubIs(lhs, Word64Type::Constant(1119), Word64Type::Range(18, 1119));
    CheckLubIs(lhs, Word64Type::Constant(0), Word64Type::Range(0, 18));
    CheckLubIs(lhs, Word64Type::Range(40, 100), Word64Type::Range(18, 100));
    CheckLubIs(lhs, Word64Type::Range(4, 90), Word64Type::Range(4, 90));
    CheckLubIs(lhs, Word64Type::Range(0, 3), Word64Type::Range(0, 18));
    CheckLubIs(lhs, Word64Type::Constant(std::numeric_limits<uint64_t>::max()),
               Word64Type::Range(18, std::numeric_limits<uint64_t>::max()));
  }
}
