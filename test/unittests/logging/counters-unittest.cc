...
static base::TimeTicks RuntimeCallStatsDeathTestNow() {
...
class RuntimeCallStatsDeathTest : public TestWithNativeContextDeathTest {
 public:
  ...
  static void SetUpTestCase() {
    ...
    RuntimeCallTimer::Now = &RuntimeCallStatsDeathTestNow;
  }
...
class NativeTimeScope {
 public:
  NativeTimeScope() {
    CHECK_EQ(RuntimeCallTimer::Now, &RuntimeCallStatsDeathTestNow);
    RuntimeCallTimer::Now = &base::TimeTicks::HighResolutionNow;
  }
  ~NativeTimeScope() {
...
class SnapshotNativeCounterDeathTest
    : public TestWithNativeContextDeathTestAndCounters {
 public:
