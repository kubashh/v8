...
TEST(StackTrace) {
  ...
  v8::Source script_source(src, v8::ScriptOrigin(isolate, origin));
...
TEST(CaptureStackTrace) {
  ...
  v8::Source script_source(overview_src, v8::ScriptOrigin(isolate, origin));
  ...
  v8::Source script_source2(detailed_src, detailed_origin);
  ...
  v8::Source script_source3(function_name_src,
