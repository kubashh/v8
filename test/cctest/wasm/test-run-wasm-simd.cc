...
WASM_SIMD_TEST_NO_LOWERING(F64x2ExtractLane) {
  WasmRunner<double> r(execution_tier, lower_simd);
  r.AllocateLocal(kWasmF64);
  r.AllocateLocal(kWasmS128);
  BUILD(r,
        WASM_SET_LOCAL(0, WASM_SIMD_F64x2_EXTRACT_LANE(
                              0, WASM_SIMD_F64x2_SPLAT(WASM_F64(1e15)))),
        WASM_SET_LOCAL(1, WASM_SIMD_F64x2_SPLAT(WASM_GET_LOCAL(0))),
        WASM_SIMD_F64x2_EXTRACT_LANE(1, WASM_GET_LOCAL(1)));
  CHECK_EQ(1e15, r.Call());
}
