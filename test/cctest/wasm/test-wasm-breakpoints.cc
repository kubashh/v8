...
WASM_COMPILED_EXEC_TEST(WasmCollectPossibleBreakpoints) {
  ...
  CheckLocations(&runner, native_module, {0, 0}, {1, 0},
                 {{0, 1}, {0, 2}, {0, 4}, {0, 6}, {0, 7}});
