...
TEST(JSObjectBasic) {
  ...
  CHECK_EQ(Smi::FromInt(42),
           GetFieldValue(
               *obj, FieldIndex::ForDescriptor(obj->map(), InternalIndex(0))));
  CHECK_EQ(4.2, GetDoubleFieldValue(*obj, FieldIndex::ForDescriptor(
                                              obj->map(), InternalIndex(1))));
  CHECK_EQ(*obj, GetFieldValue(*obj, FieldIndex::ForDescriptor(
                                         obj->map(), InternalIndex(2))));
...
TEST(JSObjectComplex) {
  ...
  CHECK_EQ(Smi::FromInt(42),
           GetFieldValue(*obj3, FieldIndex::ForDescriptor(obj3->map(),
                                                          InternalIndex(0))));
  CHECK_EQ(4.2, GetDoubleFieldValue(*obj3, FieldIndex::ForDescriptor(
                                               obj3->map(), InternalIndex(1))));
  CHECK_EQ(*obj3, GetFieldValue(*obj3, FieldIndex::ForDescriptor(
                                           obj3->map(), InternalIndex(2))));
...
TEST(SubclassBasicNoBaseClassInstances) {
  ...
  CHECK_EQ(Smi::FromInt(142),
           GetFieldValue(
               *obj, FieldIndex::ForDescriptor(obj->map(), InternalIndex(3))));
  CHECK_EQ(14.2, GetDoubleFieldValue(*obj, FieldIndex::ForDescriptor(
                                               obj->map(), InternalIndex(4))));
  CHECK_EQ(*obj, GetFieldValue(*obj, FieldIndex::ForDescriptor(
                                         obj->map(), InternalIndex(5))));
  CHECK(IsObjectShrinkable(*obj));
...
TEST(SubclassBasic) {
  ...
  CHECK_EQ(Smi::FromInt(42),
           GetFieldValue(*b_obj, FieldIndex::ForDescriptor(b_obj->map(),
                                                           InternalIndex(0))));
  CHECK_EQ(4.2,
           GetDoubleFieldValue(*b_obj, FieldIndex::ForDescriptor(
                                           b_obj->map(), InternalIndex(1))));
  CHECK_EQ(*b_obj, GetFieldValue(*b_obj, FieldIndex::ForDescriptor(
                                             b_obj->map(), InternalIndex(2))));
  CHECK_EQ(Smi::FromInt(142),
           GetFieldValue(*b_obj, FieldIndex::ForDescriptor(b_obj->map(),
                                                           InternalIndex(3))));
  CHECK_EQ(14.2,
           GetDoubleFieldValue(*b_obj, FieldIndex::ForDescriptor(
                                           b_obj->map(), InternalIndex(4))));
  CHECK_EQ(*b_obj, GetFieldValue(*b_obj, FieldIndex::ForDescriptor(
                                             b_obj->map(), InternalIndex(5))));
  ...
  CHECK_EQ(
      ...
      GetFieldValue(
          *obj, FieldIndex::ForDescriptor(
                    obj->map(), InternalIndex(builtin_properties_count + 0))));
  CHECK_EQ(4.2, GetDoubleFieldValue(
                    *obj, FieldIndex::ForDescriptor(
                              obj->map(),
                              InternalIndex(builtin_properties_count + 1))));
  CHECK_EQ(*obj, GetFieldValue(
                     *obj, FieldIndex::ForDescriptor(
                               obj->map(),
                               InternalIndex(builtin_properties_count + 2))));
  CHECK(IsObjectShrinkable(*obj));
