...
UNINITIALIZED_TEST(StringShare) {
...

  {
    ...
    Handle<String> two_byte_seq =
        factory->NewStringFromTwoByte(two_byte, AllocationType::kOld)
            .ToHandleChecked();
    Handle<String> shared_one_byte = String::Share(i_isolate, one_byte_seq);
    Handle<String> shared_two_byte = String::Share(i_isolate, two_byte_seq);
...

  {
    ...
    Handle<String> shared_one_byte_intern =
        String::Share(i_isolate, one_byte_intern);
    Handle<String> shared_two_byte_intern =
        String::Share(i_isolate, two_byte_intern);
    CHECK(one_byte_intern->IsShared());
    CHECK(two_byte_intern->IsShared());
...

  {
    ...
    Handle<String> shared_one_byte =
        String::Share(i_isolate, young_one_byte_seq);
    Handle<String> shared_two_byte =
        String::Share(i_isolate, young_two_byte_seq);
...

  {
    ...
    Handle<String> shared = String::Share(i_isolate, one_byte_seq2);
...

  {
    ...
    Handle<String> shared = String::Share(i_isolate, cons);
...

  {
    ...
    Handle<String> shared = String::Share(i_isolate, sliced);
