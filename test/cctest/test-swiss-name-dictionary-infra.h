...
// Use these for tests that may timeout on larger capacities when sanitizers are
// enabled.
...
static const std::vector<int> capactities_for_slow_tests = {4, 8, 16, 128,
                                                            1024};
#else
static const std::vector<int> capactities_for_slow_tests =
