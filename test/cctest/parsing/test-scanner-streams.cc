...
TEST(Utf8AdvanceUntil) {
  ...
  char line_term = '\n';
  char data[2 + arraysize(unicode_utf8)];
  strncpy(data, unicode_utf8, arraysize(unicode_utf8));
  data[arraysize(unicode_utf8) - 1] = line_term;
  data[arraysize(unicode_utf8)] = '\0';
