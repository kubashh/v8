...
TEST(TestOverlongAndInvalidSequences) {
  ...
  const std::vector<std::vector<uint16_t>> unicode_expected = {
      {0x58, unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar, 0x59},
      {0x58, unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar,
       unibrow::Utf8::kBadChar, 0x59},
      {0x58, unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar,
       unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar, 0x59},
      {0x58, unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar,
       unibrow::Utf8::kBadChar, 0x59},
      {0x58, unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar,
       unibrow::Utf8::kBadChar, unibrow::Utf8::kBadChar, 0x59},
