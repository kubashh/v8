...
// FIXME: Currently, the CSATestRunner isn't doing much, except generating
// runtime calls. That will change once we have the CSA implementations ready.
CSATestRunner::CSATestRunner(Isolate* isolate, int initial_capacity,
    ...
    : isolate{isolate},
      ...
      table{
          ...
          &m} {
  // FIXME: allocate with CSA rather than factory
}
