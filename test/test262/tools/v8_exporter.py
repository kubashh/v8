...
class V8TestExporter(TestExporter):
    ...
    def approve(self, pr_number):
        """Approves a PR.
        Chromium/WPT exports are self approved via a web hook
        (http://screen/BYL5fPchGhjxcmu) with self approve functionality from
        http://shortn/_A8n7jtXYcp installed @ http://shortn/_Jc3u72WPMZ .
