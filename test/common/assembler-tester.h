...
// See CodeMemoryWriteScope for details.
class V8_NODISCARD AssemblerBufferWriteScope : public CodeMemoryWriteScope {
 public:
  ...
  ~AssemblerBufferWriteScope() override { buffer_.MakeExecutable(); }
