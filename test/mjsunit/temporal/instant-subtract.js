...
assertThrows(() => badInstant.subtract(new Temporal.Duration(0, 0, 0, 0, 5)), TypeError,
    "Method Temporal.Instant.prototype.subtract called on incompatible receiver #<Object>");
...
assertThrows(() => i2.subtract(new Temporal.Duration(0, 0, 0, 0, 999999999)), RangeError,
    "Invalid time value");
