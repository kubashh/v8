...
function assertPlainTime(time, hour, minute, second, millisecond, microsecond, nanosecond) {
  ...
  assertEquals(hour, fields.isoHour, time);
  assertEquals(minute, fields.isoMinute, time);
  assertEquals(second, fields.isoSecond, time);
  assertEquals(millisecond, fields.isoMillisecond, time);
  assertEquals(microsecond, fields.isoMicrosecond, time);
  assertEquals(nanosecond, fields.isoNanosecond, time);
  assertEquals(time.calendar, fields.calendar, time);
}
