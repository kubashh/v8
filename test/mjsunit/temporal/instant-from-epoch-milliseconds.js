...
assertThrows(() => {let inst = Temporal.Instant.fromEpochMilliseconds(too_small_bigint)},
    RangeError, "Invalid time value")
assertThrows(() => {let inst = Temporal.Instant.fromEpochMilliseconds(too_big_bigint)},
    RangeError, "Invalid time value")
assertEquals(just_fit_neg_bigint,
    (Temporal.Instant.fromEpochMilliseconds(just_fit_neg_bigint)).epochMilliseconds);
assertEquals(just_fit_pos_bigint,
    (Temporal.Instant.fromEpochMilliseconds(just_fit_pos_bigint)).epochMilliseconds);
