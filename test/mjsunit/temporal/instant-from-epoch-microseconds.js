...
assertThrows(() => {let inst = Temporal.Instant.fromEpochMicroseconds(too_small_bigint)},
    RangeError, "Invalid time value")
assertThrows(() => {let inst = Temporal.Instant.fromEpochMicroseconds(too_big_bigint)},
    RangeError, "Invalid time value")
assertEquals(just_fit_neg_bigint,
    (Temporal.Instant.fromEpochMicroseconds(just_fit_neg_bigint)).epochMicroseconds);
assertEquals(just_fit_pos_bigint,
    (Temporal.Instant.fromEpochMicroseconds(just_fit_pos_bigint)).epochMicroseconds);
