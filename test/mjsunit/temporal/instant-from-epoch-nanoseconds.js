...
assertThrows(() => {let inst = Temporal.Instant.fromEpochNanoseconds(too_small_bigint)},
    RangeError, "Invalid time value")
assertThrows(() => {let inst = Temporal.Instant.fromEpochNanoseconds(too_big_bigint)},
    RangeError, "Invalid time value")
assertEquals(just_fit_neg_bigint,
    (Temporal.Instant.fromEpochNanoseconds(just_fit_neg_bigint)).epochNanoseconds);
assertEquals(just_fit_pos_bigint,
    (Temporal.Instant.fromEpochNanoseconds(just_fit_pos_bigint)).epochNanoseconds);
