...
function assertPlainDateTime(dateTime, year, month, day, hour, minute, second, millisecond, microsecond, nanosecond) {
  assertEquals(year, dateTime.year, "year");
  assertEquals(month, dateTime.month, "month");
  assertEquals(day, dateTime.day, "day");
  assertEquals(hour, dateTime.hour, "hour");
  assertEquals(minute, dateTime.minute, "minute");
  assertEquals(second, dateTime.second, "second");
  assertEquals(millisecond, dateTime.millisecond, "millisecond");
  assertEquals(microsecond, dateTime.microsecond, "microsecond");
  assertEquals(nanosecond, dateTime.nanosecond, "nanosecond");
}
