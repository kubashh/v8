...
assertThrows(() => d1.toPlainDateTime({}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({hour: 23}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({minute: 23}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({second: 23}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({millisecond: 23}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({microecond: 23}), TypeErrort);
assertThrows(() => d1.toPlainDateTime({nanosecond: 23}), TypeErrort);
