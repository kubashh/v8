...
let bigint_sec = BigInt(7890123456789n);
let inst1 = new Temporal.Instant(bigint_nano);
assertThrows(() =>
    {let inst = Temporal.Instant.fromEpochSeconds(bigint_sec)},
    TypeError)
...
assertThrows(() =>
    {let inst = Temporal.Instant.fromEpochSeconds(too_small)},
    RangeError)
assertThrows(() =>
    {let inst = Temporal.Instant.fromEpochSeconds(too_big)},
    RangeError)
