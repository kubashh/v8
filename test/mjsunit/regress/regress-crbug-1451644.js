...
// unstable. At a[0], we create a transition from HOLEY_DOUBLE_ELEMENTS to
// HOLEY_ELEMENTS. This will also transition b because they're the same object.
// And since we failed to track that the HOLEY_DOUBLE_ELEMENTS map is unstable,
// we didn't take into account that this transition might happen, and b might
// change maps while the code is executing.
