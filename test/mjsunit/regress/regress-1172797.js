...
// Force TF compilation.
// TODO(mythria): There is no way to tier up a function to TP from TF using
// intrinsics since %OptimizeFunctionOnNextCall returns if there is any
// optimized code. Update this test by using intrinsics instead of this loop.
// When we do this also drop --no-use-osr in the flags.
for (var v_1 = 0; v_1 < 100000; ++v_1) {
    f_1();
}
