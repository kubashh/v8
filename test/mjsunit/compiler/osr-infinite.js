...
%EnsureFeedbackVectorForFunction(thrower);
...
%EnsureFeedbackVectorForFunction(n1);

function n2() {
  while (true) while (true) thrower();
}
%EnsureFeedbackVectorForFunction(n2);

function n3() {
  while (true) while (true) while (true) thrower();
}
%EnsureFeedbackVectorForFunction(n3);

function n4() {
  while (true) while (true) while (true) while (true) thrower();
}
%EnsureFeedbackVectorForFunction(n4);
...
%EnsureFeedbackVectorForFunction(b1);
...
%EnsureFeedbackVectorForFunction(b2);
...
%EnsureFeedbackVectorForFunction(b3);
