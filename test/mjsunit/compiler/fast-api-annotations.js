...
assertEquals(false, compare_i32(true, 123));
%OptimizeFunctionOnNextCall(compare_i32);
assertEquals(true, compare_i32(true, 123));
assertEquals(true, compare_i32(true, -0.5));
assertEquals(true, compare_i32(true, 0.5));
assertEquals(true, compare_i32(true, 1.5));
assertEquals(true, compare_i32(true, -(2 ** 31)));
...
assertEquals(false, compare_u32(true, 123));
%OptimizeFunctionOnNextCall(compare_u32);
assertEquals(true, compare_u32(true, 123));
assertEquals(true, compare_u32(true, 0));
assertEquals(true, compare_u32(true, -0.5));
assertEquals(true, compare_u32(true, 0.5));
assertEquals(true, compare_u32(true, 2 ** 32 - 1));
...
assertEquals(false, compare_i64(true, 123));
%OptimizeFunctionOnNextCall(compare_i64);
assertEquals(true, compare_i64(true, 123));
assertEquals(true, compare_i64(true, -0.5));
assertEquals(true, compare_i64(true, 0.5));
assertEquals(true, compare_i64(true, 1.5));
assertEquals(true, compare_i64(true, -(2 ** 63)));
assertEquals(true, compare_i64(true, Number.MIN_SAFE_INTEGER));
assertEquals(true, compare_i64(true, Number.MAX_SAFE_INTEGER));
...
assertEquals(false, compare_u64(true, 123));
%OptimizeFunctionOnNextCall(compare_u64);
assertEquals(true, compare_u64(true, 123));
assertEquals(true, compare_u64(true, 0));
assertEquals(true, compare_u64(true, -0.5));
assertEquals(true, compare_u64(true, 0.5));
assertEquals(true, compare_u64(true, 2 ** 32 - 1));
assertEquals(true, compare_u64(true, Number.MAX_SAFE_INTEGER));
