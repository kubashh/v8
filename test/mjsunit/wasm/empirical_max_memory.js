...
function BuildAccessors(memory, type, load_opcode, store_opcode) {
...
(function TestInt32() {
  let a = BuildAccessors(memory, kWasmI32, kExprI32LoadMem, kExprI32StoreMem);
  probe(a, i => (0xaabbccee ^ ((i >> 11) * 0x110005)) | 0);
})();

(function TestUint16() {
  let a = BuildAccessors(memory, kWasmI32, kExprI32LoadMem16U, kExprI32StoreMem16);
  probe(a, i => (0xccee ^ ((i >> 11) * 0x110005)) & 0xFFFF);
})();

(function TestUint8() {
  let a = BuildAccessors(memory, kWasmI32, kExprI32LoadMem8U, kExprI32StoreMem8);
  probe(a, i => (0xee ^ ((i >> 11) * 0x05)) & 0xFF);
})();

(function TestFloat64() {
  let a = BuildAccessors(memory, kWasmF64, kExprF64LoadMem, kExprF64StoreMem);
  probe(a, i => 0xaabbccee ^ ((i >> 11) * 0x110005));
})();

(function TestFloat32() {
  let a = BuildAccessors(memory, kWasmF32, kExprF32LoadMem, kExprF32StoreMem);
