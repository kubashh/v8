...
(function TestDefaultValue(type, val, expected) {
...
(function TestDefaultValueSecondGlobal(type, val, expected) {
  print(arguments.callee.name);
  let builder = new WasmModuleBuilder();
...
(function TestGlobalChangeValue(type, val, expected) {
  print(arguments.callee.name);
  let builder = new WasmModuleBuilder();
  ...
  assertEquals(test_value, instance.exports.main(test_value));
})();

(function TestGlobalChangeValueWithGC(type, val, expected) {
  print(arguments.callee.name);
  let builder = new WasmModuleBuilder();
  ...
  const test_value = {hello: 'world'};
  assertEquals(test_value, instance.exports.main(test_value));
  assertEquals(5, instance.exports.main(5));
  assertEquals("Hello", instance.exports.main("Hello"));
})();

(function TestGlobalAsRoot(type, val, expected) {
  print(arguments.callee.name);
  let builder = new WasmModuleBuilder();
  const g = builder.addGlobal(kWasmAnyRef, true);
