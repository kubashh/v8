...
(function TestTable64GetFuncRefOOB() {
  ...
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size + 13)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(1n << 32n));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(offset) << 32n));
})();
...
(function TestTable64GetExternRefOOB() {
  ...
  const builder = new WasmModuleBuilder();
  const table_size = 12;
  const table = builder.addTable64(kWasmExternRef, table_size, table_size + 4).exportAs('table');
  ...
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size + 3)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size + 4)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(BigInt(table_size + 23)));
  assertTraps(kTrapTableOutOfBounds, () => exports.table64_get(1n << 32n));
})();
