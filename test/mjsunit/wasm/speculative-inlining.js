...
// implemented there and TurboFan is onits way out anyway.
...
(function CallIndirectImportedFunction() {
  ...
  let instance1 = function() {
    ...
    builder.addFunction("f1", kSig_i_i)
  ...
  let instance2 = function() {
    ...
    builder.addFunction("g", kSig_i_ii)
      .addBody([kExprLocalGet, 0, kExprLocalGet, 1, kExprI32Add])
      .exportFunc();
    ...
    return builder.instantiate({ m: { f: instance1.exports.f1 }});
  }();
