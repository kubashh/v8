...
(function testSimpleStack() {
  var expected_string = 'Error\n' +
      ...
      '    at main (wasm://wasm/1fc5dbc3:wasm-function[1]:0x72)\n' + // --
...
(function testStackFrames() {
  ...
  verifyStack(stack, [
      ...
      [    true,            "main",     1, 0x72, "wasm://wasm/1fc5dbc3", '0x72',        1],
...
(function testWasmUnreachable() {
  try {
    ...
    verifyStack(e.stack, [
        // isWasm               function   line  pos                    file  offset funcIndex
        [    true,    "exec_unreachable",    1, 0x77, "wasm://wasm/1fc5dbc3", '0x77',        2],
...
(function testWasmMemOutOfBounds() {
  try {
    ...
    verifyStack(e.stack, [
        // isWasm                  function   line   pos                    file  offset funcIndex
        [    true,                     null,     1, 0x7d, "wasm://wasm/1fc5dbc3", '0x7d',        3],
        [    true, "call_mem_out_of_bounds",     1, 0x83, "wasm://wasm/1fc5dbc3", '0x83',        4],
...
(function testStackOverflow() {
  ...
  try {
    ...
    verifyStack(e.stack.splice(0, 4), [
        // isWasm     function  line   pos                    file  offset funcIndex
        [    true, "recursion",    1, 0x34, "wasm://wasm/8b973932", '0x34',        0],
        [    true, "recursion",    1, 0x37, "wasm://wasm/8b973932", '0x37',        0],
        [    true, "recursion",    1, 0x37, "wasm://wasm/8b973932", '0x37',        0],
        [    true, "recursion",    1, 0x37, "wasm://wasm/8b973932", '0x37',        0]
    ]);
  }
...
(function testBigOffset() {
  ...
  try {
    ...
    verifyStack(e.stack, [
      // isWasm         function line                     pos                    file     offset funcIndex
      [    true,          'main',   1, unreachable_pos + 0x25, 'wasm://wasm/8cb84bba', hexOffset,        0],
