...
builder.addFunction("getHelloArray", makeSig([], [kWasmAnyRef]))
    .addBody([
        ...
        ...wasmI32Const(76),
        ...wasmI32Const(79),
        kGCPrefix, kExprArrayInitStatic, i16Array, 5
    ])
    .exportFunc();
...
builder.addFunction("getChar", makeSig([kWasmAnyRef, kWasmI32], [kWasmI32]))
    .addBody([
        ...
        kGCPrefix, kExprRefCastStatic, i16Array,
        kExprLocalGet, 1,
        kGCPrefix, kExprArrayGetS, i16Array
    ])
    .exportFunc();
...
assertEquals(WebAssembly.experimentalConvertArrayToString(getHelloArray(), 0, 5), "HELLO");
assertEquals(WebAssembly.experimentalConvertArrayToString(getHelloArray(), 1, 4), "ELLO");
assertEquals(WebAssembly.experimentalConvertArrayToString(getHelloArray(), 0, 3), "HEL");

const string = "foobar"
const array = WebAssembly.experimentalConvertStringToArray("foobar", getHelloArray());
