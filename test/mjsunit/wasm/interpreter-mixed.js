...
function createTwoInstancesCallingEachOther(inner_throws = false) {
  ...
  let sig_i_i1 = builder1.addType(kSig_i_i);
  let id_imp = builder1.addImport('q', 'id', sig_i_i1);
  let plus_one = builder1.addFunction('plus_one', sig_i_i1)
                     .addBody([
                       kExprGetLocal, 0, kExprI32Const, 1, kExprI32Add,
  ...
  let sig_i_i2 = builder2.addType(kSig_i_i);
  let plus_one_imp = builder2.addImport('q', 'plus_one', sig_i_i2);
  let plus_two = builder2.addFunction('plus_two', sig_i_i2)
                     .addBody([
                       // Call import, add one more.
                       kExprGetLocal, 0, kExprCallFunction, plus_one_imp,
