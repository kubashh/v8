...
// Flags: --experimental-wasm-typed-funcref --experimental-wasm-eh --no-liftoff
// Flags: --wasm-loop-unrolling --allow-natives-syntax --single-threaded
// Flags: --no-wasm-stack-checks
