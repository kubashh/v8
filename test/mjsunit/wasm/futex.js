...
(function TestInvalidIndex() {
  ...
  [-1, 65536, 0xffffffff].forEach(function(invalidIndex) {
    assertThrows(function() {
      GetAtomicWakeFunction(memory, 0)(invalidIndex, -1);
    }, Error);
    assertThrows(function() {
      GetAtomicWakeFunction(memory, invalidIndex)(0, -1);
    }, Error);
    assertThrows(function() {
      GetAtomicWakeFunction(memory, invalid_index/2)(invalidIndex/2, -1);
    }, Error);
  });
})();
...
(function TestWakeCounts() {
  ...
  [-1, 0, 4, 100, 0xffffffff].forEach(function(count) {
    GetAtomicWakeFunction(memory, 0)(0, count);
  });
})();
