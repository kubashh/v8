...
function assertEqualsArray(expected, buf) {
...
(function TestMemoryCopy() {
  ...
  assertEqualsArray([0, 11, 22, 33, 44, 55, 66, 77, 0, 0,
                     11, 22, 33, 44, 55, 66, 77, 0], u8a);
...
(function TestMemoryFill() {
  ...
  memoryFill(1, 33, 5);
  assertEqualsArray([0, 33, 33, 33, 33, 33, 0], u8a);

  memoryFill(4, 66, 4);
  assertEqualsArray([0, 33, 33, 33, 66, 66, 66, 66, 0], u8a);
...
(function TestMemoryFillValueWraps() {
  const mem = new WebAssembly.Memory({initial: 1});
  const memoryFill = getMemoryFill(mem);
  ...
  assertEqualsArray([expected, expected, expected], u8a);
})();
