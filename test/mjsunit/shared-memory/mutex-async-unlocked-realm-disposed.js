...
if (this.Worker) {
  (function TestAsyncLockedWorkerTerminated() {
    ...
    assertEquals(1, %AtomicsSynchronizationPrimitiveNumWaitersForTesting(mutex));
    ...
    assertEquals(2, %AtomicsSynchronizationPrimitiveNumWaitersForTesting(mutex));
    ...
    let asyncLoop = () => {
      ...
      setTimeout(() => {assertEquals(true, asyncLockPromiseResolved);}, 0);
    };
    asyncLoop();
  })();
}
