...
if (this.Worker) {
  (function TestRealmWithAsyncWaiterDisposed() {
    ...
    setTimeout(() => {
      ...
      let executeAsserts = () => {
        // The realm was disposed but the waiter node that it created is still
        // in the isolate's unlocked waiters list.
        assertEquals(
            1, %AtomicsSychronizationNumAsyncUnlockedWaitersInIsolate());
