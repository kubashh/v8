...

{
  ...
  assertEquals(s, s.padStart(NaN, throwing), MyError);
  assertEquals(s, s.padStart(-Infinity, throwing), MyError);
  assertEquals(s, s.padStart(-9, throwing), MyError);
  assertEquals(s, s.padStart(-1, throwing), MyError);
  assertEquals(s, s.padStart(-0, throwing), MyError);
  assertEquals(s, s.padStart(0, throwing), MyError);
  ...
  assertEquals(s, s.padEnd(NaN, throwing), MyError);
  assertEquals(s, s.padEnd(-Infinity, throwing), MyError);
  assertEquals(s, s.padEnd(-9, throwing), MyError);
  assertEquals(s, s.padEnd(-1, throwing), MyError);
  assertEquals(s, s.padEnd(-0, throwing), MyError);
  assertEquals(s, s.padEnd(0, throwing), MyError);
...

{
  ...
  assertEquals(s, s.padStart(-0, throwing), MyError);
  assertEquals(s, s.padStart(0, throwing), MyError);
  assertEquals(s, s.padStart(3, throwing), MyError);
  assertThrows(_ => s.padStart(9, throwing), MyError);
  assertThrows(_ => s.padStart(2**31-1, throwing), MyError);
  assertThrows(_ => s.padStart(2**31, throwing), MyError);
  assertThrows(_ => s.padStart(2**32-1, throwing), MyError);
  ...
  assertEquals(s, s.padEnd(-0, throwing), MyError);
  assertEquals(s, s.padEnd(0, throwing), MyError);
  assertEquals(s, s.padEnd(3, throwing), MyError);
  assertThrows(_ => s.padEnd(9, throwing), MyError);
  assertThrows(_ => s.padEnd(2**31-1, throwing), MyError);
  assertThrows(_ => s.padEnd(2**31, throwing), MyError);
  assertThrows(_ => s.padEnd(2**32-1, throwing), MyError);
