...
// Mapped Arguments
assertEquals(run(()=>{return [arguments.length, ...arguments]}, 1, 2, 3), [3,1,2,3]);
//assertEquals(run((a, a)=>{return [arguments.length, ...arguments]}, 1, 2, 3), [3,1,2,3]);

// Unmapped Arguments
assertEquals(run(()=>{"use strict"; return [arguments.length, ...arguments]}, 1, 2, 3), [3,1,2,3]);

// Rest Arguments
//assertEquals(run(()=>{return rest_args(1,2,3)}), [2,2,3]);
assertEquals(run((a, ...rest)=>{return [rest.length, ...rest]}, 1, 2, 3), [2,2,3]);
