...
// Set table type to $sig1_0.
const kRef = 9;
const kSmiTagSize = 1;
const kHeapTypeShift = 5;
let new_type = (($sig1_0 << kHeapTypeShift) | kRef) << kSmiTagSize;

// Set table1.entries[0] = table0.entries[0].
let t0_entries = getField(getPtr(table0), 12);
let t0_entry = getField(t0_entries, 8);
let t1_entries = getField(getPtr(table1), 12);
