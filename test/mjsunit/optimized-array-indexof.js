...
(() => {
  ...
  function testArrayIndexOf() {
    ...
    return a.indexOf(search_string);
  }
  %PrepareFunctionForOptimization(testArrayIndexOf);
  testArrayIndexOf();
...
(() => {
  ...
  %PrepareFunctionForOptimization(testArrayIndexOf);
  testArrayIndexOf(43);
  assertEquals(43, testArrayIndexOf(43));
  %OptimizeFunctionOnNextCall(testArrayIndexOf);
  testArrayIndexOf(43);
  assertEquals(43, testArrayIndexOf(43));
  assertOptimized(testArrayIndexOf);
...
(() => {
  ...
  %PrepareFunctionForOptimization(testArrayIndexOf);
  testArrayIndexOf(43.5);
  assertEquals(43, testArrayIndexOf(43.5));
  %OptimizeFunctionOnNextCall(testArrayIndexOf);
  testArrayIndexOf(43.5);
  assertEquals(43, testArrayIndexOf(43.5));
  assertOptimized(testArrayIndexOf);
...
(() => {
  ...
  %PrepareFunctionForOptimization(testArrayIndexOf);
  testArrayIndexOf(b[43]);
  assertEquals(43, testArrayIndexOf(b[43]));
  %OptimizeFunctionOnNextCall(testArrayIndexOf);
  testArrayIndexOf(b[43]);
  assertEquals(43, testArrayIndexOf(b[43]));
  assertOptimized(testArrayIndexOf);
