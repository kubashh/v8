...
// Here, retrieval of function at @@iterator has side effect (print message).
// Changing the value of 'iterator' in the JIT compiled 'foo' causes
// deoptimization after the message is printed. Now deopt cannot resume at
// the beginning of the bytecode because it would print the message twice.
