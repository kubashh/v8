...
// Flags: --allow-natives-syntax --super-ic --opt --runtime-call-stats --no-always-opt --no-stress-opt --no-turboprop --no-future --no-concurrent-inlining

// TODO(marja, v8:9237): Enable turboprop for this test.
...
(function TestUnexpectedReceiverDoesNotDeoptimize() {
  ...
  let r = C.prototype.foo.call({'lol': 5});
  assertEquals("correct value", r);
