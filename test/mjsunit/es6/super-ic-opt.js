...
/*
(function TestPolymorphicWihGetter() {
  class A {}
  A.prototype.bar = "wrong value: A.prototype.bar";
...
(function TestPolymorphicMixinDoesNotDeopt() {
  ...
  // FIXME: we need to assert that the runtime function was not called.
  // Now it is though, since the functions are not JSContextSpecialized.
})();

// FIXME: test: weird receiver doesn't deoptimize

// FIXME: mixin case, both optimized and non-optimized tests

// FIXME: the mixin case, assert we get many optimized versions and they stay optimized.
