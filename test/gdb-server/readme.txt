...
2. Strip DWARF debug data from the wasm module and put it into a separate ELF file with extension .dwo:
  ...
  python ..\wasm-to-dwo.py --dwo sort.dwo --wasm sort.wasm --module_url g:\test\sort\sort.wasm --symbols_url g:\test\sort\sort.dwo sort.wasm
