...
deps = {
  'build':
    Var('chromium_url') + '/chromium/src/build.git' + '@' + '8b9a3d06efc626a69c923adc89c0492cb3bb41bd',
  'buildtools':
  ...
  'third_party/catapult': {
    'url': Var('chromium_url') + '/catapult.git' + '@' + '7adb32fd7ad0fa60a68359fcceecec31efa32952',
    'condition': 'checkout_android',
  },
  ...
  'third_party/depot_tools':
    Var('chromium_url') + '/chromium/tools/depot_tools.git' + '@' + '840e538154a92136133a68b33a050e99266f40fd',
  ...
  'third_party/instrumented_libs': {
    'url': Var('chromium_url') + '/chromium/third_party/instrumented_libraries.git' + '@' + '584340e3f894e9bae8232e5cf1a7e3950985d569',
  ...
  'tools/clang':
    Var('chromium_url') + '/chromium/src/tools/clang.git' + '@' + '6bea657263a33a0875182ee8acbeccf365e17e25',
  'tools/luci-go': {
      'packages': [
        {
