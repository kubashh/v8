...
vars = {
  ...
  'fuchsia_version': 'version:10.20221015.0.1',
...
deps = {
  ...
  'buildtools':
    Var('chromium_url') + '/chromium/src/buildtools.git' + '@' + 'd153cfe321b0b7b26e59edac86a3d34dc5a9c7d9',
  ...
  'buildtools/third_party/libc++/trunk':
    Var('chromium_url') + '/external/github.com/llvm/llvm-project/libcxx.git' + '@' + 'de4575635003f3af708e1ae3cb05c0b219aa58b4',
