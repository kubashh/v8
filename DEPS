...
deps = {
  "v8/build":
    Var("chromium_url") + "/chromium/src/build.git" + "@" + "92ccaf1432c198e262a7f5d6b801b77879a4a46c",
  "v8/tools/gyp":
  ...
  "v8/tools/swarming_client":
    Var('chromium_url') + '/infra/luci/client-py.git' + '@' + "72b6a2dc604673b84794937cb3da3fd755ccc4cd",
  "v8/testing/gtest":
  ...
  "v8/tools/clang":
    Var("chromium_url") + "/chromium/src/tools/clang.git" + "@" + "3b354e887452b944b758fe791b0ccca60af834d6",
  "v8/test/wasm-js":
...
deps_os = {
  "android": {
    ...
    "v8/third_party/catapult":
      Var('chromium_url') + "/external/github.com/catapult-project/catapult.git" + "@" + "c9667ecd29cbb003b7fbdcd6f2da0f02bf0e7257",
  },
}
