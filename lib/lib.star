...
def ci_pair_factory(func):
    ...
    will create a builder-tester pair with similar properties. If you want properties
    specific to the tester you can add 'tester_' prefix to the property name.
    """
