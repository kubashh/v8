...
do
    ...
    then
        ...
        echo "Building" $arch
        GYP_DEFINES="component=static_library use_goma=1 target_arch=$host v8_target_arch=$arch coverage=1 clang=0" python $v8_root/gypfiles/gyp_v8.py -G output_dir=$work_dir
