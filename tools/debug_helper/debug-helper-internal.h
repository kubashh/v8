...
class ObjectProperty {
 public:
  inline ObjectProperty(std::string name, std::string type_name,
                        uintptr_t address, d::PropertyType type,
                        size_t num_values = 1,
