      ...
      if (validity == d::MemoryAccessResult::kOk) {
        ...
        if (shared_function_info_ptr.validity == d::MemoryAccessResult::kOk) {
          ...
          if (name_or_scope_info_ptr.validity == d::MemoryAccessResult::kOk) {
            ...
            std::vector<std::unique_ptr<StructProperty>>
                function_variable_info_struct_field_list;
            function_variable_info_struct_field_list.push_back(
                std::make_unique<StructProperty>(
                    "name", "v8::internal::TaggedValue", "v8::internal::Object",
                    0, 0, 0));
            // function_variable_info_struct_field_list.push_back(
            //     std::make_unique<StructProperty>(
            //         "context_or_stack_slot_index",
            //         "v8::internal::TaggedValue", "v8::internal::Object", 4,
            //         0, 0));
            ...
            if (indexed_field_slice_function_variable_info.validity ==
              ...
              props.push_back(std::make_unique<ObjectProperty>(
                  ...
                  std::get<2>(indexed_field_slice_function_variable_info.value),
                  8, std::move(function_variable_info_struct_field_list),
                  GetArrayKind(
                      indexed_field_slice_function_variable_info.validity)));
            }
            std::vector<std::unique_ptr<StructProperty>>
            ...
            position_info_struct_field_list.push_back(
                std::make_unique<StructProperty>(
                    "end", "v8::internal::TaggedValue", "v8::internal::Object",
                    4, 0, 0));
            ...
            if (indexed_field_slice_position_info.validity ==
              ...
              props.push_back(std::make_unique<ObjectProperty>(
                  ...
                  std::get<2>(indexed_field_slice_position_info.value), 8,
                  std::move(position_info_struct_field_list),
                  GetArrayKind(indexed_field_slice_position_info.validity)));
            }
          }
        }
      }
