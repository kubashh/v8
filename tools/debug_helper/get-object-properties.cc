...
#undef TYPE_NAME_CASE
    ...
    // pointers weren't provided), then create a synthetic property with the
    // more specific type. Then the caller could presumably ask us again with
    // the type hint we provided. Otherwise, just go ahead and use it to
    // generate properties.
    type_check_result =
