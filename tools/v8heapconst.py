...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05e05): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05e2d): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05e55): (134, "CallableTaskMap"),
  ("read_only_space", 0x05e7d): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05ea5): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05ecd): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05ef5): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05f1d): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05f45): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05f6d): (143, "AccessorPairMap"),
  ("read_only_space", 0x05f95): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05fbd): (145, "AllocationMementoMap"),
  ("read_only_space", 0x05fe5): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x0600d): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x06035): (150, "BreakPointMap"),
  ("read_only_space", 0x0605d): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x06085): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x060ad): (154, "CallSiteInfoMap"),
  ("read_only_space", 0x060d5): (155, "ClassPositionsMap"),
  ("read_only_space", 0x060fd): (156, "DebugInfoMap"),
  ("read_only_space", 0x06125): (158, "ErrorStackDataMap"),
  ("read_only_space", 0x0614d): (160, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x06175): (162, "InterpreterDataMap"),
  ("read_only_space", 0x0619d): (163, "ModuleRequestMap"),
  ("read_only_space", 0x061c5): (164, "PromiseCapabilityMap"),
  ("read_only_space", 0x061ed): (165, "PromiseReactionMap"),
  ("read_only_space", 0x06215): (166, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x0623d): (167, "PrototypeInfoMap"),
  ("read_only_space", 0x06265): (168, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x0628d): (169, "ScriptMap"),
  ("read_only_space", 0x062b5): (170, "ScriptOrModuleMap"),
  ("read_only_space", 0x062dd): (171, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x06305): (172, "StackFrameInfoMap"),
  ("read_only_space", 0x0632d): (173, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06355): (174, "Tuple2Map"),
  ("read_only_space", 0x0637d): (175, "WasmContinuationObjectMap"),
  ("read_only_space", 0x063a5): (176, "WasmExceptionTagMap"),
  ("read_only_space", 0x063cd): (177, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x063f5): (196, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x0641d): (231, "DescriptorArrayMap"),
  ("read_only_space", 0x06445): (219, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x0646d): (217, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06495): (220, "UncompiledDataWithoutPreparseDataWithJobMap"),
  ("read_only_space", 0x064bd): (218, "UncompiledDataWithPreparseDataAndJobMap"),
  ("read_only_space", 0x064e5): (250, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x0650d): (197, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x06535): (201, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x0655d): (200, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x06585): (198, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x065ad): (199, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x065d5): (246, "InternalClassMap"),
  ("read_only_space", 0x065fd): (257, "SmiPairMap"),
  ("read_only_space", 0x06625): (256, "SmiBoxMap"),
  ("read_only_space", 0x0664d): (225, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06675): (226, "ExportedSubClassMap"),
  ("read_only_space", 0x0669d): (202, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x066c5): (203, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x066ed): (195, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06715): (247, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x0673d): (227, "ExportedSubClass2Map"),
  ("read_only_space", 0x06765): (258, "SortStateMap"),
  ("read_only_space", 0x0678d): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x067b5): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x067dd): (137, "LoadHandler1Map"),
  ("read_only_space", 0x06805): (137, "LoadHandler2Map"),
  ("read_only_space", 0x0682d): (137, "LoadHandler3Map"),
  ("read_only_space", 0x06855): (138, "StoreHandler0Map"),
  ("read_only_space", 0x0687d): (138, "StoreHandler1Map"),
  ("read_only_space", 0x068a5): (138, "StoreHandler2Map"),
  ("read_only_space", 0x068cd): (138, "StoreHandler3Map"),
