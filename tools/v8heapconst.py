...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09341): (160, "ContextExtensionMap"),
  ("RO_SPACE", 0x093a9): (161, "DebugInfoMap"),
  ("RO_SPACE", 0x09411): (162, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x09479): (164, "InterpreterDataMap"),
  ("RO_SPACE", 0x094e1): (165, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x09549): (166, "ModuleMap"),
  ("RO_SPACE", 0x095b1): (167, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x09619): (168, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x09681): (169, "PromiseReactionMap"),
  ("RO_SPACE", 0x096e9): (170, "PrototypeInfoMap"),
  ("RO_SPACE", 0x09751): (172, "StackFrameInfoMap"),
  ("RO_SPACE", 0x097b9): (174, "Tuple3Map"),
  ("RO_SPACE", 0x09821): (175, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x09889): (176, "WasmDebugInfoMap"),
