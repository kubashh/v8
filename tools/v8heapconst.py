...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x02739): (172, "Tuple2Map"),
  ("RO_SPACE", 0x027d9): (174, "ArrayBoilerplateDescriptionMap"),
  ("RO_SPACE", 0x02b19): (162, "InterceptorInfoMap"),
  ...
  ("RO_SPACE", 0x051c9): (158, "AsmWasmDataMap"),
  ("RO_SPACE", 0x05219): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x05269): (160, "DebugInfoMap"),
  ("RO_SPACE", 0x052b9): (161, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x05309): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x05359): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x053a9): (165, "ModuleMap"),
  ("RO_SPACE", 0x053f9): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05449): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05499): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x054e9): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x05539): (170, "ScriptMap"),
  ("RO_SPACE", 0x05589): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x055d9): (173, "Tuple3Map"),
  ("RO_SPACE", 0x05629): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05679): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x056c9): (177, "CallableTaskMap"),
  ("RO_SPACE", 0x05719): (178, "CallbackTaskMap"),
  ("RO_SPACE", 0x05769): (179, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x057b9): (180, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05809): (181, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05859): (182, "WeakFactoryCleanupJobTaskMap"),
  ("RO_SPACE", 0x058a9): (183, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x058f9): (184, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05949): (184, "AllocationSiteWithoutWeakNextMap"),
