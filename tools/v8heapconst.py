...
=======
  ("read_only_space", 0x05ca9): (76, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05cd1): (77, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05cf9): (78, "CallableTaskMap"),
  ("read_only_space", 0x05d21): (79, "CallbackTaskMap"),
  ("read_only_space", 0x05d49): (80, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05d71): (83, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05d99): (84, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05dc1): (85, "AccessCheckInfoMap"),
  ("read_only_space", 0x05de9): (86, "AccessorInfoMap"),
  ("read_only_space", 0x05e11): (87, "AccessorPairMap"),
  ("read_only_space", 0x05e39): (88, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05e61): (89, "AllocationMementoMap"),
  ("read_only_space", 0x05e89): (92, "AsmWasmDataMap"),
  ("read_only_space", 0x05eb1): (93, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05ed9): (94, "BreakPointMap"),
  ("read_only_space", 0x05f01): (95, "BreakPointInfoMap"),
  ("read_only_space", 0x05f29): (96, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05f51): (98, "ClassPositionsMap"),
  ("read_only_space", 0x05f79): (99, "DebugInfoMap"),
  ("read_only_space", 0x05fa1): (102, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05fc9): (104, "InterpreterDataMap"),
  ("read_only_space", 0x05ff1): (105, "ModuleRequestMap"),
  ("read_only_space", 0x06019): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x06041): (107, "PromiseReactionMap"),
  ("read_only_space", 0x06069): (108, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x06091): (109, "PrototypeInfoMap"),
  ("read_only_space", 0x060b9): (110, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x060e1): (111, "ScriptMap"),
  ("read_only_space", 0x06109): (112, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x06131): (113, "StackFrameInfoMap"),
  ("read_only_space", 0x06159): (114, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06181): (115, "Tuple2Map"),
  ("read_only_space", 0x061a9): (116, "WasmExceptionTagMap"),
  ("read_only_space", 0x061d1): (117, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x061f9): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06221): (152, "DescriptorArrayMap"),
  ("read_only_space", 0x06249): (157, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06271): (156, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06299): (174, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x062c1): (170, "InternalClassMap"),
  ("read_only_space", 0x062e9): (181, "SmiPairMap"),
  ("read_only_space", 0x06311): (180, "SmiBoxMap"),
  ("read_only_space", 0x06339): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06361): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x06389): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x063b1): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x063d9): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06401): (171, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06429): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x06451): (182, "SortStateMap"),
  ("read_only_space", 0x06479): (160, "CallRefDataMap"),
  ("read_only_space", 0x064a1): (90, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x064c9): (90, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x064f1): (81, "LoadHandler1Map"),
  ("read_only_space", 0x06519): (81, "LoadHandler2Map"),
  ("read_only_space", 0x06541): (81, "LoadHandler3Map"),
  ("read_only_space", 0x06569): (82, "StoreHandler0Map"),
  ("read_only_space", 0x06591): (82, "StoreHandler1Map"),
  ("read_only_space", 0x065b9): (82, "StoreHandler2Map"),
  ("read_only_space", 0x065e1): (82, "StoreHandler3Map"),
>>>>>>> 8538f06483 ([Temporal] Prototype)
<<<<<<< HEAD
>>>>>>> 6e6a69ee55 ([Temporal] Prototype)
=======
  ("read_only_space", 0x05c95): (76, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05cbd): (77, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05ce5): (78, "CallableTaskMap"),
  ("read_only_space", 0x05d0d): (79, "CallbackTaskMap"),
  ("read_only_space", 0x05d35): (80, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05d5d): (83, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05d85): (84, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05dad): (85, "AccessCheckInfoMap"),
  ("read_only_space", 0x05dd5): (86, "AccessorInfoMap"),
  ("read_only_space", 0x05dfd): (87, "AccessorPairMap"),
  ("read_only_space", 0x05e25): (88, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05e4d): (89, "AllocationMementoMap"),
  ("read_only_space", 0x05e75): (92, "AsmWasmDataMap"),
  ("read_only_space", 0x05e9d): (93, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05ec5): (94, "BreakPointMap"),
  ("read_only_space", 0x05eed): (95, "BreakPointInfoMap"),
  ("read_only_space", 0x05f15): (96, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05f3d): (98, "ClassPositionsMap"),
  ("read_only_space", 0x05f65): (99, "DebugInfoMap"),
  ("read_only_space", 0x05f8d): (102, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05fb5): (104, "InterpreterDataMap"),
  ("read_only_space", 0x05fdd): (105, "ModuleRequestMap"),
  ("read_only_space", 0x06005): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x0602d): (107, "PromiseReactionMap"),
  ("read_only_space", 0x06055): (108, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x0607d): (109, "PrototypeInfoMap"),
  ("read_only_space", 0x060a5): (110, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x060cd): (111, "ScriptMap"),
  ("read_only_space", 0x060f5): (112, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x0611d): (113, "StackFrameInfoMap"),
  ("read_only_space", 0x06145): (114, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x0616d): (115, "Tuple2Map"),
  ("read_only_space", 0x06195): (116, "WasmExceptionTagMap"),
  ("read_only_space", 0x061bd): (117, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x061e5): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x0620d): (152, "DescriptorArrayMap"),
  ("read_only_space", 0x06235): (157, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x0625d): (156, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06285): (174, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x062ad): (170, "InternalClassMap"),
  ("read_only_space", 0x062d5): (181, "SmiPairMap"),
  ("read_only_space", 0x062fd): (180, "SmiBoxMap"),
  ("read_only_space", 0x06325): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x0634d): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x06375): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x0639d): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x063c5): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x063ed): (171, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06415): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x0643d): (182, "SortStateMap"),
  ("read_only_space", 0x06465): (160, "CallRefDataMap"),
  ("read_only_space", 0x0648d): (90, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x064b5): (90, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x064dd): (81, "LoadHandler1Map"),
  ("read_only_space", 0x06505): (81, "LoadHandler2Map"),
  ("read_only_space", 0x0652d): (81, "LoadHandler3Map"),
  ("read_only_space", 0x06555): (82, "StoreHandler0Map"),
  ("read_only_space", 0x0657d): (82, "StoreHandler1Map"),
  ("read_only_space", 0x065a5): (82, "StoreHandler2Map"),
  ("read_only_space", 0x065cd): (82, "StoreHandler3Map"),
>>>>>>> 193489f399 (trim)
=======
>>>>>>> 261c42f6d2 ([Temporal] Prototype)
...
<<<<<<< HEAD
  ("old_space", 0x05f79): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05f9d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05fc1): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05fe5): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x06009): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x0602d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x06051): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x06075): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x06099): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x060bd): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x060e1): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x06105): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x06129): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0614d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x06171): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x06195): "PromiseCatchFinallySharedFun",
  ("old_space", 0x061b9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x061dd): "PromiseThenFinallySharedFun",
  ("old_space", 0x06201): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x06225): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x06249): "ProxyRevokeSharedFun",
=======
...
=======
  ...
  ("old_space", 0x035f1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x03615): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03639): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0365d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x03681): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x036a5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x036c9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x036ed): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03711): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03735): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x03759): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0377d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x037a1): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x037c5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x037e9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0380d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03831): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x03855): "PromiseThenFinallySharedFun",
  ("old_space", 0x03879): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0389d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x038c1): "ProxyRevokeSharedFun",
>>>>>>> 8538f06483 ([Temporal] Prototype)
>>>>>>> 261c42f6d2 ([Temporal] Prototype)
}
