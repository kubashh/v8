...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x05b3d): "UninitializedValue",
  ("read_only_space", 0x05b75): "ArgumentsMarker",
  ("read_only_space", 0x05bad): "TerminationException",
  ("read_only_space", 0x05bed): "Exception",
  ("read_only_space", 0x05c09): "OptimizedOut",
  ("read_only_space", 0x05c41): "StaleRegister",
  ("read_only_space", 0x05c79): "SelfReferenceMarker",
  ("read_only_space", 0x05cb9): "BasicBlockCountersMarker",
  ("read_only_space", 0x0614d): "EmptySlowElementDictionary",
  ("read_only_space", 0x06171): "EmptySymbolTable",
  ("read_only_space", 0x0618d): "EmptyOrderedHashMap",
  ("read_only_space", 0x061a1): "EmptyOrderedHashSet",
  ("read_only_space", 0x061b5): "EmptyFeedbackMetadata",
  ("read_only_space", 0x061c1): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x061e1): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x06205): "NativeScopeInfo",
  ("read_only_space", 0x0621d): "ShadowRealmScopeInfo",
  ...
  ("old_space", 0x031fd): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x03229): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03255): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03281): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x032ad): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032d9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x03305): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x03331): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0335d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03389): "ErrorStackGetterSharedFun",
  ("old_space", 0x033d5): "ErrorStackSetterSharedFun",
  ("old_space", 0x03421): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0344d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03479): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x034a5): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x034d1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x034fd): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03529): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03555): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x03581): "PromiseThenFinallySharedFun",
  ("old_space", 0x035ad): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x035d9): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03605): "ProxyRevokeSharedFun",
  ("old_space", 0x03631): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x0365d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x03689): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
