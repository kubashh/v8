...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x00279): (157, "DescriptorArrayMap"),
  ("read_only_space", 0x002d9): (152, "WeakFixedArrayMap"),
  ...
  ("read_only_space", 0x007b9): (127, "FixedArrayMap"),
  ("read_only_space", 0x00809): (127, "FixedCOWArrayMap"),
  ("read_only_space", 0x00859): (130, "HashTableMap"),
  ("read_only_space", 0x008a9): (64, "SymbolMap"),
  ("read_only_space", 0x008f9): (40, "OneByteStringMap"),
  ("read_only_space", 0x00949): (140, "ScopeInfoMap"),
  ("read_only_space", 0x00999): (164, "SharedFunctionInfoMap"),
  ("read_only_space", 0x009e9): (69, "CodeMap"),
  ("read_only_space", 0x00a39): (147, "FunctionContextMap"),
  ("read_only_space", 0x00a89): (155, "CellMap"),
  ("read_only_space", 0x00ad9): (163, "GlobalPropertyCellMap"),
  ("read_only_space", 0x00b29): (71, "ForeignMap"),
  ("read_only_space", 0x00b79): (153, "TransitionArrayMap"),
  ("read_only_space", 0x00bc9): (159, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x00f61): (149, "NativeContextMap"),
  ("read_only_space", 0x00fb1): (148, "ModuleContextMap"),
  ("read_only_space", 0x01001): (146, "EvalContextMap"),
  ("read_only_space", 0x01051): (150, "ScriptContextMap"),
  ("read_only_space", 0x010a1): (142, "AwaitContextMap"),
  ("read_only_space", 0x010f1): (143, "BlockContextMap"),
  ("read_only_space", 0x01141): (144, "CatchContextMap"),
  ("read_only_space", 0x01191): (151, "WithContextMap"),
  ("read_only_space", 0x011e1): (145, "DebugEvaluateContextMap"),
  ("read_only_space", 0x01231): (141, "ScriptContextTableMap"),
  ("read_only_space", 0x01281): (129, "ClosureFeedbackCellArrayMap"),
  ("read_only_space", 0x012d1): (87, "FeedbackMetadataArrayMap"),
  ("read_only_space", 0x01321): (127, "ArrayListMap"),
  ("read_only_space", 0x01371): (66, "BigIntMap"),
  ("read_only_space", 0x013c1): (128, "ObjectBoilerplateDescriptionMap"),
  ("read_only_space", 0x01411): (73, "BytecodeArrayMap"),
  ("read_only_space", 0x01461): (156, "CodeDataContainerMap"),
  ("read_only_space", 0x014b1): (86, "FixedDoubleArrayMap"),
  ("read_only_space", 0x01501): (135, "GlobalDictionaryMap"),
  ("read_only_space", 0x01551): (158, "ManyClosuresCellMap"),
  ("read_only_space", 0x015a1): (127, "ModuleInfoMap"),
  ("read_only_space", 0x015f1): (70, "MutableHeapNumberMap"),
  ("read_only_space", 0x01641): (134, "NameDictionaryMap"),
  ("read_only_space", 0x01691): (158, "NoClosuresCellMap"),
  ("read_only_space", 0x016e1): (136, "NumberDictionaryMap"),
  ("read_only_space", 0x01731): (158, "OneClosureCellMap"),
  ("read_only_space", 0x01781): (131, "OrderedHashMapMap"),
  ("read_only_space", 0x017d1): (132, "OrderedHashSetMap"),
  ("read_only_space", 0x01821): (133, "OrderedNameDictionaryMap"),
  ("read_only_space", 0x01871): (161, "PreparseDataMap"),
  ("read_only_space", 0x018c1): (162, "PropertyArrayMap"),
  ("read_only_space", 0x01911): (154, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x01961): (154, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x019b1): (154, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x01a01): (137, "SimpleNumberDictionaryMap"),
  ("read_only_space", 0x01a51): (127, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x01aa1): (165, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x01af1): (166, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x01b41): (167, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x01b91): (138, "StringTableMap"),
  ("read_only_space", 0x01be1): (169, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x01c31): (170, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x01c81): (171, "WeakArrayListMap"),
  ("read_only_space", 0x01cd1): (139, "EphemeronHashTableMap"),
  ("read_only_space", 0x01d21): (126, "EmbedderDataArrayMap"),
  ("read_only_space", 0x01d71): (172, "WeakCellMap"),
  ...
  ("read_only_space", 0x05891): (116, "WasmDebugInfoMap"),
  ("read_only_space", 0x058e1): (117, "WasmExceptionTagMap"),
  ("read_only_space", 0x05931): (118, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05981): (119, "CallableTaskMap"),
  ("read_only_space", 0x059d1): (120, "CallbackTaskMap"),
  ("read_only_space", 0x05a21): (121, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05a71): (122, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05ac1): (123, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05b11): (124, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05b61): (125, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05bb1): (125, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05c01): (160, "LoadHandler1Map"),
  ("read_only_space", 0x05c51): (160, "LoadHandler2Map"),
  ("read_only_space", 0x05ca1): (160, "LoadHandler3Map"),
  ("read_only_space", 0x05cf1): (168, "StoreHandler0Map"),
  ("read_only_space", 0x05d41): (168, "StoreHandler1Map"),
  ("read_only_space", 0x05d91): (168, "StoreHandler2Map"),
  ("read_only_space", 0x05de1): (168, "StoreHandler3Map"),
