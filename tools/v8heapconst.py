...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x051b5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x051d9): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x051fd): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05221): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05245): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x05269): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x0528d): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x052b1): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x052d5): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x052f9): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0531d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05341): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05365): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05389): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x053ad): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x053d1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x053f5): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05419): "PromiseThenFinallySharedFun",
  ("old_space", 0x0543d): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05461): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05485): "ProxyRevokeSharedFun",
  ("old_space", 0x054a9): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x054cd): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x054f1): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
