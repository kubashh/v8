...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x05ae5): "UninitializedValue",
  ("read_only_space", 0x05b1d): "ArgumentsMarker",
  ("read_only_space", 0x05b55): "TerminationException",
  ("read_only_space", 0x05b95): "Exception",
  ("read_only_space", 0x05bb1): "OptimizedOut",
  ("read_only_space", 0x05be9): "StaleRegister",
  ("read_only_space", 0x05c21): "SelfReferenceMarker",
  ("read_only_space", 0x05c61): "BasicBlockCountersMarker",
  ("read_only_space", 0x060f5): "EmptySlowElementDictionary",
  ("read_only_space", 0x06119): "EmptySymbolTable",
  ("read_only_space", 0x06135): "EmptyOrderedHashMap",
  ("read_only_space", 0x06149): "EmptyOrderedHashSet",
  ("read_only_space", 0x0615d): "EmptyFeedbackMetadata",
  ("read_only_space", 0x06169): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x06189): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x061ad): "NativeScopeInfo",
  ("read_only_space", 0x061c5): "ShadowRealmScopeInfo",
  ...
  ("old_space", 0x05ae1): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b05): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b29): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b4d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b71): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05b95): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bb9): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05bdd): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c01): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c25): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c6d): "ErrorStackSetterSharedFun",
  ("old_space", 0x05cb5): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05cd9): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05cfd): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d21): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d45): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d69): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d8d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05db1): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05dd5): "PromiseThenFinallySharedFun",
  ("old_space", 0x05df9): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e1d): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e41): "ProxyRevokeSharedFun",
  ("old_space", 0x05e65): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e89): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05ead): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
