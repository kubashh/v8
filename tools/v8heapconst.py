...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x031e9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0320d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03231): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03255): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x03279): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0329d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x032c1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x032e5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03309): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0332d): "ErrorStackGetterSharedFun",
  ("old_space", 0x03375): "ErrorStackSetterSharedFun",
  ("old_space", 0x033bd): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x033e1): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03405): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x03429): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0344d): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x03471): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03495): "PromiseCatchFinallySharedFun",
  ("old_space", 0x034b9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x034dd): "PromiseThenFinallySharedFun",
  ("old_space", 0x03501): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x03525): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03549): "ProxyRevokeSharedFun",
  ("old_space", 0x0356d): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x03591): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x035b5): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
