...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x04f19): (77, "AccessCheckInfoMap"),
  ("read_only_space", 0x04f69): (78, "AccessorInfoMap"),
  ("read_only_space", 0x04fb9): (79, "AccessorPairMap"),
  ("read_only_space", 0x05009): (80, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05059): (81, "AllocationMementoMap"),
  ("read_only_space", 0x050a9): (83, "AsmWasmDataMap"),
  ("read_only_space", 0x050f9): (84, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05149): (85, "ClassPositionsMap"),
  ("read_only_space", 0x05199): (86, "DebugInfoMap"),
  ("read_only_space", 0x051e9): (88, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05239): (89, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05289): (91, "InterpreterDataMap"),
  ("read_only_space", 0x052d9): (92, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05329): (93, "PromiseCapabilityMap"),
  ("read_only_space", 0x05379): (94, "PromiseReactionMap"),
  ("read_only_space", 0x053c9): (95, "PrototypeInfoMap"),
  ("read_only_space", 0x05419): (96, "ScriptMap"),
  ("read_only_space", 0x05469): (97, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x054b9): (98, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05509): (99, "StackFrameInfoMap"),
  ("read_only_space", 0x05559): (100, "StackTraceFrameMap"),
  ("read_only_space", 0x055a9): (101, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x055f9): (102, "Tuple2Map"),
  ("read_only_space", 0x05649): (103, "Tuple3Map"),
  ("read_only_space", 0x05699): (104, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x056e9): (105, "WasmDebugInfoMap"),
  ("read_only_space", 0x05739): (106, "WasmExceptionTagMap"),
  ("read_only_space", 0x05789): (107, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x057d9): (108, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05829): (109, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05879): (110, "CallableTaskMap"),
  ("read_only_space", 0x058c9): (111, "CallbackTaskMap"),
  ("read_only_space", 0x05919): (112, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05969): (113, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x059b9): (114, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a09): (115, "InternalClassMap"),
  ("read_only_space", 0x05a59): (116, "SmiPairMap"),
  ("read_only_space", 0x05aa9): (117, "SmiBoxMap"),
  ("read_only_space", 0x05af9): (118, "SortStateMap"),
  ("read_only_space", 0x05b49): (121, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b99): (121, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05be9): (156, "LoadHandler1Map"),
  ("read_only_space", 0x05c39): (156, "LoadHandler2Map"),
  ("read_only_space", 0x05c89): (156, "LoadHandler3Map"),
  ("read_only_space", 0x05cd9): (164, "StoreHandler0Map"),
  ("read_only_space", 0x05d29): (164, "StoreHandler1Map"),
  ("read_only_space", 0x05d79): (164, "StoreHandler2Map"),
  ("read_only_space", 0x05dc9): (164, "StoreHandler3Map"),
