...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x08e29): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x09039): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x090a1): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09109): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09171): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x091d9): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x09241): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x092a9): (160, "ContextExtensionMap"),
  ("RO_SPACE", 0x09311): (161, "DebugInfoMap"),
  ("RO_SPACE", 0x09379): (162, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x093e1): (164, "InterpreterDataMap"),
  ("RO_SPACE", 0x09449): (165, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x094b1): (166, "ModuleMap"),
  ("RO_SPACE", 0x09519): (167, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x09581): (168, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x095e9): (169, "PromiseReactionMap"),
  ("RO_SPACE", 0x09651): (170, "PrototypeInfoMap"),
  ("RO_SPACE", 0x096b9): (172, "StackFrameInfoMap"),
  ("RO_SPACE", 0x09721): (174, "Tuple3Map"),
  ("RO_SPACE", 0x09789): (175, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x097f1): (176, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x09859): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x098c1): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x09929): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x09991): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x099f9): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x09a61): (182, "PromiseResolveThenableJobTaskMap"),
