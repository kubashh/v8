...
INSTANCE_TYPES = {
  ...
  209: "WASM_API_FUNCTION_REF_TYPE",
  210: "WASM_TYPE_INFO_TYPE",
  211: "TURBOFAN_BITSET_TYPE_TYPE",
  212: "TURBOFAN_HEAP_CONSTANT_TYPE_TYPE",
  213: "TURBOFAN_OTHER_NUMBER_CONSTANT_TYPE_TYPE",
  214: "TURBOFAN_RANGE_TYPE_TYPE",
  215: "TURBOFAN_UNION_TYPE_TYPE",
...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x02191): (230, "WeakFixedArrayMap"),
  ...
  ("read_only_space", 0x0229d): (241, "FreeSpaceMap"),
  ("read_only_space", 0x022c5): (240, "OnePointerFillerMap"),
  ("read_only_space", 0x022ed): (240, "TwoPointerFillerMap"),
  ...
  ("read_only_space", 0x025d1): (250, "ScopeInfoMap"),
  ("read_only_space", 0x025f9): (251, "SharedFunctionInfoMap"),
  ("read_only_space", 0x02621): (234, "CodeMap"),
  ("read_only_space", 0x02649): (233, "CellMap"),
  ("read_only_space", 0x02671): (249, "GlobalPropertyCellMap"),
  ("read_only_space", 0x02699): (204, "ForeignMap"),
  ("read_only_space", 0x026c1): (231, "TransitionArrayMap"),
  ("read_only_space", 0x026e9): (45, "ThinOneByteStringMap"),
  ("read_only_space", 0x02711): (239, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x0297d): (238, "FeedbackMetadataArrayMap"),
  ...
  ("read_only_space", 0x02a45): (235, "CodeDataContainerMap"),
  ("read_only_space", 0x02a6d): (236, "CoverageInfoMap"),
  ...
  ("read_only_space", 0x02b0d): (245, "MegaDomHandlerMap"),
  ...
  ("read_only_space", 0x02c75): (247, "PreparseDataMap"),
  ("read_only_space", 0x02c9d): (248, "PropertyArrayMap"),
  ...
  ("read_only_space", 0x02d65): (219, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x02d8d): (220, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x02db5): (221, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x02ddd): (226, "SourceTextModuleMap"),
  ("read_only_space", 0x02e05): (255, "SwissNameDictionaryMap"),
  ("read_only_space", 0x02e2d): (227, "SyntheticModuleMap"),
  ...
  ("read_only_space", 0x02ecd): (209, "WasmApiFunctionRefMap"),
  ("read_only_space", 0x02ef5): (210, "WasmTypeInfoMap"),
  ("read_only_space", 0x02f1d): (256, "WeakArrayListMap"),
  ("read_only_space", 0x02f45): (178, "EphemeronHashTableMap"),
  ("read_only_space", 0x02f6d): (237, "EmbedderDataArrayMap"),
  ...
  ("read_only_space", 0x0622d): (224, "DescriptorArrayMap"),
  ("read_only_space", 0x06255): (229, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x0627d): (228, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x062a5): (246, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x062cd): (211, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x062f5): (215, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x0631d): (214, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x06345): (212, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x0636d): (213, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x06395): (242, "InternalClassMap"),
  ("read_only_space", 0x063bd): (253, "SmiPairMap"),
  ("read_only_space", 0x063e5): (252, "SmiBoxMap"),
  ("read_only_space", 0x0640d): (216, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06435): (217, "ExportedSubClassMap"),
  ("read_only_space", 0x0645d): (222, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x06485): (223, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x064ad): (192, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x064d5): (243, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x064fd): (218, "ExportedSubClass2Map"),
  ("read_only_space", 0x06525): (254, "SortStateMap"),
  ("read_only_space", 0x0654d): (232, "CallRefDataMap"),
