...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x03459): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x03481): (90, "AccessorInfoMap"),
  ("read_only_space", 0x034a9): (91, "AccessorPairMap"),
  ("read_only_space", 0x034d1): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x034f9): (93, "AllocationMementoMap"),
  ("read_only_space", 0x03521): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x03549): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x03571): (96, "ClassPositionsMap"),
  ("read_only_space", 0x03599): (97, "DebugInfoMap"),
  ("read_only_space", 0x035c1): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x035e9): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x03611): (102, "InterpreterDataMap"),
  ("read_only_space", 0x03639): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x03661): (104, "ModuleMap"),
  ("read_only_space", 0x03689): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x036b1): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x036d9): (107, "PromiseReactionMap"),
  ("read_only_space", 0x03701): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x03729): (109, "ScriptMap"),
  ("read_only_space", 0x03751): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x03779): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x037a1): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x037c9): (113, "Tuple2Map"),
  ("read_only_space", 0x037f1): (114, "Tuple3Map"),
  ("read_only_space", 0x03819): (116, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x03841): (117, "WasmDebugInfoMap"),
  ("read_only_space", 0x03869): (118, "WasmExceptionTagMap"),
  ("read_only_space", 0x03891): (119, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x038b9): (120, "CallableTaskMap"),
  ("read_only_space", 0x038e1): (121, "CallbackTaskMap"),
  ("read_only_space", 0x03909): (122, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x03931): (123, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x03959): (124, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x03981): (125, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x039a9): (126, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x039d1): (126, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x039f9): (161, "LoadHandler1Map"),
  ("read_only_space", 0x03a21): (161, "LoadHandler2Map"),
  ("read_only_space", 0x03a49): (161, "LoadHandler3Map"),
  ("read_only_space", 0x03a71): (169, "StoreHandler0Map"),
  ("read_only_space", 0x03a99): (169, "StoreHandler1Map"),
  ("read_only_space", 0x03ac1): (169, "StoreHandler2Map"),
  ("read_only_space", 0x03ae9): (169, "StoreHandler3Map"),
