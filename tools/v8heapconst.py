...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x04f71): (77, "AccessCheckInfoMap"),
  ("read_only_space", 0x04fc1): (78, "AccessorInfoMap"),
  ("read_only_space", 0x05011): (79, "AccessorPairMap"),
  ("read_only_space", 0x05061): (80, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x050b1): (81, "AllocationMementoMap"),
  ("read_only_space", 0x05101): (83, "AsmWasmDataMap"),
  ("read_only_space", 0x05151): (84, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x051a1): (85, "ClassPositionsMap"),
  ("read_only_space", 0x051f1): (86, "DebugInfoMap"),
  ("read_only_space", 0x05241): (88, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05291): (89, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x052e1): (91, "InterpreterDataMap"),
  ("read_only_space", 0x05331): (92, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05381): (93, "PromiseCapabilityMap"),
  ("read_only_space", 0x053d1): (94, "PromiseReactionMap"),
  ("read_only_space", 0x05421): (95, "PrototypeInfoMap"),
  ("read_only_space", 0x05471): (96, "ScriptMap"),
  ("read_only_space", 0x054c1): (97, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05511): (98, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05561): (99, "StackFrameInfoMap"),
  ("read_only_space", 0x055b1): (100, "StackTraceFrameMap"),
  ("read_only_space", 0x05601): (101, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05651): (102, "Tuple2Map"),
  ("read_only_space", 0x056a1): (103, "Tuple3Map"),
  ("read_only_space", 0x056f1): (104, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05741): (105, "WasmDebugInfoMap"),
  ("read_only_space", 0x05791): (106, "WasmExceptionTagMap"),
  ("read_only_space", 0x057e1): (107, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05831): (108, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05881): (109, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x058d1): (110, "CallableTaskMap"),
  ("read_only_space", 0x05921): (111, "CallbackTaskMap"),
  ("read_only_space", 0x05971): (112, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x059c1): (113, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05a11): (114, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a61): (115, "InternalClassMap"),
  ("read_only_space", 0x05ab1): (116, "SmiPairMap"),
  ("read_only_space", 0x05b01): (117, "SmiBoxMap"),
  ("read_only_space", 0x05b51): (118, "SortStateMap"),
  ("read_only_space", 0x05ba1): (121, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05bf1): (121, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05c41): (156, "LoadHandler1Map"),
  ("read_only_space", 0x05c91): (156, "LoadHandler2Map"),
  ("read_only_space", 0x05ce1): (156, "LoadHandler3Map"),
  ("read_only_space", 0x05d31): (164, "StoreHandler0Map"),
  ("read_only_space", 0x05d81): (164, "StoreHandler1Map"),
  ("read_only_space", 0x05dd1): (164, "StoreHandler2Map"),
  ("read_only_space", 0x05e21): (164, "StoreHandler3Map"),
