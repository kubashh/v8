...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x031f9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x03225): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03251): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0327d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x032a9): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032d5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x03301): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0332d): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03359): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03385): "ErrorStackGetterSharedFun",
  ("old_space", 0x033d1): "ErrorStackSetterSharedFun",
  ("old_space", 0x0341d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x03449): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x03475): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x034a1): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x034cd): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x034f9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03525): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03551): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0357d): "PromiseThenFinallySharedFun",
  ("old_space", 0x035a9): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x035d5): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03601): "ProxyRevokeSharedFun",
  ("old_space", 0x0362d): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x03659): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x03685): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
