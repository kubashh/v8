...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x056f9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0571d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05741): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05765): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05789): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x057ad): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x057d1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x057f5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05819): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0583d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05861): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05885): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x058a9): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x058cd): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x058f1): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05915): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05939): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0595d): "PromiseThenFinallySharedFun",
  ("old_space", 0x05981): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x059a5): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x059c9): "ProxyRevokeSharedFun",
}
