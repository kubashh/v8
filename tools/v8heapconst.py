...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b6d): (2124, "ExternalMap"),
    ("old_space", 0x04b95): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04a1d): "ArgumentsIteratorAccessor",
  ("old_space", 0x04a35): "ArrayLengthAccessor",
  ("old_space", 0x04a4d): "BoundFunctionLengthAccessor",
  ("old_space", 0x04a65): "BoundFunctionNameAccessor",
  ("old_space", 0x04a7d): "ErrorStackAccessor",
  ("old_space", 0x04a95): "FunctionArgumentsAccessor",
  ("old_space", 0x04aad): "FunctionCallerAccessor",
  ("old_space", 0x04ac5): "FunctionNameAccessor",
  ("old_space", 0x04add): "FunctionLengthAccessor",
  ("old_space", 0x04af5): "FunctionPrototypeAccessor",
  ("old_space", 0x04b0d): "StringLengthAccessor",
  ("old_space", 0x04b25): "ValueUnavailableAccessor",
  ("old_space", 0x04b3d): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b55): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b6d): "ExternalMap",
  ("old_space", 0x04b95): "JSMessageObjectMap",
  ("old_space", 0x04bbd): "EmptyScript",
  ("old_space", 0x04c05): "ManyClosuresCell",
  ("old_space", 0x04c11): "ArrayConstructorProtector",
  ("old_space", 0x04c25): "NoElementsProtector",
  ("old_space", 0x04c39): "MegaDOMProtector",
  ("old_space", 0x04c4d): "IsConcatSpreadableProtector",
  ("old_space", 0x04c61): "ArraySpeciesProtector",
  ("old_space", 0x04c75): "TypedArraySpeciesProtector",
  ("old_space", 0x04c89): "PromiseSpeciesProtector",
  ("old_space", 0x04c9d): "RegExpSpeciesProtector",
  ("old_space", 0x04cb1): "StringLengthProtector",
  ("old_space", 0x04cc5): "ArrayIteratorProtector",
  ("old_space", 0x04cd9): "ArrayBufferDetachingProtector",
  ("old_space", 0x04ced): "PromiseHookProtector",
  ("old_space", 0x04d01): "PromiseResolveProtector",
  ("old_space", 0x04d15): "MapIteratorProtector",
  ("old_space", 0x04d29): "PromiseThenProtector",
  ("old_space", 0x04d3d): "SetIteratorProtector",
  ("old_space", 0x04d51): "StringIteratorProtector",
  ("old_space", 0x04d65): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x04d79): "StringSplitCache",
  ("old_space", 0x05181): "RegExpMultipleCache",
  ("old_space", 0x05589): "BuiltinsConstantsTable",
  ("old_space", 0x05aed): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b11): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b35): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b59): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b7d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05ba1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bc5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05be9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c0d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c31): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05c55): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05c79): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05c9d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05cc1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05ce5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d09): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05d2d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05d51): "PromiseThenFinallySharedFun",
  ("old_space", 0x05d75): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05d99): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05dbd): "ProxyRevokeSharedFun",
  ("old_space", 0x05de1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e05): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05e29): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
