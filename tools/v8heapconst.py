...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09a99): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x09ae9): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x09b39): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09b89): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09bd9): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x09c29): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x09c79): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x09cc9): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x09d19): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x09d69): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x09db9): (164, "ModuleMap"),
  ("RO_SPACE", 0x09e09): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x09e59): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x09ea9): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x09ef9): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x09f49): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x09f99): (172, "Tuple3Map"),
  ("RO_SPACE", 0x09fe9): (173, "ArrayBoilerplateDescriptionMap"),
