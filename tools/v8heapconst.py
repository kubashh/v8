...
INSTANCE_TYPES = {
  ...
  161: "FUNCTION_TEMPLATE_RARE_DATA_TYPE",
...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x01691): (194, "NumberDictionaryMap"),
  ("RO_SPACE", 0x016e1): (216, "OneClosureCellMap"),
  ("RO_SPACE", 0x01731): (189, "OrderedHashMapMap"),
  ("RO_SPACE", 0x01781): (190, "OrderedHashSetMap"),
  ("RO_SPACE", 0x017d1): (191, "OrderedNameDictionaryMap"),
  ("RO_SPACE", 0x01821): (219, "PreParsedScopeDataMap"),
  ("RO_SPACE", 0x01871): (220, "PropertyArrayMap"),
  ("RO_SPACE", 0x018c1): (213, "SideEffectCallHandlerInfoMap"),
  ("RO_SPACE", 0x01911): (213, "SideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x01961): (213, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x019b1): (195, "SimpleNumberDictionaryMap"),
  ("RO_SPACE", 0x01a01): (186, "SloppyArgumentsElementsMap"),
  ("RO_SPACE", 0x01a51): (223, "SmallOrderedHashMapMap"),
  ("RO_SPACE", 0x01aa1): (224, "SmallOrderedHashSetMap"),
  ("RO_SPACE", 0x01af1): (225, "SmallOrderedNameDictionaryMap"),
  ("RO_SPACE", 0x01b41): (196, "StringTableMap"),
  ("RO_SPACE", 0x01b91): (227, "UncompiledDataWithoutPreParsedScopeMap"),
  ("RO_SPACE", 0x01be1): (228, "UncompiledDataWithPreParsedScopeMap"),
  ("RO_SPACE", 0x01c31): (229, "WeakArrayListMap"),
  ("RO_SPACE", 0x01c81): (197, "EphemeronHashTableMap"),
  ("RO_SPACE", 0x01cd1): (185, "EmbedderDataArrayMap"),
  ...
  ("RO_SPACE", 0x02789): (172, "Tuple2Map"),
  ("RO_SPACE", 0x02829): (174, "ArrayBoilerplateDescriptionMap"),
  ("RO_SPACE", 0x02b69): (162, "InterceptorInfoMap"),
  ...
  ("RO_SPACE", 0x05309): (161, "FunctionTemplateRareDataMap"),
  ("RO_SPACE", 0x05359): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x053a9): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x053f9): (165, "ModuleMap"),
  ("RO_SPACE", 0x05449): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x05499): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x054e9): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x05539): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x05589): (170, "ScriptMap"),
  ("RO_SPACE", 0x055d9): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x05629): (173, "Tuple3Map"),
  ("RO_SPACE", 0x05679): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x056c9): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x05719): (177, "CallableTaskMap"),
  ("RO_SPACE", 0x05769): (178, "CallbackTaskMap"),
  ("RO_SPACE", 0x057b9): (179, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x05809): (180, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05859): (181, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x058a9): (182, "WeakFactoryCleanupJobTaskMap"),
  ("RO_SPACE", 0x058f9): (183, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x05949): (184, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05999): (184, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x059e9): (218, "LoadHandler1Map"),
  ("RO_SPACE", 0x05a39): (218, "LoadHandler2Map"),
  ("RO_SPACE", 0x05a89): (218, "LoadHandler3Map"),
  ("RO_SPACE", 0x05ad9): (226, "StoreHandler0Map"),
  ("RO_SPACE", 0x05b29): (226, "StoreHandler1Map"),
  ("RO_SPACE", 0x05b79): (226, "StoreHandler2Map"),
  ("RO_SPACE", 0x05bc9): (226, "StoreHandler3Map"),
