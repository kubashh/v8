...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x00279): (206, "DescriptorArrayMap"),
  ("RO_SPACE", 0x002d9): (205, "WeakFixedArrayMap"),
  ...
  ("RO_SPACE", 0x007b9): (182, "FixedArrayMap"),
  ("RO_SPACE", 0x00809): (182, "FixedCOWArrayMap"),
  ("RO_SPACE", 0x00859): (184, "HashTableMap"),
  ("RO_SPACE", 0x008a9): (128, "SymbolMap"),
  ("RO_SPACE", 0x008f9): (72, "OneByteStringMap"),
  ("RO_SPACE", 0x00949): (193, "ScopeInfoMap"),
  ("RO_SPACE", 0x00999): (217, "SharedFunctionInfoMap"),
  ("RO_SPACE", 0x009e9): (133, "CodeMap"),
  ("RO_SPACE", 0x00a39): (200, "FunctionContextMap"),
  ("RO_SPACE", 0x00a89): (209, "CellMap"),
  ("RO_SPACE", 0x00ad9): (216, "GlobalPropertyCellMap"),
  ("RO_SPACE", 0x00b29): (135, "ForeignMap"),
  ("RO_SPACE", 0x00b79): (207, "TransitionArrayMap"),
  ("RO_SPACE", 0x00bc9): (212, "FeedbackVectorMap"),
  ...
  ("RO_SPACE", 0x00f61): (202, "NativeContextMap"),
  ("RO_SPACE", 0x00fb1): (201, "ModuleContextMap"),
  ("RO_SPACE", 0x01001): (199, "EvalContextMap"),
  ("RO_SPACE", 0x01051): (203, "ScriptContextMap"),
  ("RO_SPACE", 0x010a1): (195, "AwaitContextMap"),
  ("RO_SPACE", 0x010f1): (196, "BlockContextMap"),
  ("RO_SPACE", 0x01141): (197, "CatchContextMap"),
  ("RO_SPACE", 0x01191): (204, "WithContextMap"),
  ("RO_SPACE", 0x011e1): (198, "DebugEvaluateContextMap"),
  ("RO_SPACE", 0x01231): (194, "ScriptContextTableMap"),
  ("RO_SPACE", 0x01281): (151, "FeedbackMetadataArrayMap"),
  ("RO_SPACE", 0x012d1): (182, "ArrayListMap"),
  ("RO_SPACE", 0x01321): (130, "BigIntMap"),
  ("RO_SPACE", 0x01371): (183, "ObjectBoilerplateDescriptionMap"),
  ("RO_SPACE", 0x013c1): (137, "BytecodeArrayMap"),
  ("RO_SPACE", 0x01411): (210, "CodeDataContainerMap"),
  ("RO_SPACE", 0x01461): (150, "FixedDoubleArrayMap"),
  ("RO_SPACE", 0x014b1): (188, "GlobalDictionaryMap"),
  ("RO_SPACE", 0x01501): (211, "ManyClosuresCellMap"),
  ("RO_SPACE", 0x01551): (182, "ModuleInfoMap"),
  ("RO_SPACE", 0x015a1): (134, "MutableHeapNumberMap"),
  ("RO_SPACE", 0x015f1): (187, "NameDictionaryMap"),
  ("RO_SPACE", 0x01641): (211, "NoClosuresCellMap"),
  ("RO_SPACE", 0x01691): (189, "NumberDictionaryMap"),
  ("RO_SPACE", 0x016e1): (211, "OneClosureCellMap"),
  ("RO_SPACE", 0x01731): (185, "OrderedHashMapMap"),
  ("RO_SPACE", 0x01781): (186, "OrderedHashSetMap"),
  ("RO_SPACE", 0x017d1): (214, "PreParsedScopeDataMap"),
  ("RO_SPACE", 0x01821): (215, "PropertyArrayMap"),
  ("RO_SPACE", 0x01871): (208, "SideEffectCallHandlerInfoMap"),
  ("RO_SPACE", 0x018c1): (208, "SideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x01911): (208, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x01961): (190, "SimpleNumberDictionaryMap"),
  ("RO_SPACE", 0x019b1): (182, "SloppyArgumentsElementsMap"),
  ("RO_SPACE", 0x01a01): (218, "SmallOrderedHashMapMap"),
  ("RO_SPACE", 0x01a51): (219, "SmallOrderedHashSetMap"),
  ("RO_SPACE", 0x01aa1): (191, "StringTableMap"),
  ("RO_SPACE", 0x01af1): (221, "UncompiledDataWithoutPreParsedScopeMap"),
  ("RO_SPACE", 0x01b41): (222, "UncompiledDataWithPreParsedScopeMap"),
  ("RO_SPACE", 0x01b91): (223, "WeakArrayListMap"),
  ("RO_SPACE", 0x01be1): (192, "EphemeronHashTableMap"),
  ...
  ("RO_SPACE", 0x05879): (181, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x058c9): (181, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05919): (213, "LoadHandler1Map"),
  ("RO_SPACE", 0x05969): (213, "LoadHandler2Map"),
  ("RO_SPACE", 0x059b9): (213, "LoadHandler3Map"),
  ("RO_SPACE", 0x05a09): (220, "StoreHandler0Map"),
  ("RO_SPACE", 0x05a59): (220, "StoreHandler1Map"),
  ("RO_SPACE", 0x05aa9): (220, "StoreHandler2Map"),
  ("RO_SPACE", 0x05af9): (220, "StoreHandler3Map"),
...
KNOWN_OBJECTS = {
  ...
  ("OLD_SPACE", 0x020d1): "BuiltinsConstantsTable",
