...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x01b89): (136, "StringTableMap"),
  ("read_only_space", 0x01bd9): (167, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x01c29): (168, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x01c79): (169, "WeakArrayListMap"),
  ("read_only_space", 0x01cc9): (137, "EphemeronHashTableMap"),
  ("read_only_space", 0x01d19): (124, "EmbedderDataArrayMap"),
  ("read_only_space", 0x01d69): (170, "WeakCellMap"),
  ...
  ("read_only_space", 0x026e1): (111, "Tuple2Map"),
  ("read_only_space", 0x02781): (113, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x02ad1): (100, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x05389): (98, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x053d9): (99, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05429): (101, "InterpreterDataMap"),
  ("read_only_space", 0x05479): (102, "ModuleInfoEntryMap"),
  ("read_only_space", 0x054c9): (103, "ModuleMap"),
  ("read_only_space", 0x05519): (104, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05569): (105, "PromiseCapabilityMap"),
  ("read_only_space", 0x055b9): (106, "PromiseReactionMap"),
  ("read_only_space", 0x05609): (107, "PrototypeInfoMap"),
  ("read_only_space", 0x05659): (108, "ScriptMap"),
  ("read_only_space", 0x056a9): (109, "StackFrameInfoMap"),
  ("read_only_space", 0x056f9): (110, "StackTraceFrameMap"),
  ("read_only_space", 0x05749): (112, "Tuple3Map"),
  ("read_only_space", 0x05799): (114, "WasmDebugInfoMap"),
  ("read_only_space", 0x057e9): (115, "WasmExceptionTagMap"),
  ("read_only_space", 0x05839): (116, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05889): (117, "CallableTaskMap"),
  ("read_only_space", 0x058d9): (118, "CallbackTaskMap"),
  ("read_only_space", 0x05929): (119, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05979): (120, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x059c9): (121, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a19): (122, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05a69): (123, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05ab9): (123, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05b09): (158, "LoadHandler1Map"),
  ("read_only_space", 0x05b59): (158, "LoadHandler2Map"),
  ("read_only_space", 0x05ba9): (158, "LoadHandler3Map"),
  ("read_only_space", 0x05bf9): (166, "StoreHandler0Map"),
  ("read_only_space", 0x05c49): (166, "StoreHandler1Map"),
  ("read_only_space", 0x05c99): (166, "StoreHandler2Map"),
  ("read_only_space", 0x05ce9): (166, "StoreHandler3Map"),
