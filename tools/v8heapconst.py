...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x05791): (181, "MicrotaskQueueMap"),
  ("RO_SPACE", 0x057e1): (182, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05831): (182, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05881): (214, "LoadHandler1Map"),
  ("RO_SPACE", 0x058d1): (214, "LoadHandler2Map"),
  ("RO_SPACE", 0x05921): (214, "LoadHandler3Map"),
  ("RO_SPACE", 0x05971): (221, "StoreHandler0Map"),
  ("RO_SPACE", 0x059c1): (221, "StoreHandler1Map"),
  ("RO_SPACE", 0x05a11): (221, "StoreHandler2Map"),
  ("RO_SPACE", 0x05a61): (221, "StoreHandler3Map"),
