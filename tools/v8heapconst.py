...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b7d): (2124, "ExternalMap"),
    ("old_space", 0x04ba5): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04a45): "ArgumentsIteratorAccessor",
  ("old_space", 0x04a5d): "ArrayLengthAccessor",
  ("old_space", 0x04a75): "BoundFunctionLengthAccessor",
  ("old_space", 0x04a8d): "BoundFunctionNameAccessor",
  ("old_space", 0x04aa5): "FunctionArgumentsAccessor",
  ("old_space", 0x04abd): "FunctionCallerAccessor",
  ("old_space", 0x04ad5): "FunctionNameAccessor",
  ("old_space", 0x04aed): "FunctionLengthAccessor",
  ("old_space", 0x04b05): "FunctionPrototypeAccessor",
  ("old_space", 0x04b1d): "StringLengthAccessor",
  ("old_space", 0x04b35): "ValueUnavailableAccessor",
  ("old_space", 0x04b4d): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b65): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b7d): "ExternalMap",
  ("old_space", 0x04ba5): "JSMessageObjectMap",
  ("old_space", 0x04bcd): "EmptyScript",
  ("old_space", 0x04c15): "ManyClosuresCell",
  ("old_space", 0x04c21): "ArrayConstructorProtector",
  ("old_space", 0x04c35): "NoElementsProtector",
  ("old_space", 0x04c49): "MegaDOMProtector",
  ("old_space", 0x04c5d): "IsConcatSpreadableProtector",
  ("old_space", 0x04c71): "ArraySpeciesProtector",
  ("old_space", 0x04c85): "TypedArraySpeciesProtector",
  ("old_space", 0x04c99): "PromiseSpeciesProtector",
  ("old_space", 0x04cad): "RegExpSpeciesProtector",
  ("old_space", 0x04cc1): "StringLengthProtector",
  ("old_space", 0x04cd5): "ArrayIteratorProtector",
  ("old_space", 0x04ce9): "ArrayBufferDetachingProtector",
  ("old_space", 0x04cfd): "PromiseHookProtector",
  ("old_space", 0x04d11): "PromiseResolveProtector",
  ("old_space", 0x04d25): "MapIteratorProtector",
  ("old_space", 0x04d39): "PromiseThenProtector",
  ("old_space", 0x04d4d): "SetIteratorProtector",
  ("old_space", 0x04d61): "StringIteratorProtector",
  ("old_space", 0x04d75): "NumberStringNotRegexpLikeProtector",
  ("old_space", 0x04d89): "StringSplitCache",
  ("old_space", 0x05191): "RegExpMultipleCache",
  ("old_space", 0x05599): "BuiltinsConstantsTable",
  ("old_space", 0x05b01): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b29): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b51): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b79): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05ba1): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05bc9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bf1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05c19): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c41): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c69): "ErrorStackGetterSharedFun",
  ("old_space", 0x05cb5): "ErrorStackSetterSharedFun",
  ("old_space", 0x05d01): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05d29): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d51): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d79): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05da1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05dc9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05df1): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05e19): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05e41): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e69): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e91): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05eb9): "ProxyRevokeSharedFun",
  ("old_space", 0x05ee1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05f09): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05f31): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
