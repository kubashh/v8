...
KNOWN_MAPS = {
    ...
    ("read_only_space", 0x0600d): (132, "PromiseFulfillReactionJobTaskMap"),
    ("read_only_space", 0x06035): (133, "PromiseRejectReactionJobTaskMap"),
    ("read_only_space", 0x0605d): (134, "CallableTaskMap"),
    ("read_only_space", 0x06085): (135, "CallbackTaskMap"),
    ("read_only_space", 0x060ad): (136, "PromiseResolveThenableJobTaskMap"),
    ("read_only_space", 0x060d5): (139, "FunctionTemplateInfoMap"),
    ("read_only_space", 0x060fd): (140, "ObjectTemplateInfoMap"),
    ("read_only_space", 0x06125): (141, "AccessCheckInfoMap"),
    ("read_only_space", 0x0614d): (142, "AccessorInfoMap"),
    ("read_only_space", 0x06175): (143, "AccessorPairMap"),
    ("read_only_space", 0x0619d): (144, "AliasedArgumentsEntryMap"),
    ("read_only_space", 0x061c5): (145, "AllocationMementoMap"),
    ("read_only_space", 0x061ed): (148, "AsmWasmDataMap"),
    ("read_only_space", 0x06215): (149, "AsyncGeneratorRequestMap"),
    ("read_only_space", 0x0623d): (150, "BreakPointMap"),
    ("read_only_space", 0x06265): (151, "BreakPointInfoMap"),
    ("read_only_space", 0x0628d): (152, "CachedTemplateObjectMap"),
    ("read_only_space", 0x062b5): (154, "CallSiteInfoMap"),
    ("read_only_space", 0x062dd): (155, "ClassPositionsMap"),
    ("read_only_space", 0x06305): (156, "DebugInfoMap"),
    ("read_only_space", 0x0632d): (158, "ErrorStackDataMap"),
    ("read_only_space", 0x06355): (160, "FunctionTemplateRareDataMap"),
    ("read_only_space", 0x0637d): (162, "InterpreterDataMap"),
    ("read_only_space", 0x063a5): (163, "ModuleRequestMap"),
    ("read_only_space", 0x063cd): (164, "PromiseCapabilityMap"),
    ("read_only_space", 0x063f5): (165, "PromiseReactionMap"),
    ("read_only_space", 0x0641d): (166, "PropertyDescriptorObjectMap"),
    ("read_only_space", 0x06445): (167, "PrototypeInfoMap"),
    ("read_only_space", 0x0646d): (168, "RegExpBoilerplateDescriptionMap"),
    ("read_only_space", 0x06495): (169, "ScriptMap"),
    ("read_only_space", 0x064bd): (170, "ScriptOrModuleMap"),
    ("read_only_space", 0x064e5): (171, "SourceTextModuleInfoEntryMap"),
    ("read_only_space", 0x0650d): (172, "StackFrameInfoMap"),
    ("read_only_space", 0x06535): (173, "TemplateObjectDescriptionMap"),
    ("read_only_space", 0x0655d): (174, "Tuple2Map"),
    ("read_only_space", 0x06585): (175, "WasmContinuationObjectMap"),
    ("read_only_space", 0x065ad): (176, "WasmExceptionTagMap"),
    ("read_only_space", 0x065d5): (177, "WasmIndirectFunctionTableMap"),
    ("read_only_space", 0x065fd): (197, "SloppyArgumentsElementsMap"),
    ("read_only_space", 0x06625): (233, "DescriptorArrayMap"),
    ("read_only_space", 0x0664d): (219, "UncompiledDataWithoutPreparseDataMap"),
    ("read_only_space", 0x06675): (217, "UncompiledDataWithPreparseDataMap"),
    ("read_only_space", 0x0669d): (220, "UncompiledDataWithoutPreparseDataWithJobMap"),
    ("read_only_space", 0x066c5): (218, "UncompiledDataWithPreparseDataAndJobMap"),
    ("read_only_space", 0x066ed): (251, "OnHeapBasicBlockProfilerDataMap"),
    ("read_only_space", 0x06715): (198, "TurbofanBitsetTypeMap"),
    ("read_only_space", 0x0673d): (202, "TurbofanUnionTypeMap"),
    ("read_only_space", 0x06765): (201, "TurbofanRangeTypeMap"),
    ("read_only_space", 0x0678d): (199, "TurbofanHeapConstantTypeMap"),
    ("read_only_space", 0x067b5): (200, "TurbofanOtherNumberConstantTypeMap"),
    ("read_only_space", 0x067dd): (247, "InternalClassMap"),
    ("read_only_space", 0x06805): (258, "SmiPairMap"),
    ("read_only_space", 0x0682d): (257, "SmiBoxMap"),
    ("read_only_space", 0x06855): (225, "ExportedSubClassBaseMap"),
    ("read_only_space", 0x0687d): (226, "ExportedSubClassMap"),
    ("read_only_space", 0x068a5): (231, "AbstractInternalClassSubclass1Map"),
    ("read_only_space", 0x068cd): (232, "AbstractInternalClassSubclass2Map"),
    ("read_only_space", 0x068f5): (196, "InternalClassWithSmiElementsMap"),
    ("read_only_space", 0x0691d): (248, "InternalClassWithStructElementsMap"),
    ("read_only_space", 0x06945): (227, "ExportedSubClass2Map"),
    ("read_only_space", 0x0696d): (259, "SortStateMap"),
    ("read_only_space", 0x06995): (146, "AllocationSiteWithWeakNextMap"),
    ("read_only_space", 0x069bd): (146, "AllocationSiteWithoutWeakNextMap"),
