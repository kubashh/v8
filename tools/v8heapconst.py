...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x0356d): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x03595): (90, "AccessorInfoMap"),
  ("read_only_space", 0x035bd): (91, "AccessorPairMap"),
  ("read_only_space", 0x035e5): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x0360d): (93, "AllocationMementoMap"),
  ("read_only_space", 0x03635): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x0365d): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x03685): (96, "ClassPositionsMap"),
  ("read_only_space", 0x036ad): (97, "DebugInfoMap"),
  ("read_only_space", 0x036d5): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x036fd): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x03725): (102, "InterpreterDataMap"),
  ("read_only_space", 0x0374d): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x03775): (104, "ModuleMap"),
  ("read_only_space", 0x0379d): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x037c5): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x037ed): (107, "PromiseReactionMap"),
  ("read_only_space", 0x03815): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x0383d): (109, "ScriptMap"),
  ("read_only_space", 0x03865): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x0388d): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x038b5): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x038dd): (113, "Tuple2Map"),
  ("read_only_space", 0x03905): (114, "Tuple3Map"),
  ("read_only_space", 0x0392d): (116, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x03955): (117, "WasmDebugInfoMap"),
  ("read_only_space", 0x0397d): (118, "WasmExceptionTagMap"),
  ("read_only_space", 0x039a5): (119, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x039cd): (120, "CallableTaskMap"),
  ("read_only_space", 0x039f5): (121, "CallbackTaskMap"),
  ("read_only_space", 0x03a1d): (122, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x03a45): (123, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x03a6d): (124, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x03a95): (125, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x03abd): (126, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x03ae5): (126, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x03b0d): (161, "LoadHandler1Map"),
  ("read_only_space", 0x03b35): (161, "LoadHandler2Map"),
  ("read_only_space", 0x03b5d): (161, "LoadHandler3Map"),
  ("read_only_space", 0x03b85): (169, "StoreHandler0Map"),
  ("read_only_space", 0x03bad): (169, "StoreHandler1Map"),
  ("read_only_space", 0x03bd5): (169, "StoreHandler2Map"),
  ("read_only_space", 0x03bfd): (169, "StoreHandler3Map"),
