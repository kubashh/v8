...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x02ddd): (179, "SwissNameDictionaryMap"),
  ("read_only_space", 0x02e05): (154, "SyntheticModuleMap"),
  ("read_only_space", 0x02e2d): (71, "WasmTypeInfoMap"),
  ("read_only_space", 0x02e55): (183, "WeakArrayListMap"),
  ("read_only_space", 0x02e7d): (118, "EphemeronHashTableMap"),
  ("read_only_space", 0x02ea5): (163, "EmbedderDataArrayMap"),
  ("read_only_space", 0x02ecd): (184, "WeakCellMap"),
  ...
  ("read_only_space", 0x032c1): (99, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x05735): (101, "ModuleRequestMap"),
  ("read_only_space", 0x0575d): (102, "PromiseCapabilityMap"),
  ("read_only_space", 0x05785): (103, "PromiseReactionMap"),
  ("read_only_space", 0x057ad): (104, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x057d5): (105, "PrototypeInfoMap"),
  ("read_only_space", 0x057fd): (106, "ScriptMap"),
  ("read_only_space", 0x05825): (107, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x0584d): (108, "StackFrameInfoMap"),
  ("read_only_space", 0x05875): (109, "StackTraceFrameMap"),
  ("read_only_space", 0x0589d): (110, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x058c5): (111, "Tuple2Map"),
  ...
  ("read_only_space", 0x0598d): (134, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x059b5): (151, "DescriptorArrayMap"),
  ("read_only_space", 0x059dd): (156, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x05a05): (155, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x05a2d): (171, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x05a55): (181, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05a7d): (168, "InternalClassMap"),
  ("read_only_space", 0x05aa5): (177, "SmiPairMap"),
  ("read_only_space", 0x05acd): (176, "SmiBoxMap"),
  ("read_only_space", 0x05af5): (145, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05b1d): (146, "ExportedSubClassMap"),
  ("read_only_space", 0x05b45): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05b6d): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05b95): (133, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05bbd): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05be5): (147, "ExportedSubClass2Map"),
  ("read_only_space", 0x05c0d): (178, "SortStateMap"),
  ("read_only_space", 0x05c35): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05c5d): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05c85): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05cad): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05cd5): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05cfd): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05d25): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05d4d): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05d75): (78, "StoreHandler3Map"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x03289): "EmptyOrderedPropertyDictionary",
  ("read_only_space", 0x032a1): "EmptySwissPropertyDictionary",
  ("read_only_space", 0x032e9): "NoOpInterceptorInfo",
  ("read_only_space", 0x03311): "EmptyWeakArrayList",
  ("read_only_space", 0x0331d): "InfinityValue",
  ("read_only_space", 0x03329): "MinusZeroValue",
  ("read_only_space", 0x03335): "MinusInfinityValue",
  ("read_only_space", 0x03341): "SelfReferenceMarker",
  ("read_only_space", 0x03381): "BasicBlockCountersMarker",
  ("read_only_space", 0x033c5): "OffHeapTrampolineRelocationInfo",
  ("read_only_space", 0x033d1): "TrampolineTrivialCodeDataContainer",
  ("read_only_space", 0x033dd): "TrampolinePromiseRejectionCodeDataContainer",
  ("read_only_space", 0x033e9): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x03421): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x03449): "NativeScopeInfo",
  ("read_only_space", 0x03465): "HashSeed",
