...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x03201): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0322d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03259): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x03285): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x032b1): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x032dd): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x03309): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x03335): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03361): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0338d): "ErrorStackGetterSharedFun",
  ("old_space", 0x033d9): "ErrorStackSetterSharedFun",
  ("old_space", 0x03425): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x03451): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0347d): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x034a9): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x034d5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x03501): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0352d): "PromiseCatchFinallySharedFun",
  ("old_space", 0x03559): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x03585): "PromiseThenFinallySharedFun",
  ("old_space", 0x035b1): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x035dd): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03609): "ProxyRevokeSharedFun",
  ("old_space", 0x03635): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x03661): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0368d): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
