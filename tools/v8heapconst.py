...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x053a9): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x053d1): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x053f9): (74, "CallableTaskMap"),
  ("read_only_space", 0x05421): (75, "CallbackTaskMap"),
  ("read_only_space", 0x05449): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05471): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05499): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x054c1): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x054e9): (82, "AccessorInfoMap"),
  ("read_only_space", 0x05511): (83, "AccessorPairMap"),
  ("read_only_space", 0x05539): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05561): (85, "AllocationMementoMap"),
  ("read_only_space", 0x05589): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x055b1): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x055d9): (90, "BreakPointMap"),
  ("read_only_space", 0x05601): (91, "BreakPointInfoMap"),
  ("read_only_space", 0x05629): (92, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05651): (94, "ClassPositionsMap"),
  ("read_only_space", 0x05679): (95, "DebugInfoMap"),
  ("read_only_space", 0x056a1): (98, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x056c9): (100, "InterpreterDataMap"),
  ("read_only_space", 0x056f1): (101, "PromiseCapabilityMap"),
  ("read_only_space", 0x05719): (102, "PromiseReactionMap"),
  ("read_only_space", 0x05741): (103, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x05769): (104, "PrototypeInfoMap"),
  ("read_only_space", 0x05791): (105, "ScriptMap"),
  ("read_only_space", 0x057b9): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x057e1): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x05809): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05831): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05859): (110, "Tuple2Map"),
  ("read_only_space", 0x05881): (111, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x058a9): (112, "WasmExceptionTagMap"),
  ("read_only_space", 0x058d1): (113, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x058f9): (114, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05921): (115, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05949): (116, "WasmValueMap"),
  ("read_only_space", 0x05971): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x05999): (171, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x059c1): (168, "InternalClassMap"),
  ("read_only_space", 0x059e9): (177, "SmiPairMap"),
  ("read_only_space", 0x05a11): (176, "SmiBoxMap"),
  ("read_only_space", 0x05a39): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05a61): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x05a89): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05ab1): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05ad9): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05b01): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05b29): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x05b51): (178, "SortStateMap"),
  ("read_only_space", 0x05b79): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05ba1): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05bc9): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05bf1): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05c19): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05c41): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05c69): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05c91): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05cb9): (78, "StoreHandler3Map"),
