...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x021b1): (262, "WeakArrayListMap"),
  ...
  ("read_only_space", 0x02f69): (261, "WasmOnFulfilledDataMap"),
  ("read_only_space", 0x02f91): (206, "WasmTypeInfoMap"),
  ("read_only_space", 0x02fb9): (235, "WeakFixedArrayMap"),
  ("read_only_space", 0x02fe1): (180, "EphemeronHashTableMap"),
  ("read_only_space", 0x03009): (241, "EmbedderDataArrayMap"),
  ("read_only_space", 0x03031): (263, "WeakCellMap"),
  ("read_only_space", 0x03059): (32, "StringMap"),
  ("read_only_space", 0x03081): (41, "ConsOneByteStringMap"),
  ("read_only_space", 0x030a9): (33, "ConsStringMap"),
  ("read_only_space", 0x030d1): (37, "ThinStringMap"),
  ("read_only_space", 0x030f9): (35, "SlicedStringMap"),
  ("read_only_space", 0x03121): (43, "SlicedOneByteStringMap"),
  ("read_only_space", 0x03149): (34, "ExternalStringMap"),
  ("read_only_space", 0x03171): (42, "ExternalOneByteStringMap"),
  ("read_only_space", 0x03199): (50, "UncachedExternalStringMap"),
  ("read_only_space", 0x031c1): (0, "InternalizedStringMap"),
  ("read_only_space", 0x031e9): (2, "ExternalInternalizedStringMap"),
  ("read_only_space", 0x03211): (10, "ExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03239): (18, "UncachedExternalInternalizedStringMap"),
  ("read_only_space", 0x03261): (26, "UncachedExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03289): (58, "UncachedExternalOneByteStringMap"),
  ("read_only_space", 0x032b1): (104, "SharedOneByteStringMap"),
  ("read_only_space", 0x032d9): (96, "SharedStringMap"),
  ("read_only_space", 0x03301): (109, "SharedThinOneByteStringMap"),
  ("read_only_space", 0x03329): (101, "SharedThinStringMap"),
  ("read_only_space", 0x03351): (96, "TwoByteSeqStringMigrationSentinelMap"),
  ("read_only_space", 0x03379): (104, "OneByteSeqStringMigrationSentinelMap"),
  ("read_only_space", 0x033a1): (131, "SelfReferenceMarkerMap"),
  ("read_only_space", 0x033c9): (131, "BasicBlockCountersMarkerMap"),
  ("read_only_space", 0x0340d): (147, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x0350d): (161, "InterceptorInfoMap"),
  ("read_only_space", 0x05e2d): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05e55): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05e7d): (134, "CallableTaskMap"),
  ("read_only_space", 0x05ea5): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05ecd): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05ef5): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05f1d): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05f45): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05f6d): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05f95): (143, "AccessorPairMap"),
  ("read_only_space", 0x05fbd): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05fe5): (145, "AllocationMementoMap"),
  ("read_only_space", 0x0600d): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x06035): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x0605d): (150, "BreakPointMap"),
  ("read_only_space", 0x06085): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x060ad): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x060d5): (154, "CallSiteInfoMap"),
  ("read_only_space", 0x060fd): (155, "ClassPositionsMap"),
  ("read_only_space", 0x06125): (156, "DebugInfoMap"),
  ("read_only_space", 0x0614d): (158, "ErrorStackDataMap"),
  ("read_only_space", 0x06175): (160, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x0619d): (162, "InterpreterDataMap"),
  ("read_only_space", 0x061c5): (163, "ModuleRequestMap"),
  ("read_only_space", 0x061ed): (164, "PromiseCapabilityMap"),
  ("read_only_space", 0x06215): (165, "PromiseReactionMap"),
  ("read_only_space", 0x0623d): (166, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x06265): (167, "PrototypeInfoMap"),
  ("read_only_space", 0x0628d): (168, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x062b5): (169, "ScriptMap"),
  ("read_only_space", 0x062dd): (170, "ScriptOrModuleMap"),
  ("read_only_space", 0x06305): (171, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x0632d): (172, "StackFrameInfoMap"),
  ("read_only_space", 0x06355): (173, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x0637d): (174, "Tuple2Map"),
  ("read_only_space", 0x063a5): (175, "WasmContinuationObjectMap"),
  ("read_only_space", 0x063cd): (176, "WasmExceptionTagMap"),
  ("read_only_space", 0x063f5): (177, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x0641d): (196, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06445): (231, "DescriptorArrayMap"),
  ("read_only_space", 0x0646d): (219, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06495): (217, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x064bd): (220, "UncompiledDataWithoutPreparseDataWithJobMap"),
  ("read_only_space", 0x064e5): (218, "UncompiledDataWithPreparseDataAndJobMap"),
  ("read_only_space", 0x0650d): (250, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x06535): (197, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x0655d): (201, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x06585): (200, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x065ad): (198, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x065d5): (199, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x065fd): (246, "InternalClassMap"),
  ("read_only_space", 0x06625): (257, "SmiPairMap"),
  ("read_only_space", 0x0664d): (256, "SmiBoxMap"),
  ("read_only_space", 0x06675): (225, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x0669d): (226, "ExportedSubClassMap"),
  ("read_only_space", 0x066c5): (202, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x066ed): (203, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x06715): (195, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x0673d): (247, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06765): (227, "ExportedSubClass2Map"),
  ("read_only_space", 0x0678d): (258, "SortStateMap"),
  ("read_only_space", 0x067b5): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x067dd): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x06805): (137, "LoadHandler1Map"),
  ("read_only_space", 0x0682d): (137, "LoadHandler2Map"),
  ("read_only_space", 0x06855): (137, "LoadHandler3Map"),
  ("read_only_space", 0x0687d): (138, "StoreHandler0Map"),
  ("read_only_space", 0x068a5): (138, "StoreHandler1Map"),
  ("read_only_space", 0x068cd): (138, "StoreHandler2Map"),
  ("read_only_space", 0x068f5): (138, "StoreHandler3Map"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x0355d): "EmptyWeakFixedArray",
  ("read_only_space", 0x03565): "InfinityValue",
  ("read_only_space", 0x03571): "MinusZeroValue",
  ("read_only_space", 0x0357d): "MinusInfinityValue",
  ("read_only_space", 0x03589): "SelfReferenceMarker",
  ("read_only_space", 0x035c9): "BasicBlockCountersMarker",
  ("read_only_space", 0x0360d): "OffHeapTrampolineRelocationInfo",
  ("read_only_space", 0x03619): "TrampolineTrivialCodeDataContainer",
  ("read_only_space", 0x03625): "TrampolinePromiseRejectionCodeDataContainer",
