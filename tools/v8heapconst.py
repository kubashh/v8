...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x01261): (93, "ManyClosuresCellMap"),
  ("read_only_space", 0x012b1): (118, "ModuleInfoMap"),
  ("read_only_space", 0x01301): (122, "NameDictionaryMap"),
  ("read_only_space", 0x01351): (93, "NoClosuresCellMap"),
  ("read_only_space", 0x013a1): (123, "NumberDictionaryMap"),
  ("read_only_space", 0x013f1): (93, "OneClosureCellMap"),
  ...
  ("read_only_space", 0x015d1): (89, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x01621): (89, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x01671): (89, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ...
  ("read_only_space", 0x02039): (92, "EnumCacheMap"),
  ("read_only_space", 0x020d9): (86, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x022c9): (95, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x04e39): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x04e89): (81, "AccessorInfoMap"),
  ("read_only_space", 0x04ed9): (82, "AccessorPairMap"),
  ("read_only_space", 0x04f29): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x04f79): (84, "AllocationMementoMap"),
  ("read_only_space", 0x04fc9): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x05019): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05069): (90, "ClassPositionsMap"),
  ("read_only_space", 0x050b9): (91, "DebugInfoMap"),
  ("read_only_space", 0x05109): (94, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05159): (97, "InterpreterDataMap"),
  ("read_only_space", 0x051a9): (98, "PromiseCapabilityMap"),
  ("read_only_space", 0x051f9): (99, "PromiseReactionMap"),
  ("read_only_space", 0x05249): (100, "PrototypeInfoMap"),
  ("read_only_space", 0x05299): (101, "ScriptMap"),
  ("read_only_space", 0x052e9): (105, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05339): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05389): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x053d9): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05429): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05479): (110, "Tuple2Map"),
  ("read_only_space", 0x054c9): (111, "Tuple3Map"),
  ...
  ("read_only_space", 0x056f9): (96, "InternalClassMap"),
  ("read_only_space", 0x05749): (103, "SmiPairMap"),
  ("read_only_space", 0x05799): (102, "SmiBoxMap"),
  ("read_only_space", 0x057e9): (104, "SortStateMap"),
  ("read_only_space", 0x05839): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05889): (85, "AllocationSiteWithoutWeakNextMap"),
