...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x09c29): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x09e39): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x09ea1): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x09f09): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x09f71): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x09fd9): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a041): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x0a0a9): (160, "DebugInfoMap"),
  ("RO_SPACE", 0x0a111): (161, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x0a179): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a1e1): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a249): (165, "ModuleMap"),
  ("RO_SPACE", 0x0a2b1): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a319): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a381): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a3e9): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a451): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a4b9): (173, "Tuple3Map"),
  ("RO_SPACE", 0x0a521): (174, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x0a589): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a5f1): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a659): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x0a6c1): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x0a729): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a791): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a7f9): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a861): (182, "PromiseResolveThenableJobTaskMap"),
