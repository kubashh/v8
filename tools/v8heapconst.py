...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x03629): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x03651): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x03679): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x036a1): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x036c9): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x036f1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x03719): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x03741): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x03769): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x03791): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x037b9): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x037e1): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x03809): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x03831): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x03859): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x03881): "PromiseCatchFinallySharedFun",
  ("old_space", 0x038a9): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x038d1): "PromiseThenFinallySharedFun",
  ("old_space", 0x038f9): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x03921): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x03949): "ProxyRevokeSharedFun",
}
