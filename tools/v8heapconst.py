...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x060f1): (112, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x06119): (113, "StackFrameInfoMap"),
  ("read_only_space", 0x06141): (114, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06169): (115, "Tuple2Map"),
  ("read_only_space", 0x06191): (116, "WasmExceptionTagMap"),
  ("read_only_space", 0x061b9): (117, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x061e1): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06209): (152, "DescriptorArrayMap"),
  ("read_only_space", 0x06231): (157, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06259): (156, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06281): (174, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x062a9): (170, "InternalClassMap"),
  ("read_only_space", 0x062d1): (181, "SmiPairMap"),
  ("read_only_space", 0x062f9): (180, "SmiBoxMap"),
  ("read_only_space", 0x06321): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06349): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x06371): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x06399): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x063c1): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x063e9): (171, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06411): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x06439): (182, "SortStateMap"),
  ("read_only_space", 0x06461): (160, "CallRefDataMap"),
  ("read_only_space", 0x06489): (90, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x064b1): (90, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x064d9): (81, "LoadHandler1Map"),
  ("read_only_space", 0x06501): (81, "LoadHandler2Map"),
  ("read_only_space", 0x06529): (81, "LoadHandler3Map"),
  ("read_only_space", 0x06551): (82, "StoreHandler0Map"),
  ("read_only_space", 0x06579): (82, "StoreHandler1Map"),
  ("read_only_space", 0x065a1): (82, "StoreHandler2Map"),
  ("read_only_space", 0x065c9): (82, "StoreHandler3Map"),
