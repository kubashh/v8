...
KNOWN_MAPS = {
    ...
    ("old_space", 0x02261): (2124, "ExternalMap"),
    ("old_space", 0x02289): (2128, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x05b11): "UninitializedValue",
  ("read_only_space", 0x05b49): "ArgumentsMarker",
  ("read_only_space", 0x05b81): "TerminationException",
  ("read_only_space", 0x05bc1): "Exception",
  ("read_only_space", 0x05bdd): "OptimizedOut",
  ("read_only_space", 0x05c15): "StaleRegister",
  ("read_only_space", 0x05c4d): "SelfReferenceMarker",
  ("read_only_space", 0x05c8d): "BasicBlockCountersMarker",
  ("read_only_space", 0x06121): "EmptySlowElementDictionary",
  ("read_only_space", 0x06145): "EmptySymbolTable",
  ("read_only_space", 0x06161): "EmptyOrderedHashMap",
  ("read_only_space", 0x06175): "EmptyOrderedHashSet",
  ("read_only_space", 0x06189): "EmptyFeedbackMetadata",
  ("read_only_space", 0x06195): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x061b5): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x061d9): "NativeScopeInfo",
  ("read_only_space", 0x061f1): "ShadowRealmScopeInfo",
