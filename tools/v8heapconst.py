...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x04ed1): (77, "AccessCheckInfoMap"),
  ("read_only_space", 0x04f21): (78, "AccessorInfoMap"),
  ("read_only_space", 0x04f71): (79, "AccessorPairMap"),
  ("read_only_space", 0x04fc1): (80, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05011): (81, "AllocationMementoMap"),
  ("read_only_space", 0x05061): (83, "AsmWasmDataMap"),
  ("read_only_space", 0x050b1): (84, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05101): (85, "ClassPositionsMap"),
  ("read_only_space", 0x05151): (86, "DebugInfoMap"),
  ("read_only_space", 0x051a1): (88, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x051f1): (89, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05241): (91, "InterpreterDataMap"),
  ("read_only_space", 0x05291): (92, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x052e1): (93, "PromiseCapabilityMap"),
  ("read_only_space", 0x05331): (94, "PromiseReactionMap"),
  ("read_only_space", 0x05381): (95, "PrototypeInfoMap"),
  ("read_only_space", 0x053d1): (96, "ScriptMap"),
  ("read_only_space", 0x05421): (97, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05471): (98, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x054c1): (99, "StackFrameInfoMap"),
  ("read_only_space", 0x05511): (100, "StackTraceFrameMap"),
  ("read_only_space", 0x05561): (101, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x055b1): (102, "Tuple2Map"),
  ("read_only_space", 0x05601): (103, "Tuple3Map"),
  ("read_only_space", 0x05651): (104, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x056a1): (105, "WasmDebugInfoMap"),
  ("read_only_space", 0x056f1): (106, "WasmExceptionTagMap"),
  ("read_only_space", 0x05741): (107, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05791): (108, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x057e1): (109, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05831): (110, "CallableTaskMap"),
  ("read_only_space", 0x05881): (111, "CallbackTaskMap"),
  ("read_only_space", 0x058d1): (112, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05921): (113, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05971): (114, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x059c1): (115, "InternalClassMap"),
  ("read_only_space", 0x05a11): (116, "SmiPairMap"),
  ("read_only_space", 0x05a61): (117, "SmiBoxMap"),
  ("read_only_space", 0x05ab1): (118, "SortStateMap"),
  ("read_only_space", 0x05b01): (121, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b51): (121, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05ba1): (156, "LoadHandler1Map"),
  ("read_only_space", 0x05bf1): (156, "LoadHandler2Map"),
  ("read_only_space", 0x05c41): (156, "LoadHandler3Map"),
  ("read_only_space", 0x05c91): (164, "StoreHandler0Map"),
  ("read_only_space", 0x05ce1): (164, "StoreHandler1Map"),
  ("read_only_space", 0x05d31): (164, "StoreHandler2Map"),
  ("read_only_space", 0x05d81): (164, "StoreHandler3Map"),
