...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05121): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x05171): (90, "AccessorInfoMap"),
  ("read_only_space", 0x051c1): (91, "AccessorPairMap"),
  ("read_only_space", 0x05211): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05261): (93, "AllocationMementoMap"),
  ("read_only_space", 0x052b1): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x05301): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05351): (96, "ClassPositionsMap"),
  ("read_only_space", 0x053a1): (97, "DebugInfoMap"),
  ("read_only_space", 0x053f1): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05441): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05491): (102, "InterpreterDataMap"),
  ("read_only_space", 0x054e1): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x05531): (104, "ModuleMap"),
  ("read_only_space", 0x05581): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x055d1): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x05621): (107, "PromiseReactionMap"),
  ("read_only_space", 0x05671): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x056c1): (109, "ScriptMap"),
  ("read_only_space", 0x05711): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05761): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x057b1): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x05801): (113, "Tuple2Map"),
  ("read_only_space", 0x05851): (114, "Tuple3Map"),
  ("read_only_space", 0x058a1): (116, "WasmDebugInfoMap"),
  ("read_only_space", 0x058f1): (117, "WasmExceptionTagMap"),
  ("read_only_space", 0x05941): (118, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05991): (119, "CallableTaskMap"),
  ("read_only_space", 0x059e1): (120, "CallbackTaskMap"),
  ("read_only_space", 0x05a31): (121, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05a81): (122, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05ad1): (123, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05b21): (124, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05b71): (125, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05bc1): (125, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05c11): (160, "LoadHandler1Map"),
  ("read_only_space", 0x05c61): (160, "LoadHandler2Map"),
  ("read_only_space", 0x05cb1): (160, "LoadHandler3Map"),
  ("read_only_space", 0x05d01): (168, "StoreHandler0Map"),
  ("read_only_space", 0x05d51): (168, "StoreHandler1Map"),
  ("read_only_space", 0x05da1): (168, "StoreHandler2Map"),
  ("read_only_space", 0x05df1): (168, "StoreHandler3Map"),
