...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x05b19): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b45): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b71): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b9d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05bc9): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bf5): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05c21): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c4d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c79): "ErrorStackGetterSharedFun",
  ("old_space", 0x05cc5): "ErrorStackSetterSharedFun",
  ("old_space", 0x05d11): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05d3d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d69): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d95): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05dc1): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05ded): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05e19): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05e45): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05e71): "PromiseThenFinallySharedFun",
  ("old_space", 0x05e9d): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05ec9): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05ef5): "ProxyRevokeSharedFun",
  ("old_space", 0x05f21): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05f4d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05f79): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
