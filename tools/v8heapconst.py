...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x056d1): (101, "PromiseCapabilityMap"),
  ("read_only_space", 0x056f9): (102, "PromiseReactionMap"),
  ("read_only_space", 0x05721): (103, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x05749): (104, "PrototypeInfoMap"),
  ("read_only_space", 0x05771): (105, "ScriptMap"),
  ("read_only_space", 0x05799): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x057c1): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x057e9): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05811): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05839): (110, "Tuple2Map"),
  ("read_only_space", 0x05861): (111, "WasmCapiFunctionDataMap"),
  ...
  ("read_only_space", 0x05979): (171, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x059a1): (168, "InternalClassMap"),
  ("read_only_space", 0x059c9): (177, "SmiPairMap"),
  ("read_only_space", 0x059f1): (176, "SmiBoxMap"),
  ("read_only_space", 0x05a19): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05a41): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x05a69): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05a91): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05ab9): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05ae1): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05b09): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x05b31): (178, "SortStateMap"),
  ("read_only_space", 0x05b59): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b81): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05ba9): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05bd1): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05bf9): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05c21): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05c49): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05c71): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05c99): (78, "StoreHandler3Map"),
