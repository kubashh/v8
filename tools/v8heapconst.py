...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05585): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x055ad): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x055d5): (74, "CallableTaskMap"),
  ("read_only_space", 0x055fd): (75, "CallbackTaskMap"),
  ("read_only_space", 0x05625): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x0564d): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05675): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x0569d): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x056c5): (82, "AccessorInfoMap"),
  ("read_only_space", 0x056ed): (83, "AccessorPairMap"),
  ("read_only_space", 0x05715): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x0573d): (85, "AllocationMementoMap"),
  ("read_only_space", 0x05765): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x0578d): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x057b5): (90, "BaselineDataMap"),
  ("read_only_space", 0x057dd): (91, "BreakPointMap"),
  ("read_only_space", 0x05805): (92, "BreakPointInfoMap"),
  ("read_only_space", 0x0582d): (93, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05855): (95, "ClassPositionsMap"),
  ("read_only_space", 0x0587d): (96, "DebugInfoMap"),
  ("read_only_space", 0x058a5): (99, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x058cd): (101, "InterpreterDataMap"),
  ("read_only_space", 0x058f5): (102, "ModuleRequestMap"),
  ("read_only_space", 0x0591d): (103, "PromiseCapabilityMap"),
  ("read_only_space", 0x05945): (104, "PromiseReactionMap"),
  ("read_only_space", 0x0596d): (105, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x05995): (106, "PrototypeInfoMap"),
  ("read_only_space", 0x059bd): (107, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x059e5): (108, "ScriptMap"),
  ("read_only_space", 0x05a0d): (109, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05a35): (110, "StackFrameInfoMap"),
  ("read_only_space", 0x05a5d): (111, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05a85): (112, "Tuple2Map"),
  ("read_only_space", 0x05aad): (113, "WasmExceptionTagMap"),
  ("read_only_space", 0x05ad5): (114, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05afd): (115, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05b25): (116, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05b4d): (134, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x05b75): (151, "DescriptorArrayMap"),
  ("read_only_space", 0x05b9d): (156, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x05bc5): (155, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x05bed): (172, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x05c15): (168, "InternalClassMap"),
  ("read_only_space", 0x05c3d): (179, "SmiPairMap"),
  ("read_only_space", 0x05c65): (178, "SmiBoxMap"),
  ("read_only_space", 0x05c8d): (145, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05cb5): (146, "ExportedSubClassMap"),
  ("read_only_space", 0x05cdd): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05d05): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05d2d): (133, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05d55): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05d7d): (147, "ExportedSubClass2Map"),
  ("read_only_space", 0x05da5): (180, "SortStateMap"),
  ("read_only_space", 0x05dcd): (183, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05df5): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05e1d): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05e45): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05e6d): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05e95): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05ebd): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05ee5): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05f0d): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05f35): (78, "StoreHandler3Map"),
