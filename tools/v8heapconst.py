...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x053b1): (72, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x053d9): (73, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05401): (74, "CallableTaskMap"),
  ("read_only_space", 0x05429): (75, "CallbackTaskMap"),
  ("read_only_space", 0x05451): (76, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05479): (79, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x054a1): (80, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x054c9): (81, "AccessCheckInfoMap"),
  ("read_only_space", 0x054f1): (82, "AccessorInfoMap"),
  ("read_only_space", 0x05519): (83, "AccessorPairMap"),
  ("read_only_space", 0x05541): (84, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05569): (85, "AllocationMementoMap"),
  ("read_only_space", 0x05591): (88, "AsmWasmDataMap"),
  ("read_only_space", 0x055b9): (89, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x055e1): (90, "BreakPointMap"),
  ("read_only_space", 0x05609): (91, "BreakPointInfoMap"),
  ("read_only_space", 0x05631): (92, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05659): (94, "ClassPositionsMap"),
  ("read_only_space", 0x05681): (95, "DebugInfoMap"),
  ("read_only_space", 0x056a9): (98, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x056d1): (100, "InterpreterDataMap"),
  ("read_only_space", 0x056f9): (101, "PromiseCapabilityMap"),
  ("read_only_space", 0x05721): (102, "PromiseReactionMap"),
  ("read_only_space", 0x05749): (103, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x05771): (104, "PrototypeInfoMap"),
  ("read_only_space", 0x05799): (105, "ScriptMap"),
  ("read_only_space", 0x057c1): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x057e9): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x05811): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05839): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05861): (110, "Tuple2Map"),
  ("read_only_space", 0x05889): (111, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x058b1): (112, "WasmExceptionTagMap"),
  ("read_only_space", 0x058d9): (113, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05901): (114, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05929): (115, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05951): (116, "WasmValueMap"),
  ("read_only_space", 0x05979): (135, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x059a1): (172, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x059c9): (169, "InternalClassMap"),
  ("read_only_space", 0x059f1): (178, "SmiPairMap"),
  ("read_only_space", 0x05a19): (177, "SmiBoxMap"),
  ("read_only_space", 0x05a41): (146, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05a69): (147, "ExportedSubClassMap"),
  ("read_only_space", 0x05a91): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05ab9): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05ae1): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05b09): (170, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05b31): (148, "ExportedSubClass2Map"),
  ("read_only_space", 0x05b59): (179, "SortStateMap"),
  ("read_only_space", 0x05b81): (86, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05ba9): (86, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05bd1): (77, "LoadHandler1Map"),
  ("read_only_space", 0x05bf9): (77, "LoadHandler2Map"),
  ("read_only_space", 0x05c21): (77, "LoadHandler3Map"),
  ("read_only_space", 0x05c49): (78, "StoreHandler0Map"),
  ("read_only_space", 0x05c71): (78, "StoreHandler1Map"),
  ("read_only_space", 0x05c99): (78, "StoreHandler2Map"),
  ("read_only_space", 0x05cc1): (78, "StoreHandler3Map"),
