...
KNOWN_MAPS = {
  ("read_only_space", 0x02131): (243, "MetaMap"),
  ("read_only_space", 0x02159): (131, "NullMap"),
  ("read_only_space", 0x02181): (225, "StrongDescriptorArrayMap"),
  ("read_only_space", 0x021a9): (256, "WeakArrayListMap"),
  ...
  ("read_only_space", 0x022b9): (240, "FreeSpaceMap"),
  ("read_only_space", 0x022e1): (239, "OnePointerFillerMap"),
  ("read_only_space", 0x02309): (239, "TwoPointerFillerMap"),
  ...
  ("read_only_space", 0x025ed): (249, "ScopeInfoMap"),
  ("read_only_space", 0x02615): (250, "SharedFunctionInfoMap"),
  ("read_only_space", 0x0263d): (233, "CodeMap"),
  ("read_only_space", 0x02665): (232, "CellMap"),
  ("read_only_space", 0x0268d): (248, "GlobalPropertyCellMap"),
  ("read_only_space", 0x026b5): (204, "ForeignMap"),
  ("read_only_space", 0x026dd): (231, "TransitionArrayMap"),
  ("read_only_space", 0x02705): (45, "ThinOneByteStringMap"),
  ("read_only_space", 0x0272d): (238, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x02999): (237, "FeedbackMetadataArrayMap"),
  ...
  ("read_only_space", 0x02a61): (234, "CodeDataContainerMap"),
  ("read_only_space", 0x02a89): (235, "CoverageInfoMap"),
  ...
  ("read_only_space", 0x02b29): (244, "MegaDomHandlerMap"),
  ...
  ("read_only_space", 0x02c91): (246, "PreparseDataMap"),
  ("read_only_space", 0x02cb9): (247, "PropertyArrayMap"),
  ...
  ("read_only_space", 0x02d81): (219, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x02da9): (220, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x02dd1): (221, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x02df9): (226, "SourceTextModuleMap"),
  ("read_only_space", 0x02e21): (254, "SwissNameDictionaryMap"),
  ("read_only_space", 0x02e49): (227, "SyntheticModuleMap"),
  ("read_only_space", 0x02e71): (255, "WasmApiFunctionRefMap"),
  ("read_only_space", 0x02e99): (213, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x02ec1): (214, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x02ee9): (205, "WasmInternalFunctionMap"),
  ("read_only_space", 0x02f11): (215, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x02f39): (206, "WasmTypeInfoMap"),
  ("read_only_space", 0x02f61): (230, "WeakFixedArrayMap"),
  ("read_only_space", 0x02f89): (178, "EphemeronHashTableMap"),
  ("read_only_space", 0x02fb1): (236, "EmbedderDataArrayMap"),
  ("read_only_space", 0x02fd9): (257, "WeakCellMap"),
