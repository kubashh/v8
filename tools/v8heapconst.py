...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05cb9): (77, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05ce1): (78, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05d09): (79, "CallableTaskMap"),
  ("read_only_space", 0x05d31): (80, "CallbackTaskMap"),
  ("read_only_space", 0x05d59): (81, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05d81): (84, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05da9): (85, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05dd1): (86, "AccessCheckInfoMap"),
  ("read_only_space", 0x05df9): (87, "AccessorInfoMap"),
  ("read_only_space", 0x05e21): (88, "AccessorPairMap"),
  ("read_only_space", 0x05e49): (89, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05e71): (90, "AllocationMementoMap"),
  ("read_only_space", 0x05e99): (93, "AsmWasmDataMap"),
  ("read_only_space", 0x05ec1): (94, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05ee9): (95, "BreakPointMap"),
  ("read_only_space", 0x05f11): (96, "BreakPointInfoMap"),
  ("read_only_space", 0x05f39): (97, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05f61): (99, "ClassPositionsMap"),
  ("read_only_space", 0x05f89): (100, "DebugInfoMap"),
  ("read_only_space", 0x05fb1): (103, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05fd9): (105, "InterpreterDataMap"),
  ("read_only_space", 0x06001): (106, "ModuleRequestMap"),
  ("read_only_space", 0x06029): (107, "PromiseCapabilityMap"),
  ("read_only_space", 0x06051): (108, "PromiseReactionMap"),
  ("read_only_space", 0x06079): (109, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x060a1): (110, "PrototypeInfoMap"),
  ("read_only_space", 0x060c9): (111, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x060f1): (112, "ScriptMap"),
  ("read_only_space", 0x06119): (113, "ScriptOrModuleMap"),
  ("read_only_space", 0x06141): (114, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x06169): (115, "StackFrameInfoMap"),
  ("read_only_space", 0x06191): (116, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x061b9): (117, "Tuple2Map"),
  ("read_only_space", 0x061e1): (118, "WasmContinuationObjectMap"),
  ("read_only_space", 0x06209): (119, "WasmExceptionTagMap"),
  ("read_only_space", 0x06231): (120, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x06259): (138, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06281): (160, "DescriptorArrayMap"),
  ("read_only_space", 0x062a9): (165, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x062d1): (164, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x062f9): (182, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x06321): (149, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x06349): (153, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x06371): (152, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x06399): (150, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x063c1): (151, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x063e9): (178, "InternalClassMap"),
  ("read_only_space", 0x06411): (189, "SmiPairMap"),
  ("read_only_space", 0x06439): (188, "SmiBoxMap"),
  ("read_only_space", 0x06461): (154, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06489): (155, "ExportedSubClassMap"),
  ("read_only_space", 0x064b1): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x064d9): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x06501): (137, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06529): (179, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06551): (156, "ExportedSubClass2Map"),
  ("read_only_space", 0x06579): (190, "SortStateMap"),
  ("read_only_space", 0x065a1): (168, "CallRefDataMap"),
  ("read_only_space", 0x065c9): (91, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x065f1): (91, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x06619): (82, "LoadHandler1Map"),
  ("read_only_space", 0x06641): (82, "LoadHandler2Map"),
  ("read_only_space", 0x06669): (82, "LoadHandler3Map"),
  ("read_only_space", 0x06691): (83, "StoreHandler0Map"),
  ("read_only_space", 0x066b9): (83, "StoreHandler1Map"),
  ("read_only_space", 0x066e1): (83, "StoreHandler2Map"),
  ("read_only_space", 0x06709): (83, "StoreHandler3Map"),
