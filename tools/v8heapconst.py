...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05d09): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05d31): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05d59): (134, "CallableTaskMap"),
  ("read_only_space", 0x05d81): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05da9): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05dd1): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05df9): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05e21): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05e49): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05e71): (143, "AccessorPairMap"),
  ("read_only_space", 0x05e99): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05ec1): (145, "AllocationMementoMap"),
  ("read_only_space", 0x05ee9): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x05f11): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05f39): (150, "BreakPointMap"),
  ("read_only_space", 0x05f61): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x05f89): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05fb1): (154, "ClassPositionsMap"),
  ("read_only_space", 0x05fd9): (155, "DebugInfoMap"),
  ("read_only_space", 0x06001): (158, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x06029): (160, "InterpreterDataMap"),
  ("read_only_space", 0x06051): (161, "ModuleRequestMap"),
  ("read_only_space", 0x06079): (162, "PromiseCapabilityMap"),
  ("read_only_space", 0x060a1): (163, "PromiseReactionMap"),
  ("read_only_space", 0x060c9): (164, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x060f1): (165, "PrototypeInfoMap"),
  ("read_only_space", 0x06119): (166, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x06141): (167, "ScriptMap"),
  ("read_only_space", 0x06169): (168, "ScriptOrModuleMap"),
  ("read_only_space", 0x06191): (169, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x061b9): (170, "StackFrameInfoMap"),
  ("read_only_space", 0x061e1): (171, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06209): (172, "Tuple2Map"),
  ("read_only_space", 0x06231): (173, "WasmContinuationObjectMap"),
  ("read_only_space", 0x06259): (174, "WasmExceptionTagMap"),
  ("read_only_space", 0x06281): (175, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x062a9): (193, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x062d1): (223, "DescriptorArrayMap"),
  ("read_only_space", 0x062f9): (228, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06321): (227, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06349): (245, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x06371): (210, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x06399): (214, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x063c1): (213, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x063e9): (211, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x06411): (212, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x06439): (241, "InternalClassMap"),
  ("read_only_space", 0x06461): (252, "SmiPairMap"),
  ("read_only_space", 0x06489): (251, "SmiBoxMap"),
  ("read_only_space", 0x064b1): (215, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x064d9): (216, "ExportedSubClassMap"),
  ("read_only_space", 0x06501): (221, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x06529): (222, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x06551): (192, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06579): (242, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x065a1): (217, "ExportedSubClass2Map"),
  ("read_only_space", 0x065c9): (253, "SortStateMap"),
  ("read_only_space", 0x065f1): (231, "CallRefDataMap"),
  ("read_only_space", 0x06619): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x06641): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x06669): (137, "LoadHandler1Map"),
  ("read_only_space", 0x06691): (137, "LoadHandler2Map"),
  ("read_only_space", 0x066b9): (137, "LoadHandler3Map"),
  ("read_only_space", 0x066e1): (138, "StoreHandler0Map"),
  ("read_only_space", 0x06709): (138, "StoreHandler1Map"),
  ("read_only_space", 0x06731): (138, "StoreHandler2Map"),
  ("read_only_space", 0x06759): (138, "StoreHandler3Map"),
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x056e9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0570d): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05731): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05755): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05779): "AsyncGeneratorYieldResolveSharedFun",
  ("old_space", 0x0579d): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x057c1): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x057e5): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05809): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0582d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05851): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05875): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05899): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x058bd): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x058e1): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05905): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05929): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0594d): "PromiseThenFinallySharedFun",
  ("old_space", 0x05971): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05995): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x059b9): "ProxyRevokeSharedFun",
}
