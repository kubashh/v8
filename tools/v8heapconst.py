...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x05b01): "UninitializedValue",
  ("read_only_space", 0x05b39): "ArgumentsMarker",
  ("read_only_space", 0x05b71): "TerminationException",
  ("read_only_space", 0x05bb1): "Exception",
  ("read_only_space", 0x05bcd): "OptimizedOut",
  ("read_only_space", 0x05c05): "StaleRegister",
  ("read_only_space", 0x05c3d): "SelfReferenceMarker",
  ("read_only_space", 0x05c7d): "BasicBlockCountersMarker",
  ...
  ("old_space", 0x05ae5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x05b09): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05b2d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05b51): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x05b75): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05b99): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05bbd): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x05be1): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x05c05): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05c29): "ErrorStackGetterSharedFun",
  ("old_space", 0x05c71): "ErrorStackSetterSharedFun",
  ("old_space", 0x05cb9): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05cdd): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05d01): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x05d25): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05d49): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x05d6d): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x05d91): "PromiseCatchFinallySharedFun",
  ("old_space", 0x05db5): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05dd9): "PromiseThenFinallySharedFun",
  ("old_space", 0x05dfd): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05e21): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x05e45): "ProxyRevokeSharedFun",
  ("old_space", 0x05e69): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x05e8d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x05eb1): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
