...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x04f19): (78, "AccessCheckInfoMap"),
  ("read_only_space", 0x04f69): (79, "AccessorInfoMap"),
  ("read_only_space", 0x04fb9): (80, "AccessorPairMap"),
  ("read_only_space", 0x05009): (81, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05059): (82, "AllocationMementoMap"),
  ("read_only_space", 0x050a9): (84, "AsmWasmDataMap"),
  ("read_only_space", 0x050f9): (85, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05149): (86, "ClassPositionsMap"),
  ("read_only_space", 0x05199): (87, "DebugInfoMap"),
  ("read_only_space", 0x051e9): (89, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05239): (90, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05289): (92, "InterpreterDataMap"),
  ("read_only_space", 0x052d9): (93, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05329): (94, "PromiseCapabilityMap"),
  ("read_only_space", 0x05379): (95, "PromiseReactionMap"),
  ("read_only_space", 0x053c9): (96, "PrototypeInfoMap"),
  ("read_only_space", 0x05419): (97, "ScriptMap"),
  ("read_only_space", 0x05469): (98, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x054b9): (99, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05509): (100, "StackFrameInfoMap"),
  ("read_only_space", 0x05559): (101, "StackTraceFrameMap"),
  ("read_only_space", 0x055a9): (102, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x055f9): (103, "Tuple2Map"),
  ("read_only_space", 0x05649): (104, "Tuple3Map"),
  ("read_only_space", 0x05699): (105, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x056e9): (106, "WasmDebugInfoMap"),
  ("read_only_space", 0x05739): (107, "WasmExceptionTagMap"),
  ("read_only_space", 0x05789): (108, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x057d9): (109, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x05829): (110, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x05879): (111, "CallableTaskMap"),
  ("read_only_space", 0x058c9): (112, "CallbackTaskMap"),
  ("read_only_space", 0x05919): (113, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05969): (114, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x059b9): (115, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a09): (116, "InternalClassMap"),
  ("read_only_space", 0x05a59): (117, "SmiPairMap"),
  ("read_only_space", 0x05aa9): (118, "SmiBoxMap"),
  ("read_only_space", 0x05af9): (119, "SortStateMap"),
  ("read_only_space", 0x05b49): (122, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b99): (122, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05be9): (157, "LoadHandler1Map"),
  ("read_only_space", 0x05c39): (157, "LoadHandler2Map"),
  ("read_only_space", 0x05c89): (157, "LoadHandler3Map"),
  ("read_only_space", 0x05cd9): (165, "StoreHandler0Map"),
  ("read_only_space", 0x05d29): (165, "StoreHandler1Map"),
  ("read_only_space", 0x05d79): (165, "StoreHandler2Map"),
  ("read_only_space", 0x05dc9): (165, "StoreHandler3Map"),
