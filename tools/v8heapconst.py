...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x050d1): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x05121): (90, "AccessorInfoMap"),
  ("read_only_space", 0x05171): (91, "AccessorPairMap"),
  ("read_only_space", 0x051c1): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05211): (93, "AllocationMementoMap"),
  ("read_only_space", 0x05261): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x052b1): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05301): (96, "ClassPositionsMap"),
  ("read_only_space", 0x05351): (97, "DebugInfoMap"),
  ("read_only_space", 0x053a1): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x053f1): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05441): (102, "InterpreterDataMap"),
  ("read_only_space", 0x05491): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x054e1): (104, "ModuleMap"),
  ("read_only_space", 0x05531): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05581): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x055d1): (107, "PromiseReactionMap"),
  ("read_only_space", 0x05621): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x05671): (109, "ScriptMap"),
  ("read_only_space", 0x056c1): (110, "StackFrameInfoMap"),
  ("read_only_space", 0x05711): (111, "StackTraceFrameMap"),
  ("read_only_space", 0x05761): (112, "Tuple2Map"),
  ("read_only_space", 0x057b1): (113, "Tuple3Map"),
  ("read_only_space", 0x05801): (115, "WasmDebugInfoMap"),
  ("read_only_space", 0x05851): (116, "WasmExceptionTagMap"),
  ("read_only_space", 0x058a1): (117, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x058f1): (118, "CallableTaskMap"),
  ("read_only_space", 0x05941): (119, "CallbackTaskMap"),
  ("read_only_space", 0x05991): (120, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x059e1): (121, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05a31): (122, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a81): (123, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05ad1): (124, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b21): (124, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05b71): (159, "LoadHandler1Map"),
  ("read_only_space", 0x05bc1): (159, "LoadHandler2Map"),
  ("read_only_space", 0x05c11): (159, "LoadHandler3Map"),
  ("read_only_space", 0x05c61): (167, "StoreHandler0Map"),
  ("read_only_space", 0x05cb1): (167, "StoreHandler1Map"),
  ("read_only_space", 0x05d01): (167, "StoreHandler2Map"),
  ("read_only_space", 0x05d51): (167, "StoreHandler3Map"),
