...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x03281): (71, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x032a9): (72, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x032d1): (73, "CallableTaskMap"),
  ("read_only_space", 0x032f9): (74, "CallbackTaskMap"),
  ("read_only_space", 0x03321): (75, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x03349): (78, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x03371): (79, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x03399): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x033c1): (81, "AccessorInfoMap"),
  ("read_only_space", 0x033e9): (82, "AccessorPairMap"),
  ("read_only_space", 0x03411): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x03439): (84, "AllocationMementoMap"),
  ("read_only_space", 0x03461): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x03489): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x034b1): (90, "ClassPositionsMap"),
  ("read_only_space", 0x034d9): (91, "DebugInfoMap"),
  ("read_only_space", 0x03501): (94, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x03529): (97, "InterpreterDataMap"),
  ("read_only_space", 0x03551): (98, "PromiseCapabilityMap"),
  ("read_only_space", 0x03579): (99, "PromiseReactionMap"),
  ("read_only_space", 0x035a1): (100, "PrototypeInfoMap"),
  ("read_only_space", 0x035c9): (101, "ScriptMap"),
  ("read_only_space", 0x035f1): (105, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x03619): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x03641): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x03669): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x03691): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x036b9): (110, "Tuple2Map"),
  ("read_only_space", 0x036e1): (111, "Tuple3Map"),
  ("read_only_space", 0x03709): (112, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x03731): (113, "WasmDebugInfoMap"),
  ("read_only_space", 0x03759): (114, "WasmExceptionTagMap"),
  ("read_only_space", 0x03781): (115, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x037a9): (116, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x037d1): (117, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x037f9): (96, "InternalClassMap"),
  ("read_only_space", 0x03821): (103, "SmiPairMap"),
  ("read_only_space", 0x03849): (102, "SmiBoxMap"),
  ("read_only_space", 0x03871): (104, "SortStateMap"),
  ("read_only_space", 0x03899): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x038c1): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x038e9): (76, "LoadHandler1Map"),
  ("read_only_space", 0x03911): (76, "LoadHandler2Map"),
  ("read_only_space", 0x03939): (76, "LoadHandler3Map"),
  ("read_only_space", 0x03961): (77, "StoreHandler0Map"),
  ("read_only_space", 0x03989): (77, "StoreHandler1Map"),
  ("read_only_space", 0x039b1): (77, "StoreHandler2Map"),
  ("read_only_space", 0x039d9): (77, "StoreHandler3Map"),
