...
INSTANCE_TYPES = {
  ...
  2117: "JS_ASYNC_LOCAL_TYPE",
  2118: "JS_ASYNC_SNAPSHOT_TYPE",
...
KNOWN_MAPS = {
    ...
    ("old_space", 0x04b65): (2126, "ExternalMap"),
    ("old_space", 0x04b8d): (2130, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x05b19): "UninitializedValue",
  ("read_only_space", 0x05b51): "ArgumentsMarker",
  ("read_only_space", 0x05b89): "TerminationException",
  ("read_only_space", 0x05bc9): "Exception",
  ("read_only_space", 0x05be5): "OptimizedOut",
  ("read_only_space", 0x05c1d): "StaleRegister",
  ("read_only_space", 0x05c55): "SelfReferenceMarker",
  ("read_only_space", 0x05c95): "BasicBlockCountersMarker",
  ("read_only_space", 0x06129): "EmptySlowElementDictionary",
  ("read_only_space", 0x0614d): "EmptySymbolTable",
  ("read_only_space", 0x06169): "EmptyOrderedHashMap",
  ("read_only_space", 0x0617d): "EmptyOrderedHashSet",
  ("read_only_space", 0x06191): "EmptyFeedbackMetadata",
  ("read_only_space", 0x0619d): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x061bd): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x061e1): "NativeScopeInfo",
  ("read_only_space", 0x061f9): "ShadowRealmScopeInfo",
  ("read_only_space", 0x0fffd): "WasmNull",
  ("old_space", 0x04a2d): "ArgumentsIteratorAccessor",
  ("old_space", 0x04a45): "ArrayLengthAccessor",
  ("old_space", 0x04a5d): "BoundFunctionLengthAccessor",
  ("old_space", 0x04a75): "BoundFunctionNameAccessor",
  ("old_space", 0x04a8d): "FunctionArgumentsAccessor",
  ("old_space", 0x04aa5): "FunctionCallerAccessor",
  ("old_space", 0x04abd): "FunctionNameAccessor",
  ("old_space", 0x04ad5): "FunctionLengthAccessor",
  ("old_space", 0x04aed): "FunctionPrototypeAccessor",
  ("old_space", 0x04b05): "StringLengthAccessor",
  ("old_space", 0x04b1d): "ValueUnavailableAccessor",
  ("old_space", 0x04b35): "WrappedFunctionLengthAccessor",
  ("old_space", 0x04b4d): "WrappedFunctionNameAccessor",
  ("old_space", 0x04b65): "ExternalMap",
  ("old_space", 0x04b8d): "JSMessageObjectMap",
  ("old_space", 0x04bb5): "EmptyScript",
  ("old_space", 0x04bfd): "ManyClosuresCell",
  ("old_space", 0x04c09): "ArrayConstructorProtector",
  ("old_space", 0x04c1d): "NoElementsProtector",
  ("old_space", 0x04c31): "MegaDOMProtector",
  ("old_space", 0x04c45): "IsConcatSpreadableProtector",
  ("old_space", 0x04c59): "ArraySpeciesProtector",
  ("old_space", 0x04c6d): "TypedArraySpeciesProtector",
  ("old_space", 0x04c81): "PromiseSpeciesProtector",
  ("old_space", 0x04c95): "RegExpSpeciesProtector",
  ("old_space", 0x04ca9): "StringLengthProtector",
  ("old_space", 0x04cbd): "ArrayIteratorProtector",
  ("old_space", 0x04cd1): "ArrayBufferDetachingProtector",
  ("old_space", 0x04ce5): "PromiseHookProtector",
  ("old_space", 0x04cf9): "PromiseResolveProtector",
  ("old_space", 0x04d0d): "MapIteratorProtector",
  ("old_space", 0x04d21): "PromiseThenProtector",
  ("old_space", 0x04d35): "SetIteratorProtector",
  ("old_space", 0x04d49): "StringIteratorProtector",
  ("old_space", 0x04d5d): "NumberStringNotRegexpLikeProtector",
  ("old_space", 0x04d71): "StringSplitCache",
  ("old_space", 0x05179): "RegExpMultipleCache",
  ("old_space", 0x05581): "BuiltinsConstantsTable",
  ("old_space", 0x0ac6d): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0ac95): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x0acbd): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0ace5): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0ad0d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0ad35): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x0ad5d): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0ad85): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0adad): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0add5): "ErrorStackGetterSharedFun",
  ("old_space", 0x0ae1d): "ErrorStackSetterSharedFun",
  ("old_space", 0x0ae65): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0ae8d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0aeb5): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0aedd): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0af05): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x0af2d): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0af55): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0af7d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0afa5): "PromiseThenFinallySharedFun",
  ("old_space", 0x0afcd): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0aff5): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0b01d): "ProxyRevokeSharedFun",
  ("old_space", 0x0b045): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x0b06d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0b095): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}

# Lower 32 bits of first page addresses for various heap spaces.
HEAP_FIRST_PAGES = {
  0x00080000: "old_space",
