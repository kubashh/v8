...
INSTANCE_TYPES = {
  ...
  150: "EXPORTED_SUB_CLASS_BASE_TYPE",
  151: "EXPORTED_SUB_CLASS_TYPE",
...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x03395): (71, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x033bd): (72, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x033e5): (73, "CallableTaskMap"),
  ("read_only_space", 0x0340d): (74, "CallbackTaskMap"),
  ("read_only_space", 0x03435): (75, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x0345d): (78, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x03485): (79, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x034ad): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x034d5): (81, "AccessorInfoMap"),
  ("read_only_space", 0x034fd): (82, "AccessorPairMap"),
  ("read_only_space", 0x03525): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x0354d): (84, "AllocationMementoMap"),
  ("read_only_space", 0x03575): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x0359d): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x035c5): (89, "BreakPointMap"),
  ("read_only_space", 0x035ed): (90, "BreakPointInfoMap"),
  ("read_only_space", 0x03615): (91, "CachedTemplateObjectMap"),
  ("read_only_space", 0x0363d): (93, "ClassPositionsMap"),
  ("read_only_space", 0x03665): (94, "DebugInfoMap"),
  ("read_only_space", 0x0368d): (97, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x036b5): (99, "InterpreterDataMap"),
  ("read_only_space", 0x036dd): (100, "PromiseCapabilityMap"),
  ("read_only_space", 0x03705): (101, "PromiseReactionMap"),
  ("read_only_space", 0x0372d): (102, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x03755): (103, "PrototypeInfoMap"),
  ("read_only_space", 0x0377d): (104, "ScriptMap"),
  ("read_only_space", 0x037a5): (105, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x037cd): (106, "StackFrameInfoMap"),
  ("read_only_space", 0x037f5): (107, "StackTraceFrameMap"),
  ("read_only_space", 0x0381d): (108, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x03845): (109, "Tuple2Map"),
  ("read_only_space", 0x0386d): (110, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x03895): (111, "WasmDebugInfoMap"),
  ("read_only_space", 0x038bd): (112, "WasmExceptionTagMap"),
  ("read_only_space", 0x038e5): (113, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x0390d): (114, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x03935): (115, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x0395d): (116, "WasmValueMap"),
  ("read_only_space", 0x03985): (136, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x039ad): (171, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x039d5): (168, "InternalClassMap"),
  ("read_only_space", 0x039fd): (177, "SmiPairMap"),
  ("read_only_space", 0x03a25): (176, "SmiBoxMap"),
  ("read_only_space", 0x03a4d): (150, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x03a75): (151, "ExportedSubClassMap"),
  ("read_only_space", 0x03a9d): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x03ac5): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x03aed): (135, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x03b15): (169, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x03b3d): (178, "SortStateMap"),
  ("read_only_space", 0x03b65): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x03b8d): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x03bb5): (76, "LoadHandler1Map"),
  ("read_only_space", 0x03bdd): (76, "LoadHandler2Map"),
  ("read_only_space", 0x03c05): (76, "LoadHandler3Map"),
  ("read_only_space", 0x03c2d): (77, "StoreHandler0Map"),
  ("read_only_space", 0x03c55): (77, "StoreHandler1Map"),
  ("read_only_space", 0x03c7d): (77, "StoreHandler2Map"),
  ("read_only_space", 0x03ca5): (77, "StoreHandler3Map"),
