...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x05019): (171, "Tuple2Map"),
  ("RO_SPACE", 0x05211): (169, "ScriptMap"),
  ("RO_SPACE", 0x053d9): (161, "InterceptorInfoMap"),
  ...
  ("RO_SPACE", 0x07f29): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x07f91): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x07ff9): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x08061): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x080c9): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x08131): (164, "ModuleMap"),
  ("RO_SPACE", 0x08199): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x08201): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x08269): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x082d1): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x08339): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x083a1): (172, "Tuple3Map"),
  ("RO_SPACE", 0x08409): (173, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x08471): (174, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x084d9): (175, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x08541): (176, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x085a9): (177, "CallableTaskMap"),
  ("RO_SPACE", 0x08611): (178, "CallbackTaskMap"),
  ("RO_SPACE", 0x08679): (179, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x086e1): (180, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x08749): (181, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x087b1): (182, "AllocationSiteMap"),
  ("RO_SPACE", 0x08819): (182, "AllocationSiteMap"),
