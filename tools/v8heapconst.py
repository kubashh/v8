...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x084f5): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x08521): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x0854d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x08579): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x085a5): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x085d1): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x085fd): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x08629): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x08655): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x08681): "ErrorStackGetterSharedFun",
  ("old_space", 0x086cd): "ErrorStackSetterSharedFun",
  ("old_space", 0x08719): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x08745): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x08771): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0879d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x087c9): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x087f5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x08821): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0884d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x08879): "PromiseThenFinallySharedFun",
  ("old_space", 0x088a5): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x088d1): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x088fd): "ProxyRevokeSharedFun",
  ("old_space", 0x08929): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x08955): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x08981): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
