...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05d15): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05d3d): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05d65): (134, "CallableTaskMap"),
  ("read_only_space", 0x05d8d): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05db5): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05ddd): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05e05): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05e2d): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05e55): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05e7d): (143, "AccessorPairMap"),
  ("read_only_space", 0x05ea5): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05ecd): (145, "AllocationMementoMap"),
  ("read_only_space", 0x05ef5): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x05f1d): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05f45): (150, "BreakPointMap"),
  ("read_only_space", 0x05f6d): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x05f95): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05fbd): (154, "ClassPositionsMap"),
  ("read_only_space", 0x05fe5): (155, "DebugInfoMap"),
  ("read_only_space", 0x0600d): (158, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x06035): (160, "InterpreterDataMap"),
  ("read_only_space", 0x0605d): (161, "ModuleRequestMap"),
  ("read_only_space", 0x06085): (162, "PromiseCapabilityMap"),
  ("read_only_space", 0x060ad): (163, "PromiseReactionMap"),
  ("read_only_space", 0x060d5): (164, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x060fd): (165, "PrototypeInfoMap"),
  ("read_only_space", 0x06125): (166, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x0614d): (167, "ScriptMap"),
  ("read_only_space", 0x06175): (168, "ScriptOrModuleMap"),
  ("read_only_space", 0x0619d): (169, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x061c5): (170, "StackFrameInfoMap"),
  ("read_only_space", 0x061ed): (171, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06215): (172, "Tuple2Map"),
  ("read_only_space", 0x0623d): (173, "WasmContinuationObjectMap"),
  ("read_only_space", 0x06265): (174, "WasmExceptionTagMap"),
  ("read_only_space", 0x0628d): (175, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x062b5): (193, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x062dd): (224, "DescriptorArrayMap"),
  ("read_only_space", 0x06305): (229, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x0632d): (228, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x06355): (245, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x0637d): (207, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x063a5): (211, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x063cd): (210, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x063f5): (208, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x0641d): (209, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x06445): (241, "InternalClassMap"),
  ("read_only_space", 0x0646d): (252, "SmiPairMap"),
  ("read_only_space", 0x06495): (251, "SmiBoxMap"),
  ("read_only_space", 0x064bd): (216, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x064e5): (217, "ExportedSubClassMap"),
  ("read_only_space", 0x0650d): (222, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x06535): (223, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x0655d): (192, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06585): (242, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x065ad): (218, "ExportedSubClass2Map"),
  ("read_only_space", 0x065d5): (253, "SortStateMap"),
  ("read_only_space", 0x065fd): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x06625): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x0664d): (137, "LoadHandler1Map"),
  ("read_only_space", 0x06675): (137, "LoadHandler2Map"),
  ("read_only_space", 0x0669d): (137, "LoadHandler3Map"),
  ("read_only_space", 0x066c5): (138, "StoreHandler0Map"),
  ("read_only_space", 0x066ed): (138, "StoreHandler1Map"),
  ("read_only_space", 0x06715): (138, "StoreHandler2Map"),
  ("read_only_space", 0x0673d): (138, "StoreHandler3Map"),
