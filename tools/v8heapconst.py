...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05281): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x052d1): (90, "AccessorInfoMap"),
  ("read_only_space", 0x05321): (91, "AccessorPairMap"),
  ("read_only_space", 0x05371): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x053c1): (93, "AllocationMementoMap"),
  ("read_only_space", 0x05411): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x05461): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x054b1): (96, "ClassPositionsMap"),
  ("read_only_space", 0x05501): (97, "DebugInfoMap"),
  ("read_only_space", 0x05551): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x055a1): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x055f1): (102, "InterpreterDataMap"),
  ("read_only_space", 0x05641): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x05691): (104, "ModuleMap"),
  ("read_only_space", 0x056e1): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05731): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x05781): (107, "PromiseReactionMap"),
  ("read_only_space", 0x057d1): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x05821): (109, "ScriptMap"),
  ("read_only_space", 0x05871): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x058c1): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x05911): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x05961): (113, "Tuple2Map"),
  ("read_only_space", 0x059b1): (114, "Tuple3Map"),
  ("read_only_space", 0x05a01): (116, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05a51): (117, "WasmDebugInfoMap"),
  ("read_only_space", 0x05aa1): (118, "WasmExceptionTagMap"),
  ("read_only_space", 0x05af1): (119, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05b41): (120, "CallableTaskMap"),
  ("read_only_space", 0x05b91): (121, "CallbackTaskMap"),
  ("read_only_space", 0x05be1): (122, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05c31): (123, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05c81): (124, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05cd1): (125, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05d21): (126, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05d71): (126, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05dc1): (161, "LoadHandler1Map"),
  ("read_only_space", 0x05e11): (161, "LoadHandler2Map"),
  ("read_only_space", 0x05e61): (161, "LoadHandler3Map"),
  ("read_only_space", 0x05eb1): (169, "StoreHandler0Map"),
  ("read_only_space", 0x05f01): (169, "StoreHandler1Map"),
  ("read_only_space", 0x05f51): (169, "StoreHandler2Map"),
  ("read_only_space", 0x05fa1): (169, "StoreHandler3Map"),
