...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05131): (89, "AccessCheckInfoMap"),
  ("read_only_space", 0x05181): (90, "AccessorInfoMap"),
  ("read_only_space", 0x051d1): (91, "AccessorPairMap"),
  ("read_only_space", 0x05221): (92, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05271): (93, "AllocationMementoMap"),
  ("read_only_space", 0x052c1): (94, "AsmWasmDataMap"),
  ("read_only_space", 0x05311): (95, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05361): (96, "ClassPositionsMap"),
  ("read_only_space", 0x053b1): (97, "DebugInfoMap"),
  ("read_only_space", 0x05401): (99, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05451): (100, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x054a1): (102, "InterpreterDataMap"),
  ("read_only_space", 0x054f1): (103, "ModuleInfoEntryMap"),
  ("read_only_space", 0x05541): (104, "ModuleMap"),
  ("read_only_space", 0x05591): (105, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x055e1): (106, "PromiseCapabilityMap"),
  ("read_only_space", 0x05631): (107, "PromiseReactionMap"),
  ("read_only_space", 0x05681): (108, "PrototypeInfoMap"),
  ("read_only_space", 0x056d1): (109, "ScriptMap"),
  ("read_only_space", 0x05721): (110, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05771): (111, "StackFrameInfoMap"),
  ("read_only_space", 0x057c1): (112, "StackTraceFrameMap"),
  ("read_only_space", 0x05811): (113, "Tuple2Map"),
  ("read_only_space", 0x05861): (114, "Tuple3Map"),
  ("read_only_space", 0x058b1): (116, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05901): (117, "WasmDebugInfoMap"),
  ("read_only_space", 0x05951): (118, "WasmExceptionTagMap"),
  ("read_only_space", 0x059a1): (119, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x059f1): (120, "CallableTaskMap"),
  ("read_only_space", 0x05a41): (121, "CallbackTaskMap"),
  ("read_only_space", 0x05a91): (122, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05ae1): (123, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05b31): (124, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05b81): (125, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05bd1): (126, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05c21): (126, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05c71): (161, "LoadHandler1Map"),
  ("read_only_space", 0x05cc1): (161, "LoadHandler2Map"),
  ("read_only_space", 0x05d11): (161, "LoadHandler3Map"),
  ("read_only_space", 0x05d61): (169, "StoreHandler0Map"),
  ("read_only_space", 0x05db1): (169, "StoreHandler1Map"),
  ("read_only_space", 0x05e01): (169, "StoreHandler2Map"),
  ("read_only_space", 0x05e51): (169, "StoreHandler3Map"),
