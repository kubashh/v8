...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x05291): (158, "AsmWasmDataMap"),
  ("RO_SPACE", 0x052e1): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x05331): (160, "ClassPositionsMap"),
  ("RO_SPACE", 0x05381): (161, "DebugInfoMap"),
  ("RO_SPACE", 0x053d1): (162, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x05421): (163, "FunctionTemplateRareDataMap"),
  ("RO_SPACE", 0x05471): (165, "InterpreterDataMap"),
  ("RO_SPACE", 0x054c1): (166, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x05511): (167, "ModuleMap"),
  ("RO_SPACE", 0x05561): (168, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x055b1): (169, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05601): (170, "PromiseReactionMap"),
  ("RO_SPACE", 0x05651): (171, "PrototypeInfoMap"),
  ("RO_SPACE", 0x056a1): (172, "ScriptMap"),
  ("RO_SPACE", 0x056f1): (173, "StackFrameInfoMap"),
  ("RO_SPACE", 0x05741): (174, "StackTraceFrameMap"),
  ("RO_SPACE", 0x05791): (176, "Tuple3Map"),
  ("RO_SPACE", 0x057e1): (178, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05831): (179, "WasmExceptionTagMap"),
  ("RO_SPACE", 0x05881): (180, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x058d1): (181, "CallableTaskMap"),
  ("RO_SPACE", 0x05921): (182, "CallbackTaskMap"),
  ("RO_SPACE", 0x05971): (183, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x059c1): (184, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05a11): (185, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05a61): (186, "FinalizationGroupCleanupJobTaskMap"),
  ("RO_SPACE", 0x05ab1): (187, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05b01): (187, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05b51): (221, "LoadHandler1Map"),
  ("RO_SPACE", 0x05ba1): (221, "LoadHandler2Map"),
  ("RO_SPACE", 0x05bf1): (221, "LoadHandler3Map"),
  ("RO_SPACE", 0x05c41): (229, "StoreHandler0Map"),
  ("RO_SPACE", 0x05c91): (229, "StoreHandler1Map"),
  ("RO_SPACE", 0x05ce1): (229, "StoreHandler2Map"),
  ("RO_SPACE", 0x05d31): (229, "StoreHandler3Map"),
