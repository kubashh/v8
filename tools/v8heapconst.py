...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x03a11): (150, "FixedDoubleArrayMap"),
  ("RO_SPACE", 0x03a79): (183, "GlobalDictionaryMap"),
  ("RO_SPACE", 0x03ae1): (201, "ManyClosuresCellMap"),
  ("RO_SPACE", 0x03b49): (181, "ModuleInfoMap"),
  ("RO_SPACE", 0x03bb1): (134, "MutableHeapNumberMap"),
  ("RO_SPACE", 0x03c19): (183, "NameDictionaryMap"),
  ("RO_SPACE", 0x03c81): (201, "NoClosuresCellMap"),
  ("RO_SPACE", 0x03ce9): (183, "NumberDictionaryMap"),
  ("RO_SPACE", 0x03d51): (201, "OneClosureCellMap"),
  ("RO_SPACE", 0x03db9): (183, "OrderedHashMapMap"),
  ("RO_SPACE", 0x03e21): (183, "OrderedHashSetMap"),
  ("RO_SPACE", 0x03e89): (204, "PropertyArrayMap"),
  ("RO_SPACE", 0x03ef1): (198, "SideEffectCallHandlerInfoMap"),
  ("RO_SPACE", 0x03f59): (198, "SideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x03fc1): (198, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("RO_SPACE", 0x04029): (183, "SimpleNumberDictionaryMap"),
  ("RO_SPACE", 0x04091): (181, "SloppyArgumentsElementsMap"),
  ("RO_SPACE", 0x040f9): (207, "SmallOrderedHashMapMap"),
  ("RO_SPACE", 0x04161): (208, "SmallOrderedHashSetMap"),
  ("RO_SPACE", 0x041c9): (183, "StringTableMap"),
  ("RO_SPACE", 0x04231): (195, "WeakFixedArrayMap"),
  ("RO_SPACE", 0x04299): (211, "WeakArrayListMap"),
  ("RO_SPACE", 0x04301): (184, "EphemeronHashTableMap"),
  ("RO_SPACE", 0x04369): (106, "NativeSourceStringMap"),
  ("RO_SPACE", 0x043d1): (64, "StringMap"),
  ("RO_SPACE", 0x04439): (73, "ConsOneByteStringMap"),
  ("RO_SPACE", 0x044a1): (65, "ConsStringMap"),
  ("RO_SPACE", 0x04509): (77, "ThinOneByteStringMap"),
  ("RO_SPACE", 0x04571): (69, "ThinStringMap"),
  ("RO_SPACE", 0x045d9): (67, "SlicedStringMap"),
  ("RO_SPACE", 0x04641): (75, "SlicedOneByteStringMap"),
  ("RO_SPACE", 0x046a9): (66, "ExternalStringMap"),
  ("RO_SPACE", 0x04711): (82, "ExternalStringWithOneByteDataMap"),
  ("RO_SPACE", 0x04779): (74, "ExternalOneByteStringMap"),
  ("RO_SPACE", 0x047e1): (98, "ShortExternalStringMap"),
  ("RO_SPACE", 0x04849): (114, "ShortExternalStringWithOneByteDataMap"),
  ("RO_SPACE", 0x048b1): (0, "InternalizedStringMap"),
  ("RO_SPACE", 0x04919): (2, "ExternalInternalizedStringMap"),
  ("RO_SPACE", 0x04981): (18, "ExternalInternalizedStringWithOneByteDataMap"),
  ("RO_SPACE", 0x049e9): (10, "ExternalOneByteInternalizedStringMap"),
  ("RO_SPACE", 0x04a51): (34, "ShortExternalInternalizedStringMap"),
  ("RO_SPACE", 0x04ab9): (50, "ShortExternalInternalizedStringWithOneByteDataMap"),
  ("RO_SPACE", 0x04b21): (42, "ShortExternalOneByteInternalizedStringMap"),
  ("RO_SPACE", 0x04b89): (106, "ShortExternalOneByteStringMap"),
  ("RO_SPACE", 0x04bf1): (140, "FixedUint8ArrayMap"),
  ("RO_SPACE", 0x04c59): (139, "FixedInt8ArrayMap"),
  ("RO_SPACE", 0x04cc1): (142, "FixedUint16ArrayMap"),
  ("RO_SPACE", 0x04d29): (141, "FixedInt16ArrayMap"),
  ("RO_SPACE", 0x04d91): (144, "FixedUint32ArrayMap"),
  ("RO_SPACE", 0x04df9): (143, "FixedInt32ArrayMap"),
  ("RO_SPACE", 0x04e61): (145, "FixedFloat32ArrayMap"),
  ("RO_SPACE", 0x04ec9): (146, "FixedFloat64ArrayMap"),
  ("RO_SPACE", 0x04f31): (147, "FixedUint8ClampedArrayMap"),
  ("RO_SPACE", 0x04f99): (149, "FixedBigUint64ArrayMap"),
  ("RO_SPACE", 0x05001): (148, "FixedBigInt64ArrayMap"),
  ("RO_SPACE", 0x05069): (131, "SelfReferenceMarkerMap"),
  ("RO_SPACE", 0x050e9): (171, "Tuple2Map"),
  ("RO_SPACE", 0x052e1): (169, "ScriptMap"),
  ("RO_SPACE", 0x054a9): (161, "InterceptorInfoMap"),
  ("RO_SPACE", 0x09e29): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x0a039): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x0a0a1): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x0a109): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x0a171): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x0a1d9): (158, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x0a241): (159, "DebugInfoMap"),
  ("RO_SPACE", 0x0a2a9): (160, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x0a311): (162, "InterpreterDataMap"),
  ("RO_SPACE", 0x0a379): (163, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x0a3e1): (164, "ModuleMap"),
  ("RO_SPACE", 0x0a449): (165, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x0a4b1): (166, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x0a519): (167, "PromiseReactionMap"),
  ("RO_SPACE", 0x0a581): (168, "PrototypeInfoMap"),
  ("RO_SPACE", 0x0a5e9): (170, "StackFrameInfoMap"),
  ("RO_SPACE", 0x0a651): (172, "Tuple3Map"),
  ("RO_SPACE", 0x0a6b9): (173, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x0a721): (174, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x0a789): (175, "CallableTaskMap"),
  ("RO_SPACE", 0x0a7f1): (176, "CallbackTaskMap"),
  ("RO_SPACE", 0x0a859): (177, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x0a8c1): (178, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x0a929): (179, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x0a991): (180, "AllocationSiteMap"),
  ("RO_SPACE", 0x0a9f9): (180, "AllocationSiteMap"),
...
KNOWN_OBJECTS = {
  ...
  ("RO_SPACE", 0x05161): "EmptyByteArray",
  ("RO_SPACE", 0x05181): "EmptyFixedUint8Array",
  ("RO_SPACE", 0x051a1): "EmptyFixedInt8Array",
  ("RO_SPACE", 0x051c1): "EmptyFixedUint16Array",
  ("RO_SPACE", 0x051e1): "EmptyFixedInt16Array",
  ("RO_SPACE", 0x05201): "EmptyFixedUint32Array",
  ("RO_SPACE", 0x05221): "EmptyFixedInt32Array",
  ("RO_SPACE", 0x05241): "EmptyFixedFloat32Array",
  ("RO_SPACE", 0x05261): "EmptyFixedFloat64Array",
  ("RO_SPACE", 0x05281): "EmptyFixedUint8ClampedArray",
  ("RO_SPACE", 0x05359): "EmptySloppyArgumentsElements",
  ("RO_SPACE", 0x05379): "EmptySlowElementDictionary",
  ("RO_SPACE", 0x053c1): "EmptyOrderedHashMap",
  ("RO_SPACE", 0x053e9): "EmptyOrderedHashSet",
  ("RO_SPACE", 0x05421): "EmptyPropertyCell",
  ("RO_SPACE", 0x05449): "EmptyWeakCell",
  ("RO_SPACE", 0x05529): "InfinityValue",
  ("RO_SPACE", 0x05539): "MinusZeroValue",
  ("RO_SPACE", 0x05549): "MinusInfinityValue",
  ("RO_SPACE", 0x05559): "SelfReferenceMarker",
