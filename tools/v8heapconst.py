...
KNOWN_MAPS = {
    ...
    ("old_space", 0x043b5): (2121, "ExternalMap"),
    ("old_space", 0x043dd): (2125, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x04265): "ArgumentsIteratorAccessor",
  ("old_space", 0x0427d): "ArrayLengthAccessor",
  ("old_space", 0x04295): "BoundFunctionLengthAccessor",
  ("old_space", 0x042ad): "BoundFunctionNameAccessor",
  ("old_space", 0x042c5): "ErrorStackAccessor",
  ("old_space", 0x042dd): "FunctionArgumentsAccessor",
  ("old_space", 0x042f5): "FunctionCallerAccessor",
  ("old_space", 0x0430d): "FunctionNameAccessor",
  ("old_space", 0x04325): "FunctionLengthAccessor",
  ("old_space", 0x0433d): "FunctionPrototypeAccessor",
  ("old_space", 0x04355): "StringLengthAccessor",
  ("old_space", 0x0436d): "ValueUnavailableAccessor",
  ("old_space", 0x04385): "WrappedFunctionLengthAccessor",
  ("old_space", 0x0439d): "WrappedFunctionNameAccessor",
  ("old_space", 0x043b5): "ExternalMap",
  ("old_space", 0x043dd): "JSMessageObjectMap",
  ("old_space", 0x04405): "EmptyScript",
  ...
  ("old_space", 0x045ad): "NumberStringPrototypeNoReplaceProtector",
  ("old_space", 0x045c1): "StringSplitCache",
  ("old_space", 0x049c9): "RegExpMultipleCache",
  ("old_space", 0x04dd1): "BuiltinsConstantsTable",
  ("old_space", 0x0a2ed): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x0a315): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x0a33d): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0a365): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0a38d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x0a3b5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x0a3dd): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0a405): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x0a42d): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x0a455): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x0a47d): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x0a4a5): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0a4cd): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x0a4f5): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x0a51d): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x0a545): "PromiseCatchFinallySharedFun",
  ("old_space", 0x0a56d): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0a595): "PromiseThenFinallySharedFun",
  ("old_space", 0x0a5bd): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x0a5e5): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0a60d): "ProxyRevokeSharedFun",
  ("old_space", 0x0a635): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x0a65d): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x0a685): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
