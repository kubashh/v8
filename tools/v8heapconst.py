...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x05121): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x05171): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x051c1): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x05211): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x05261): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x052b1): (158, "AsmWasmDataMap"),
  ("RO_SPACE", 0x05301): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x05351): (160, "ClassPositionsMap"),
  ("RO_SPACE", 0x053a1): (161, "DebugInfoMap"),
  ("RO_SPACE", 0x053f1): (162, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x05441): (163, "FunctionTemplateRareDataMap"),
  ("RO_SPACE", 0x05491): (165, "InterpreterDataMap"),
  ("RO_SPACE", 0x054e1): (166, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x05531): (167, "ModuleMap"),
  ("RO_SPACE", 0x05581): (168, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x055d1): (169, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x05621): (170, "PromiseReactionMap"),
  ("RO_SPACE", 0x05671): (171, "PrototypeInfoMap"),
  ("RO_SPACE", 0x056c1): (172, "ScriptMap"),
  ("RO_SPACE", 0x05711): (173, "StackFrameInfoMap"),
  ("RO_SPACE", 0x05761): (174, "StackTraceFrameMap"),
  ("RO_SPACE", 0x057b1): (176, "Tuple3Map"),
  ("RO_SPACE", 0x05801): (178, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x05851): (179, "WasmExceptionTagMap"),
  ("RO_SPACE", 0x058a1): (180, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x058f1): (181, "CallableTaskMap"),
  ("RO_SPACE", 0x05941): (182, "CallbackTaskMap"),
  ("RO_SPACE", 0x05991): (183, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x059e1): (184, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x05a31): (185, "PromiseResolveThenableJobTaskMap"),
  ("RO_SPACE", 0x05a81): (186, "FinalizationGroupCleanupJobTaskMap"),
  ("RO_SPACE", 0x05ad1): (187, "AllocationSiteWithWeakNextMap"),
  ("RO_SPACE", 0x05b21): (187, "AllocationSiteWithoutWeakNextMap"),
  ("RO_SPACE", 0x05b71): (221, "LoadHandler1Map"),
  ("RO_SPACE", 0x05bc1): (221, "LoadHandler2Map"),
  ("RO_SPACE", 0x05c11): (221, "LoadHandler3Map"),
  ("RO_SPACE", 0x05c61): (229, "StoreHandler0Map"),
  ("RO_SPACE", 0x05cb1): (229, "StoreHandler1Map"),
  ("RO_SPACE", 0x05d01): (229, "StoreHandler2Map"),
  ("RO_SPACE", 0x05d51): (229, "StoreHandler3Map"),
