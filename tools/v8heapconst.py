...
INSTANCE_TYPES = {
  ...
  150: "SOURCE_TEXT_MODULE_TYPE",
  151: "SYNTHETIC_MODULE_TYPE",
  152: "UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE",
  153: "UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE",
  154: "WEAK_FIXED_ARRAY_TYPE",
  155: "TRANSITION_ARRAY_TYPE",
  156: "CELL_TYPE",
  157: "CODE_TYPE",
  158: "CODE_DATA_CONTAINER_TYPE",
  159: "COVERAGE_INFO_TYPE",
  160: "DESCRIPTOR_ARRAY_TYPE",
  161: "EMBEDDER_DATA_ARRAY_TYPE",
  162: "FEEDBACK_METADATA_TYPE",
  163: "FEEDBACK_VECTOR_TYPE",
  164: "FILLER_TYPE",
  165: "FREE_SPACE_TYPE",
  166: "INTERNAL_CLASS_TYPE",
  167: "INTERNAL_CLASS_WITH_STRUCT_ELEMENTS_TYPE",
  168: "MAP_TYPE",
  169: "PREPARSE_DATA_TYPE",
  170: "PROPERTY_ARRAY_TYPE",
  171: "PROPERTY_CELL_TYPE",
...
KNOWN_MAPS = {
  ("read_only_space", 0x00121): (165, "FreeSpaceMap"),
  ("read_only_space", 0x00149): (168, "MetaMap"),
  ("read_only_space", 0x0018d): (67, "NullMap"),
  ("read_only_space", 0x001c5): (160, "DescriptorArrayMap"),
  ("read_only_space", 0x001f5): (154, "WeakFixedArrayMap"),
  ("read_only_space", 0x0021d): (164, "OnePointerFillerMap"),
  ("read_only_space", 0x00245): (164, "TwoPointerFillerMap"),
  ...
  ("read_only_space", 0x005a1): (172, "SharedFunctionInfoMap"),
  ("read_only_space", 0x005c9): (157, "CodeMap"),
  ("read_only_space", 0x005f1): (156, "CellMap"),
  ("read_only_space", 0x00619): (171, "GlobalPropertyCellMap"),
  ("read_only_space", 0x00641): (70, "ForeignMap"),
  ("read_only_space", 0x00669): (155, "TransitionArrayMap"),
  ("read_only_space", 0x00691): (45, "ThinOneByteStringMap"),
  ("read_only_space", 0x006b9): (163, "FeedbackVectorMap"),
  ...
  ("read_only_space", 0x00925): (162, "FeedbackMetadataArrayMap"),
  ...
  ("read_only_space", 0x009ed): (158, "CodeDataContainerMap"),
  ("read_only_space", 0x00a15): (159, "CoverageInfoMap"),
  ...
  ("read_only_space", 0x00bf5): (169, "PreparseDataMap"),
  ("read_only_space", 0x00c1d): (170, "PropertyArrayMap"),
  ...
  ("read_only_space", 0x00d85): (150, "SourceTextModuleMap"),
  ("read_only_space", 0x00dad): (126, "StringTableMap"),
  ("read_only_space", 0x00dd5): (151, "SyntheticModuleMap"),
  ("read_only_space", 0x00dfd): (153, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x00e25): (152, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x00e4d): (176, "WeakArrayListMap"),
  ("read_only_space", 0x00e75): (118, "EphemeronHashTableMap"),
  ("read_only_space", 0x00e9d): (161, "EmbedderDataArrayMap"),
  ...
  ("read_only_space", 0x0389d): (166, "InternalClassMap"),
  ("read_only_space", 0x038c5): (174, "SmiPairMap"),
  ("read_only_space", 0x038ed): (173, "SmiBoxMap"),
  ("read_only_space", 0x03915): (148, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x0393d): (149, "ExportedSubClassMap"),
  ("read_only_space", 0x03965): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x0398d): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x039b5): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x039dd): (167, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x03a05): (175, "SortStateMap"),
  ("read_only_space", 0x03a2d): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x03a55): (85, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x03a7d): (76, "LoadHandler1Map"),
  ("read_only_space", 0x03aa5): (76, "LoadHandler2Map"),
  ("read_only_space", 0x03acd): (76, "LoadHandler3Map"),
  ("read_only_space", 0x03af5): (77, "StoreHandler0Map"),
  ("read_only_space", 0x03b1d): (77, "StoreHandler1Map"),
  ("read_only_space", 0x03b45): (77, "StoreHandler2Map"),
  ("read_only_space", 0x03b6d): (77, "StoreHandler3Map"),
