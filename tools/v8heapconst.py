...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x01391): (93, "ManyClosuresCellMap"),
  ("read_only_space", 0x013d9): (118, "ModuleInfoMap"),
  ("read_only_space", 0x01421): (122, "NameDictionaryMap"),
  ("read_only_space", 0x01469): (93, "NoClosuresCellMap"),
  ("read_only_space", 0x014b1): (123, "NumberDictionaryMap"),
  ("read_only_space", 0x014f9): (93, "OneClosureCellMap"),
  ...
  ("read_only_space", 0x016a9): (89, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x016f1): (89, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x01739): (89, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ...
  ("read_only_space", 0x01c01): (41, "ConsOneByteStringMap"),
  ("read_only_space", 0x01c49): (33, "ConsStringMap"),
  ("read_only_space", 0x01c91): (45, "ThinOneByteStringMap"),
  ("read_only_space", 0x01cd9): (37, "ThinStringMap"),
  ("read_only_space", 0x01d21): (35, "SlicedStringMap"),
  ("read_only_space", 0x01d69): (43, "SlicedOneByteStringMap"),
  ("read_only_space", 0x01db1): (34, "ExternalStringMap"),
  ("read_only_space", 0x01df9): (42, "ExternalOneByteStringMap"),
  ("read_only_space", 0x01e41): (50, "UncachedExternalStringMap"),
  ("read_only_space", 0x01e89): (0, "InternalizedStringMap"),
  ("read_only_space", 0x01ed1): (2, "ExternalInternalizedStringMap"),
  ("read_only_space", 0x01f19): (10, "ExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x01f61): (18, "UncachedExternalInternalizedStringMap"),
  ...
  ("read_only_space", 0x02099): (92, "EnumCacheMap"),
  ("read_only_space", 0x02131): (86, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x02319): (95, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x04e49): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x04e91): (81, "AccessorInfoMap"),
  ("read_only_space", 0x04ed9): (82, "AccessorPairMap"),
  ("read_only_space", 0x04f21): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x04f69): (84, "AllocationMementoMap"),
  ("read_only_space", 0x04fb1): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x04ff9): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05041): (90, "ClassPositionsMap"),
  ("read_only_space", 0x05089): (91, "DebugInfoMap"),
  ("read_only_space", 0x050d1): (94, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05119): (97, "InterpreterDataMap"),
  ("read_only_space", 0x05161): (98, "PromiseCapabilityMap"),
  ("read_only_space", 0x051a9): (99, "PromiseReactionMap"),
  ("read_only_space", 0x051f1): (100, "PrototypeInfoMap"),
  ("read_only_space", 0x05239): (101, "ScriptMap"),
  ("read_only_space", 0x05281): (105, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x052c9): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x05311): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x05359): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x053a1): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x053e9): (110, "Tuple2Map"),
  ("read_only_space", 0x05431): (111, "Tuple3Map"),
  ...
  ("read_only_space", 0x05629): (96, "InternalClassMap"),
  ("read_only_space", 0x05671): (103, "SmiPairMap"),
  ("read_only_space", 0x056b9): (102, "SmiBoxMap"),
  ("read_only_space", 0x05701): (104, "SortStateMap"),
  ("read_only_space", 0x05749): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05791): (85, "AllocationSiteWithoutWeakNextMap"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x02081): "EmptyEnumCache",
  ("read_only_space", 0x020e1): "EmptyPropertyArray",
  ("read_only_space", 0x020f1): "EmptyByteArray",
  ("read_only_space", 0x02101): "EmptyObjectBoilerplateDescription",
  ("read_only_space", 0x02119): "EmptyArrayBoilerplateDescription",
  ...
  ("read_only_space", 0x02361): "EmptyWeakArrayList",
  ("read_only_space", 0x02379): "InfinityValue",
  ("read_only_space", 0x02389): "MinusZeroValue",
  ("read_only_space", 0x02399): "MinusInfinityValue",
  ("read_only_space", 0x023a9): "SelfReferenceMarker",
  ("read_only_space", 0x02401): "OffHeapTrampolineRelocationInfo",
  ("read_only_space", 0x02419): "TrampolineTrivialCodeDataContainer",
  ("read_only_space", 0x02431): "TrampolinePromiseRejectionCodeDataContainer",
  ("read_only_space", 0x02449): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x024b1): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x02501): "HashSeed",
