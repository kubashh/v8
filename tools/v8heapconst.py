...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05159): (93, "ModuleInfoEntryMap"),
  ("read_only_space", 0x051a9): (94, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x051f9): (95, "PromiseCapabilityMap"),
  ("read_only_space", 0x05249): (96, "PromiseReactionMap"),
  ("read_only_space", 0x05299): (97, "PrototypeInfoMap"),
  ("read_only_space", 0x052e9): (98, "ScriptMap"),
  ("read_only_space", 0x05339): (99, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x05389): (100, "StackFrameInfoMap"),
  ("read_only_space", 0x053d9): (101, "StackTraceFrameMap"),
  ("read_only_space", 0x05429): (102, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x05479): (103, "Tuple2Map"),
  ("read_only_space", 0x054c9): (104, "Tuple3Map"),
  ("read_only_space", 0x05519): (106, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05569): (107, "WasmDebugInfoMap"),
  ("read_only_space", 0x055b9): (108, "WasmExceptionTagMap"),
  ("read_only_space", 0x05609): (109, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05659): (110, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x056a9): (92, "JSModuleMap"),
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x010f9): "StringSplitCache",
  ("old_space", 0x01909): "RegExpMultipleCache",
  ("old_space", 0x02119): "BuiltinsConstantsTable",
}
