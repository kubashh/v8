...
KNOWN_MAPS = {
    ...
    ("old_space", 0x043c5): (2121, "ExternalMap"),
    ("old_space", 0x043ed): (2125, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x053bd): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x053e1): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x05405): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x05429): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x0544d): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x05471): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x05495): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x054b9): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x054dd): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x05501): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x05525): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x05549): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x0556d): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x05591): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x055b5): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x055d9): "PromiseCatchFinallySharedFun",
  ("old_space", 0x055fd): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x05621): "PromiseThenFinallySharedFun",
  ("old_space", 0x05645): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x05669): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x0568d): "ProxyRevokeSharedFun",
  ("old_space", 0x056b1): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x056d5): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x056f9): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
