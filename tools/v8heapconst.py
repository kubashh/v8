...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05d19): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05d41): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05d69): (134, "CallableTaskMap"),
  ("read_only_space", 0x05d91): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05db9): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05de1): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05e09): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05e31): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05e59): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05e81): (143, "AccessorPairMap"),
  ("read_only_space", 0x05ea9): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05ed1): (145, "AllocationMementoMap"),
  ("read_only_space", 0x05ef9): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x05f21): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05f49): (150, "BreakPointMap"),
  ("read_only_space", 0x05f71): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x05f99): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x05fc1): (154, "CallSiteInfoMap"),
  ("read_only_space", 0x05fe9): (155, "ClassPositionsMap"),
  ("read_only_space", 0x06011): (156, "DebugInfoMap"),
  ("read_only_space", 0x06039): (158, "ErrorStackDataMap"),
  ("read_only_space", 0x06061): (160, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x06089): (162, "InterpreterDataMap"),
  ("read_only_space", 0x060b1): (163, "ModuleRequestMap"),
  ("read_only_space", 0x060d9): (164, "PromiseCapabilityMap"),
  ("read_only_space", 0x06101): (165, "PromiseReactionMap"),
  ("read_only_space", 0x06129): (166, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x06151): (167, "PrototypeInfoMap"),
  ("read_only_space", 0x06179): (168, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x061a1): (169, "ScriptMap"),
  ("read_only_space", 0x061c9): (170, "ScriptOrModuleMap"),
  ("read_only_space", 0x061f1): (171, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x06219): (172, "StackFrameInfoMap"),
  ("read_only_space", 0x06241): (173, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x06269): (174, "Tuple2Map"),
  ("read_only_space", 0x06291): (175, "WasmContinuationObjectMap"),
  ("read_only_space", 0x062b9): (176, "WasmExceptionTagMap"),
  ("read_only_space", 0x062e1): (177, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x06309): (195, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06331): (230, "DescriptorArrayMap"),
  ("read_only_space", 0x06359): (219, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06381): (217, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x063a9): (220, "UncompiledDataWithoutPreparseDataWithJobMap"),
  ("read_only_space", 0x063d1): (218, "UncompiledDataWithPreparseDataAndJobMap"),
  ("read_only_space", 0x063f9): (249, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x06421): (196, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x06449): (200, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x06471): (199, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x06499): (197, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x064c1): (198, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x064e9): (245, "InternalClassMap"),
  ("read_only_space", 0x06511): (256, "SmiPairMap"),
  ("read_only_space", 0x06539): (255, "SmiBoxMap"),
  ("read_only_space", 0x06561): (201, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x06589): (202, "ExportedSubClassMap"),
  ("read_only_space", 0x065b1): (228, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x065d9): (229, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x06601): (194, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x06629): (246, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06651): (203, "ExportedSubClass2Map"),
  ("read_only_space", 0x06679): (257, "SortStateMap"),
  ("read_only_space", 0x066a1): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x066c9): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x066f1): (137, "LoadHandler1Map"),
  ("read_only_space", 0x06719): (137, "LoadHandler2Map"),
  ("read_only_space", 0x06741): (137, "LoadHandler3Map"),
  ("read_only_space", 0x06769): (138, "StoreHandler0Map"),
  ("read_only_space", 0x06791): (138, "StoreHandler1Map"),
  ("read_only_space", 0x067b9): (138, "StoreHandler2Map"),
  ("read_only_space", 0x067e1): (138, "StoreHandler3Map"),
