...
KNOWN_MAPS = {
    ...
    ("read_only_space", 0x0325d): (250, "OnePointerFillerMap"),
    ("read_only_space", 0x03285): (250, "TwoPointerFillerMap"),
    ("read_only_space", 0x032ad): (259, "PropertyArrayMap"),
    ("read_only_space", 0x032d5): (231, "SmallOrderedHashMapMap"),
    ("read_only_space", 0x032fd): (232, "SmallOrderedHashSetMap"),
    ("read_only_space", 0x03325): (233, "SmallOrderedNameDictionaryMap"),
    ("read_only_space", 0x0334d): (222, "UncompiledDataWithoutPreparseDataMap"),
    ("read_only_space", 0x03375): (220, "UncompiledDataWithPreparseDataMap"),
    ("read_only_space", 0x0339d): (223, "UncompiledDataWithoutPreparseDataWithJobMap"),
    ("read_only_space", 0x033c5): (221, "UncompiledDataWithPreparseDataAndJobMap"),
    ("read_only_space", 0x033ed): (257, "OnHeapBasicBlockProfilerDataMap"),
    ("read_only_space", 0x03415): (215, "TurbofanBitsetTypeMap"),
    ("read_only_space", 0x0343d): (219, "TurbofanUnionTypeMap"),
    ("read_only_space", 0x03465): (218, "TurbofanRangeTypeMap"),
    ("read_only_space", 0x0348d): (216, "TurbofanHeapConstantTypeMap"),
    ("read_only_space", 0x034b5): (217, "TurbofanOtherNumberConstantTypeMap"),
    ("read_only_space", 0x034dd): (198, "TurboshaftWord32TypeMap"),
    ("read_only_space", 0x03505): (199, "TurboshaftWord32RangeTypeMap"),
    ("read_only_space", 0x0352d): (201, "TurboshaftWord64TypeMap"),
    ("read_only_space", 0x03555): (202, "TurboshaftWord64RangeTypeMap"),
    ("read_only_space", 0x0357d): (195, "TurboshaftFloat64TypeMap"),
    ("read_only_space", 0x035a5): (196, "TurboshaftFloat64RangeTypeMap"),
    ("read_only_space", 0x035cd): (253, "InternalClassMap"),
    ("read_only_space", 0x035f5): (264, "SmiPairMap"),
    ("read_only_space", 0x0361d): (263, "SmiBoxMap"),
    ("read_only_space", 0x03645): (228, "ExportedSubClassBaseMap"),
    ("read_only_space", 0x0366d): (229, "ExportedSubClassMap"),
    ("read_only_space", 0x03695): (234, "AbstractInternalClassSubclass1Map"),
    ("read_only_space", 0x036bd): (235, "AbstractInternalClassSubclass2Map"),
    ("read_only_space", 0x036e5): (230, "ExportedSubClass2Map"),
    ("read_only_space", 0x0370d): (265, "SortStateMap"),
    ("read_only_space", 0x03735): (271, "WasmStringViewIterMap"),
    ("read_only_space", 0x0375d): (194, "SloppyArgumentsElementsMap"),
    ("read_only_space", 0x03785): (237, "StrongDescriptorArrayMap"),
    ("read_only_space", 0x037ad): (200, "TurboshaftWord32SetTypeMap"),
    ("read_only_space", 0x037d5): (203, "TurboshaftWord64SetTypeMap"),
    ("read_only_space", 0x037fd): (197, "TurboshaftFloat64SetTypeMap"),
    ("read_only_space", 0x03825): (193, "InternalClassWithSmiElementsMap"),
    ("read_only_space", 0x0384d): (254, "InternalClassWithStructElementsMap"),
    ("read_only_space", 0x03875): (252, "InstructionStreamMap"),
    ("read_only_space", 0x0389d): (244, "CellMap"),
    ("read_only_space", 0x038cd): (260, "GlobalPropertyCellMap"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x038c5): "InvalidPrototypeValidityCell",
