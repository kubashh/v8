...
KNOWN_MAPS = {
    ...
    ("old_space", 0x02269): (2126, "ExternalMap"),
    ("old_space", 0x02291): (2130, "JSMessageObjectMap"),
}
...
KNOWN_OBJECTS = {
  ...
  ("old_space", 0x083f9): "AsyncFunctionAwaitRejectSharedFun",
  ("old_space", 0x08425): "AsyncFunctionAwaitResolveSharedFun",
  ("old_space", 0x08451): "AsyncGeneratorAwaitRejectSharedFun",
  ("old_space", 0x0847d): "AsyncGeneratorAwaitResolveSharedFun",
  ("old_space", 0x084a9): "AsyncGeneratorYieldWithAwaitResolveSharedFun",
  ("old_space", 0x084d5): "AsyncGeneratorReturnResolveSharedFun",
  ("old_space", 0x08501): "AsyncGeneratorReturnClosedRejectSharedFun",
  ("old_space", 0x0852d): "AsyncGeneratorReturnClosedResolveSharedFun",
  ("old_space", 0x08559): "AsyncIteratorValueUnwrapSharedFun",
  ("old_space", 0x08585): "ErrorStackGetterSharedFun",
  ("old_space", 0x085d1): "ErrorStackSetterSharedFun",
  ("old_space", 0x0861d): "PromiseAllResolveElementSharedFun",
  ("old_space", 0x08649): "PromiseAllSettledResolveElementSharedFun",
  ("old_space", 0x08675): "PromiseAllSettledRejectElementSharedFun",
  ("old_space", 0x086a1): "PromiseAnyRejectElementSharedFun",
  ("old_space", 0x086cd): "PromiseCapabilityDefaultRejectSharedFun",
  ("old_space", 0x086f9): "PromiseCapabilityDefaultResolveSharedFun",
  ("old_space", 0x08725): "PromiseCatchFinallySharedFun",
  ("old_space", 0x08751): "PromiseGetCapabilitiesExecutorSharedFun",
  ("old_space", 0x0877d): "PromiseThenFinallySharedFun",
  ("old_space", 0x087a9): "PromiseThrowerFinallySharedFun",
  ("old_space", 0x087d5): "PromiseValueThunkFinallySharedFun",
  ("old_space", 0x08801): "ProxyRevokeSharedFun",
  ("old_space", 0x0882d): "ShadowRealmImportValueFulfilledSFI",
  ("old_space", 0x08859): "SourceTextModuleExecuteAsyncModuleFulfilledSFI",
  ("old_space", 0x08885): "SourceTextModuleExecuteAsyncModuleRejectedSFI",
}
