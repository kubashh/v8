...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x02de1): (156, "SyntheticModuleMap"),
  ("read_only_space", 0x02e09): (71, "WasmTypeInfoMap"),
  ("read_only_space", 0x02e31): (184, "WeakArrayListMap"),
  ("read_only_space", 0x02e59): (120, "EphemeronHashTableMap"),
  ("read_only_space", 0x02e81): (165, "EmbedderDataArrayMap"),
  ("read_only_space", 0x02ea9): (185, "WeakCellMap"),
  ...
  ("read_only_space", 0x03269): (100, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x058bd): (111, "StackTraceFrameMap"),
  ("read_only_space", 0x058e5): (112, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x0590d): (113, "Tuple2Map"),
  ("read_only_space", 0x05935): (114, "WasmExceptionTagMap"),
  ("read_only_space", 0x0595d): (115, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x05985): (116, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x059ad): (117, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x059d5): (136, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x059fd): (153, "DescriptorArrayMap"),
  ("read_only_space", 0x05a25): (158, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x05a4d): (157, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x05a75): (173, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x05a9d): (182, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x05ac5): (170, "InternalClassMap"),
  ("read_only_space", 0x05aed): (179, "SmiPairMap"),
  ("read_only_space", 0x05b15): (178, "SmiBoxMap"),
  ("read_only_space", 0x05b3d): (147, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x05b65): (148, "ExportedSubClassMap"),
  ("read_only_space", 0x05b8d): (68, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x05bb5): (69, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x05bdd): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x05c05): (171, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x05c2d): (149, "ExportedSubClass2Map"),
  ("read_only_space", 0x05c55): (180, "SortStateMap"),
