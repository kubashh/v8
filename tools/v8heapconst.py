...
INSTANCE_TYPES = {
  ...
  3: "SLICED_INTERNALIZED_STRING_TYPE",
  8: "ONE_BYTE_INTERNALIZED_STRING_TYPE",
  10: "EXTERNAL_ONE_BYTE_INTERNALIZED_STRING_TYPE",
  11: "SLICED_ONE_BYTE_INTERNALIZED_STRING_TYPE",
...
KNOWN_MAPS = {
  ...
  ("RO_SPACE", 0x04849): (3, "SlicedInternalizedStringMap"),
  ("RO_SPACE", 0x048b1): (11, "SlicedOneByteInternalizedStringMap"),
  ...
  ("RO_SPACE", 0x050e9): (172, "Tuple2Map"),
  ("RO_SPACE", 0x052e1): (170, "ScriptMap"),
  ("RO_SPACE", 0x054a9): (162, "InterceptorInfoMap"),
  ("RO_SPACE", 0x07cd9): (154, "AccessorInfoMap"),
  ("RO_SPACE", 0x07ee9): (153, "AccessCheckInfoMap"),
  ("RO_SPACE", 0x07f51): (155, "AccessorPairMap"),
  ("RO_SPACE", 0x07fb9): (156, "AliasedArgumentsEntryMap"),
  ("RO_SPACE", 0x08021): (157, "AllocationMementoMap"),
  ("RO_SPACE", 0x08089): (158, "AllocationSiteMap"),
  ("RO_SPACE", 0x080f1): (159, "AsyncGeneratorRequestMap"),
  ("RO_SPACE", 0x08159): (160, "DebugInfoMap"),
  ("RO_SPACE", 0x081c1): (161, "FunctionTemplateInfoMap"),
  ("RO_SPACE", 0x08229): (163, "InterpreterDataMap"),
  ("RO_SPACE", 0x08291): (164, "ModuleInfoEntryMap"),
  ("RO_SPACE", 0x082f9): (165, "ModuleMap"),
  ("RO_SPACE", 0x08361): (166, "ObjectTemplateInfoMap"),
  ("RO_SPACE", 0x083c9): (167, "PromiseCapabilityMap"),
  ("RO_SPACE", 0x08431): (168, "PromiseReactionMap"),
  ("RO_SPACE", 0x08499): (169, "PrototypeInfoMap"),
  ("RO_SPACE", 0x08501): (171, "StackFrameInfoMap"),
  ("RO_SPACE", 0x08569): (173, "Tuple3Map"),
  ("RO_SPACE", 0x085d1): (174, "WasmCompiledModuleMap"),
  ("RO_SPACE", 0x08639): (175, "WasmDebugInfoMap"),
  ("RO_SPACE", 0x086a1): (176, "WasmExportedFunctionDataMap"),
  ("RO_SPACE", 0x08709): (177, "WasmSharedModuleDataMap"),
  ("RO_SPACE", 0x08771): (178, "CallableTaskMap"),
  ("RO_SPACE", 0x087d9): (179, "CallbackTaskMap"),
  ("RO_SPACE", 0x08841): (180, "PromiseFulfillReactionJobTaskMap"),
  ("RO_SPACE", 0x088a9): (181, "PromiseRejectReactionJobTaskMap"),
  ("RO_SPACE", 0x08911): (182, "PromiseResolveThenableJobTaskMap"),
