...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x01531): (93, "ManyClosuresCellMap"),
  ("read_only_space", 0x01581): (118, "ModuleInfoMap"),
  ("read_only_space", 0x015d1): (122, "NameDictionaryMap"),
  ("read_only_space", 0x01621): (93, "NoClosuresCellMap"),
  ("read_only_space", 0x01671): (123, "NumberDictionaryMap"),
  ("read_only_space", 0x016c1): (93, "OneClosureCellMap"),
  ...
  ("read_only_space", 0x018a1): (89, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x018f1): (89, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x01941): (89, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ...
  ("read_only_space", 0x023a9): (92, "EnumCacheMap"),
  ("read_only_space", 0x02449): (86, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x02639): (95, "InterceptorInfoMap"),
  ...
  ("read_only_space", 0x051a9): (80, "AccessCheckInfoMap"),
  ("read_only_space", 0x051f9): (81, "AccessorInfoMap"),
  ("read_only_space", 0x05249): (82, "AccessorPairMap"),
  ("read_only_space", 0x05299): (83, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x052e9): (84, "AllocationMementoMap"),
  ("read_only_space", 0x05339): (87, "AsmWasmDataMap"),
  ("read_only_space", 0x05389): (88, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x053d9): (90, "ClassPositionsMap"),
  ("read_only_space", 0x05429): (91, "DebugInfoMap"),
  ("read_only_space", 0x05479): (94, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x054c9): (97, "InterpreterDataMap"),
  ("read_only_space", 0x05519): (98, "PromiseCapabilityMap"),
  ("read_only_space", 0x05569): (99, "PromiseReactionMap"),
  ("read_only_space", 0x055b9): (100, "PrototypeInfoMap"),
  ("read_only_space", 0x05609): (101, "ScriptMap"),
  ("read_only_space", 0x05659): (105, "SourcePositionTableWithFrameCacheMap"),
  ("read_only_space", 0x056a9): (106, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x056f9): (107, "StackFrameInfoMap"),
  ("read_only_space", 0x05749): (108, "StackTraceFrameMap"),
  ("read_only_space", 0x05799): (109, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x057e9): (110, "Tuple2Map"),
  ("read_only_space", 0x05839): (111, "Tuple3Map"),
  ...
  ("read_only_space", 0x05a69): (96, "InternalClassMap"),
  ("read_only_space", 0x05ab9): (103, "SmiPairMap"),
  ("read_only_space", 0x05b09): (102, "SmiBoxMap"),
  ("read_only_space", 0x05b59): (104, "SortStateMap"),
  ("read_only_space", 0x05ba9): (85, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05bf9): (85, "AllocationSiteWithoutWeakNextMap"),
