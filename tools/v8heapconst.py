...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x0389d): (164, "InternalClassMap"),
  ("read_only_space", 0x038c5): (172, "SmiPairMap"),
  ("read_only_space", 0x038ed): (171, "SmiBoxMap"),
  ("read_only_space", 0x03915): (68, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x0393d): (69, "ExportedSubClassMap"),
  ("read_only_space", 0x03965): (134, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x0398d): (165, "InternalClassWithStructElementsMap"),
