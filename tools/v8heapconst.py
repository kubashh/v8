...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x05121): (153, "AccessCheckInfoMap"),
  ("read_only_space", 0x05171): (154, "AccessorInfoMap"),
  ("read_only_space", 0x051c1): (155, "AccessorPairMap"),
  ("read_only_space", 0x05211): (156, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05261): (157, "AllocationMementoMap"),
  ("read_only_space", 0x052b1): (158, "AsmWasmDataMap"),
  ("read_only_space", 0x05301): (159, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x05351): (160, "ClassPositionsMap"),
  ("read_only_space", 0x053a1): (161, "DebugInfoMap"),
  ("read_only_space", 0x053f1): (162, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05441): (163, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x05491): (165, "InterpreterDataMap"),
  ("read_only_space", 0x054e1): (166, "ModuleInfoEntryMap"),
  ("read_only_space", 0x05531): (167, "ModuleMap"),
  ("read_only_space", 0x05581): (168, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x055d1): (169, "PromiseCapabilityMap"),
  ("read_only_space", 0x05621): (170, "PromiseReactionMap"),
  ("read_only_space", 0x05671): (171, "PrototypeInfoMap"),
  ("read_only_space", 0x056c1): (172, "ScriptMap"),
  ("read_only_space", 0x05711): (173, "StackFrameInfoMap"),
  ("read_only_space", 0x05761): (174, "StackTraceFrameMap"),
  ("read_only_space", 0x057b1): (176, "Tuple3Map"),
  ("read_only_space", 0x05801): (178, "WasmDebugInfoMap"),
  ("read_only_space", 0x05851): (179, "WasmExceptionTagMap"),
  ("read_only_space", 0x058a1): (180, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x058f1): (181, "CallableTaskMap"),
  ("read_only_space", 0x05941): (182, "CallbackTaskMap"),
  ("read_only_space", 0x05991): (183, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x059e1): (184, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05a31): (185, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05a81): (186, "FinalizationGroupCleanupJobTaskMap"),
  ("read_only_space", 0x05ad1): (187, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x05b21): (187, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x05b71): (222, "LoadHandler1Map"),
  ("read_only_space", 0x05bc1): (222, "LoadHandler2Map"),
  ("read_only_space", 0x05c11): (222, "LoadHandler3Map"),
  ("read_only_space", 0x05c61): (230, "StoreHandler0Map"),
  ("read_only_space", 0x05cb1): (230, "StoreHandler1Map"),
  ("read_only_space", 0x05d01): (230, "StoreHandler2Map"),
  ("read_only_space", 0x05d51): (230, "StoreHandler3Map"),
