...
KNOWN_MAPS = {
  ...
  ("read_only_space", 0x021b1): (261, "WeakArrayListMap"),
  ...
  ("read_only_space", 0x02bd1): (184, "NumberDictionaryMap"),
  ("read_only_space", 0x02bf9): (159, "OneClosureCellMap"),
  ("read_only_space", 0x02c21): (185, "OrderedHashMapMap"),
  ("read_only_space", 0x02c49): (186, "OrderedHashSetMap"),
  ("read_only_space", 0x02c71): (183, "NameToIndexHashTableMap"),
  ("read_only_space", 0x02c99): (187, "OrderedNameDictionaryMap"),
  ("read_only_space", 0x02cc1): (251, "PreparseDataMap"),
  ("read_only_space", 0x02ce9): (252, "PropertyArrayMap"),
  ("read_only_space", 0x02d11): (153, "SideEffectCallHandlerInfoMap"),
  ("read_only_space", 0x02d39): (153, "SideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x02d61): (153, "NextCallSideEffectFreeCallHandlerInfoMap"),
  ("read_only_space", 0x02d89): (188, "SimpleNumberDictionaryMap"),
  ("read_only_space", 0x02db1): (228, "SmallOrderedHashMapMap"),
  ("read_only_space", 0x02dd9): (229, "SmallOrderedHashSetMap"),
  ("read_only_space", 0x02e01): (230, "SmallOrderedNameDictionaryMap"),
  ("read_only_space", 0x02e29): (233, "SourceTextModuleMap"),
  ("read_only_space", 0x02e51): (259, "SwissNameDictionaryMap"),
  ("read_only_space", 0x02e79): (234, "SyntheticModuleMap"),
  ("read_only_space", 0x02ea1): (260, "WasmApiFunctionRefMap"),
  ("read_only_space", 0x02ec9): (222, "WasmCapiFunctionDataMap"),
  ("read_only_space", 0x02ef1): (223, "WasmExportedFunctionDataMap"),
  ("read_only_space", 0x02f19): (205, "WasmInternalFunctionMap"),
  ("read_only_space", 0x02f41): (224, "WasmJSFunctionDataMap"),
  ("read_only_space", 0x02f69): (206, "WasmTypeInfoMap"),
  ("read_only_space", 0x02f91): (235, "WeakFixedArrayMap"),
  ("read_only_space", 0x02fb9): (180, "EphemeronHashTableMap"),
  ("read_only_space", 0x02fe1): (241, "EmbedderDataArrayMap"),
  ("read_only_space", 0x03009): (262, "WeakCellMap"),
  ("read_only_space", 0x03031): (32, "StringMap"),
  ("read_only_space", 0x03059): (41, "ConsOneByteStringMap"),
  ("read_only_space", 0x03081): (33, "ConsStringMap"),
  ("read_only_space", 0x030a9): (37, "ThinStringMap"),
  ("read_only_space", 0x030d1): (35, "SlicedStringMap"),
  ("read_only_space", 0x030f9): (43, "SlicedOneByteStringMap"),
  ("read_only_space", 0x03121): (34, "ExternalStringMap"),
  ("read_only_space", 0x03149): (42, "ExternalOneByteStringMap"),
  ("read_only_space", 0x03171): (50, "UncachedExternalStringMap"),
  ("read_only_space", 0x03199): (0, "InternalizedStringMap"),
  ("read_only_space", 0x031c1): (2, "ExternalInternalizedStringMap"),
  ("read_only_space", 0x031e9): (10, "ExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03211): (18, "UncachedExternalInternalizedStringMap"),
  ("read_only_space", 0x03239): (26, "UncachedExternalOneByteInternalizedStringMap"),
  ("read_only_space", 0x03261): (58, "UncachedExternalOneByteStringMap"),
  ("read_only_space", 0x03289): (104, "SharedOneByteStringMap"),
  ("read_only_space", 0x032b1): (96, "SharedStringMap"),
  ("read_only_space", 0x032d9): (109, "SharedThinOneByteStringMap"),
  ("read_only_space", 0x03301): (101, "SharedThinStringMap"),
  ("read_only_space", 0x03329): (96, "TwoByteSeqStringMigrationSentinelMap"),
  ("read_only_space", 0x03351): (104, "OneByteSeqStringMigrationSentinelMap"),
  ("read_only_space", 0x03379): (131, "SelfReferenceMarkerMap"),
  ("read_only_space", 0x033a1): (131, "BasicBlockCountersMarkerMap"),
  ("read_only_space", 0x033e5): (147, "ArrayBoilerplateDescriptionMap"),
  ("read_only_space", 0x034e5): (161, "InterceptorInfoMap"),
  ("read_only_space", 0x05ded): (132, "PromiseFulfillReactionJobTaskMap"),
  ("read_only_space", 0x05e15): (133, "PromiseRejectReactionJobTaskMap"),
  ("read_only_space", 0x05e3d): (134, "CallableTaskMap"),
  ("read_only_space", 0x05e65): (135, "CallbackTaskMap"),
  ("read_only_space", 0x05e8d): (136, "PromiseResolveThenableJobTaskMap"),
  ("read_only_space", 0x05eb5): (139, "FunctionTemplateInfoMap"),
  ("read_only_space", 0x05edd): (140, "ObjectTemplateInfoMap"),
  ("read_only_space", 0x05f05): (141, "AccessCheckInfoMap"),
  ("read_only_space", 0x05f2d): (142, "AccessorInfoMap"),
  ("read_only_space", 0x05f55): (143, "AccessorPairMap"),
  ("read_only_space", 0x05f7d): (144, "AliasedArgumentsEntryMap"),
  ("read_only_space", 0x05fa5): (145, "AllocationMementoMap"),
  ("read_only_space", 0x05fcd): (148, "AsmWasmDataMap"),
  ("read_only_space", 0x05ff5): (149, "AsyncGeneratorRequestMap"),
  ("read_only_space", 0x0601d): (150, "BreakPointMap"),
  ("read_only_space", 0x06045): (151, "BreakPointInfoMap"),
  ("read_only_space", 0x0606d): (152, "CachedTemplateObjectMap"),
  ("read_only_space", 0x06095): (154, "CallSiteInfoMap"),
  ("read_only_space", 0x060bd): (155, "ClassPositionsMap"),
  ("read_only_space", 0x060e5): (156, "DebugInfoMap"),
  ("read_only_space", 0x0610d): (158, "ErrorStackDataMap"),
  ("read_only_space", 0x06135): (160, "FunctionTemplateRareDataMap"),
  ("read_only_space", 0x0615d): (162, "InterpreterDataMap"),
  ("read_only_space", 0x06185): (163, "ModuleRequestMap"),
  ("read_only_space", 0x061ad): (164, "PromiseCapabilityMap"),
  ("read_only_space", 0x061d5): (165, "PromiseReactionMap"),
  ("read_only_space", 0x061fd): (166, "PropertyDescriptorObjectMap"),
  ("read_only_space", 0x06225): (167, "PrototypeInfoMap"),
  ("read_only_space", 0x0624d): (168, "RegExpBoilerplateDescriptionMap"),
  ("read_only_space", 0x06275): (169, "ScriptMap"),
  ("read_only_space", 0x0629d): (170, "ScriptOrModuleMap"),
  ("read_only_space", 0x062c5): (171, "SourceTextModuleInfoEntryMap"),
  ("read_only_space", 0x062ed): (172, "StackFrameInfoMap"),
  ("read_only_space", 0x06315): (173, "TemplateObjectDescriptionMap"),
  ("read_only_space", 0x0633d): (174, "Tuple2Map"),
  ("read_only_space", 0x06365): (175, "WasmContinuationObjectMap"),
  ("read_only_space", 0x0638d): (176, "WasmExceptionTagMap"),
  ("read_only_space", 0x063b5): (177, "WasmIndirectFunctionTableMap"),
  ("read_only_space", 0x063dd): (196, "SloppyArgumentsElementsMap"),
  ("read_only_space", 0x06405): (231, "DescriptorArrayMap"),
  ("read_only_space", 0x0642d): (219, "UncompiledDataWithoutPreparseDataMap"),
  ("read_only_space", 0x06455): (217, "UncompiledDataWithPreparseDataMap"),
  ("read_only_space", 0x0647d): (220, "UncompiledDataWithoutPreparseDataWithJobMap"),
  ("read_only_space", 0x064a5): (218, "UncompiledDataWithPreparseDataAndJobMap"),
  ("read_only_space", 0x064cd): (250, "OnHeapBasicBlockProfilerDataMap"),
  ("read_only_space", 0x064f5): (197, "TurbofanBitsetTypeMap"),
  ("read_only_space", 0x0651d): (201, "TurbofanUnionTypeMap"),
  ("read_only_space", 0x06545): (200, "TurbofanRangeTypeMap"),
  ("read_only_space", 0x0656d): (198, "TurbofanHeapConstantTypeMap"),
  ("read_only_space", 0x06595): (199, "TurbofanOtherNumberConstantTypeMap"),
  ("read_only_space", 0x065bd): (246, "InternalClassMap"),
  ("read_only_space", 0x065e5): (257, "SmiPairMap"),
  ("read_only_space", 0x0660d): (256, "SmiBoxMap"),
  ("read_only_space", 0x06635): (225, "ExportedSubClassBaseMap"),
  ("read_only_space", 0x0665d): (226, "ExportedSubClassMap"),
  ("read_only_space", 0x06685): (202, "AbstractInternalClassSubclass1Map"),
  ("read_only_space", 0x066ad): (203, "AbstractInternalClassSubclass2Map"),
  ("read_only_space", 0x066d5): (195, "InternalClassWithSmiElementsMap"),
  ("read_only_space", 0x066fd): (247, "InternalClassWithStructElementsMap"),
  ("read_only_space", 0x06725): (227, "ExportedSubClass2Map"),
  ("read_only_space", 0x0674d): (258, "SortStateMap"),
  ("read_only_space", 0x06775): (146, "AllocationSiteWithWeakNextMap"),
  ("read_only_space", 0x0679d): (146, "AllocationSiteWithoutWeakNextMap"),
  ("read_only_space", 0x067c5): (137, "LoadHandler1Map"),
  ("read_only_space", 0x067ed): (137, "LoadHandler2Map"),
  ("read_only_space", 0x06815): (137, "LoadHandler3Map"),
  ("read_only_space", 0x0683d): (138, "StoreHandler0Map"),
  ("read_only_space", 0x06865): (138, "StoreHandler1Map"),
  ("read_only_space", 0x0688d): (138, "StoreHandler2Map"),
  ("read_only_space", 0x068b5): (138, "StoreHandler3Map"),
...
KNOWN_OBJECTS = {
  ...
  ("read_only_space", 0x033c9): "EmptyPropertyArray",
  ("read_only_space", 0x033d1): "EmptyByteArray",
  ("read_only_space", 0x033d9): "EmptyObjectBoilerplateDescription",
  ("read_only_space", 0x0340d): "EmptyArrayBoilerplateDescription",
  ("read_only_space", 0x03419): "EmptyClosureFeedbackCellArray",
  ("read_only_space", 0x03421): "EmptySlowElementDictionary",
  ("read_only_space", 0x03445): "EmptyOrderedHashMap",
  ("read_only_space", 0x03459): "EmptyOrderedHashSet",
  ("read_only_space", 0x0346d): "EmptyFeedbackMetadata",
  ("read_only_space", 0x03479): "EmptyPropertyDictionary",
  ("read_only_space", 0x034a1): "EmptyOrderedPropertyDictionary",
  ("read_only_space", 0x034b9): "EmptySwissPropertyDictionary",
  ("read_only_space", 0x0350d): "NoOpInterceptorInfo",
  ("read_only_space", 0x03535): "EmptyWeakFixedArray",
  ("read_only_space", 0x0353d): "InfinityValue",
  ("read_only_space", 0x03549): "MinusZeroValue",
  ("read_only_space", 0x03555): "MinusInfinityValue",
  ("read_only_space", 0x03561): "SelfReferenceMarker",
  ("read_only_space", 0x035a1): "BasicBlockCountersMarker",
  ("read_only_space", 0x035e5): "OffHeapTrampolineRelocationInfo",
  ("read_only_space", 0x035f1): "TrampolineTrivialCodeDataContainer",
  ("read_only_space", 0x035fd): "TrampolinePromiseRejectionCodeDataContainer",
  ("read_only_space", 0x03609): "GlobalThisBindingScopeInfo",
  ("read_only_space", 0x03639): "EmptyFunctionScopeInfo",
  ("read_only_space", 0x0365d): "NativeScopeInfo",
  ("read_only_space", 0x03675): "HashSeed",
