...
function IcProcessor() {
  var propertyICParser = [parseInt, parseInt, parseInt, null, null, parseInt, null, null];
  LogReader.call(this, {
      'code-creation': {
      ...
      'CompareIC': {
        parsers : [parseInt, parseInt, parseInt, parseInt, null, null, null, null, null, null, null],
        processor: this.processCompareIC },
      'BinaryOpIC': {
        parsers : [parseInt, parseInt, parseInt, parseInt, null, null, parseInt],
...
IcProcessor.prototype.processPropertyIC = function (
    type, pc, line, column, old_state, new_state, map, name, slow_reason) {
  this[type]++;
  var entry = this.profile_.findEntry(pc);
  print(type + " (" + old_state + "->" + new_state + ") at " +
