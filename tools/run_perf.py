...
class Platform(object):
  ...
  def _RunWrapper(self, runnable, count, secondary=False):
  ...
  def Run(self, runnable, count):
    ...
    """
    output = self._RunWrapper(runnable, count, secondary=False)
    if self.shell_dir_secondary:
      return output, self._RunWrapper(runnable, count, secondary=True)
    else:
