    ...
    "traces": [
      {
        ...
        "results": [<list of values measured in each run>],
...
def AccumulateResults(
  ...
  if len(set(map(lambda r: len(r), raw_results))) != 1:
    results.AddErrors(['Not all traces have the same number of results.'])
    return
