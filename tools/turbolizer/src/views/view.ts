...
export abstract class PhaseView extends View {
  public abstract initializeContent(data: GenericPhase, rememberedSelection: SelectionStorage): void;
  ...
  public abstract searchInputAction(searchInput: HTMLInputElement, e: KeyboardEvent, onlyVisible: boolean): void;
