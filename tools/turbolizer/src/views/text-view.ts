...
export abstract class TextView extends PhaseView {
  ...
  private initializeRegisterAllocationSelectionHandler(): RegisterAllocationSelectionHandler & ClearableHandler {
    const view = this;
    return {
      ...
      brokeredRegisterAllocationSelect: function (instructionIds: Array<number>, selected: boolean) {
        const firstSelect = view.blockSelection.isEmpty();
        view.registerAllocationSelection.select(instructionIds, selected);
        view.updateSelection(firstSelect);
      },
