...
export class GraphMultiView extends View {
  ...
  private displayPhase(phase: GenericPhase, selection?: RememberedSelection): void {
  ...
  private displayPhaseView(view: PhaseView, data: GenericPhase, selection?: RememberedSelection):
    void {
  ...
  private displayPhaseByName(phaseName: string, selection?: RememberedSelection): void {
  ...
  private hideCurrentPhase(): RememberedSelection {
