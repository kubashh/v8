...
class BuildConfig(object):
  ...
  def no_js_shared_memory(self):
    return (not self.shared_ro_heap) or (self.pointer_compression and not self.pointer_compression_shared_cage)
  ...
  def simd_mips(self):
    return (
      self.is_mips_arch and
      self.mips_arch_variant == "r6" and
      self.mips_use_msa)
