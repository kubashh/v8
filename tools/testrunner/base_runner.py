...
class BaseTestRunner(object):
  ...
  def _load_testsuite_generators(self, ctx, names):
    ...
    for name in names:
      ...
      suite = testsuite.TestSuite.Load(ctx,
  ...
  def _get_statusfile_variables(self):
    return {
      ...
      "mips_arch_variant": self.build_config.mips_arch_variant,
      "mode": self.mode_options.status_mode,
      "msan": self.build_config.msan,
      "no_harness": self.options.no_harness,
      "no_i18n": self.build_config.no_i18n,
      "no_simd_hardware": self.build_config.no_simd_hardware,
      "novfp3": False,
      "optimize_for_size": "--optimize-for-size" in self.options.extra_flags,
      "predictable": self.build_config.predictable,
      "simd_mips": self.build_config.simd_mips,
      ...
      "no_js_shared_memory": self.build_config.no_js_shared_memory,
