...
class GCFuzzer(base_runner.BaseTestRunner):
  ...
  def _add_parser_options(self, parser):
    ...
    parser.add_option("--stress-marking", default=0, type="int",
                      help="probability [0-100] of adding --stress-marking "
                           "flag to the test")
    parser.add_option("--stress-scavenge", default=0, type="int",
                      help="probability [0-100] of adding --stress-scavenge "
                           "flag to the test")
    parser.add_option("--stress-compaction", default=0, type="int",
                      help="probability [0-100] of adding --stress-compaction "
                           "flag to the test")
    parser.add_option("--stress-gc", default=0, type="int",
                      help="probability [0-100] of adding --random-gc-interval "
                           "flag to the test")
