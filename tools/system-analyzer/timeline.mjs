...
class Timeline {
  ...
  // Return the first index before {time}.
  find(time, startIndex = 0) {
    return this._find(this._values, each => each.time - time, startIndex);
  }

  _find(array, compareFn, startIndex = 0) {
