...
# Extracted using: gn desc out/$PLATFORM.release ':d8'
OPTIONS_64BIT = [
...
def main(args):
  ...
  parser.add_option(
      ...
      help=f"V8 checkout directory containting /src, default='{default_root_dir}'"
  )
...
def verify_dirs(parser, options):
  for flag in [
      "--v8-build-dir", "--v8-build-dir", "--clang-bin-dir",
      "--clang-plugins-dir"
  ]:
