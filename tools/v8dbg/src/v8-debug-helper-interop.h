...
#ifndef V8_TOOLS_V8DBG_SRC_V8_DEBUG_HELPER_INTEROP_H_
#define V8_TOOLS_V8DBG_SRC_V8_DEBUG_HELPER_INTEROP_H_
...
struct StructField {
  ...
  uint64_t offset;  // Offset, in bytes, from beginning of struct.
...
#endif  // V8_TOOLS_V8DBG_SRC_V8_DEBUG_HELPER_INTEROP_H_
